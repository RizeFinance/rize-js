...
class Rize {
    ...
    constructor(
         ...
         * at the end of the respective periods. The document resource returned in `document.getList()` and `GET document.get()` will describe
         * the metadata of the document, such as its document type and the document period.
         * 
