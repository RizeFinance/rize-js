...
class Rize {
    ...
    constructor(
        ...
        /**
         * A Custodial Account is the account held by the Custodian participating in your Program.
         * Customer must successfully complete onboarding and pass all KYC/AML checks before their Custodial Accounts can be opened.
