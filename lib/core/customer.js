...
class CustomerService {
   ...
   */
    _validateUpdateParams(uid, email, details, customer_type = 'primary') {
        if (validator.isEmpty(uid, { ignore_whitespace: true })) {
            throw new Error('Customer "uid" is required.');
        }
        if (email && !validator.isEmail(email)) {
   ...
   * @param {CustomerDetails} details
   */
         _validateSecondaryCustomerParams(uid, primary_customer_uid, details, customer_type) {
            if (validator.isEmpty(uid, { ignore_whitespace: true })) {
                throw new Error('Customer "uid" is required.');
            }
            if (validator.isEmpty(primary_customer_uid, { ignore_whitespace: true })) {
   ...
   */
         async createSecondary(externalUid, primary_customer_uid, details) {
            this._validateSecondaryCustomerParams(externalUid, primary_customer_uid, details);
