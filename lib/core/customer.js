...
class CustomerService {
     ...
     * @param {string} email
     */
    _validateCreateParams(externalUid, email) {
     ...
     */
    async create(externalUid, email) {
        this._validateCreateParams(externalUid, email);
    ...
    async identityConfirmation(uid) {
        ...
        const response = await this._api.put(`/customers/${uid}/identity_confirmation`);
