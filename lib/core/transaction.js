...
class TransactionService {
    ...
    async getList(query = {}) {
        ...
        const response = await this._api.get(`/transactions/${queryStr}`);
    ...
    async get(uid) {
        ...
        const response = await this._api.get(`/transactions/${uid}`);
    ...
    async getTransactionEventList(query = {}) {
        ...
        const response = await this._api.get(`/transaction_events/${queryStr}`);
    ...
    async getTransactionEvent(uid) {
        ...
        const response = await this._api.get(`/transaction_events/${uid}`);
    ...
    async getSyntheticLineItemList(query = {}) {
        ...
        const response = await this._api.get(`/synthetic_line_items/${queryStr}`);
    ...
    async getSyntheticLineItem(uid) {
        ...
        const response = await this._api.get(`/synthetic_line_items/${uid}`);
    ...
    async getCustodialLineItemList(query = {}) {
        ...
        const response = await this._api.get(`/custodial_line_items/${queryStr}`);
    ...
    async getCustodialLineItem(uid) {
        ...
        const response = await this._api.get(`/custodial_line_items/${uid}`);
