...
class ComplianceWorkflowService {
     ...
     */
    async create (customerExternalUid, compliancePlanUid) {
        if (validator.isEmpty(customerExternalUid, { ignore_whitespace: true })) {
            throw new Error('"customerExternalUid" is required.');
        }
        if (validator.isEmpty(compliancePlanUid, { ignore_whitespace: true })) {
            throw new Error('"compliancePlanUid" is invalid.');
        }
        ...
        const response = await this._api.post(
            '/compliance_workflows',
            {
                ...
                'compliance_plan_uid': compliancePlanUid
            }
        );
