 ...
 * @property {string} externalUid - (Required) A unique identifier Client supplies
 * @property {string} name - (Required) A unique name to identify the resource
 * @property {string} poolUid - (Required) A UID referring to the pool this Synthetic Account belongs to
 * @property {string} syntheticAccountTypeUid - (Required) A UID referring to the Synthetic Account Type this Synthetic Account should be created as
