 ...
 * @property {'general' | 'external' | 'plaid_external' | 'target_yield_account' | 'outbound_ach'} synthetic_account_category - The name of the Synthetic Account Category associated with the Synthetic Account Type for this account. Refer to the Synthetic Account Type for details.
 ...
 * @property {'general' | 'external' | 'plaid_external' | 'target_yield_account' | 'outbound_ach'} [synthetic_account_category] - Filter by Synthetic Account Category
