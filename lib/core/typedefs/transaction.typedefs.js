 ...
 * @property {integer} phase - Some Transfer types will trigger multiple transfers at the custodial level. Some of these custodial transfers must wait for all dependent custodial transfers to complete before initiating.
 ...
 * @property {string} status - Other statuses such as pending will be available later
 * @property {string} us_dollar_amount - The amount will never be negative
 ...
 * @property {string} [transaction_uid] - Filter by Transaction. Multiple values are allowed
 * @property {number} [limit] - Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default = 100.
 * @property {number} [offset] - Index of the items to start retrieving from. Default = 0.
