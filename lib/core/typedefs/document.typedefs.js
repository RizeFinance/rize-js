 ...
 * @property {Array<string>} custodial_account_uids
 ...
 * @property {Array<string>} synthetic_account_uids
 ...
 * @property {number} [month] - Filter by month. This includes any document for which the period started in the specified month.
 ...
 * @property {string} data - Object that contains more information about the response.
 * @property {string} headers - Collection of response headers.
 */
