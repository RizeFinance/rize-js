 ...
 * @property {'physical'|'virtual'} type - The type of debit card
...
/**
 * @typedef {Object} DebitCardAccessToken
 * @property {string} token - This token will be used to request a virtual card image.
 * @property {string} config_id - This configuration ID is required to retrieve the virtual card image.
 */

/**
 * @typedef {Object} DebitCardMigrateData
 * @property {string} uid - Rize-generated unique Debit Card uid
 * @property {string} [externalUid] - A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
 * @property {string} customerUid - A UID referring to the Customer who owns this Card
 * @property {string} poolUid - A UID referring to the Pool to which this Card belongs
 * @property {Address} [shippingAddress] - An optional field used to specify the shipping address for a physical Debit Card.
 */
