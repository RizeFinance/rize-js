 ...
 * @property {'primary'|'secondary'|'sole_proprietor'} customer_type - The type of Customer.
 ...
 * @property {'primary'|'secondary'|'sole_proprietor'} [customer_type] - Only return Customers with a customer type matching exactly what is submitted.
