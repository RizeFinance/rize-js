...
/**
 * @typedef {Object} CustomerDetailsParams
 * @property {string} first_name
 * @property {string|null} [middle_name]
 * @property {string} last_name
 * @property {string} [business_name] Required for customers of type sole_proprietor; ignored otherwise. 1-256 alphanumeric characters.
 * @property {string|null} [suffix]
 * @property {string} phone
 * @property {string} [ssn] Required for customers of type primary and sole_proprietor; ignored otherwise.
 * @property {string} dob
 * @property {Address} address
 */
 ...
 * @property {string|null} external_uid - A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
 * @property {'primary'|'secondary'|'sole_proprietor'|'sub_ledger'} customer_type - The type of Customer.
 ...
 * @property {string|null} email - Email of the customer
 * @property {'initiated'|'queued'|'identity_verified'|'active'|'manual_review'|'rejected'|'archived'|'under_review'|'pending_archival'} status
 ...
 * @property {Array<string> | null} secondary_customer_uids Secondary type customers associated with the Customer. 
 * @property {Array<CustomerProfileAnswerDetails>} profile_responses 
 * @property {string | null} primary_customer_uid 
 * @property {Date} pii_confirmed_at
 * @property {Array | null} kyc_status_reasons
 ...
 * @property {string | Record<string, unknown>} profile_response - The Customer's response to the Profile Requirement, pending on the question may require a string or object ordered hash list response.
 */
 ...
 * @property {'primary'|'secondary'|'sole_proprietor'|'sub_ledger'} [customer_type] - Only return Customers with a customer type matching exactly what is submitted.
 ...
 * @property {string} [business_name] - Only return Customers with a business name at least partially matching what is submitted. Exact matches will be sorted first
