...
declare class CustomerService {
     ...
     * @param {CustomerDetails} details
     */
    protected _validateDetailParams(details: CustomerDetails): void;
    /**
     * @ignore @protected
     ...
     */
    createSecondary(externalUid: string, primary_customer_uid: string, email: string, details: CustomerDetails): Promise<Customer>;
    /**
     ...
     * );
     */
    update(uid: string, email: string | null, details: CustomerDetails, customer_type: 'primary' | 'sole_proprietor' | 'secondary'): Promise<Customer>;
    /**
