...
Returns **[Promise][63]&lt;[RizeList][67]&lt;[Customer][68]>>** A promise that returns a Customer List if resolved.
...
-   `summary` **[ComplianceWorkflowSummary][73]** 
-   `customer` **[ComplianceWorkflowCustomer][74]** 
-   `accepted_documents` **[Array][72]&lt;[ComplianceDocument][75]>** 
...
-   `pool_uids` **[Array][72]&lt;[string][62]>** A list of uids referring to Pools belonging to this Customer.
-   `email` **[string][62]** Email of the customer
