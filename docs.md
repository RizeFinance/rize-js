...
-   `customer_uids` **[Array][217]&lt;[string][187]>** A list of UIDs of Customers that are associated with the document.
...
-   `custodial_account_uids` **[Array][217]&lt;[string][187]>** A list of UIDs of Custodial Accounts that are associated with the document.
...
-   `synthetic_account_uids` **[Array][217]&lt;[string][187]>** A list of UIDs of Synthetic Accounts that are associated with the document.
...
-   `month` **[number][216]** This includes any document for which the period started in the specified month.
