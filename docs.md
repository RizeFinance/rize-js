...
-   `name` **[string][58]** 
-   `step` **[number][67]** Multiple Compliance Documents are grouped into a Step, and Compliance Documents are presented to a Customer, Step-by-Step
-   `version` **[number][67]** 
...
-   `summary` **[ComplianceWorkflowSummary][68]** 
-   `customer` **[ComplianceWorkflowCustomer][69]** 
-   `accepted_documents` **[Array][70]&lt;[ComplianceDocument][71]>** 
-   `current_step_documents_pending` **[Array][70]&lt;Omit&lt;[ComplianceDocument][71], `"accepted_at"`>>** Compliance Documents that await acknowledgment in the current Step
-   `all_documents` **[Array][70]&lt;Omit&lt;[ComplianceDocument][71], (`"accepted_at"` \| `"uid"`)>>** The set of all Compliance Documents that would require acknowledgment
...
-   `total_count` **[number][67]** Total count of items available to retrieve
-   `count` **[number][67]** Number of items retrieved
-   `limit` **[number][67]** Maximum number of items to retrieve
-   `offset` **[number][67]** Index of the first item to retrieve
-   `data` **[Array][70]&lt;[Customer][64]>** 
...
-   `pool_uids` **[Array][70]&lt;[string][58]>** A list of uids referring to Pools belonging to this Customer.
-   `email` **[string][58]** Email of the customer
...
-   `include_initiated` **[boolean][74]?** By default, Customers in initiated status are not shown, even if the `status=initiated` parameter is provided. In order for Customers with status initiated to appear in search results, parameters must include `include_initiated=true`.
...
-   `locked` **[boolean][74]?** Only return locked Customers if true and only return unlocked Customers if false
...
-   `pool_uid` **[Array][70]&lt;[string][58]>?** Filter by pool. Multiple values are allowed.
...
-   `timeout` **[number][67]?** Specifies the number of milliseconds before the each request times out. (Default: 80000)
