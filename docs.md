...
-   [TransactionService][90]
    ...
    -   [get][94]
        -   [Parameters][95]
        -   [Examples][96]
    -   [getTransactionEventList][97]
        -   [Parameters][98]
        -   [Examples][99]
    -   [getTransactionEvent][100]
        -   [Parameters][101]
        -   [Examples][102]
    -   [getSyntheticLineItemList][103]
        -   [Parameters][104]
        -   [Examples][105]
    -   [getSyntheticLineItem][106]
        -   [Parameters][107]
        -   [Examples][108]
    -   [getCustodialLineItemList][109]
        -   [Parameters][110]
        -   [Examples][111]
    -   [getCustodialLineItem][112]
        -   [Parameters][113]
        -   [Examples][114]
-   [TransferService][115]
    -   [getList][116]
...
-   [Address][127]
    -   [Properties][128]
-   [ComplianceWorkflowSummary][129]
    -   [Properties][130]
-   [ComplianceWorkflowCustomer][131]
    -   [Properties][132]
-   [ComplianceDocument][133]
    -   [Properties][134]
-   [ComplianceDocumentAcknowledgementRequest][135]
    -   [Properties][136]
-   [ComplianceWorkflow][137]
    -   [Properties][138]
-   [AccountError][139]
    -   [Properties][140]
-   [CustodialAccount][141]
    -   [Properties][142]
-   [CustodialAccountListQuery][143]
    -   [Properties][144]
-   [CustomerDetails][145]
    -   [Properties][146]
-   [Customer][147]
    -   [Properties][148]
-   [CustomerListQuery][149]
    -   [Properties][150]
-   [DebitCard][151]
    -   [Properties][152]
-   [DebitCardListQuery][153]
    -   [Properties][154]
-   [debit-card.typedefs][155]
-   [Document][156]
    -   [Properties][157]
-   [DocumentListQuery][158]
    -   [Properties][159]
-   [SyntheticAccountType][160]
    -   [Properties][161]
-   [SyntheticAccountTypeListQuery][162]
    -   [Properties][163]
-   [SyntheticAccount][164]
    -   [Properties][165]
-   [SyntheticAccountListQuery][166]
    -   [Properties][167]
-   [SyntheticAccountCreateRequest][168]
    -   [Properties][169]
-   [Transaction][170]
    -   [Properties][171]
-   [TransactionListQuery][172]
    -   [Properties][173]
-   [SyntheticLineItem][174]
    -   [Properties][175]
-   [SyntheticLineItemListQuery][176]
    -   [Properties][177]
-   [CustodialLineItem][178]
    -   [Properties][179]
-   [CustodialLineItemListQuery][180]
    -   [Properties][181]
-   [Transfer][182]
    -   [Properties][183]
-   [TransferListQuery][184]
    -   [Properties][185]
-   [RizeOptions][186]
    -   [Properties][187]
-   [Rize][188]
    -   [Parameters][189]
    -   [complianceWorkflow][190]
    -   [customer][191]
    -   [syntheticAccount][192]
    -   [custodialAccount][193]
    -   [transaction][194]
    -   [transfer][195]
    -   [debitCard][196]
    -   [document][197]
...
-   `customerExternalUid` **[string][199]** A Customer identifier supplied by the Partner, unique among the collection of all partner Customers.
-   `email` **[string][199]** Email address associated with the Customer.
...
Returns **[Promise][200]&lt;[ComplianceWorkflow][201]>** A promise that returns the new Compliance Workflow if resolved.
...
-   `customerExternalUid` **[string][199]** A Customer identifier supplied by the Partner, unique among the collection of all partner Customers.
-   `customerUid` **[string][199]** A UID referring to the Customer generated by Rize
-   `email` **[string][199]** Email address associated with the Customer.

Returns **[Promise][200]&lt;[ComplianceWorkflow][201]>** A promise that returns the new Compliance Workflow entity if resolved.
...
-   `customerUid` **[string][199]** A UID referring to the Customer
...
Returns **[Promise][200]&lt;[ComplianceWorkflow][201]>** A promise that returns the latest Compliance Workflow if resolved.
...
-   `complianceWorkflowUid` **[string][199]** A UID referring to the Compliance Workflow.
-   `customerUid` **[string][199]** A UID referring to the Customer.
-   `documents` **...[ComplianceDocumentAcknowledgementRequest][202]** 
...
Returns **[Promise][200]&lt;[ComplianceWorkflow][201]>** A promise that returns the updated Compliance Workflow if resolved.
...
-   `uid` **[string][199]** Rize-generated unique custodial account id
...
Returns **[Promise][200]&lt;[CustodialAccount][203]>** A promise that returns a Custodial Account if resolved.
...
-   `query` **[CustodialAccountListQuery][204]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][200]&lt;[RizeList][205]&lt;CustodialAccountList>>** A promise that returns a Custodial Account List if resolved.
...
-   `query` **[CustomerListQuery][206]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][200]&lt;[RizeList][205]&lt;[Customer][207]>>** A promise that returns a Customer List if resolved.
...
-   `uid` **[string][199]** Rize-generated unique customer id
...
Returns **[Promise][200]&lt;[Customer][207]>** A promise that returns a Customer if resolved.
...
-   `uid` **[string][199]** Rize-generated unique customer id
-   `email` **[string][199]** Email of the customer
-   `details` **[CustomerDetails][208]** An object containing the supplied identifying information for the Customer
...
Returns **[Promise][200]&lt;[Customer][207]>** A promise that returns the updated Customer if resolved.
...
Returns **[Promise][200]&lt;void>** A promise that returns void if resolved.
...
-   `uid` **[string][199]** Rize-generated unique customer id
-   `lockReason` **[string][199]** The reason that the Customer is being locked must be submitted with the request body.
...
Returns **[Promise][200]&lt;[Customer][207]>** A promise that returns the locked Customer if resolved.
...
-   `uid` **[string][199]** Rize-generated unique customer id
-   `unlockReason` **[string][199]** The reason that the Customer is being unlocked. (optional, default `null`)
...
Returns **[Promise][200]&lt;[Customer][207]>** A promise that returns the unlocked Customer if resolved.
...
-   `query` **[DebitCardListQuery][209]?** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][200]&lt;[RizeList][205]&lt;[DebitCard][210]>>** A promise that returns a Debit Card List if resolved.
...
-   `uid` **[string][199]** Rize-generated unique debitCard id
...
Returns **[Promise][200]&lt;[DebitCard][210]>** A promise that returns a Debit Card if resolved.
...
-   `externalUid` **[string][199]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `customerUid` **[string][199]** A UID referring to the Customer who owns this Card
-   `poolUid` **[string][199]** A UID referring to the Pool to which this Card belongs
-   `shippingAddress` **([Address][211] | null)?** An optional field used to specify the shipping address for a physical Debit Card.Either the whole `address` must be nullable or all fields must be provided, with an except of `street2`, which is nullable.If no address is specified, the primary address associated with the customer will be used as a shipping address. (optional, default `null`)
...
-   `uid` **[string][199]** Rize-generated unique Debit Card id
-   `lockReason` **[string][199]** A lock reason is required to be submitted when locking a Debit Card
...
-   `query` **[DocumentListQuery][212]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][200]&lt;[RizeList][205]&lt;[Document][213]>>** A promise that returns a Document List if resolved.
...
Returns **[Promise][200]&lt;[Document][213]>** A promise that returns a downloaded Document if resolved.
...
-   `query` **[SyntheticAccountListQuery][214]** An object containing key value paris for filtering the result. (optional, default `{}`)
...
Returns **[Promise][200]&lt;[RizeList][205]&lt;[SyntheticAccount][215]>>** A promise that returns the Synthetic Account list if resolved.
...
-   `uid` **[string][199]** Rize-generated unique synthetic account id
...
Returns **[Promise][200]&lt;[SyntheticAccount][215]>** A promise that returns a SyntheticAccount if resolved.

### create

#### Parameters

-   `payload` **[SyntheticAccountCreateRequest][216]** is a JSON object needs to send as body parameters in order to create new synthetic accounts.
...
Returns **[Promise][200]&lt;[RizeList][205]&lt;[SyntheticAccount][215]>>** 
...
Returns **[Promise][200]&lt;[SyntheticAccount][215]>** A promise that returns a Synthetic Account if resolved.
...
-   `query` **[SyntheticAccountTypeListQuery][217]** An object containing key value paris for filtering the result. (optional, default `{}`)
...
Returns **[Promise][200]&lt;[RizeList][205]&lt;[SyntheticAccountType][218]>>** A promise that returns a Synthetic Account Type List if resolved.
...
-   `uid` **[string][199]** Rize-generated unique Synthetic Account Type id
...
Returns **[Promise][200]&lt;[SyntheticAccountType][218]>** A promise that returns a Synthetic Account Type if resolved.
...
-   `query` **[TransactionListQuery][219]?** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][200]&lt;[RizeList][205]&lt;[Transaction][220]>>** A promise that returns a Transaction List if resolved.
...
Returns **[Promise][200]&lt;[Transaction][220]>** A promise that returns a Transaction if resolved.
...
Returns **[Promise][200]&lt;[RizeList][205]&lt;TransactionEvent>>** A promise that returns a TransactionEvent List if resolved.
...
-   `uid` **[string][199]** Rize-generated unique transaction event id
...
Returns **[Promise][200]&lt;TransactionEvent>** A promise that returns a Transaction Event if resolved.
...
-   `query` **[SyntheticLineItemListQuery][221]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][200]&lt;[RizeList][205]&lt;[SyntheticLineItem][222]>>** A promise that returns a Synthetic Line Item List if resolved.
...
-   `uid` **[string][199]** Rize-generated unique Synthetic Line Item id
...
Returns **[Promise][200]&lt;[SyntheticLineItem][222]>** A promise that returns a Synthetic Line Item if resolved.

### getCustodialLineItemList

#### Parameters

-   `query` **[CustodialLineItemListQuery][223]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][200]&lt;[RizeList][205]&lt;[CustodialLineItem][224]>>** A promise that returns a Custodial Line Item List if resolved.
...
-   `uid` **[string][199]** Rize-generated unique Custodial Line Item id
...
Returns **[Promise][200]&lt;[CustodialLineItem][224]>** A promise that returns a Custodial Line Item if resolved.
...
-   `query` **[TransferListQuery][225]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][200]&lt;[RizeList][205]&lt;[Transfer][226]>>** A promise that returns a Transfer List if resolved.
...
-   `uid` **[string][199]** Rize-generated unique Transfer id
...
Returns **[Promise][200]&lt;[Transfer][226]>** A promise that returns a Transfer if resolved.
...
-   `externalUid` **[string][199]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `sourceSyntheticAccountUid` **[string][199]** Synthetic Account to pull asset from. Must be an active liability or external-type account. Cannot be equal to `destination_synthetic_account_uid`.
-   `destinationSyntheticAccountUid` **[string][199]** Synthetic Account where the asset should land. Must be an active liability or external-type account. Cannot be equal to `source_synthetic_account_uid`.
-   `initiatingCustomerUid` **[string][199]** 
-   `usTransferAmount` **[string][199]** The USD amount to transfer.
...
-   `total_count` **[number][228]** Total count of items available to retrieve
-   `count` **[number][228]** Number of items retrieved
-   `limit` **[number][228]** Maximum number of items to retrieve
-   `offset` **[number][228]** Index of the first item to retrieve
-   `data` **[Array][229]&lt;T>** 
...
-   `street1` **[string][199]** 
-   `street2` **([string][199] | null)?** 
-   `city` **[string][199]** 
-   `state` **[string][199]** 
-   `postal_code` **[string][199]** 
...
-   `accepted_quantity` **[number][228]** 
-   `begun_at` **[string][199]** The DateTime at which this Compliance Workflow was requested
-   `completed_step` **[number][228]** 
-   `current_step` **[number][228]** 
...
-   `email` **[string][199]** 
-   `external_uid` **[string][199]** A Customer identifier supplied by the Client, unique among the collection of all Client Customers
-   `uid` **[string][199]** A UID referring to the Customer
...
-   `external_storage_name` **[string][199]** Amazon S3 key used to retrieve the contents of a Compliance Document
-   `compliance_document_url` **[string][199]** Amazon S3 URL used to retrieve the contents of a Compliance Document
-   `name` **[string][199]** 
-   `step` **[number][228]** Multiple Compliance Documents are grouped into a Step, and Compliance Documents are presented to a Customer, Step-by-Step
-   `version` **[number][228]** 
-   `uid` **[string][199]** A UID referring to a Compliance Document; note that this UID will be different for each Customer
-   `accepted_at` **[string][199]** The DateTime at which this Compliance Document was acknowledged
...
-   `documentUid` **[string][199]** A UID referring to the Compliance Document being acknowledged.
-   `accept` **(`"yes"` \| `"no"`)** An indication of acceptance or rejection.
-   `userName` **[string][199]?** A label associated with the Customer (required for electronic signing).
-   `ipAddress` **[string][199]?** A numerical label assigned to each device connected to a computer network that uses the Internet Protocol for communication (required for electronic signing); in this case, the label associated with the computer used by the Customer.
...
-   `uid` **[string][199]** A unique identifier generated by Rize.
-   `summary` **[ComplianceWorkflowSummary][230]** 
-   `customer` **[ComplianceWorkflowCustomer][231]** 
-   `accepted_documents` **[Array][229]&lt;[ComplianceDocument][232]>** 
-   `current_step_documents_pending` **[Array][229]&lt;Omit&lt;[ComplianceDocument][232], `"accepted_at"`>>** Compliance Documents that await acknowledgment in the current Step
-   `all_documents` **[Array][229]&lt;Omit&lt;[ComplianceDocument][232], (`"accepted_at"` \| `"uid"`)>>** The set of all Compliance Documents that would require acknowledgment
...
-   `error_code` **[string][199]** 
-   `error_name` **[string][199]** 
-   `error_description` **[string][199]** 
...
-   `uid` **[string][199]** A unique identifier generated by Rize
-   `external_uid` **[string][199]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `customer_uid` **[string][199]** A UID referring to the customer this Custodial Account belongs to
-   `pool_uid` **[Array][229]&lt;[string][199]>** A UID referring to the pool this Custodial Account belongs to
-   `program_service_offering_uid` **([string][199] | null)** A UID referring to the specific Program Service Offering for which this account was created. Nullable if asset.
...
-   `liability` **[boolean][233]** Liability or asset. Liability Custodial Accounts represent real accounts at Financial Institutions. Asset accounts are used for accounting purposes and may be generated by Rize during events such as new custodial account creations or new external account connections.
-   `name` **([string][199] | null)** A friendly name used to identify the account at the Custodial Partner.
-   `primary_account` **[boolean][233]** The date and time when the Customer was locked. This field will be null if and only if the lock_reason is null.
...
-   `account_errors` **[Array][229]&lt;[AccountError][234]>** A list of errors related to this account. These are passed through during interactions with the underlying Custodial Partner and can help with resolving customer issues. Only provided for accounts that are in an error or manual_review status.
-   `net_usd_balance` **[string][199]** The current settled balance of this Custodial Account in US Dollars
-   `net_usd_pending_balance` **[string][199]** The sum of all pending transactions for this Custodial Account in US Dollars
-   `net_usd_available_balance` **[string][199]** The balance available to spend calculated as Normal balance less any withdrawals. Pending deposits are not included
-   `account_number` **([string][199] | null)** The ACH account number that can be used to make transfers into/out of this account. Nullable if asset.
-   `account_number_masked` **([string][199] | null)** Last 4 digits of the ACH account number. Nullable if asset.
-   `routing_number` **([string][199] | null)** The ABA routing number associated with the Custodial Partner. Nullable if asset.
-   `opened_at` **[Date][235]** The DateTime at which this account was created
-   `closed_at` **[Date][235]** The DateTime at which this account was closed
...
-   `customer_uid` **[Array][229]&lt;[string][199]>?** Filter by Customer. Multiple values are allowed
-   `external_uid` **[string][199]?** A unique, immutable id provided Clien
-   `limit` **[string][199]?**  Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[string][199]?** Index of the items to start retrieving from. Default: 0
-   `liability` **[string][199]?** Filter by liability or asset
-   `type` **[Array][229]&lt;[string][199]>?** Filter by type. Multiple values are allowed.
...
-   `first_name` **[string][199]** 
-   `middle_name` **([string][199] | null)?** 
-   `last_name` **[string][199]** 
-   `suffix` **([string][199] | null)?** 
-   `phone` **[string][199]** 
-   `ssn` **[string][199]** 
-   `dob` **[string][199]** 
-   `address` **[Address][211]** 
...
-   `uid` **[string][199]** A unique identifier generated by Rize
-   `external_uid` **[string][199]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `program_uid` **[string][199]** A uid referring to the program this customer belongs to.
-   `pool_uids` **[Array][229]&lt;[string][199]>** A list of uids referring to Pools belonging to this Customer.
-   `email` **[string][199]** Email of the customer
...
-   `total_balance` **[string][199]** Total asset owned by the customer in US dollars.
-   `created_at` **[Date][235]** 
-   `locked_at` **([Date][235] | null)?** The date and time when the Customer was locked. This field will be null if and only if the lock_reason is null.
-   `lock_reason` **([string][199] | null)?** The lock reason provided by the Client, an admin User, or the system at the time the Customer was locked. This field will be null if and only if the locked_at is null.
-   `details` **[CustomerDetails][208]** An object containing the supplied identifying information for the Customer.
...
-   `include_initiated` **[boolean][233]?** By default, Customers in initiated status are not shown, even if the `status=initiated` parameter is provided. In order for Customers with status initiated to appear in search results, parameters must include `include_initiated=true`.
...
-   `first_name` **[string][199]?** Only return Customers with a first name matching exactly what is submitted
-   `last_name` **[string][199]?** Only return Customers with a last name matching exactly what is submitted
-   `email` **[string][199]?** Only return Customers with an email address matching exactly what is submitted
-   `locked` **[boolean][233]?** Only return locked Customers if true and only return unlocked Customers if false
-   `program_uid` **[string][199]?** Only return Customers belonging to the submitted Program.
-   `external_uid` **[string][199]?** A unique, immutable id provided by Client.
-   `pool_uid` **[Array][229]&lt;[string][199]>?** Filter by pool. Multiple values are allowed.
-   `limit` **[string][199]?**  Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[string][199]?** Index of the items to start retrieving from. Default: 0
...
-   `uid` **[string][199]** A unique identifier generated by Rize
-   `external_uid` **[string][199]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `customer_uid` **[string][199]** A UID referring to the Customer who owns this Card.
-   `pool_uid` **[string][199]** A UID referring to the Pool to which this Card belongs.
-   `synthetic_account_uid` **[string][199]** A UID referring to the specific Synthetic Account to which this Card belongs. Any debit or credit transactions from this Card will occur in this account.
-   `custodial_account_uid` **[string][199]** A UID referring to the specific Custodial Account to which this Card belongs. Any debit or credit transactions from this Card will occur in this account.
-   `card_last_four_digits` **([string][199] | null)?** Last 4 digits of the Debit Card number to aid in indentifying the Card. Null if the Card is not yet issued (i.e. status is `initiated`).
...
-   `ready_to_use` **[boolean][233]** If the Card can be used, this value will be `true`; `false` otherwise.
-   `lock_reason` **([string][199] | null)?** If the Card is in a locked state, this field will be populated describing why the Card was locked. Null if the Card is not locked.
-   `issued_on` **([string][199] | null)?** The date this Card was issued. It may be briefly null when a new Card is requested, but the issuance has not yet happened (i.e. status is `initiated`).
-   `locked_at` **([string][199] | null)?** The date and time at which this Card was locked. Null if the Card is not locked.
-   `closed_at` **([string][199] | null)?** The date and time at which this Card was closed. This field will be null unless the `status` is `closed`, `closed_by_administrator`, `lost`, or `stolen`.
-   `latest_shipping_address` **([Address][211] | null)?** An optional field used to specify the shipping address for a physical Debit Card.If no address was specified via `debitCard.create`, this field will be null. In case of reissuance, only the address from the latest shipment will be provided, if any.
...
-   `customer_uid` **[Array][229]&lt;[string][199]>?** Filter by Customer. Multiple values are allowed.
-   `external_uid` **[string][199]?** A unique, immutable id provided Client
-   `limit` **[string][199]?**  Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[string][199]?** Index of the items to start retrieving from. Default: 0
-   `pool_uid` **[Array][229]&lt;[string][199]>?** Filter by pool. Multiple values are allowed.
-   `locked` **[boolean][233]?** Only return locked Cards if `true` and only return unlocked Cards if `false`
...
-   `uid` **[string][199]** A unique identifier generated by Rize
-   `document_type` **[string][199]** The document type. Only monthly statements are currently available.
...
-   `period_started_at` **[string][199]** The date and time when the document period started at, inclusive
-   `period_ended_at` **[string][199]** The date and time when the document period ended at, exclusive
-   `created_at` **[string][199]** The date and time when the document became available
-   `customer_uids` **[Array][229]&lt;[string][199]>** A list of UIDs of Customers that are associated with the document.(not implemented) Note that once we allow joint pool and accounts, this list will be pessimistic; each
...
-   `custodial_account_uids` **[Array][229]&lt;[string][199]>** A list of UIDs of Custodial Accounts that are associated with the document.If `scope_type` is `custodial_account`, this list will contain only one UID. In fact, currently as implemented,
    this list should always have exactly one UID.
-   `synthetic_account_uids` **[Array][229]&lt;[string][199]>** A list of UIDs of Synthetic Accounts that are associated with the document.If `scope_type` is `synthetic_account`, this list will contain only one UID.
...
-   `month` **[number][228]?** Filter by month. This includes any document for which the period started in the specified month.
-   `year` **[number][228]?** Filter by year
-   `scope_type` **(`"customer"` \| `"synthetic_account"` \| `"custodial_account"`)?** (not implemented) Filter by scope type
-   `custodial_account_uid` **[string][199]?** Filter by Custodial Account
-   `customer_uid` **[Array][229]&lt;[string][199]>?** Filter by Customer. Multiple values are allowed.
-   `synthetic_account_uid` **[Array][229]&lt;[string][199]>?** Filter by Synthetic Account. Multiple values are allowed.
-   `limit` **[number][228]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default = 100.
-   `offset` **[number][228]?** Index of the items to start retrieving from. Default = 0.
...
-   `uid` **[string][199]** A unique identifier generated by Rize
-   `name` **[string][199]** A unique name to identify the resource
...
-   `description` **[string][199]** A description outlining the intended use and requirements for this program's instance of the synthetic_account_type
-   `program_uid` **[string][199]?** A uid referring to the Program this synthetic_account_type belongs to
...
-   `program_uid` **[string][199]?** Only list Synthetic Account Types that are available to be used by the given Program
-   `limit` **[number][228]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[number][228]?** Index of the items to start retrieving from. Default: 0
...
-   `external_uid` **[string][199]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `name` **[string][199]** A unique name to identify the resource.
-   `pool_uid` **[string][199]** A UID referring to the pool this Synthetic Account belongs to.
-   `synthetic_account_type_uid` **[string][199]** A UID referring to the Synthetic Account Type this Synthetic Account should be created as.
...
-   `liability` **[boolean][233]** Liability or asset. Any Synthetic Account created via POST /synthetic_accounts is a liability account, except for external accounts. Some asset Synthetic Accounts are automatically created by Rize during Customer onboarding for accounting purposes.
-   `net_usd_balance` **[string][199]** The current settled balance of this account in US Dollars. This field will be null for synthetic_account_types in the external category.
-   `net_usd_pending_balance` **[string][199]** The sum of all pending transactions for this account in US Dollars. This field will be null for Synthetic Account Types in the external category.
-   `net_usd_available_balance` **[string][199]** The balance available to spend calculated as the settled balance less any pending withdrawals Pending deposits are not included. This field will be null for Synthetic Account Types in the external category.
-   `master_account` **[boolean][233]** Used to identify the Master Synthetic Accounts that exist for every Program Customer. Master Synthetic Accounts are the default accounts where any unknown custodial transactions will settle and cannot be archived while a Program Customer is still active.
-   `account_number` **([string][199] | null)** The ACH account number (if any) associated with this account. Some Synthetic Account Types require this field to be submitted along with the POST request. For example, any Synthetic Account Type from the `external` category will require an `account_number`. Submitting an `account_number` with a Synthetic Account Type that does not require one will result in the account number being ignored.
-   `account_number_last_four` **([string][199] | null)** Last 4 digits of the ACH account number.
-   `routing_number` **([string][199] | null)** The ABA routing number (if any) associated with this account. Some Synthetic Account Types require this field to be submitted along with the POST request. For example, any Synthetic Account Type from the `external` category will require a `routing_number`. Submitting a `routing_number` with a Synthetic Account Type that does not require one will result in the routing number being ignored.
-   `opened_at` **[string][199]** The DateTime at which this account was created
-   `closed_at` **([string][199] | null)** The DateTime at which this account was closed. This value will be present if the status is `archived` or `failed`.
-   `closed_to_synthetic_account_uid` **([string][199] | null)** A UID referring to the Synthetic Account where the funds in this account were transferred when closed. Any transactions issued against this account after it is closed will instead go to the `closed_to` account
...
-   `customer_uid` **[Array][229]&lt;[string][199]>?** Filter by Customer. Multiple string values are allowed.
-   `external_uid` **[string][199]?** A unique, immutable id provided Client
-   `pool_uid` **[Array][229]&lt;[string][199]>?** Filter by pool. Multiple string values are allowed.
-   `limit` **[number][228]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[number][228]?** Index of the items to start retrieving from. Default: 0
-   `synthetic_account_type_uid` **[string][199]?** Filter by Synthetic Account Type
-   `synthetic_account_category` **(`"general"` \| `"external"` \| `"plaid_external"`)?** Filter by Synthetic Account Category
-   `liability` **[boolean][233]?** Filter by liability or asset
...
-   `externalUid` **([string][199] | null)?** A unique identifier Client supplies
-   `name` **([string][199] | null)?** A unique name to identify the resource
-   `poolUid` **([string][199] | null)?** A UID referring to the pool this Synthetic Account belongs to
-   `syntheticAccountTypeUid` **([string][199] | null)?** A UID referring to the Synthetic Account Type this Synthetic Account should be created as
-   `accountNumber` **([string][199] | null)?** The ACH account number (if any) associated with this account. Some Synthetic Account Types require this field to be submitted along with the POST request. For example, any Synthetic Account Type from the `external` category will require an `account_number`. Submitting an `account_number` with a Synthetic Account Type that does not require one will result in the account number being ignored.
-   `routingNumber` **([string][199] | null)?** The ABA routing number (if any) associated with this account. Some Synthetic Account Types require this field to be submitted along with the POST request. For example, any Synthetic Account Type from the `external` category will require a `routing_number`. Submitting a `routing_number` with a Synthetic Account Type that does not require one will result in the routing number being ignored.
...
-   `uid` **[string][199]** A unique identifier generated by Rize
-   `id` **[number][228]** A unique numeric identifier that indicates the order in which the Transactions were created
-   `settled_index` **([number][228] | null)?** A unique index that indicates the order in which the Transactions were settled. Null if status is `queued` or `pending`.
-   `transfer_uid` **([number][228] | null)?** The UID of the Transfer this Transaction is associated with, if any.
-   `source_synthetic_account_uid` **[string][199]** Synthetic Account from where the asset is pulled
-   `destination_synthetic_account_uid` **[string][199]** Synthetic Account where the asset is landed
-   `transaction_event_uids` **[Array][229]&lt;[string][199]>** A list of UIDS referring to Transaction Events belonging to this Transaction, if any. 
...
-   `custodial_account_uids` **[Array][229]&lt;[string][199]>** A list of UIDS referring to Custodial Accounts that are so far invovled in this Transaction. 
...
-   `us_dollar_amount` **[string][199]** The amount will never be negative
...
-   `created_at` **[string][199]** The date and time when the Transaction is first recognized by Rize. This may be when the Transfer is initiated if the Transaction is associated with one.
-   `settled_at` **[string][199]** The date and time when the Transaction is settled.
...
-   `customer_uid` **[Array][229]&lt;[string][199]>?** Filter by Customer.
-   `source_synthetic_account_uid` **[Array][229]&lt;[string][199]>?** Filter by source Synthetic Account.
-   `destination_synthetic_account_uid` **[Array][229]&lt;[string][199]>?** Filter by destination Synthetic Account.
-   `synthetic_account_uid` **[Array][229]&lt;[string][199]>?** Filter by Synthetic Account, source or destination.
-   `type` **[Array][229]&lt;(`"atm_withdrawal"` \| `"card_purchase"` \| `"card_refund"` \| `"dispute"` \| `"external_transfer"` \| `"fee"` \| `"internal_transfer"` \| `"other"` \| `"reversed_transfer"` \| `"third_party_transfer"`)>?** Filter by type.
-   `status` **[Array][229]&lt;(`"queued"` \| `"pending"` \| `"settled"` \| `"failed"`)>?** Filter by status.
-   `search_description` **[string][199]?** Attempts to search for the provided string in the description field. '\*' can be used as a wildcard. Any record with a match will be returned.
-   `limit` **[number][228]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default = 100.
-   `offset` **[number][228]?** Index of the items to start retrieving from. Default = 0.
...
-   `uid` **[string][199]** A unique identifier generated by Rize
-   `settled_index` **[number][228]** A unique index that indicates the order in which Transaction Events were settled
-   `transaction_uid` **[string][199]** UID of the Transaction this line item belongs to
-   `phase` **[number][228]** Some Transfer types will trigger multiple transfers at the custodial level. Some of these custodial transfers must wait for all dependent custodial transfers to complete before initiating. Transaction Events with `phase` value 1 are recorded for the first set of custodial transfers that get initiated after the (Synthetic) Transfer starts. Custodial transfers in later phases cannot initiate before all events from previous phases are settled.
-   `source_custodial_account_uid` **[string][199]** Custodial Account from which the asset is pulled
-   `destination_custodial_account_uid` **[string][199]** Custodial Account where the asset lands
-   `custodial_line_item_uids` **[Array][229]&lt;[string][199]>** A list of UIDS referring to Custodial Line Items belonging to this event. There are always at least two line items if the status is `settled`.
-   `status` **[string][199]** 
-   `us_dollar_amount` **[string][199]** The amount will never be negative
...
-   `description` **[string][199]** 
-   `created_at` **[string][199]** The date and time when the event is first recognized by Rize. This may be when the Transfer is initiated if the event is associated with one.
-   `settled_at` **[string][199]** The date and time when the event is settled.
    //\*\*
-   `source_custodial_account_uid` **[Array][229]&lt;[string][199]>?** Filter by source Custodial Account.
-   `destination_custodial_account_uid` **[Array][229]&lt;[string][199]>?** Filter by destination Custodial Account.
-   `custodial_account_uid` **[Array][229]&lt;[string][199]>?** Filter by Custodial Account, source or destination.
-   `type` **[Array][229]&lt;(`"odfi_ach_deposit"` \| `"odfi_ach_withdrawal"` \| `"rdfi_ach_deposit"` \| `"rdfi_ach_withdrawal"`)>?** Filter by type. Multiple values are allowed.
-   `transaction_uid` **[Array][229]&lt;[string][199]>?** Filter by Transaction. Multiple values are allowed
-   `limit` **[number][228]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default = 100.
-   `offset` **[number][228]?** Index of the items to start retrieving from. Default = 0.
...
-   `uid` **[string][199]** A unique identifier generated by Rize
-   `settled_index` **[number][228]** A unique index that indicates the order in which the Synthetic Line Items were settled
-   `transaction_uid` **[string][199]** UID of the Transaction this Synthetic Line Item belongs to
-   `synthetic_account_uid` **[string][199]** UID of the Synthetic Account this Synthetic Line Item is associated with
-   `status` **[string][199]** 
-   `us_dollar_amount` **[string][199]** The signed USD amount of this specific Synthetic Line Item
-   `running_us_dollar_balance` **[string][199]** The Synthetic Account balance after this Synthetic Line Item was settled
-   `description` **[string][199]** Human-readable description in context of Synthetic Accounts
-   `created_at` **[string][199]** The date and time when the Synthetic Line Item is first recognized by Rize. This may be when the Transfer is initiated if the Synthetic Line Item is associated with one.
-   `settled_at` **[string][199]** The date and time when the Synthetic Line Item is settled
...
-   `customer_uid` **[Array][229]&lt;[string][199]>?** Filter by Customer.
-   `pool_uid` **[Array][229]&lt;[string][199]>?** Filter by pool.
-   `synthetic_account_uid` **[Array][229]&lt;[string][199]>?** Filter by Synthetic Account.
-   `limit` **[number][228]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default = 100.
-   `offset` **[number][228]?** Index of the items to start retrieving from. Default = 0.
-   `transaction_uid` **[Array][229]&lt;[string][199]>?** Filter by Transaction.
-   `status` **[Array][229]&lt;(`"begun"` \| `"failed"` \| `"in_progress"` \| `"settled"`)>?** Filter by status.
...
-   `uid` **[string][199]** A unique identifier generated by Rize.
-   `settled_index` **[number][228]** A unique index that indicates the order in which the Custodial Line Items were settled.
-   `transaction_uid` **[string][199]** UID of the Transaction this Custodial Line Item belongs to.
-   `transaction_event_uid` **[string][199]** UID of the Transaction Event this Custodial Line Item belongs to.
-   `custodial_account_uid` **[string][199]** UID of the Custodial Account this Custodial Line Item is associated with.
-   `status` **[string][199]** 
-   `us_dollar_amount` **[string][199]** The signed USD amount of this specific Custodial Line Item
-   `running_us_dollar_balance` **([string][199] | null)?** US dollar balance of the Custodial Account as of the completion of this Custodial Line Item. This field may be empty unless the status is `settled` or `voided`.
-   `type` **[string][199]** Symbols and/or numbers that represent different types of Custodial Line Items.
-   `description` **[string][199]** Descriptions pulled from the custodians, such as through NACHA description or ISO-8583 data element 43.
-   `created_at` **[string][199]** The date and time when the Custodial Line Items is first recognized by Rize. This may be when the Transfer is initiated if the Custodial Line Item is associated with one.
-   `occurred_at` **[string][199]** This field may be empty if status is not settled or voided.
-   `settled_at` **[string][199]** The date and time when the Custodial Line Item is settled.
...
-   `customer_uid` **[Array][229]&lt;[string][199]>?** Filter by Customer.
-   `custodial_account_uid` **[Array][229]&lt;[string][199]>?** Filter by Custodial Account.
-   `status` **[Array][229]&lt;(`"settled"` \| `"voided"`)>?** Filter by status.
-   `us_dollar_amount_tax` **[number][228]?** Return any records having a us_dollar_amount at or below us_dollar_amount_max.
-   `us_dollar_amount_min` **[number][228]?** Return any records having a us_dollar_amount at or above us_dollar_amount_min.
-   `transaction_event_uid` **[Array][229]&lt;[string][199]>?** Filter by Transaction Event.
-   `transaction_uid` **[Array][229]&lt;[string][199]>?** Filter by Transaction.
-   `limit` **[number][228]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default = 100.
-   `offset` **[number][228]?** Index of the items to start retrieving from. Default = 0.
-   `sort` **(`"created_at_asc"` \| `"created_at_desc"` \| `"description_asc"` \| `"description_desc"` \| `"settled_index_asc"` \| `"settled_index_desc"` \| `"us_dollar_amount_asc"` \| `"us_dollar_amount_desc"`)?** 
...
-   `uid` **[string][199]** A unique identifier generated by Rize.
-   `external_uid` **[string][199]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `source_synthetic_account_uid` **[string][199]** Synthetic Account to pull asset from. Must be an active liability or external-type account. Cannot be equal to `destination_synthetic_account_uid`.
-   `destination_synthetic_account_uid` **[string][199]** Synthetic Account where the asset should land. Must be an active liability or external-type account. Cannot be equal to `source_synthetic_account_uid`.
-   `initiating_customer_uid` **[string][199]** 
-   `usd_transfer_amount` **[string][199]** The USD amount to transfer
...
-   `timeout` **[number][228]?** Specifies the number of milliseconds before the each request times out. (Default: 80000)
...
-   `programUid` **[string][199]** The Rize Program ID.
-   `hmac` **[string][199]** The HMAC that will be used to sign the JSON web signature in order to get access to the API.
-   `options` **[RizeOptions][236]?** Configuration options (optional, default `RizeOptions`)
...
Type: [ComplianceWorkflowService][237]
...
Type: [SyntheticAccountService][239]
...
Type: [CustodialAccountService][240]
...
[97]: #gettransactioneventlist

[98]: #parameters-30

[99]: #examples-29

[100]: #gettransactionevent

[101]: #parameters-31

[102]: #examples-30

[103]: #getsyntheticlineitemlist

[104]: #parameters-32

[105]: #examples-31

[106]: #getsyntheticlineitem

[107]: #parameters-33

[108]: #examples-32

[109]: #getcustodiallineitemlist

[110]: #parameters-34

[111]: #examples-33

[112]: #getcustodiallineitem
...
[129]: #complianceworkflowsummary

[130]: #properties-2

[131]: #complianceworkflowcustomer

[132]: #properties-3

[133]: #compliancedocument

[134]: #properties-4

[135]: #compliancedocumentacknowledgementrequest
...
[153]: #debitcardlistquery

[154]: #properties-14

[155]: #debit-cardtypedefs

[156]: #document

[157]: #properties-15

[158]: #documentlistquery

[159]: #properties-16

[160]: #syntheticaccounttype

[161]: #properties-17

[162]: #syntheticaccounttypelistquery

[163]: #properties-18

[164]: #syntheticaccount

[165]: #properties-19

[166]: #syntheticaccountlistquery

[167]: #properties-20

[168]: #syntheticaccountcreaterequest
...
[172]: #transactionlistquery

[173]: #properties-23

[174]: #syntheticlineitem

[175]: #properties-24

[176]: #syntheticlineitemlistquery

[177]: #properties-25

[178]: #custodiallineitem

[179]: #properties-26

[180]: #custodiallineitemlistquery
...
[190]: #complianceworkflow-1

[191]: #customer-1

[192]: #syntheticaccount-1

[193]: #custodialaccount-1
...
[203]: #custodialaccount

[204]: #custodialaccountlistquery

[205]: #rizelist

[206]: #customerlistquery

[207]: #customer

[208]: #customerdetails

[209]: #debitcardlistquery

[210]: #debitcard

[211]: #address

[212]: #documentlistquery

[213]: #document

[214]: #syntheticaccountlistquery

[215]: #syntheticaccount

[216]: #syntheticaccountcreaterequest

[217]: #syntheticaccounttypelistquery

[218]: #syntheticaccounttype

[219]: #transactionlistquery

[220]: #transaction

[221]: #syntheticlineitemlistquery

[222]: #syntheticlineitem

[223]: #custodiallineitemlistquery

[224]: #custodiallineitem
...
[230]: #complianceworkflowsummary

[231]: #complianceworkflowcustomer

[232]: #compliancedocument

[233]: https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Boolean

[234]: #accounterror

[235]: https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Date

[236]: #rizeoptions

[237]: #complianceworkflowservice

[238]: #customerservice

[239]: #syntheticaccountservice

[240]: #custodialaccountservice

[241]: #transactionservice
