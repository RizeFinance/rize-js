...
-   [Address][108]
    -   [Properties][109]
-   [ComplianceWorkflowSummary][110]
    -   [Properties][111]
-   [ComplianceWorkflowCustomer][112]
    -   [Properties][113]
-   [ComplianceDocument][114]
    -   [Properties][115]
-   [ComplianceDocumentAcknowledgementRequest][116]
    -   [Properties][117]
-   [ComplianceWorkflow][118]
    -   [Properties][119]
-   [AccountError][120]
    -   [Properties][121]
-   [CustodialAccount][122]
    -   [Properties][123]
-   [CustodialAccountListQuery][124]
    -   [Properties][125]
-   [CustomerDetails][126]
    -   [Properties][127]
-   [Customer][128]
    -   [Properties][129]
-   [CustomerListQuery][130]
    -   [Properties][131]
-   [DebitCard][132]
    -   [Properties][133]
-   [DebitCardListQuery][134]
    -   [Properties][135]
-   [debit-card.typedefs][136]
-   [SyntheticAccountType][137]
    -   [Properties][138]
-   [SyntheticAccountTypeListQuery][139]
    -   [Properties][140]
-   [SyntheticAccount][141]
    -   [Properties][142]
-   [SyntheticAccountListQuery][143]
    -   [Properties][144]
-   [SyntheticAccountCreateRequest][145]
    -   [Properties][146]
-   [Transaction][147]
    -   [Properties][148]
-   [TransactionListQuery][149]
    -   [Properties][150]
-   [SyntheticLineItem][151]
    -   [Properties][152]
-   [SyntheticLineItemListQuery][153]
    -   [Properties][154]
-   [CustodialLineItem][155]
    -   [Properties][156]
-   [CustodialLineItemListQuery][157]
    -   [Properties][158]
-   [Transfer][159]
    -   [Properties][160]
-   [TransferListQuery][161]
    -   [Properties][162]
-   [RizeOptions][163]
    -   [Properties][164]
-   [Rize][165]
    -   [Parameters][166]
    -   [complianceWorkflow][167]
    -   [customer][168]
    -   [syntheticAccount][169]
    -   [custodialAccount][170]
    -   [transaction][171]
    -   [transfer][172]
    -   [debitCard][173]
    -   [PACKAGE_VERSION][174]
...
-   `customerExternalUid` **[string][175]** A Customer identifier supplied by the Partner, unique among the collection of all partner Customers.
-   `email` **[string][175]** Email address associated with the Customer.
...
Returns **[Promise][176]&lt;[ComplianceWorkflow][177]>** A promise that returns the new Compliance Workflow if resolved.
...
-   `customerExternalUid` **[string][175]** A Customer identifier supplied by the Partner, unique among the collection of all partner Customers.
-   `customerUid` **[string][175]** A UID referring to the Customer generated by Rize
-   `email` **[string][175]** Email address associated with the Customer.

Returns **[Promise][176]&lt;[ComplianceWorkflow][177]>** A promise that returns the new Compliance Workflow entity if resolved.
...
-   `customerUid` **[string][175]** A UID referring to the Customer
...
Returns **[Promise][176]&lt;[ComplianceWorkflow][177]>** A promise that returns the latest Compliance Workflow if resolved.
...
-   `complianceWorkflowUid` **[string][175]** A UID referring to the Compliance Workflow.
-   `customerUid` **[string][175]** A UID referring to the Customer.
-   `documents` **...[ComplianceDocumentAcknowledgementRequest][178]** 
...
Returns **[Promise][176]&lt;[ComplianceWorkflow][177]>** A promise that returns the updated Compliance Workflow if resolved.
...
-   `uid` **[string][175]** Rize-generated unique custodial account id
...
Returns **[Promise][176]&lt;[CustodialAccount][179]>** A promise that returns a Custodial Account if resolved.
...
-   `query` **[CustodialAccountListQuery][180]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][176]&lt;[RizeList][181]&lt;CustodialAccountList>>** A promise that returns a Custodial Account List if resolved.
...
-   `query` **[CustomerListQuery][182]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][176]&lt;[RizeList][181]&lt;[Customer][183]>>** A promise that returns a Customer List if resolved.
...
-   `uid` **[string][175]** Rize-generated unique customer id
...
Returns **[Promise][176]&lt;[Customer][183]>** A promise that returns a Customer if resolved.
...
-   `uid` **[string][175]** Rize-generated unique customer id
-   `email` **[string][175]** Email of the customer
-   `details` **[CustomerDetails][184]** An object containing the supplied identifying information for the Customer
...
Returns **[Promise][176]&lt;[Customer][183]>** A promise that returns the updated Customer if resolved.
...
Returns **[Promise][176]&lt;void>** A promise that returns void if resolved.
...
-   `uid` **[string][175]** Rize-generated unique customer id
-   `lockReason` **[string][175]** The reason that the Customer is being locked must be submitted with the request body.
...
Returns **[Promise][176]&lt;[Customer][183]>** A promise that returns the locked Customer if resolved.
...
-   `uid` **[string][175]** Rize-generated unique customer id
-   `unlockReason` **[string][175]** The reason that the Customer is being unlocked. (optional, default `null`)
...
Returns **[Promise][176]&lt;[Customer][183]>** A promise that returns the unlocked Customer if resolved.
...
-   `query` **[DebitCardListQuery][185]?** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][176]&lt;[RizeList][181]&lt;[DebitCard][186]>>** A promise that returns a Debit Card List if resolved.
...
-   `uid` **[string][175]** Rize-generated unique debitCard id
...
Returns **[Promise][176]&lt;[DebitCard][186]>** A promise that returns a Debit Card if resolved.
...
-   `query` **[SyntheticAccountListQuery][187]** An object containing key value paris for filtering the result. (optional, default `{}`)
...
Returns **[Promise][176]&lt;[RizeList][181]&lt;[SyntheticAccount][188]>>** A promise that returns the Synthetic Account list if resolved.
...
-   `uid` **[string][175]** Rize-generated unique synthetic account id
...
Returns **[Promise][176]&lt;[SyntheticAccount][188]>** A promise that returns a SyntheticAccount if resolved.

### create

#### Parameters

-   `payload` **[SyntheticAccountCreateRequest][189]** is a JSON object needs to send as body parameters in order to create new synthetic accounts.
...
Returns **[Promise][176]&lt;[RizeList][181]&lt;[SyntheticAccount][188]>>** 
...
Returns **[Promise][176]&lt;[SyntheticAccount][188]>** A promise that returns a Synthetic Account if resolved.
...
-   `query` **[SyntheticAccountTypeListQuery][190]** An object containing key value paris for filtering the result. (optional, default `{}`)
...
Returns **[Promise][176]&lt;[RizeList][181]&lt;[SyntheticAccountType][191]>>** A promise that returns a Synthetic Account Type List if resolved.
...
-   `uid` **[string][175]** Rize-generated unique Synthetic Account Type id
...
Returns **[Promise][176]&lt;[SyntheticAccountType][191]>** A promise that returns a Synthetic Account Type if resolved.
...
-   `query` **[TransactionListQuery][192]?** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][176]&lt;[RizeList][181]&lt;[Transaction][193]>>** A promise that returns a Transaction List if resolved.
...
-   `uid` **[string][175]** Rize-generated unique transaction id
...
Returns **[Promise][176]&lt;[Transaction][193]>** A promise that returns a Transaction if resolved.
...
Returns **[Promise][176]&lt;[RizeList][181]&lt;TransactionEvent>>** A promise that returns a TransactionEvent List if resolved.
...
-   `uid` **[string][175]** Rize-generated unique transaction event id
...
Returns **[Promise][176]&lt;TransactionEvent>** A promise that returns a Transaction Event if resolved.
...
-   `query` **[SyntheticLineItemListQuery][194]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][176]&lt;[RizeList][181]&lt;[SyntheticLineItem][195]>>** A promise that returns a Synthetic Line Item List if resolved.
...
-   `uid` **[string][175]** Rize-generated unique Synthetic Line Item id
...
Returns **[Promise][176]&lt;[SyntheticLineItem][195]>** A promise that returns a Synthetic Line Item if resolved.

### getCustodialLineItemList

#### Parameters

-   `query` **[CustodialLineItemListQuery][196]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][176]&lt;[RizeList][181]&lt;[CustodialLineItem][197]>>** A promise that returns a Custodial Line Item List if resolved.
...
-   `uid` **[string][175]** Rize-generated unique Custodial Line Item id
...
Returns **[Promise][176]&lt;[CustodialLineItem][197]>** A promise that returns a Custodial Line Item if resolved.
...
-   `query` **[TransferListQuery][198]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][176]&lt;[RizeList][181]&lt;[Transfer][199]>>** A promise that returns a Transfer List if resolved.
...
-   `uid` **[string][175]** Rize-generated unique Transfer id
...
Returns **[Promise][176]&lt;[Transfer][199]>** A promise that returns a Transfer if resolved.
...
-   `externalUid` **[string][175]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `sourceSyntheticAccountUid` **[string][175]** Synthetic Account to pull asset from. Must be an active liability or external-type account. Cannot be equal to `destination_synthetic_account_uid`.
-   `destinationSyntheticAccountUid` **[string][175]** Synthetic Account where the asset should land. Must be an active liability or external-type account. Cannot be equal to `source_synthetic_account_uid`.
-   `initiatingCustomerUid` **[string][175]** 
-   `usTransferAmount` **[string][175]** The USD amount to transfer.
...
-   `total_count` **[number][201]** Total count of items available to retrieve
-   `count` **[number][201]** Number of items retrieved
-   `limit` **[number][201]** Maximum number of items to retrieve
-   `offset` **[number][201]** Index of the first item to retrieve
-   `data` **[Array][202]&lt;T>** 
...
-   `street1` **[string][175]** 
-   `street2` **([string][175] | null)?** 
-   `city` **[string][175]** 
-   `state` **[string][175]** 
-   `postal_code` **[string][175]** 
...
-   `accepted_quantity` **[number][201]** 
-   `begun_at` **[string][175]** The DateTime at which this Compliance Workflow was requested
-   `completed_step` **[number][201]** 
-   `current_step` **[number][201]** 
...
-   `email` **[string][175]** 
-   `external_uid` **[string][175]** A Customer identifier supplied by the Client, unique among the collection of all Client Customers
-   `uid` **[string][175]** A UID referring to the Customer
...
-   `external_storage_name` **[string][175]** Amazon S3 key used to retrieve the contents of a Compliance Document
-   `compliance_document_url` **[string][175]** Amazon S3 URL used to retrieve the contents of a Compliance Document
-   `name` **[string][175]** 
-   `step` **[number][201]** Multiple Compliance Documents are grouped into a Step, and Compliance Documents are presented to a Customer, Step-by-Step
-   `version` **[number][201]** 
-   `uid` **[string][175]** A UID referring to a Compliance Document; note that this UID will be different for each Customer
-   `accepted_at` **[string][175]** The DateTime at which this Compliance Document was acknowledged
...
-   `documentUid` **[string][175]** A UID referring to the Compliance Document being acknowledged.
-   `accept` **(`"yes"` \| `"no"`)** An indication of acceptance or rejection.
-   `userName` **[string][175]?** A label associated with the Customer (required for electronic signing).
-   `ipAddress` **[string][175]?** A numerical label assigned to each device connected to a computer network that uses the Internet Protocol for communication (required for electronic signing); in this case, the label associated with the computer used by the Customer.
...
-   `uid` **[string][175]** A unique identifier generated by Rize.
-   `summary` **[ComplianceWorkflowSummary][203]** 
-   `customer` **[ComplianceWorkflowCustomer][204]** 
-   `accepted_documents` **[Array][202]&lt;[ComplianceDocument][205]>** 
-   `current_step_documents_pending` **[Array][202]&lt;Omit&lt;[ComplianceDocument][205], `"accepted_at"`>>** Compliance Documents that await acknowledgment in the current Step
-   `all_documents` **[Array][202]&lt;Omit&lt;[ComplianceDocument][205], (`"accepted_at"` \| `"uid"`)>>** The set of all Compliance Documents that would require acknowledgment
...
-   `error_code` **[string][175]** 
-   `error_name` **[string][175]** 
-   `error_description` **[string][175]** 
...
-   `uid` **[string][175]** A unique identifier generated by Rize
-   `external_uid` **[string][175]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `customer_uid` **[string][175]** A UID referring to the customer this Custodial Account belongs to
-   `pool_uid` **[Array][202]&lt;[string][175]>** A UID referring to the pool this Custodial Account belongs to
-   `program_service_offering_uid` **([string][175] | null)** A UID referring to the specific Program Service Offering for which this account was created. Nullable if asset.
...
-   `liability` **[boolean][206]** Liability or asset. Liability Custodial Accounts represent real accounts at Financial Institutions. Asset accounts are used for accounting purposes and may be generated by Rize during events such as new custodial account creations or new external account connections.
-   `name` **([string][175] | null)** A friendly name used to identify the account at the Custodial Partner.
-   `primary_account` **[boolean][206]** The date and time when the Customer was locked. This field will be null if and only if the lock_reason is null.
...
-   `account_errors` **[Array][202]&lt;[AccountError][207]>** A list of errors related to this account. These are passed through during interactions with the underlying Custodial Partner and can help with resolving customer issues. Only provided for accounts that are in an error or manual_review status.
-   `net_usd_balance` **[string][175]** The current settled balance of this Custodial Account in US Dollars
-   `net_usd_pending_balance` **[string][175]** The sum of all pending transactions for this Custodial Account in US Dollars
-   `net_usd_available_balance` **[string][175]** The balance available to spend calculated as Normal balance less any withdrawals. Pending deposits are not included
-   `account_number` **([string][175] | null)** The ACH account number that can be used to make transfers into/out of this account. Nullable if asset.
-   `account_number_masked` **([string][175] | null)** Last 4 digits of the ACH account number. Nullable if asset.
-   `routing_number` **([string][175] | null)** The ABA routing number associated with the Custodial Partner. Nullable if asset.
-   `opened_at` **[Date][208]** The DateTime at which this account was created
-   `closed_at` **[Date][208]** The DateTime at which this account was closed
...
-   `customer_uid` **[Array][202]&lt;[string][175]>?** Filter by Customer. Multiple values are allowed
-   `external_uid` **[string][175]?** A unique, immutable id provided Clien
-   `limit` **[string][175]?**  Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[string][175]?** Index of the items to start retrieving from. Default: 0
-   `liability` **[string][175]?** Filter by liability or asset
-   `type` **[Array][202]&lt;[string][175]>?** Filter by type. Multiple values are allowed.
...
-   `first_name` **[string][175]** 
-   `middle_name` **([string][175] | null)?** 
-   `last_name` **[string][175]** 
-   `suffix` **([string][175] | null)?** 
-   `phone` **[string][175]** 
-   `ssn` **[string][175]** 
-   `dob` **[string][175]** 
-   `address` **[Address][209]** 
...
-   `uid` **[string][175]** A unique identifier generated by Rize
-   `external_uid` **[string][175]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `program_uid` **[string][175]** A uid referring to the program this customer belongs to.
-   `pool_uids` **[Array][202]&lt;[string][175]>** A list of uids referring to Pools belonging to this Customer.
-   `email` **[string][175]** Email of the customer
...
-   `total_balance` **[string][175]** Total asset owned by the customer in US dollars.
-   `created_at` **[Date][208]** 
-   `locked_at` **([Date][208] | null)?** The date and time when the Customer was locked. This field will be null if and only if the lock_reason is null.
-   `lock_reason` **([string][175] | null)?** The lock reason provided by the Client, an admin User, or the system at the time the Customer was locked. This field will be null if and only if the locked_at is null.
-   `details` **[CustomerDetails][184]** An object containing the supplied identifying information for the Customer.
...
-   `include_initiated` **[boolean][206]?** By default, Customers in initiated status are not shown, even if the `status=initiated` parameter is provided. In order for Customers with status initiated to appear in search results, parameters must include `include_initiated=true`.
...
-   `first_name` **[string][175]?** Only return Customers with a first name matching exactly what is submitted
-   `last_name` **[string][175]?** Only return Customers with a last name matching exactly what is submitted
-   `email` **[string][175]?** Only return Customers with an email address matching exactly what is submitted
-   `locked` **[boolean][206]?** Only return locked Customers if true and only return unlocked Customers if false
-   `program_uid` **[string][175]?** Only return Customers belonging to the submitted Program.
-   `external_uid` **[string][175]?** A unique, immutable id provided by Client.
-   `pool_uid` **[Array][202]&lt;[string][175]>?** Filter by pool. Multiple values are allowed.
-   `limit` **[string][175]?**  Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[string][175]?** Index of the items to start retrieving from. Default: 0
...
-   `uid` **[string][175]** A unique identifier generated by Rize
-   `external_uid` **[string][175]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `customer_uid` **[string][175]** A UID referring to the Customer who owns this Card.
-   `pool_uid` **[string][175]** A UID referring to the Pool to which this Card belongs.
-   `synthetic_account_uid` **[string][175]** A UID referring to the specific Synthetic Account to which this Card belongs. Any debit or credit transactions from this Card will occur in this account.
-   `custodial_account_uid` **[string][175]** A UID referring to the specific Custodial Account to which this Card belongs. Any debit or credit transactions from this Card will occur in this account.
-   `card_last_four_digits` **([string][175] | null)?** Last 4 digits of the Debit Card number to aid in indentifying the Card. Null if the Card is not yet issued (i.e. status is `initiated`).
...
-   `ready_to_use` **[boolean][206]** If the Card can be used, this value will be `true`; `false` otherwise.
-   `lock_reason` **([string][175] | null)?** If the Card is in a locked state, this field will be populated describing why the Card was locked. Null if the Card is not locked.
-   `issued_on` **([string][175] | null)?** The date this Card was issued. It may be briefly null when a new Card is requested, but the issuance has not yet happened (i.e. status is `initiated`).
-   `locked_at` **([string][175] | null)?** The date and time at which this Card was locked. Null if the Card is not locked.
-   `closed_at` **([string][175] | null)?** The date and time at which this Card was closed. This field will be null unless the `status` is `closed`, `closed_by_administrator`, `lost`, or `stolen`.
-   `latest_shipping_address` **([Address][209] | null)?** An optional field used to specify the shipping address for a physical Debit Card.If no address was specified via `debitCard.create`, this field will be null. In case of reissuance, only the address from the latest shipment will be provided, if any.
...
-   `customer_uid` **[Array][202]&lt;[string][175]>?** Filter by Customer. Multiple values are allowed.
-   `external_uid` **[string][175]?** A unique, immutable id provided Client
-   `limit` **[string][175]?**  Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[string][175]?** Index of the items to start retrieving from. Default: 0
-   `pool_uid` **[Array][202]&lt;[string][175]>?** Filter by pool. Multiple values are allowed.
-   `locked` **[boolean][206]?** Only return locked Cards if `true` and only return unlocked Cards if `false`
...
-   `uid` **[string][175]** A unique identifier generated by Rize
-   `name` **[string][175]** A unique name to identify the resource
...
-   `description` **[string][175]** A description outlining the intended use and requirements for this program's instance of the synthetic_account_type
-   `program_uid` **[string][175]?** A uid referring to the Program this synthetic_account_type belongs to
...
-   `program_uid` **[string][175]?** Only list Synthetic Account Types that are available to be used by the given Program
-   `limit` **[number][201]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[number][201]?** Index of the items to start retrieving from. Default: 0
...
-   `external_uid` **[string][175]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `name` **[string][175]** A unique name to identify the resource.
-   `pool_uid` **[string][175]** A UID referring to the pool this Synthetic Account belongs to.
-   `synthetic_account_type_uid` **[string][175]** A UID referring to the Synthetic Account Type this Synthetic Account should be created as.
...
-   `liability` **[boolean][206]** Liability or asset. Any Synthetic Account created via POST /synthetic_accounts is a liability account, except for external accounts. Some asset Synthetic Accounts are automatically created by Rize during Customer onboarding for accounting purposes.
-   `net_usd_balance` **[string][175]** The current settled balance of this account in US Dollars. This field will be null for synthetic_account_types in the external category.
-   `net_usd_pending_balance` **[string][175]** The sum of all pending transactions for this account in US Dollars. This field will be null for Synthetic Account Types in the external category.
-   `net_usd_available_balance` **[string][175]** The balance available to spend calculated as the settled balance less any pending withdrawals Pending deposits are not included. This field will be null for Synthetic Account Types in the external category.
-   `master_account` **[boolean][206]** Used to identify the Master Synthetic Accounts that exist for every Program Customer. Master Synthetic Accounts are the default accounts where any unknown custodial transactions will settle and cannot be archived while a Program Customer is still active.
-   `account_number` **([string][175] | null)** The ACH account number (if any) associated with this account. Some Synthetic Account Types require this field to be submitted along with the POST request. For example, any Synthetic Account Type from the `external` category will require an `account_number`. Submitting an `account_number` with a Synthetic Account Type that does not require one will result in the account number being ignored.
-   `account_number_last_four` **([string][175] | null)** Last 4 digits of the ACH account number.
-   `routing_number` **([string][175] | null)** The ABA routing number (if any) associated with this account. Some Synthetic Account Types require this field to be submitted along with the POST request. For example, any Synthetic Account Type from the `external` category will require a `routing_number`. Submitting a `routing_number` with a Synthetic Account Type that does not require one will result in the routing number being ignored.
-   `opened_at` **[string][175]** The DateTime at which this account was created
-   `closed_at` **([string][175] | null)** The DateTime at which this account was closed. This value will be present if the status is `archived` or `failed`.
-   `closed_to_synthetic_account_uid` **([string][175] | null)** A UID referring to the Synthetic Account where the funds in this account were transferred when closed. Any transactions issued against this account after it is closed will instead go to the `closed_to` account
...
-   `customer_uid` **[Array][202]&lt;[string][175]>?** Filter by Customer. Multiple string values are allowed.
-   `external_uid` **[string][175]?** A unique, immutable id provided Client
-   `pool_uid` **[Array][202]&lt;[string][175]>?** Filter by pool. Multiple string values are allowed.
-   `limit` **[number][201]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[number][201]?** Index of the items to start retrieving from. Default: 0
-   `synthetic_account_type_uid` **[string][175]?** Filter by Synthetic Account Type
-   `synthetic_account_category` **(`"general"` \| `"external"` \| `"plaid_external"`)?** Filter by Synthetic Account Category
-   `liability` **[boolean][206]?** Filter by liability or asset
...
-   `externalUid` **([string][175] | null)?** A unique identifier Client supplies
-   `name` **([string][175] | null)?** A unique name to identify the resource
-   `poolUid` **([string][175] | null)?** A UID referring to the pool this Synthetic Account belongs to
-   `syntheticAccountTypeUid` **([string][175] | null)?** A UID referring to the Synthetic Account Type this Synthetic Account should be created as
-   `accountNumber` **([string][175] | null)?** The ACH account number (if any) associated with this account. Some Synthetic Account Types require this field to be submitted along with the POST request. For example, any Synthetic Account Type from the `external` category will require an `account_number`. Submitting an `account_number` with a Synthetic Account Type that does not require one will result in the account number being ignored.
-   `routingNumber` **([string][175] | null)?** The ABA routing number (if any) associated with this account. Some Synthetic Account Types require this field to be submitted along with the POST request. For example, any Synthetic Account Type from the `external` category will require a `routing_number`. Submitting a `routing_number` with a Synthetic Account Type that does not require one will result in the routing number being ignored.
...
-   `uid` **[string][175]** A unique identifier generated by Rize
-   `id` **[number][201]** A unique numeric identifier that indicates the order in which the Transactions were created
-   `settled_index` **([number][201] | null)?** A unique index that indicates the order in which the Transactions were settled. Null if status is `queued` or `pending`.
-   `transfer_uid` **([number][201] | null)?** The UID of the Transfer this Transaction is associated with, if any.
-   `source_synthetic_account_uid` **[string][175]** Synthetic Account from where the asset is pulled
-   `destination_synthetic_account_uid` **[string][175]** Synthetic Account where the asset is landed
-   `transaction_event_uids` **[Array][202]&lt;[string][175]>** A list of UIDS referring to Transaction Events belonging to this Transaction, if any. 
...
-   `custodial_account_uids` **[Array][202]&lt;[string][175]>** A list of UIDS referring to Custodial Accounts that are so far invovled in this Transaction. 
...
-   `us_dollar_amount` **[string][175]** The amount will never be negative
...
-   `description` **[string][175]** 
-   `created_at` **[string][175]** The date and time when the Transaction is first recognized by Rize. This may be when the Transfer is initiated if the Transaction is associated with one.
-   `settled_at` **[string][175]** The date and time when the Transaction is settled.
...
-   `customer_uid` **[Array][202]&lt;[string][175]>?** Filter by Customer.
-   `source_synthetic_account_uid` **[Array][202]&lt;[string][175]>?** Filter by source Synthetic Account.
-   `destination_synthetic_account_uid` **[Array][202]&lt;[string][175]>?** Filter by destination Synthetic Account.
-   `synthetic_account_uid` **[Array][202]&lt;[string][175]>?** Filter by Synthetic Account, source or destination.
-   `type` **[Array][202]&lt;(`"atm_withdrawal"` \| `"card_purchase"` \| `"card_refund"` \| `"dispute"` \| `"external_transfer"` \| `"fee"` \| `"internal_transfer"` \| `"other"` \| `"reversed_transfer"` \| `"third_party_transfer"`)>?** Filter by type.
-   `status` **[Array][202]&lt;(`"queued"` \| `"pending"` \| `"settled"` \| `"failed"`)>?** Filter by status.
-   `search_description` **[string][175]?** Attempts to search for the provided string in the description field. '\*' can be used as a wildcard. Any record with a match will be returned.
-   `limit` **[number][201]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default = 100.
-   `offset` **[number][201]?** Index of the items to start retrieving from. Default = 0.
...
-   `uid` **[string][175]** A unique identifier generated by Rize
-   `settled_index` **[number][201]** A unique index that indicates the order in which Transaction Events were settled
-   `transaction_uid` **[string][175]** UID of the Transaction this line item belongs to
-   `phase` **[number][201]** Some Transfer types will trigger multiple transfers at the custodial level. Some of these custodial transfers must wait for all dependent custodial transfers to complete before initiating. Transaction Events with `phase` value 1 are recorded for the first set of custodial transfers that get initiated after the (Synthetic) Transfer starts. Custodial transfers in later phases cannot initiate before all events from previous phases are settled.
-   `source_custodial_account_uid` **[string][175]** Custodial Account from which the asset is pulled
-   `destination_custodial_account_uid` **[string][175]** Custodial Account where the asset lands
-   `custodial_line_item_uids` **[Array][202]&lt;[string][175]>** A list of UIDS referring to Custodial Line Items belonging to this event. There are always at least two line items if the status is `settled`.
-   `status` **[string][175]** 
-   `us_dollar_amount` **[string][175]** The amount will never be negative
...
-   `description` **[string][175]** 
-   `created_at` **[string][175]** The date and time when the event is first recognized by Rize. This may be when the Transfer is initiated if the event is associated with one.
-   `settled_at` **[string][175]** The date and time when the event is settled.
    //\*\*
-   `source_custodial_account_uid` **[Array][202]&lt;[string][175]>?** Filter by source Custodial Account.
-   `destination_custodial_account_uid` **[Array][202]&lt;[string][175]>?** Filter by destination Custodial Account.
-   `custodial_account_uid` **[Array][202]&lt;[string][175]>?** Filter by Custodial Account, source or destination.
-   `type` **[Array][202]&lt;(`"odfi_ach_deposit"` \| `"odfi_ach_withdrawal"` \| `"rdfi_ach_deposit"` \| `"rdfi_ach_withdrawal"`)>?** Filter by type. Multiple values are allowed.
-   `transaction_uid` **[Array][202]&lt;[string][175]>?** Filter by Transaction. Multiple values are allowed
-   `limit` **[number][201]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default = 100.
-   `offset` **[number][201]?** Index of the items to start retrieving from. Default = 0.
...
-   `uid` **[string][175]** A unique identifier generated by Rize
-   `settled_index` **[number][201]** A unique index that indicates the order in which the Synthetic Line Items were settled
-   `transaction_uid` **[string][175]** UID of the Transaction this Synthetic Line Item belongs to
-   `synthetic_account_uid` **[string][175]** UID of the Synthetic Account this Synthetic Line Item is associated with
-   `status` **[string][175]** 
-   `us_dollar_amount` **[string][175]** The signed USD amount of this specific Synthetic Line Item
-   `running_us_dollar_balance` **[string][175]** The Synthetic Account balance after this Synthetic Line Item was settled
-   `description` **[string][175]** Human-readable description in context of Synthetic Accounts
-   `created_at` **[string][175]** The date and time when the Synthetic Line Item is first recognized by Rize. This may be when the Transfer is initiated if the Synthetic Line Item is associated with one.
-   `settled_at` **[string][175]** The date and time when the Synthetic Line Item is settled
...
-   `customer_uid` **[Array][202]&lt;[string][175]>?** Filter by Customer.
-   `pool_uid` **[Array][202]&lt;[string][175]>?** Filter by pool.
-   `synthetic_account_uid` **[Array][202]&lt;[string][175]>?** Filter by Synthetic Account.
-   `limit` **[number][201]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default = 100.
-   `offset` **[number][201]?** Index of the items to start retrieving from. Default = 0.
-   `transaction_uid` **[Array][202]&lt;[string][175]>?** Filter by Transaction.
-   `status` **[Array][202]&lt;(`"begun"` \| `"failed"` \| `"in_progress"` \| `"settled"`)>?** Filter by status.
...
-   `uid` **[string][175]** A unique identifier generated by Rize.
-   `settled_index` **[number][201]** A unique index that indicates the order in which the Custodial Line Items were settled.
-   `transaction_uid` **[string][175]** UID of the Transaction this Custodial Line Item belongs to.
-   `transaction_event_uid` **[string][175]** UID of the Transaction Event this Custodial Line Item belongs to.
-   `custodial_account_uid` **[string][175]** UID of the Custodial Account this Custodial Line Item is associated with.
-   `status` **[string][175]** 
-   `us_dollar_amount` **[string][175]** The signed USD amount of this specific Custodial Line Item
-   `running_us_dollar_balance` **([string][175] | null)?** US dollar balance of the Custodial Account as of the completion of this Custodial Line Item. This field may be empty unless the status is `settled` or `voided`.
-   `type` **[string][175]** Symbols and/or numbers that represent different types of Custodial Line Items.
-   `description` **[string][175]** Descriptions pulled from the custodians, such as through NACHA description or ISO-8583 data element 43.
-   `created_at` **[string][175]** The date and time when the Custodial Line Items is first recognized by Rize. This may be when the Transfer is initiated if the Custodial Line Item is associated with one.
-   `occurred_at` **[string][175]** This field may be empty if status is not settled or voided.
-   `settled_at` **[string][175]** The date and time when the Custodial Line Item is settled.
...
-   `customer_uid` **[Array][202]&lt;[string][175]>?** Filter by Customer.
-   `custodial_account_uid` **[Array][202]&lt;[string][175]>?** Filter by Custodial Account.
-   `status` **[Array][202]&lt;(`"settled"` \| `"voided"`)>?** Filter by status.
-   `us_dollar_amount_tax` **[number][201]?** Return any records having a us_dollar_amount at or below us_dollar_amount_max.
-   `us_dollar_amount_min` **[number][201]?** Return any records having a us_dollar_amount at or above us_dollar_amount_min.
-   `transaction_event_uid` **[Array][202]&lt;[string][175]>?** Filter by Transaction Event.
-   `transaction_uid` **[Array][202]&lt;[string][175]>?** Filter by Transaction.
-   `limit` **[number][201]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default = 100.
-   `offset` **[number][201]?** Index of the items to start retrieving from. Default = 0.
-   `sort` **(`"created_at_asc"` \| `"created_at_desc"` \| `"description_asc"` \| `"description_desc"` \| `"settled_index_asc"` \| `"settled_index_desc"` \| `"us_dollar_amount_asc"` \| `"us_dollar_amount_desc"`)?** 
...
-   `uid` **[string][175]** A unique identifier generated by Rize.
-   `external_uid` **[string][175]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `source_synthetic_account_uid` **[string][175]** Synthetic Account to pull asset from. Must be an active liability or external-type account. Cannot be equal to `destination_synthetic_account_uid`.
-   `destination_synthetic_account_uid` **[string][175]** Synthetic Account where the asset should land. Must be an active liability or external-type account. Cannot be equal to `source_synthetic_account_uid`.
-   `initiating_customer_uid` **[string][175]** 
-   `usd_transfer_amount` **[string][175]** The USD amount to transfer
...
-   `external_uid` **[string][175]?** A unique, immutable id provided Client.
-   `pool_uid` **[Array][202]&lt;[string][175]>?** Filter by pool. Multiple values are allowed.
-   `synthetic_account_uid` **[Array][202]&lt;[string][175]>?** Filter by Synthetic Account. Multiple values are allowed.
-   `limit` **[number][201]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default = 100.
-   `offset` **[number][201]?** Index of the items to start retrieving from. Default = 0.
...
-   `timeout` **[number][201]?** Specifies the number of milliseconds before the each request times out. (Default: 80000)
...
-   `programUid` **[string][175]** The Rize Program ID.
-   `hmac` **[string][175]** The HMAC that will be used to sign the JSON web signature in order to get access to the API.
-   `options` **[RizeOptions][210]?** Configuration options (optional, default `RizeOptions`)
...
Type: [ComplianceWorkflowService][211]
...
Type: [SyntheticAccountService][213]
...
Type: [CustodialAccountService][214]
...
[110]: #complianceworkflowsummary

[111]: #properties-2

[112]: #complianceworkflowcustomer

[113]: #properties-3

[114]: #compliancedocument

[115]: #properties-4

[116]: #compliancedocumentacknowledgementrequest

[117]: #properties-5

[118]: #complianceworkflow
...
[122]: #custodialaccount

[123]: #properties-8

[124]: #custodialaccountlistquery
...
[134]: #debitcardlistquery

[135]: #properties-14

[136]: #debit-cardtypedefs

[137]: #syntheticaccounttype

[138]: #properties-15

[139]: #syntheticaccounttypelistquery

[140]: #properties-16

[141]: #syntheticaccount

[142]: #properties-17

[143]: #syntheticaccountlistquery

[144]: #properties-18

[145]: #syntheticaccountcreaterequest
...
[149]: #transactionlistquery

[150]: #properties-21

[151]: #syntheticlineitem

[152]: #properties-22

[153]: #syntheticlineitemlistquery

[154]: #properties-23

[155]: #custodiallineitem

[156]: #properties-24

[157]: #custodiallineitemlistquery
...
[167]: #complianceworkflow-1

[168]: #customer-1

[169]: #syntheticaccount-1

[170]: #custodialaccount-1
...
[177]: #complianceworkflow

[178]: #compliancedocumentacknowledgementrequest

[179]: #custodialaccount

[180]: #custodialaccountlistquery

[181]: #rizelist

[182]: #customerlistquery

[183]: #customer

[184]: #customerdetails

[185]: #debitcardlistquery

[186]: #debitcard

[187]: #syntheticaccountlistquery

[188]: #syntheticaccount

[189]: #syntheticaccountcreaterequest
...
[194]: #syntheticlineitemlistquery

[195]: #syntheticlineitem

[196]: #custodiallineitemlistquery

[197]: #custodiallineitem

[198]: #transferlistquery
...
[203]: #complianceworkflowsummary

[204]: #complianceworkflowcustomer

[205]: #compliancedocument

[206]: https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Boolean

[207]: #accounterror

[208]: https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Date

[209]: #address

[210]: #rizeoptions

[211]: #complianceworkflowservice

[212]: #customerservice

[213]: #syntheticaccountservice

[214]: #custodialaccountservice

[215]: #transactionservice
