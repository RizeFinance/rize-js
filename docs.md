...
-   [EvaluationService][68]
    ...
    -   [get][72]
        -   [Parameters][73]
        -   [Examples][74]
-   [KYCDocumentService][75]
    -   [getList][76]
        -   [Parameters][77]
        -   [Examples][78]
-   [SyntheticAccountService][79]
    -   [getList][80]
        -   [Parameters][81]
        -   [Examples][82]
    -   [get][83]
...
-   [TransactionService][101]
    ...
    -   [get][105]
        -   [Parameters][106]
        -   [Examples][107]
    -   [getTransactionEventList][108]
        -   [Parameters][109]
        -   [Examples][110]
    -   [getTransactionEvent][111]
        -   [Parameters][112]
        -   [Examples][113]
    -   [getSyntheticLineItemList][114]
        -   [Parameters][115]
        -   [Examples][116]
    -   [getSyntheticLineItem][117]
        -   [Parameters][118]
        -   [Examples][119]
    -   [getCustodialLineItemList][120]
        -   [Parameters][121]
        -   [Examples][122]
    -   [getCustodialLineItem][123]
        -   [Parameters][124]
        -   [Examples][125]
-   [TransferService][126]
    -   [getList][127]
...
-   [Address][138]
    -   [Properties][139]
-   [ComplianceWorkflowSummary][140]
    -   [Properties][141]
-   [ComplianceWorkflowCustomer][142]
    -   [Properties][143]
-   [ComplianceDocument][144]
    -   [Properties][145]
-   [ComplianceDocumentAcknowledgementRequest][146]
    -   [Properties][147]
-   [ComplianceWorkflow][148]
    -   [Properties][149]
-   [AccountError][150]
    -   [Properties][151]
-   [CustodialAccount][152]
    -   [Properties][153]
-   [CustodialAccountListQuery][154]
    -   [Properties][155]
-   [CustomerDetails][156]
    -   [Properties][157]
-   [Customer][158]
    -   [Properties][159]
-   [CustomerListQuery][160]
    -   [Properties][161]
-   [DebitCard][162]
    -   [Properties][163]
-   [DebitCardListQuery][164]
    -   [Properties][165]
-   [debit-card.typedefs][166]
-   [Document][167]
    -   [Properties][168]
-   [DocumentListQuery][169]
    -   [Properties][170]
-   [Evaluation][171]
    -   [Properties][172]
-   [EvaluationListQuery][173]
    -   [Properties][174]
-   [KYCDocument][175]
    -   [Properties][176]
-   [SyntheticAccountType][177]
    -   [Properties][178]
-   [SyntheticAccountTypeListQuery][179]
    -   [Properties][180]
-   [SyntheticAccount][181]
    -   [Properties][182]
-   [SyntheticAccountListQuery][183]
    -   [Properties][184]
-   [SyntheticAccountCreateRequest][185]
    -   [Properties][186]
-   [Transaction][187]
    -   [Properties][188]
-   [TransactionListQuery][189]
    -   [Properties][190]
-   [SyntheticLineItem][191]
    -   [Properties][192]
-   [SyntheticLineItemListQuery][193]
    -   [Properties][194]
-   [CustodialLineItem][195]
    -   [Properties][196]
-   [CustodialLineItemListQuery][197]
    -   [Properties][198]
-   [Transfer][199]
    -   [Properties][200]
-   [TransferListQuery][201]
    -   [Properties][202]
-   [RizeOptions][203]
    -   [Properties][204]
-   [Rize][205]
    ...
    -   [customer][208]
    -   [syntheticAccount][209]
    -   [custodialAccount][210]
    -   [transaction][211]
    -   [transfer][212]
    -   [debitCard][213]
    -   [document][214]
...
-   `customerExternalUid` **[string][218]** A Customer identifier supplied by the Partner, unique among the collection of all partner Customers.
-   `email` **[string][218]** Email address associated with the Customer.
...
Returns **[Promise][219]&lt;[ComplianceWorkflow][220]>** A promise that returns the new Compliance Workflow if resolved.
...
-   `customerExternalUid` **[string][218]** A Customer identifier supplied by the Partner, unique among the collection of all partner Customers.
-   `customerUid` **[string][218]** A UID referring to the Customer generated by Rize
-   `email` **[string][218]** Email address associated with the Customer.

Returns **[Promise][219]&lt;[ComplianceWorkflow][220]>** A promise that returns the new Compliance Workflow entity if resolved.
...
-   `customerUid` **[string][218]** A UID referring to the Customer
...
Returns **[Promise][219]&lt;[ComplianceWorkflow][220]>** A promise that returns the latest Compliance Workflow if resolved.
...
-   `complianceWorkflowUid` **[string][218]** A UID referring to the Compliance Workflow.
-   `customerUid` **[string][218]** A UID referring to the Customer.
-   `documents` **...[ComplianceDocumentAcknowledgementRequest][221]** 
...
Returns **[Promise][219]&lt;[ComplianceWorkflow][220]>** A promise that returns the updated Compliance Workflow if resolved.
...
-   `uid` **[string][218]** Rize-generated unique custodial account id
...
Returns **[Promise][219]&lt;[CustodialAccount][222]>** A promise that returns a Custodial Account if resolved.
...
-   `query` **[CustodialAccountListQuery][223]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][219]&lt;[RizeList][224]&lt;CustodialAccountList>>** A promise that returns a Custodial Account List if resolved.
...
-   `query` **[CustomerListQuery][225]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][219]&lt;[RizeList][224]&lt;[Customer][226]>>** A promise that returns a Customer List if resolved.
...
-   `uid` **[string][218]** Rize-generated unique customer id
...
Returns **[Promise][219]&lt;[Customer][226]>** A promise that returns a Customer if resolved.
...
-   `uid` **[string][218]** Rize-generated unique customer id
-   `email` **[string][218]** Email of the customer
-   `details` **[CustomerDetails][227]** An object containing the supplied identifying information for the Customer
...
Returns **[Promise][219]&lt;[Customer][226]>** A promise that returns the updated Customer if resolved.
...
Returns **[Promise][219]&lt;void>** A promise that returns void if resolved.
...
-   `uid` **[string][218]** Rize-generated unique customer id
-   `lockReason` **[string][218]** The reason that the Customer is being locked must be submitted with the request body.
...
Returns **[Promise][219]&lt;[Customer][226]>** A promise that returns the locked Customer if resolved.
...
-   `uid` **[string][218]** Rize-generated unique customer id
-   `unlockReason` **[string][218]** The reason that the Customer is being unlocked. (optional, default `null`)
...
Returns **[Promise][219]&lt;[Customer][226]>** A promise that returns the unlocked Customer if resolved.
...
-   `query` **[DebitCardListQuery][228]?** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][219]&lt;[RizeList][224]&lt;[DebitCard][229]>>** A promise that returns a Debit Card List if resolved.
...
-   `uid` **[string][218]** Rize-generated unique debitCard id
...
Returns **[Promise][219]&lt;[DebitCard][229]>** A promise that returns a Debit Card if resolved.
...
-   `externalUid` **[string][218]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `customerUid` **[string][218]** A UID referring to the Customer who owns this Card
-   `poolUid` **[string][218]** A UID referring to the Pool to which this Card belongs
-   `shippingAddress` **([Address][230] | null)?** An optional field used to specify the shipping address for a physical Debit Card.Either the whole `address` must be nullable or all fields must be provided, with an except of `street2`, which is nullable.If no address is specified, the primary address associated with the customer will be used as a shipping address. (optional, default `null`)
...
-   `uid` **[string][218]** Rize-generated unique Debit Card id
-   `lockReason` **[string][218]** A lock reason is required to be submitted when locking a Debit Card
...
-   `query` **[DocumentListQuery][231]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][219]&lt;[RizeList][224]&lt;[Document][232]>>** A promise that returns a Document List if resolved.
...
-   `uid` **[string][218]** Rize-generated unique document id
...
Returns **[Promise][219]&lt;[Document][232]>** A promise that returns a Document if resolved.
...
-   `query` **[EvaluationListQuery][233]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][219]&lt;[RizeList][224]&lt;[Evaluation][234]>>** A promise that returns a Evaluation List if resolved.
...
-   `uid` **[string][218]** Rize-generated unique evaluation id
...
Returns **[Promise][219]&lt;[Evaluation][234]>** A promise that returns a Evaluation if resolved.
...
-   `evaluationUid` **[string][218]** An object containing key value pair for getting the results list.
...
Returns **[Promise][219]&lt;[RizeList][224]&lt;[KYCDocument][235]>>** A promise that returns a List of KYC Documents if resolved.
...
-   `query` **[SyntheticAccountListQuery][236]** An object containing key value paris for filtering the result. (optional, default `{}`)
...
Returns **[Promise][219]&lt;[RizeList][224]&lt;[SyntheticAccount][237]>>** A promise that returns the Synthetic Account list if resolved.
...
-   `uid` **[string][218]** Rize-generated unique synthetic account id
...
Returns **[Promise][219]&lt;[SyntheticAccount][237]>** A promise that returns a SyntheticAccount if resolved.

### create

#### Parameters

-   `payload` **[SyntheticAccountCreateRequest][238]** is a JSON object needs to send as body parameters in order to create new synthetic accounts.
...
Returns **[Promise][219]&lt;[RizeList][224]&lt;[SyntheticAccount][237]>>** 
...
Returns **[Promise][219]&lt;[SyntheticAccount][237]>** A promise that returns a Synthetic Account if resolved.
...
-   `query` **[SyntheticAccountTypeListQuery][239]** An object containing key value paris for filtering the result. (optional, default `{}`)
...
Returns **[Promise][219]&lt;[RizeList][224]&lt;[SyntheticAccountType][240]>>** A promise that returns a Synthetic Account Type List if resolved.
...
-   `uid` **[string][218]** Rize-generated unique Synthetic Account Type id
...
Returns **[Promise][219]&lt;[SyntheticAccountType][240]>** A promise that returns a Synthetic Account Type if resolved.
...
-   `query` **[TransactionListQuery][241]?** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][219]&lt;[RizeList][224]&lt;[Transaction][242]>>** A promise that returns a Transaction List if resolved.
...
-   `uid` **[string][218]** Rize-generated unique transaction id
...
Returns **[Promise][219]&lt;[Transaction][242]>** A promise that returns a Transaction if resolved.
...
Returns **[Promise][219]&lt;[RizeList][224]&lt;TransactionEvent>>** A promise that returns a TransactionEvent List if resolved.
...
-   `uid` **[string][218]** Rize-generated unique transaction event id
...
Returns **[Promise][219]&lt;TransactionEvent>** A promise that returns a Transaction Event if resolved.
...
-   `query` **[SyntheticLineItemListQuery][243]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][219]&lt;[RizeList][224]&lt;[SyntheticLineItem][244]>>** A promise that returns a Synthetic Line Item List if resolved.
...
-   `uid` **[string][218]** Rize-generated unique Synthetic Line Item id
...
Returns **[Promise][219]&lt;[SyntheticLineItem][244]>** A promise that returns a Synthetic Line Item if resolved.

### getCustodialLineItemList

#### Parameters

-   `query` **[CustodialLineItemListQuery][245]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][219]&lt;[RizeList][224]&lt;[CustodialLineItem][246]>>** A promise that returns a Custodial Line Item List if resolved.
...
-   `uid` **[string][218]** Rize-generated unique Custodial Line Item id
...
Returns **[Promise][219]&lt;[CustodialLineItem][246]>** A promise that returns a Custodial Line Item if resolved.
...
-   `query` **[TransferListQuery][247]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][219]&lt;[RizeList][224]&lt;[Transfer][248]>>** A promise that returns a Transfer List if resolved.
...
-   `uid` **[string][218]** Rize-generated unique Transfer id
...
Returns **[Promise][219]&lt;[Transfer][248]>** A promise that returns a Transfer if resolved.
...
-   `externalUid` **[string][218]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `sourceSyntheticAccountUid` **[string][218]** Synthetic Account to pull asset from. Must be an active liability or external-type account. Cannot be equal to `destination_synthetic_account_uid`.
-   `destinationSyntheticAccountUid` **[string][218]** Synthetic Account where the asset should land. Must be an active liability or external-type account. Cannot be equal to `source_synthetic_account_uid`.
-   `initiatingCustomerUid` **[string][218]** 
-   `usTransferAmount` **[string][218]** The USD amount to transfer.
...
-   `total_count` **[number][250]** Total count of items available to retrieve
-   `count` **[number][250]** Number of items retrieved
-   `limit` **[number][250]** Maximum number of items to retrieve
-   `offset` **[number][250]** Index of the first item to retrieve
-   `data` **[Array][251]&lt;T>** 
...
-   `street1` **[string][218]** 
-   `street2` **([string][218] | null)?** 
-   `city` **[string][218]** 
-   `state` **[string][218]** 
-   `postal_code` **[string][218]** 
...
-   `accepted_quantity` **[number][250]** 
-   `begun_at` **[string][218]** The DateTime at which this Compliance Workflow was requested
-   `completed_step` **[number][250]** 
-   `current_step` **[number][250]** 
...
-   `email` **[string][218]** 
-   `external_uid` **[string][218]** A Customer identifier supplied by the Client, unique among the collection of all Client Customers
-   `uid` **[string][218]** A UID referring to the Customer
...
-   `external_storage_name` **[string][218]** Amazon S3 key used to retrieve the contents of a Compliance Document
-   `compliance_document_url` **[string][218]** Amazon S3 URL used to retrieve the contents of a Compliance Document
-   `name` **[string][218]** 
-   `step` **[number][250]** Multiple Compliance Documents are grouped into a Step, and Compliance Documents are presented to a Customer, Step-by-Step
-   `version` **[number][250]** 
-   `uid` **[string][218]** A UID referring to a Compliance Document; note that this UID will be different for each Customer
-   `accepted_at` **[string][218]** The DateTime at which this Compliance Document was acknowledged
...
-   `documentUid` **[string][218]** A UID referring to the Compliance Document being acknowledged.
-   `accept` **(`"yes"` \| `"no"`)** An indication of acceptance or rejection.
-   `userName` **[string][218]?** A label associated with the Customer (required for electronic signing).
-   `ipAddress` **[string][218]?** A numerical label assigned to each device connected to a computer network that uses the Internet Protocol for communication (required for electronic signing); in this case, the label associated with the computer used by the Customer.
...
-   `uid` **[string][218]** A unique identifier generated by Rize.
-   `summary` **[ComplianceWorkflowSummary][252]** 
-   `customer` **[ComplianceWorkflowCustomer][253]** 
-   `accepted_documents` **[Array][251]&lt;[ComplianceDocument][254]>** 
-   `current_step_documents_pending` **[Array][251]&lt;Omit&lt;[ComplianceDocument][254], `"accepted_at"`>>** Compliance Documents that await acknowledgment in the current Step
-   `all_documents` **[Array][251]&lt;Omit&lt;[ComplianceDocument][254], (`"accepted_at"` \| `"uid"`)>>** The set of all Compliance Documents that would require acknowledgment
...
-   `error_code` **[string][218]** 
-   `error_name` **[string][218]** 
-   `error_description` **[string][218]** 
...
-   `uid` **[string][218]** A unique identifier generated by Rize
-   `external_uid` **[string][218]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `customer_uid` **[string][218]** A UID referring to the customer this Custodial Account belongs to
-   `pool_uid` **[Array][251]&lt;[string][218]>** A UID referring to the pool this Custodial Account belongs to
-   `program_service_offering_uid` **([string][218] | null)** A UID referring to the specific Program Service Offering for which this account was created. Nullable if asset.
...
-   `liability` **[boolean][255]** Liability or asset. Liability Custodial Accounts represent real accounts at Financial Institutions. Asset accounts are used for accounting purposes and may be generated by Rize during events such as new custodial account creations or new external account connections.
-   `name` **([string][218] | null)** A friendly name used to identify the account at the Custodial Partner.
-   `primary_account` **[boolean][255]** The date and time when the Customer was locked. This field will be null if and only if the lock_reason is null.
...
-   `account_errors` **[Array][251]&lt;[AccountError][256]>** A list of errors related to this account. These are passed through during interactions with the underlying Custodial Partner and can help with resolving customer issues. Only provided for accounts that are in an error or manual_review status.
-   `net_usd_balance` **[string][218]** The current settled balance of this Custodial Account in US Dollars
-   `net_usd_pending_balance` **[string][218]** The sum of all pending transactions for this Custodial Account in US Dollars
-   `net_usd_available_balance` **[string][218]** The balance available to spend calculated as Normal balance less any withdrawals. Pending deposits are not included
-   `account_number` **([string][218] | null)** The ACH account number that can be used to make transfers into/out of this account. Nullable if asset.
-   `account_number_masked` **([string][218] | null)** Last 4 digits of the ACH account number. Nullable if asset.
-   `routing_number` **([string][218] | null)** The ABA routing number associated with the Custodial Partner. Nullable if asset.
-   `opened_at` **[Date][257]** The DateTime at which this account was created
-   `closed_at` **[Date][257]** The DateTime at which this account was closed
...
-   `customer_uid` **[Array][251]&lt;[string][218]>?** Filter by Customer. Multiple values are allowed
-   `external_uid` **[string][218]?** A unique, immutable id provided Clien
-   `limit` **[string][218]?**  Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[string][218]?** Index of the items to start retrieving from. Default: 0
-   `liability` **[string][218]?** Filter by liability or asset
-   `type` **[Array][251]&lt;[string][218]>?** Filter by type. Multiple values are allowed.
...
-   `first_name` **[string][218]** 
-   `middle_name` **([string][218] | null)?** 
-   `last_name` **[string][218]** 
-   `suffix` **([string][218] | null)?** 
-   `phone` **[string][218]** 
-   `ssn` **[string][218]** 
-   `dob` **[string][218]** 
-   `address` **[Address][230]** 
...
-   `uid` **[string][218]** A unique identifier generated by Rize
-   `external_uid` **[string][218]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `program_uid` **[string][218]** A uid referring to the program this customer belongs to.
-   `pool_uids` **[Array][251]&lt;[string][218]>** A list of uids referring to Pools belonging to this Customer.
-   `email` **[string][218]** Email of the customer
...
-   `total_balance` **[string][218]** Total asset owned by the customer in US dollars.
-   `created_at` **[Date][257]** 
-   `locked_at` **([Date][257] | null)?** The date and time when the Customer was locked. This field will be null if and only if the lock_reason is null.
-   `lock_reason` **([string][218] | null)?** The lock reason provided by the Client, an admin User, or the system at the time the Customer was locked. This field will be null if and only if the locked_at is null.
-   `details` **[CustomerDetails][227]** An object containing the supplied identifying information for the Customer.
...
-   `include_initiated` **[boolean][255]?** By default, Customers in initiated status are not shown, even if the `status=initiated` parameter is provided. In order for Customers with status initiated to appear in search results, parameters must include `include_initiated=true`.
...
-   `first_name` **[string][218]?** Only return Customers with a first name matching exactly what is submitted
-   `last_name` **[string][218]?** Only return Customers with a last name matching exactly what is submitted
-   `email` **[string][218]?** Only return Customers with an email address matching exactly what is submitted
-   `locked` **[boolean][255]?** Only return locked Customers if true and only return unlocked Customers if false
-   `program_uid` **[string][218]?** Only return Customers belonging to the submitted Program.
-   `external_uid` **[string][218]?** A unique, immutable id provided by Client.
-   `pool_uid` **[Array][251]&lt;[string][218]>?** Filter by pool. Multiple values are allowed.
-   `limit` **[string][218]?**  Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[string][218]?** Index of the items to start retrieving from. Default: 0
...
-   `uid` **[string][218]** A unique identifier generated by Rize
-   `external_uid` **[string][218]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `customer_uid` **[string][218]** A UID referring to the Customer who owns this Card.
-   `pool_uid` **[string][218]** A UID referring to the Pool to which this Card belongs.
-   `synthetic_account_uid` **[string][218]** A UID referring to the specific Synthetic Account to which this Card belongs. Any debit or credit transactions from this Card will occur in this account.
-   `custodial_account_uid` **[string][218]** A UID referring to the specific Custodial Account to which this Card belongs. Any debit or credit transactions from this Card will occur in this account.
-   `card_last_four_digits` **([string][218] | null)?** Last 4 digits of the Debit Card number to aid in indentifying the Card. Null if the Card is not yet issued (i.e. status is `initiated`).
...
-   `ready_to_use` **[boolean][255]** If the Card can be used, this value will be `true`; `false` otherwise.
-   `lock_reason` **([string][218] | null)?** If the Card is in a locked state, this field will be populated describing why the Card was locked. Null if the Card is not locked.
-   `issued_on` **([string][218] | null)?** The date this Card was issued. It may be briefly null when a new Card is requested, but the issuance has not yet happened (i.e. status is `initiated`).
-   `locked_at` **([string][218] | null)?** The date and time at which this Card was locked. Null if the Card is not locked.
-   `closed_at` **([string][218] | null)?** The date and time at which this Card was closed. This field will be null unless the `status` is `closed`, `closed_by_administrator`, `lost`, or `stolen`.
-   `latest_shipping_address` **([Address][230] | null)?** An optional field used to specify the shipping address for a physical Debit Card.If no address was specified via `debitCard.create`, this field will be null. In case of reissuance, only the address from the latest shipment will be provided, if any.
...
-   `customer_uid` **[Array][251]&lt;[string][218]>?** Filter by Customer. Multiple values are allowed.
-   `external_uid` **[string][218]?** A unique, immutable id provided Client
-   `limit` **[string][218]?**  Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[string][218]?** Index of the items to start retrieving from. Default: 0
-   `pool_uid` **[Array][251]&lt;[string][218]>?** Filter by pool. Multiple values are allowed.
-   `locked` **[boolean][255]?** Only return locked Cards if `true` and only return unlocked Cards if `false`
...
-   `uid` **[string][218]** A unique identifier generated by Rize
-   `document_type` **[string][218]** The document type. Only monthly statements are currently available.
...
-   `period_started_at` **[string][218]** The date and time when the document period started at, inclusive
-   `period_ended_at` **[string][218]** The date and time when the document period ended at, exclusive
-   `created_at` **[string][218]** The date and time when the document became available
-   `customer_uids` **[Array][251]&lt;[string][218]>** A list of UIDs of Customers that are associated with the document.(not implemented) Note that once we allow joint pool and accounts, this list will be pessimistic; each
...
-   `custodial_account_uids` **[Array][251]&lt;[string][218]>** A list of UIDs of Custodial Accounts that are associated with the document.If `scope_type` is `custodial_account`, this list will contain only one UID. In fact, currently as implemented,
    this list should always have exactly one UID.
-   `synthetic_account_uids` **[Array][251]&lt;[string][218]>** A list of UIDs of Synthetic Accounts that are associated with the document.If `scope_type` is `synthetic_account`, this list will contain only one UID.
...
-   `month` **[number][250]?** Filter by month. This includes any document for which the period started in the specified month.
-   `year` **[number][250]?** Filter by year
-   `scope_type` **(`"customer"` \| `"synthetic_account"` \| `"custodial_account"`)?** (not implemented) Filter by scope type
-   `custodial_account_uid` **[string][218]?** Filter by Custodial Account
-   `customer_uid` **[Array][251]&lt;[string][218]>?** Filter by Customer. Multiple values are allowed.
-   `synthetic_account_uid` **[Array][251]&lt;[string][218]>?** Filter by Synthetic Account. Multiple values are allowed.
-   `limit` **[number][250]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default = 100.
-   `offset` **[number][250]?** Index of the items to start retrieving from. Default = 0.
...
-   `created_at` **[string][218]** The date and time when the evaluation became created
-   `flags` **[string][218]** A mapping of categories to outcomes for those categories. Items are defined as: key - 
...
-   `pii_match` **[string][218]** A mapping of KYC categories to results returned from various services queried by our KYC partner.
...
-   `customer_uid` **[Array][251]&lt;[string][218]>?** Filter by Customer. Multiple values are allowed
-   `latest` **[boolean][255]?** Return only the latest evaluation
...
-   `filename` **[string][218]** The name of this file, exclusive of any extension.
-   `note` **[string][218]** A note describing the document.
-   `extension` **[string][218]** The filename extension.
-   `created_at` **[string][218]** 
...
-   `uid` **[string][218]** A unique identifier generated by Rize
-   `name` **[string][218]** A unique name to identify the resource
...
-   `description` **[string][218]** A description outlining the intended use and requirements for this program's instance of the synthetic_account_type
-   `program_uid` **[string][218]?** A uid referring to the Program this synthetic_account_type belongs to
...
-   `program_uid` **[string][218]?** Only list Synthetic Account Types that are available to be used by the given Program
-   `limit` **[number][250]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[number][250]?** Index of the items to start retrieving from. Default: 0
...
-   `external_uid` **[string][218]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `name` **[string][218]** A unique name to identify the resource.
-   `pool_uid` **[string][218]** A UID referring to the pool this Synthetic Account belongs to.
-   `synthetic_account_type_uid` **[string][218]** A UID referring to the Synthetic Account Type this Synthetic Account should be created as.
...
-   `liability` **[boolean][255]** Liability or asset. Any Synthetic Account created via POST /synthetic_accounts is a liability account, except for external accounts. Some asset Synthetic Accounts are automatically created by Rize during Customer onboarding for accounting purposes.
-   `net_usd_balance` **[string][218]** The current settled balance of this account in US Dollars. This field will be null for synthetic_account_types in the external category.
-   `net_usd_pending_balance` **[string][218]** The sum of all pending transactions for this account in US Dollars. This field will be null for Synthetic Account Types in the external category.
-   `net_usd_available_balance` **[string][218]** The balance available to spend calculated as the settled balance less any pending withdrawals Pending deposits are not included. This field will be null for Synthetic Account Types in the external category.
-   `master_account` **[boolean][255]** Used to identify the Master Synthetic Accounts that exist for every Program Customer. Master Synthetic Accounts are the default accounts where any unknown custodial transactions will settle and cannot be archived while a Program Customer is still active.
-   `account_number` **([string][218] | null)** The ACH account number (if any) associated with this account. Some Synthetic Account Types require this field to be submitted along with the POST request. For example, any Synthetic Account Type from the `external` category will require an `account_number`. Submitting an `account_number` with a Synthetic Account Type that does not require one will result in the account number being ignored.
-   `account_number_last_four` **([string][218] | null)** Last 4 digits of the ACH account number.
-   `routing_number` **([string][218] | null)** The ABA routing number (if any) associated with this account. Some Synthetic Account Types require this field to be submitted along with the POST request. For example, any Synthetic Account Type from the `external` category will require a `routing_number`. Submitting a `routing_number` with a Synthetic Account Type that does not require one will result in the routing number being ignored.
-   `opened_at` **[string][218]** The DateTime at which this account was created
-   `closed_at` **([string][218] | null)** The DateTime at which this account was closed. This value will be present if the status is `archived` or `failed`.
-   `closed_to_synthetic_account_uid` **([string][218] | null)** A UID referring to the Synthetic Account where the funds in this account were transferred when closed. Any transactions issued against this account after it is closed will instead go to the `closed_to` account
...
-   `customer_uid` **[Array][251]&lt;[string][218]>?** Filter by Customer. Multiple string values are allowed.
-   `external_uid` **[string][218]?** A unique, immutable id provided Client
-   `pool_uid` **[Array][251]&lt;[string][218]>?** Filter by pool. Multiple string values are allowed.
-   `limit` **[number][250]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[number][250]?** Index of the items to start retrieving from. Default: 0
-   `synthetic_account_type_uid` **[string][218]?** Filter by Synthetic Account Type
-   `synthetic_account_category` **(`"general"` \| `"external"` \| `"plaid_external"`)?** Filter by Synthetic Account Category
-   `liability` **[boolean][255]?** Filter by liability or asset
...
-   `externalUid` **([string][218] | null)?** A unique identifier Client supplies
-   `name` **([string][218] | null)?** A unique name to identify the resource
-   `poolUid` **([string][218] | null)?** A UID referring to the pool this Synthetic Account belongs to
-   `syntheticAccountTypeUid` **([string][218] | null)?** A UID referring to the Synthetic Account Type this Synthetic Account should be created as
-   `accountNumber` **([string][218] | null)?** The ACH account number (if any) associated with this account. Some Synthetic Account Types require this field to be submitted along with the POST request. For example, any Synthetic Account Type from the `external` category will require an `account_number`. Submitting an `account_number` with a Synthetic Account Type that does not require one will result in the account number being ignored.
-   `routingNumber` **([string][218] | null)?** The ABA routing number (if any) associated with this account. Some Synthetic Account Types require this field to be submitted along with the POST request. For example, any Synthetic Account Type from the `external` category will require a `routing_number`. Submitting a `routing_number` with a Synthetic Account Type that does not require one will result in the routing number being ignored.
...
-   `uid` **[string][218]** A unique identifier generated by Rize
-   `id` **[number][250]** A unique numeric identifier that indicates the order in which the Transactions were created
-   `settled_index` **([number][250] | null)?** A unique index that indicates the order in which the Transactions were settled. Null if status is `queued` or `pending`.
-   `transfer_uid` **([number][250] | null)?** The UID of the Transfer this Transaction is associated with, if any.
-   `source_synthetic_account_uid` **[string][218]** Synthetic Account from where the asset is pulled
-   `destination_synthetic_account_uid` **[string][218]** Synthetic Account where the asset is landed
-   `transaction_event_uids` **[Array][251]&lt;[string][218]>** A list of UIDS referring to Transaction Events belonging to this Transaction, if any. 
...
-   `custodial_account_uids` **[Array][251]&lt;[string][218]>** A list of UIDS referring to Custodial Accounts that are so far invovled in this Transaction. 
...
-   `us_dollar_amount` **[string][218]** The amount will never be negative
...
-   `description` **[string][218]** 
-   `created_at` **[string][218]** The date and time when the Transaction is first recognized by Rize. This may be when the Transfer is initiated if the Transaction is associated with one.
-   `settled_at` **[string][218]** The date and time when the Transaction is settled.
...
-   `customer_uid` **[Array][251]&lt;[string][218]>?** Filter by Customer.
-   `source_synthetic_account_uid` **[Array][251]&lt;[string][218]>?** Filter by source Synthetic Account.
-   `destination_synthetic_account_uid` **[Array][251]&lt;[string][218]>?** Filter by destination Synthetic Account.
-   `synthetic_account_uid` **[Array][251]&lt;[string][218]>?** Filter by Synthetic Account, source or destination.
-   `type` **[Array][251]&lt;(`"atm_withdrawal"` \| `"card_purchase"` \| `"card_refund"` \| `"dispute"` \| `"external_transfer"` \| `"fee"` \| `"internal_transfer"` \| `"other"` \| `"reversed_transfer"` \| `"third_party_transfer"`)>?** Filter by type.
-   `status` **[Array][251]&lt;(`"queued"` \| `"pending"` \| `"settled"` \| `"failed"`)>?** Filter by status.
-   `search_description` **[string][218]?** Attempts to search for the provided string in the description field. '\*' can be used as a wildcard. Any record with a match will be returned.
-   `limit` **[number][250]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default = 100.
-   `offset` **[number][250]?** Index of the items to start retrieving from. Default = 0.
...
-   `uid` **[string][218]** A unique identifier generated by Rize
-   `settled_index` **[number][250]** A unique index that indicates the order in which Transaction Events were settled
-   `transaction_uid` **[string][218]** UID of the Transaction this line item belongs to
-   `phase` **[number][250]** Some Transfer types will trigger multiple transfers at the custodial level. Some of these custodial transfers must wait for all dependent custodial transfers to complete before initiating. Transaction Events with `phase` value 1 are recorded for the first set of custodial transfers that get initiated after the (Synthetic) Transfer starts. Custodial transfers in later phases cannot initiate before all events from previous phases are settled.
-   `source_custodial_account_uid` **[string][218]** Custodial Account from which the asset is pulled
-   `destination_custodial_account_uid` **[string][218]** Custodial Account where the asset lands
-   `custodial_line_item_uids` **[Array][251]&lt;[string][218]>** A list of UIDS referring to Custodial Line Items belonging to this event. There are always at least two line items if the status is `settled`.
-   `status` **[string][218]** 
-   `us_dollar_amount` **[string][218]** The amount will never be negative
...
-   `description` **[string][218]** 
-   `created_at` **[string][218]** The date and time when the event is first recognized by Rize. This may be when the Transfer is initiated if the event is associated with one.
-   `settled_at` **[string][218]** The date and time when the event is settled.
    //\*\*
-   `source_custodial_account_uid` **[Array][251]&lt;[string][218]>?** Filter by source Custodial Account.
-   `destination_custodial_account_uid` **[Array][251]&lt;[string][218]>?** Filter by destination Custodial Account.
-   `custodial_account_uid` **[Array][251]&lt;[string][218]>?** Filter by Custodial Account, source or destination.
-   `type` **[Array][251]&lt;(`"odfi_ach_deposit"` \| `"odfi_ach_withdrawal"` \| `"rdfi_ach_deposit"` \| `"rdfi_ach_withdrawal"`)>?** Filter by type. Multiple values are allowed.
-   `transaction_uid` **[Array][251]&lt;[string][218]>?** Filter by Transaction. Multiple values are allowed
-   `limit` **[number][250]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default = 100.
-   `offset` **[number][250]?** Index of the items to start retrieving from. Default = 0.
...
-   `uid` **[string][218]** A unique identifier generated by Rize
-   `settled_index` **[number][250]** A unique index that indicates the order in which the Synthetic Line Items were settled
-   `transaction_uid` **[string][218]** UID of the Transaction this Synthetic Line Item belongs to
-   `synthetic_account_uid` **[string][218]** UID of the Synthetic Account this Synthetic Line Item is associated with
-   `status` **[string][218]** 
-   `us_dollar_amount` **[string][218]** The signed USD amount of this specific Synthetic Line Item
-   `running_us_dollar_balance` **[string][218]** The Synthetic Account balance after this Synthetic Line Item was settled
-   `description` **[string][218]** Human-readable description in context of Synthetic Accounts
-   `created_at` **[string][218]** The date and time when the Synthetic Line Item is first recognized by Rize. This may be when the Transfer is initiated if the Synthetic Line Item is associated with one.
-   `settled_at` **[string][218]** The date and time when the Synthetic Line Item is settled
...
-   `customer_uid` **[Array][251]&lt;[string][218]>?** Filter by Customer.
-   `pool_uid` **[Array][251]&lt;[string][218]>?** Filter by pool.
-   `synthetic_account_uid` **[Array][251]&lt;[string][218]>?** Filter by Synthetic Account.
-   `limit` **[number][250]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default = 100.
-   `offset` **[number][250]?** Index of the items to start retrieving from. Default = 0.
-   `transaction_uid` **[Array][251]&lt;[string][218]>?** Filter by Transaction.
-   `status` **[Array][251]&lt;(`"begun"` \| `"failed"` \| `"in_progress"` \| `"settled"`)>?** Filter by status.
...
-   `uid` **[string][218]** A unique identifier generated by Rize.
-   `settled_index` **[number][250]** A unique index that indicates the order in which the Custodial Line Items were settled.
-   `transaction_uid` **[string][218]** UID of the Transaction this Custodial Line Item belongs to.
-   `transaction_event_uid` **[string][218]** UID of the Transaction Event this Custodial Line Item belongs to.
-   `custodial_account_uid` **[string][218]** UID of the Custodial Account this Custodial Line Item is associated with.
-   `status` **[string][218]** 
-   `us_dollar_amount` **[string][218]** The signed USD amount of this specific Custodial Line Item
-   `running_us_dollar_balance` **([string][218] | null)?** US dollar balance of the Custodial Account as of the completion of this Custodial Line Item. This field may be empty unless the status is `settled` or `voided`.
-   `type` **[string][218]** Symbols and/or numbers that represent different types of Custodial Line Items.
-   `description` **[string][218]** Descriptions pulled from the custodians, such as through NACHA description or ISO-8583 data element 43.
-   `created_at` **[string][218]** The date and time when the Custodial Line Items is first recognized by Rize. This may be when the Transfer is initiated if the Custodial Line Item is associated with one.
-   `occurred_at` **[string][218]** This field may be empty if status is not settled or voided.
-   `settled_at` **[string][218]** The date and time when the Custodial Line Item is settled.
...
-   `customer_uid` **[Array][251]&lt;[string][218]>?** Filter by Customer.
-   `custodial_account_uid` **[Array][251]&lt;[string][218]>?** Filter by Custodial Account.
-   `status` **[Array][251]&lt;(`"settled"` \| `"voided"`)>?** Filter by status.
-   `us_dollar_amount_tax` **[number][250]?** Return any records having a us_dollar_amount at or below us_dollar_amount_max.
-   `us_dollar_amount_min` **[number][250]?** Return any records having a us_dollar_amount at or above us_dollar_amount_min.
-   `transaction_event_uid` **[Array][251]&lt;[string][218]>?** Filter by Transaction Event.
-   `transaction_uid` **[Array][251]&lt;[string][218]>?** Filter by Transaction.
-   `limit` **[number][250]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default = 100.
-   `offset` **[number][250]?** Index of the items to start retrieving from. Default = 0.
-   `sort` **(`"created_at_asc"` \| `"created_at_desc"` \| `"description_asc"` \| `"description_desc"` \| `"settled_index_asc"` \| `"settled_index_desc"` \| `"us_dollar_amount_asc"` \| `"us_dollar_amount_desc"`)?** 
...
-   `uid` **[string][218]** A unique identifier generated by Rize.
-   `external_uid` **[string][218]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `source_synthetic_account_uid` **[string][218]** Synthetic Account to pull asset from. Must be an active liability or external-type account. Cannot be equal to `destination_synthetic_account_uid`.
-   `destination_synthetic_account_uid` **[string][218]** Synthetic Account where the asset should land. Must be an active liability or external-type account. Cannot be equal to `source_synthetic_account_uid`.
-   `initiating_customer_uid` **[string][218]** 
-   `usd_transfer_amount` **[string][218]** The USD amount to transfer
...
-   `timeout` **[number][250]?** Specifies the number of milliseconds before the each request times out. (Default: 80000)
...
-   `programUid` **[string][218]** The Rize Program ID.
-   `hmac` **[string][218]** The HMAC that will be used to sign the JSON web signature in order to get access to the API.
-   `options` **[RizeOptions][258]?** Configuration options (optional, default `RizeOptions`)
...
Type: [ComplianceWorkflowService][259]
...
Type: [SyntheticAccountService][261]
...
Type: [CustodialAccountService][262]
...
[108]: #gettransactioneventlist

[109]: #parameters-33

[110]: #examples-32

[111]: #gettransactionevent

[112]: #parameters-34

[113]: #examples-33

[114]: #getsyntheticlineitemlist

[115]: #parameters-35

[116]: #examples-34

[117]: #getsyntheticlineitem

[118]: #parameters-36

[119]: #examples-35

[120]: #getcustodiallineitemlist

[121]: #parameters-37

[122]: #examples-36

[123]: #getcustodiallineitem
...
[140]: #complianceworkflowsummary

[141]: #properties-2

[142]: #complianceworkflowcustomer

[143]: #properties-3

[144]: #compliancedocument

[145]: #properties-4

[146]: #compliancedocumentacknowledgementrequest

[147]: #properties-5

[148]: #complianceworkflow
...
[152]: #custodialaccount

[153]: #properties-8

[154]: #custodialaccountlistquery
...
[164]: #debitcardlistquery

[165]: #properties-14

[166]: #debit-cardtypedefs

[167]: #document

[168]: #properties-15

[169]: #documentlistquery
...
[177]: #syntheticaccounttype

[178]: #properties-20

[179]: #syntheticaccounttypelistquery

[180]: #properties-21

[181]: #syntheticaccount

[182]: #properties-22

[183]: #syntheticaccountlistquery

[184]: #properties-23

[185]: #syntheticaccountcreaterequest
...
[189]: #transactionlistquery

[190]: #properties-26

[191]: #syntheticlineitem

[192]: #properties-27

[193]: #syntheticlineitemlistquery

[194]: #properties-28

[195]: #custodiallineitem

[196]: #properties-29

[197]: #custodiallineitemlistquery
...
[207]: #complianceworkflow-1

[208]: #customer-1

[209]: #syntheticaccount-1

[210]: #custodialaccount-1
...
[220]: #complianceworkflow

[221]: #compliancedocumentacknowledgementrequest

[222]: #custodialaccount

[223]: #custodialaccountlistquery
...
[228]: #debitcardlistquery

[229]: #debitcard

[230]: #address

[231]: #documentlistquery

[232]: #document

[233]: #evaluationlistquery

[234]: #evaluation

[235]: #kycdocument

[236]: #syntheticaccountlistquery

[237]: #syntheticaccount

[238]: #syntheticaccountcreaterequest

[239]: #syntheticaccounttypelistquery

[240]: #syntheticaccounttype

[241]: #transactionlistquery

[242]: #transaction

[243]: #syntheticlineitemlistquery

[244]: #syntheticlineitem

[245]: #custodiallineitemlistquery

[246]: #custodiallineitem

[247]: #transferlistquery
...
[252]: #complianceworkflowsummary

[253]: #complianceworkflowcustomer

[254]: #compliancedocument
...
[259]: #complianceworkflowservice

[260]: #customerservice

[261]: #syntheticaccountservice

[262]: #custodialaccountservice

[263]: #transactionservice

[264]: #transferservice

[265]: #documentservice

[266]: #evaluationservice
