...
-   [CustomerService][13]
    ...
    -   [unlock][27]
        -   [Parameters][28]
-   [ComplianceWorkflow][29]
    -   [Properties][30]
-   [ComplianceDocument][31]
    -   [Properties][32]
-   [ComplianceWorkflowCustomer][33]
    -   [Properties][34]
...
-   `uid` **[string][56]** Rize-generated unique id

Returns **[Promise][57]&lt;[Customer][62]>** A promise that returns a Customer if resolved.
...
-   `details` **[CustomerDetails][63]** An object containing the supplied identifying information for the Customer
...
Returns **[Promise][57]&lt;[Customer][62]>** A promise that returns the updated Customer if resolved.
...
-   `summary` **[ComplianceWorkflowSummary][65]** 
-   `customer` **[ComplianceWorkflowCustomer][66]** 
-   `accepted_documents` **[Array][67]&lt;[ComplianceDocument][68]>** 
-   `current_step_documents_pending` **[Array][67]&lt;Omit&lt;[ComplianceDocument][68], `"accepted_at"`>>** Compliance Documents that await acknowledgment in the current Step
-   `all_documents` **[Array][67]&lt;Omit&lt;[ComplianceDocument][68], (`"accepted_at"` \| `"uid"`)>>** The set of all Compliance Documents that would require acknowledgment
...
-   `name` **[string][56]** 
-   `step` **[number][69]** Multiple Compliance Documents are grouped into a Step, and Compliance Documents are presented to a Customer, Step-by-Step
-   `version` **[number][69]** 
...
-   `pool_uid` **[Array][67]&lt;[string][56]>?** Filter by pool. Multiple values are allowed.
...
-   `pool_uids` **[Array][67]&lt;[string][56]>** A list of uids referring to Pools belonging to this Customer.
-   `email` **[string][56]** Email of the customer
...
-   `created_at` **[Date][72]** 
-   `locked_at` **([Date][72] | null)?** The date and time when the Customer was locked. This field will be null if and only if the lock_reason is null.
...
-   `total_count` **[number][69]** Total count of items available to retrieve
-   `count` **[number][69]** Number of items retrieved
-   `limit` **[number][69]** Maximum number of items to retrieve
-   `offset` **[number][69]** Index of the first item to retrieve
-   `data` **[Array][67]&lt;[Customer][62]>** 
...
-   `timeout` **[number][69]?** Specifies the number of milliseconds before the each request times out. (Default: 80000)
