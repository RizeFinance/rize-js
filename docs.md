...
-   [TransactionService][119]
    ...
    -   [get][123]
        -   [Parameters][124]
        -   [Examples][125]
    -   [getTransactionEventList][126]
        -   [Parameters][127]
        -   [Examples][128]
    -   [getTransactionEvent][129]
        -   [Parameters][130]
        -   [Examples][131]
    -   [getSyntheticLineItemList][132]
        -   [Parameters][133]
        -   [Examples][134]
    -   [getSyntheticLineItem][135]
        -   [Parameters][136]
        -   [Examples][137]
    -   [getCustodialLineItemList][138]
        -   [Parameters][139]
        -   [Examples][140]
    -   [getCustodialLineItem][141]
        -   [Parameters][142]
        -   [Examples][143]
-   [TransferService][144]
    -   [getList][145]
...
-   [HTTPResponse][158]
    -   [Properties][159]
-   [ComplianceWorkflowSummary][160]
    -   [Properties][161]
-   [ComplianceWorkflowCustomer][162]
    -   [Properties][163]
-   [ComplianceDocument][164]
    -   [Properties][165]
-   [ComplianceDocumentAcknowledgementRequest][166]
    -   [Properties][167]
-   [ComplianceWorkflow][168]
    -   [Properties][169]
-   [AccountError][170]
    -   [Properties][171]
-   [CustodialAccount][172]
    -   [Properties][173]
-   [CustodialAccountListQuery][174]
    -   [Properties][175]
-   [CustomerDetails][176]
    -   [Properties][177]
-   [Customer][178]
    -   [Properties][179]
-   [CustomerListQuery][180]
    -   [Properties][181]
-   [DebitCard][182]
    -   [Properties][183]
-   [DebitCardListQuery][184]
    -   [Properties][185]
-   [debit-card.typedefs][186]
-   [Document][187]
    -   [Properties][188]
-   [DocumentListQuery][189]
    -   [Properties][190]
-   [Evaluation][191]
    -   [Properties][192]
-   [EvaluationListQuery][193]
    -   [Properties][194]
-   [KYCDocument][195]
    -   [Properties][196]
-   [SyntheticAccountType][197]
    -   [Properties][198]
-   [SyntheticAccountTypeListQuery][199]
    -   [Properties][200]
-   [SyntheticAccount][201]
    -   [Properties][202]
-   [SyntheticAccountListQuery][203]
    -   [Properties][204]
-   [SyntheticAccountCreateRequest][205]
    -   [Properties][206]
-   [Transaction][207]
    -   [Properties][208]
-   [TransactionListQuery][209]
    -   [Properties][210]
-   [TransactionEvent][211]
    -   [Properties][212]
-   [TransactionEventListQuery][213]
    -   [Properties][214]
-   [SyntheticLineItem][215]
    -   [Properties][216]
-   [SyntheticLineItemListQuery][217]
    -   [Properties][218]
-   [CustodialLineItem][219]
    -   [Properties][220]
-   [CustodialLineItemListQuery][221]
    -   [Properties][222]
-   [Transfer][223]
    -   [Properties][224]
-   [TransferListQuery][225]
    -   [Properties][226]
-   [RizeMessageQueue][227]
    -   [Parameters][228]
    -   [connect][229]
        -   [Parameters][230]
-   [RizeMessageQueueClient][231]
    -   [Parameters][232]
    -   [subscribe][233]
        -   [Parameters][234]
-   [RizeOptions][235]
...
-   [Rize][237]
    -   [Parameters][238]
    -   [complianceWorkflow][239]
    -   [customer][240]
    -   [syntheticAccount][241]
    -   [custodialAccount][242]
    -   [transaction][243]
    -   [transfer][244]
    -   [debitCard][245]
    -   [document][246]
...
-   `customerExternalUid` **[string][251]** A Customer identifier supplied by the Partner, unique among the collection of all partner Customers.
-   `email` **[string][251]** Email address associated with the Customer.
...
Returns **[Promise][252]&lt;[ComplianceWorkflow][253]>** A promise that returns the new Compliance Workflow if resolved.
...
-   `customerExternalUid` **[string][251]** A Customer identifier supplied by the Partner, unique among the collection of all partner Customers.
-   `customerUid` **[string][251]** A UID referring to the Customer generated by Rize
-   `email` **[string][251]** Email address associated with the Customer.

Returns **[Promise][252]&lt;[ComplianceWorkflow][253]>** A promise that returns the new Compliance Workflow entity if resolved.
...
-   `customerUid` **[string][251]** A UID referring to the Customer
...
Returns **[Promise][252]&lt;[ComplianceWorkflow][253]>** A promise that returns the latest Compliance Workflow if resolved.
...
-   `complianceWorkflowUid` **[string][251]** A UID referring to the Compliance Workflow.
-   `customerUid` **[string][251]** A UID referring to the Customer.
-   `documents` **...[ComplianceDocumentAcknowledgementRequest][254]** 
...
Returns **[Promise][252]&lt;[ComplianceWorkflow][253]>** A promise that returns the updated Compliance Workflow if resolved.
...
-   `uid` **[string][251]** Rize-generated unique custodial account id
...
Returns **[Promise][252]&lt;[CustodialAccount][255]>** A promise that returns a Custodial Account if resolved.
...
-   `query` **[CustodialAccountListQuery][256]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][252]&lt;[RizeList][257]&lt;CustodialAccountList>>** A promise that returns a Custodial Account List if resolved.
...
-   `query` **[CustomerListQuery][258]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][252]&lt;[RizeList][257]&lt;[Customer][259]>>** A promise that returns a Customer List if resolved.
...
-   `uid` **[string][251]** Rize-generated unique customer id
...
Returns **[Promise][252]&lt;[Customer][259]>** A promise that returns a Customer if resolved.
...
-   `uid` **[string][251]** Rize-generated unique customer id
-   `email` **[string][251]** Email of the customer
-   `details` **[CustomerDetails][260]** An object containing the supplied identifying information for the Customer
...
Returns **[Promise][252]&lt;[Customer][259]>** A promise that returns the updated Customer if resolved.
...
Returns **[Promise][252]&lt;void>** A promise that returns void if resolved.
...
-   `uid` **[string][251]** Rize-generated unique customer id
-   `lockReason` **[string][251]** The reason that the Customer is being locked must be submitted with the request body.
...
Returns **[Promise][252]&lt;[Customer][259]>** A promise that returns the locked Customer if resolved.
...
-   `uid` **[string][251]** Rize-generated unique customer id
-   `unlockReason` **[string][251]** The reason that the Customer is being unlocked. (optional, default `null`)
...
Returns **[Promise][252]&lt;[Customer][259]>** A promise that returns the unlocked Customer if resolved.
...
-   `query` **[DebitCardListQuery][261]?** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][252]&lt;[RizeList][257]&lt;[DebitCard][262]>>** A promise that returns a Debit Card List if resolved.
...
-   `uid` **[string][251]** Rize-generated unique debitCard id
...
Returns **[Promise][252]&lt;[DebitCard][262]>** A promise that returns a Debit Card if resolved.
...
-   `externalUid` **[string][251]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `customerUid` **[string][251]** A UID referring to the Customer who owns this Card
-   `poolUid` **[string][251]** A UID referring to the Pool to which this Card belongs
-   `shippingAddress` **([Address][263] | null)?** An optional field used to specify the shipping address for a physical Debit Card.Either the whole `address` must be nullable or all fields must be provided, with an except of `street2`, which is nullable.If no address is specified, the primary address associated with the customer will be used as a shipping address. (optional, default `null`)
...
-   `uid` **[string][251]** Rize-generated unique Debit Card id
-   `lockReason` **[string][251]** A lock reason is required to be submitted when locking a Debit Card
...
-   `query` **[DocumentListQuery][264]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][252]&lt;[RizeList][257]&lt;[Document][265]>>** A promise that returns a Document List if resolved.
...
-   `uid` **[string][251]** Rize-generated unique document id
...
Returns **[Promise][252]&lt;[HTTPResponse][266]&lt;[string][251]>>** A promise that returns a binary Document with headers if resolved.
...
Returns **[Promise][252]&lt;[string][251]>** A promise that returns a base64-encoded Document string if resolved.
...
Returns **[Promise][252]&lt;[Document][265]>** A promise that returns a Document if resolved.
...
-   `query` **[EvaluationListQuery][267]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][252]&lt;[RizeList][257]&lt;[Evaluation][268]>>** A promise that returns an Evaluation List if resolved.
...
-   `uid` **[string][251]** Rize-generated unique evaluation id
...
Returns **[Promise][252]&lt;[Evaluation][268]>** A promise that returns an Evaluation if resolved.
...
-   `evaluationUid` **[string][251]** An object containing key value pair for getting the results list.
...
Returns **[Promise][252]&lt;[RizeList][257]&lt;[KYCDocument][269]>>** A promise that returns a List of KYC Documents if resolved.
...
-   `evaluationUid` **[string][251]** A uid referring to the evaluation with which this document is associated
-   `filename` **[string][251]** The name of the file to be uploaded
-   `fileContent` **[string][251]** The contents of the file to be uploaded, base64-encoded.
-   `note` **[string][251]** A note describing this document
...
Returns **[Promise][252]&lt;[KYCDocument][269]>** A promise that returns a KYC Document if resolved.
...
-   `uid` **[string][251]** Rize-generated unique KYC Document id
...
Returns **[Promise][252]&lt;[KYCDocument][269]>** A promise that returns a KYC Document Metadata if resolved.
...
Returns **[Promise][252]&lt;[HTTPResponse][266]&lt;[string][251]>>** A promise that returns a binary KYC Document with headers if resolved.
...
Returns **[Promise][252]&lt;[string][251]>** A promise that returns a base64-encoded KYC Document string if resolved.
...
-   `query` **[SyntheticAccountListQuery][270]** An object containing key value paris for filtering the result. (optional, default `{}`)
...
Returns **[Promise][252]&lt;[RizeList][257]&lt;[SyntheticAccount][271]>>** A promise that returns the Synthetic Account list if resolved.
...
-   `uid` **[string][251]** Rize-generated unique synthetic account id
...
Returns **[Promise][252]&lt;[SyntheticAccount][271]>** A promise that returns a SyntheticAccount if resolved.

### create

#### Parameters

-   `payload` **[SyntheticAccountCreateRequest][272]** 
...
-   `uid` **[string][251]** Rize-generated unique Synthetic Account id
-   `name` **[string][251]** A unique name to identify the resource
-   `note` **[string][251]?** A reason for the Synthetic Account name change
...
Returns **[Promise][252]&lt;[SyntheticAccount][271]>** A promise that returns a Synthetic Account if resolved.
...
-   `query` **[SyntheticAccountTypeListQuery][273]** An object containing key value paris for filtering the result. (optional, default `{}`)
...
Returns **[Promise][252]&lt;[RizeList][257]&lt;[SyntheticAccountType][274]>>** A promise that returns a Synthetic Account Type List if resolved.
...
-   `uid` **[string][251]** Rize-generated unique Synthetic Account Type id
...
Returns **[Promise][252]&lt;[SyntheticAccountType][274]>** A promise that returns a Synthetic Account Type if resolved.
...
-   `query` **[TransactionListQuery][275]?** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][252]&lt;[RizeList][257]&lt;[Transaction][276]>>** A promise that returns a Transaction List if resolved.
...
-   `uid` **[string][251]** Rize-generated unique transaction id
...
Returns **[Promise][252]&lt;[Transaction][276]>** A promise that returns a Transaction if resolved.
...
-   `query` **[TransactionEventListQuery][277]?** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][252]&lt;[RizeList][257]&lt;[TransactionEvent][278]>>** A promise that returns a TransactionEvent List if resolved.
...
-   `uid` **[string][251]** Rize-generated unique transaction event id
...
Returns **[Promise][252]&lt;[TransactionEvent][278]>** A promise that returns a Transaction Event if resolved.
...
-   `query` **[SyntheticLineItemListQuery][279]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][252]&lt;[RizeList][257]&lt;[SyntheticLineItem][280]>>** A promise that returns a Synthetic Line Item List if resolved.
...
-   `uid` **[string][251]** Rize-generated unique Synthetic Line Item id
...
Returns **[Promise][252]&lt;[SyntheticLineItem][280]>** A promise that returns a Synthetic Line Item if resolved.

### getCustodialLineItemList

#### Parameters

-   `query` **[CustodialLineItemListQuery][281]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][252]&lt;[RizeList][257]&lt;[CustodialLineItem][282]>>** A promise that returns a Custodial Line Item List if resolved.
...
-   `uid` **[string][251]** Rize-generated unique Custodial Line Item id
...
Returns **[Promise][252]&lt;[CustodialLineItem][282]>** A promise that returns a Custodial Line Item if resolved.
...
-   `query` **[TransferListQuery][283]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][252]&lt;[RizeList][257]&lt;[Transfer][284]>>** A promise that returns a Transfer List if resolved.
...
-   `uid` **[string][251]** Rize-generated unique Transfer id
...
Returns **[Promise][252]&lt;[Transfer][284]>** A promise that returns a Transfer if resolved.
...
-   `externalUid` **[string][251]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `sourceSyntheticAccountUid` **[string][251]** Synthetic Account to pull asset from. Must be an active liability or external-type account. Cannot be equal to `destination_synthetic_account_uid`.
-   `destinationSyntheticAccountUid` **[string][251]** Synthetic Account where the asset should land. Must be an active liability or external-type account. Cannot be equal to `source_synthetic_account_uid`.
-   `initiatingCustomerUid` **[string][251]** 
-   `usTransferAmount` **[string][251]** The USD amount to transfer.
...
-   `total_count` **[number][286]** Total count of items available to retrieve
-   `count` **[number][286]** Number of items retrieved
-   `limit` **[number][286]** Maximum number of items to retrieve
-   `offset` **[number][286]** Index of the first item to retrieve
-   `data` **[Array][287]&lt;T>** 
...
-   `street1` **[string][251]** 
-   `street2` **([string][251] | null)?** 
-   `city` **[string][251]** 
-   `state` **[string][251]** 
-   `postal_code` **[string][251]** 
...
-   `accepted_quantity` **[number][286]** 
-   `begun_at` **[string][251]** The DateTime at which this Compliance Workflow was requested
-   `completed_step` **[number][286]** 
-   `current_step` **[number][286]** 
...
-   `email` **[string][251]** 
-   `external_uid` **[string][251]** A Customer identifier supplied by the Client, unique among the collection of all Client Customers
-   `uid` **[string][251]** A UID referring to the Customer
...
-   `external_storage_name` **[string][251]** Amazon S3 key used to retrieve the contents of a Compliance Document
-   `compliance_document_url` **[string][251]** Amazon S3 URL used to retrieve the contents of a Compliance Document
-   `name` **[string][251]** 
-   `step` **[number][286]** Multiple Compliance Documents are grouped into a Step, and Compliance Documents are presented to a Customer, Step-by-Step
-   `version` **[number][286]** 
-   `uid` **[string][251]** A UID referring to a Compliance Document; note that this UID will be different for each Customer
-   `accepted_at` **[string][251]** The DateTime at which this Compliance Document was acknowledged
...
-   `documentUid` **[string][251]** A UID referring to the Compliance Document being acknowledged.
-   `accept` **(`"yes"` \| `"no"`)** An indication of acceptance or rejection.
-   `userName` **[string][251]?** A label associated with the Customer (required for electronic signing).
-   `ipAddress` **[string][251]?** A numerical label assigned to each device connected to a computer network that uses the Internet Protocol for communication (required for electronic signing); in this case, the label associated with the computer used by the Customer.
...
-   `uid` **[string][251]** A unique identifier generated by Rize.
-   `summary` **[ComplianceWorkflowSummary][288]** 
-   `customer` **[ComplianceWorkflowCustomer][289]** 
-   `accepted_documents` **[Array][287]&lt;[ComplianceDocument][290]>** 
-   `current_step_documents_pending` **[Array][287]&lt;Omit&lt;[ComplianceDocument][290], `"accepted_at"`>>** Compliance Documents that await acknowledgment in the current Step
-   `all_documents` **[Array][287]&lt;Omit&lt;[ComplianceDocument][290], (`"accepted_at"` \| `"uid"`)>>** The set of all Compliance Documents that would require acknowledgment
...
-   `error_code` **[string][251]** 
-   `error_name` **[string][251]** 
-   `error_description` **[string][251]** 
...
-   `uid` **[string][251]** A unique identifier generated by Rize
-   `external_uid` **[string][251]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `customer_uid` **[string][251]** A UID referring to the customer this Custodial Account belongs to
-   `pool_uid` **[Array][287]&lt;[string][251]>** A UID referring to the pool this Custodial Account belongs to
-   `program_service_offering_uid` **([string][251] | null)** A UID referring to the specific Program Service Offering for which this account was created. Nullable if asset.
...
-   `liability` **[boolean][291]** Liability or asset. Liability Custodial Accounts represent real accounts at Financial Institutions. Asset accounts are used for accounting purposes and may be generated by Rize during events such as new custodial account creations or new external account connections.
-   `name` **([string][251] | null)** A friendly name used to identify the account at the Custodial Partner.
-   `primary_account` **[boolean][291]** The date and time when the Customer was locked. This field will be null if and only if the lock_reason is null.
...
-   `account_errors` **[Array][287]&lt;[AccountError][292]>** A list of errors related to this account. These are passed through during interactions with the underlying Custodial Partner and can help with resolving customer issues. Only provided for accounts that are in an error or manual_review status.
-   `net_usd_balance` **[string][251]** The current settled balance of this Custodial Account in US Dollars
-   `net_usd_pending_balance` **[string][251]** The sum of all pending transactions for this Custodial Account in US Dollars
-   `net_usd_available_balance` **[string][251]** The balance available to spend calculated as Normal balance less any withdrawals. Pending deposits are not included
-   `account_number` **([string][251] | null)** The ACH account number that can be used to make transfers into/out of this account. Nullable if asset.
-   `account_number_masked` **([string][251] | null)** Last 4 digits of the ACH account number. Nullable if asset.
-   `routing_number` **([string][251] | null)** The ABA routing number associated with the Custodial Partner. Nullable if asset.
-   `opened_at` **[Date][293]** The DateTime at which this account was created
-   `closed_at` **[Date][293]** The DateTime at which this account was closed
...
-   `customer_uid` **[Array][287]&lt;[string][251]>?** Filter by Customer. Multiple values are allowed
-   `external_uid` **[string][251]?** A unique, immutable id provided Clien
-   `limit` **[string][251]?**  Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[string][251]?** Index of the items to start retrieving from. Default: 0
-   `liability` **[string][251]?** Filter by liability or asset
-   `type` **[Array][287]&lt;[string][251]>?** Filter by type. Multiple values are allowed.
...
-   `first_name` **[string][251]** 
-   `middle_name` **([string][251] | null)?** 
-   `last_name` **[string][251]** 
-   `suffix` **([string][251] | null)?** 
-   `phone` **[string][251]** 
-   `ssn` **[string][251]** 
-   `dob` **[string][251]** 
-   `address` **[Address][263]** 
...
-   `uid` **[string][251]** A unique identifier generated by Rize
-   `external_uid` **[string][251]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `program_uid` **[string][251]** A uid referring to the program this customer belongs to.
-   `pool_uids` **[Array][287]&lt;[string][251]>** A list of uids referring to Pools belonging to this Customer.
-   `email` **[string][251]** Email of the customer
...
-   `total_balance` **[string][251]** Total asset owned by the customer in US dollars.
-   `created_at` **[Date][293]** 
-   `locked_at` **([Date][293] | null)?** The date and time when the Customer was locked. This field will be null if and only if the lock_reason is null.
-   `lock_reason` **([string][251] | null)?** The lock reason provided by the Client, an admin User, or the system at the time the Customer was locked. This field will be null if and only if the locked_at is null.
-   `details` **[CustomerDetails][260]** An object containing the supplied identifying information for the Customer.
...
-   `include_initiated` **[boolean][291]?** By default, Customers in initiated status are not shown, even if the `status=initiated` parameter is provided. In order for Customers with status initiated to appear in search results, parameters must include `include_initiated=true`.
...
-   `first_name` **[string][251]?** Only return Customers with a first name matching exactly what is submitted
-   `last_name` **[string][251]?** Only return Customers with a last name matching exactly what is submitted
-   `email` **[string][251]?** Only return Customers with an email address matching exactly what is submitted
-   `locked` **[boolean][291]?** Only return locked Customers if true and only return unlocked Customers if false
-   `program_uid` **[string][251]?** Only return Customers belonging to the submitted Program.
-   `external_uid` **[string][251]?** A unique, immutable id provided by Client.
-   `pool_uid` **[Array][287]&lt;[string][251]>?** Filter by pool. Multiple values are allowed.
-   `limit` **[string][251]?**  Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[string][251]?** Index of the items to start retrieving from. Default: 0
...
-   `uid` **[string][251]** A unique identifier generated by Rize
-   `external_uid` **[string][251]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `customer_uid` **[string][251]** A UID referring to the Customer who owns this Card.
-   `pool_uid` **[string][251]** A UID referring to the Pool to which this Card belongs.
-   `synthetic_account_uid` **[string][251]** A UID referring to the specific Synthetic Account to which this Card belongs. Any debit or credit transactions from this Card will occur in this account.
-   `custodial_account_uid` **[string][251]** A UID referring to the specific Custodial Account to which this Card belongs. Any debit or credit transactions from this Card will occur in this account.
-   `card_last_four_digits` **([string][251] | null)?** Last 4 digits of the Debit Card number to aid in indentifying the Card. Null if the Card is not yet issued (i.e. status is `initiated`).
...
-   `ready_to_use` **[boolean][291]** If the Card can be used, this value will be `true`; `false` otherwise.
-   `lock_reason` **([string][251] | null)?** If the Card is in a locked state, this field will be populated describing why the Card was locked. Null if the Card is not locked.
-   `issued_on` **([string][251] | null)?** The date this Card was issued. It may be briefly null when a new Card is requested, but the issuance has not yet happened (i.e. status is `initiated`).
-   `locked_at` **([string][251] | null)?** The date and time at which this Card was locked. Null if the Card is not locked.
-   `closed_at` **([string][251] | null)?** The date and time at which this Card was closed. This field will be null unless the `status` is `closed`, `closed_by_administrator`, `lost`, or `stolen`.
-   `latest_shipping_address` **([Address][263] | null)?** An optional field used to specify the shipping address for a physical Debit Card.If no address was specified via `debitCard.create`, this field will be null. In case of reissuance, only the address from the latest shipment will be provided, if any.
...
-   `customer_uid` **[Array][287]&lt;[string][251]>?** Filter by Customer. Multiple values are allowed.
-   `external_uid` **[string][251]?** A unique, immutable id provided Client
-   `limit` **[string][251]?**  Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[string][251]?** Index of the items to start retrieving from. Default: 0
-   `pool_uid` **[Array][287]&lt;[string][251]>?** Filter by pool. Multiple values are allowed.
-   `locked` **[boolean][291]?** Only return locked Cards if `true` and only return unlocked Cards if `false`
...
-   `uid` **[string][251]** A unique identifier generated by Rize
-   `document_type` **[string][251]** The document type. Only monthly statements are currently available.
...
-   `period_started_at` **[string][251]** The date and time when the document period started at, inclusive
-   `period_ended_at` **[string][251]** The date and time when the document period ended at, exclusive
-   `created_at` **[string][251]** The date and time when the document became available
-   `customer_uids` **[Array][287]&lt;[string][251]>** A list of UIDs of Customers that are associated with the document.(not implemented) Note that once we allow joint pool and accounts, this list will be pessimistic; each
...
-   `custodial_account_uids` **[Array][287]&lt;[string][251]>** A list of UIDs of Custodial Accounts that are associated with the document.If `scope_type` is `custodial_account`, this list will contain only one UID. In fact, currently as implemented,
    this list should always have exactly one UID.
-   `synthetic_account_uids` **[Array][287]&lt;[string][251]>** A list of UIDs of Synthetic Accounts that are associated with the document.If `scope_type` is `synthetic_account`, this list will contain only one UID.
...
-   `month` **[number][286]?** Filter by month. This includes any document for which the period started in the specified month.
-   `year` **[number][286]?** Filter by year
-   `scope_type` **(`"customer"` \| `"synthetic_account"` \| `"custodial_account"`)?** (not implemented) Filter by scope type
-   `custodial_account_uid` **[string][251]?** Filter by Custodial Account
-   `customer_uid` **[Array][287]&lt;[string][251]>?** Filter by Customer. Multiple values are allowed.
-   `synthetic_account_uid` **[Array][287]&lt;[string][251]>?** Filter by Synthetic Account. Multiple values are allowed.
-   `limit` **[number][286]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default = 100.
-   `offset` **[number][286]?** Index of the items to start retrieving from. Default = 0.
...
-   `customer_uid` **[Array][287]&lt;[string][251]>?** Filter by Customer. Multiple values are allowed
-   `latest` **[boolean][291]?** Return only the latest evaluation
...
-   `filename` **[string][251]** The name of this file, exclusive of any extension.
-   `note` **[string][251]** A note describing the document.
-   `extension` **[string][251]** The filename extension.
-   `created_at` **[string][251]** 
...
-   `description` **[string][251]** A description outlining the intended use and requirements for this program's instance of the synthetic_account_type
-   `program_uid` **[string][251]?** A uid referring to the Program this synthetic_account_type belongs to
...
-   `program_uid` **[string][251]?** Only list Synthetic Account Types that are available to be used by the given Program
-   `limit` **[number][286]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[number][286]?** Index of the items to start retrieving from. Default: 0
...
-   `external_uid` **[string][251]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `name` **[string][251]** A unique name to identify the resource.
-   `pool_uid` **[string][251]** A UID referring to the pool this Synthetic Account belongs to.
-   `synthetic_account_type_uid` **[string][251]** A UID referring to the Synthetic Account Type this Synthetic Account should be created as.
...
-   `liability` **[boolean][291]** Liability or asset. Any Synthetic Account created via POST /synthetic_accounts is a liability account, except for external accounts. Some asset Synthetic Accounts are automatically created by Rize during Customer onboarding for accounting purposes.
-   `net_usd_balance` **[string][251]** The current settled balance of this account in US Dollars. This field will be null for synthetic_account_types in the external category.
-   `net_usd_pending_balance` **[string][251]** The sum of all pending transactions for this account in US Dollars. This field will be null for Synthetic Account Types in the external category.
-   `net_usd_available_balance` **[string][251]** The balance available to spend calculated as the settled balance less any pending withdrawals Pending deposits are not included. This field will be null for Synthetic Account Types in the external category.
-   `master_account` **[boolean][291]** Used to identify the Master Synthetic Accounts that exist for every Program Customer. Master Synthetic Accounts are the default accounts where any unknown custodial transactions will settle and cannot be archived while a Program Customer is still active.
-   `account_number` **([string][251] | null)** The ACH account number (if any) associated with this account. Some Synthetic Account Types require this field to be submitted along with the POST request. For example, any Synthetic Account Type from the `external` category will require an `account_number`. Submitting an `account_number` with a Synthetic Account Type that does not require one will result in the account number being ignored.
-   `account_number_last_four` **([string][251] | null)** Last 4 digits of the ACH account number.
-   `routing_number` **([string][251] | null)** The ABA routing number (if any) associated with this account. Some Synthetic Account Types require this field to be submitted along with the POST request. For example, any Synthetic Account Type from the `external` category will require a `routing_number`. Submitting a `routing_number` with a Synthetic Account Type that does not require one will result in the routing number being ignored.
-   `opened_at` **[string][251]** The DateTime at which this account was created
-   `closed_at` **([string][251] | null)** The DateTime at which this account was closed. This value will be present if the status is `archived` or `failed`.
-   `closed_to_synthetic_account_uid` **([string][251] | null)** A UID referring to the Synthetic Account where the funds in this account were transferred when closed. Any transactions issued against this account after it is closed will instead go to the `closed_to` account
...
-   `customer_uid` **[Array][287]&lt;[string][251]>?** Filter by Customer. Multiple string values are allowed.
-   `external_uid` **[string][251]?** A unique, immutable id provided Client
-   `pool_uid` **[Array][287]&lt;[string][251]>?** Filter by pool. Multiple string values are allowed.
-   `limit` **[number][286]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[number][286]?** Index of the items to start retrieving from. Default: 0
-   `synthetic_account_type_uid` **[string][251]?** Filter by Synthetic Account Type
-   `synthetic_account_category` **(`"general"` \| `"external"` \| `"plaid_external"`)?** Filter by Synthetic Account Category
-   `liability` **[boolean][291]?** Filter by liability or asset
...
-   `externalUid` **[string][251]** (Required) A unique identifier Client supplies
-   `name` **[string][251]** (Required) A unique name to identify the resource
-   `poolUid` **[string][251]** (Required) A UID referring to the pool this Synthetic Account belongs to
-   `syntheticAccountTypeUid` **[string][251]** (Required) A UID referring to the Synthetic Account Type this Synthetic Account should be created as
-   `accountNumber` **([string][251] | null)?** The ACH account number (if any) associated with this account. Some Synthetic Account Types require this field to be submitted along with the POST request. For example, any Synthetic Account Type from the `external` category will require an `account_number`. Submitting an `account_number` with a Synthetic Account Type that does not require one will result in the account number being ignored.
-   `routingNumber` **([string][251] | null)?** The ABA routing number (if any) associated with this account. Some Synthetic Account Types require this field to be submitted along with the POST request. For example, any Synthetic Account Type from the `external` category will require a `routing_number`. Submitting a `routing_number` with a Synthetic Account Type that does not require one will result in the routing number being ignored.
-   `plaidProcessorToken` **([string][251] | null)?** The Rize processor token from Plaid. If a Synthetic Account Type from the category `plaid_external` is provided, `plaid_processor_token` must also be provided. Submitting a `plaid_processor_token` with any other Synthetic Account Type will result in the token being ignored.
...
-   `uid` **[string][251]** A unique identifier generated by Rize
-   `id` **[number][286]** A unique numeric identifier that indicates the order in which the Transactions were created
-   `settled_index` **([number][286] | null)?** A unique index that indicates the order in which the Transactions were settled. Null if status is `queued` or `pending`.
-   `transfer_uid` **([number][286] | null)?** The UID of the Transfer this Transaction is associated with, if any.
-   `source_synthetic_account_uid` **[string][251]** Synthetic Account from where the asset is pulled
-   `destination_synthetic_account_uid` **[string][251]** Synthetic Account where the asset is landed
-   `transaction_event_uids` **[Array][287]&lt;[string][251]>** A list of UIDS referring to Transaction Events belonging to this Transaction, if any. 
...
-   `custodial_account_uids` **[Array][287]&lt;[string][251]>** A list of UIDS referring to Custodial Accounts that are so far invovled in this Transaction. 
...
-   `us_dollar_amount` **[string][251]** The amount will never be negative
...
-   `description` **[string][251]** 
-   `created_at` **[string][251]** The date and time when the Transaction is first recognized by Rize. This may be when the Transfer is initiated if the Transaction is associated with one.
-   `settled_at` **[string][251]** The date and time when the Transaction is settled.
...
-   `customer_uid` **[Array][287]&lt;[string][251]>?** Filter by Customer.
-   `source_synthetic_account_uid` **[Array][287]&lt;[string][251]>?** Filter by source Synthetic Account.
-   `destination_synthetic_account_uid` **[Array][287]&lt;[string][251]>?** Filter by destination Synthetic Account.
-   `synthetic_account_uid` **[Array][287]&lt;[string][251]>?** Filter by Synthetic Account, source or destination.
-   `type` **[Array][287]&lt;(`"atm_withdrawal"` \| `"card_purchase"` \| `"card_refund"` \| `"dispute"` \| `"external_transfer"` \| `"fee"` \| `"internal_transfer"` \| `"other"` \| `"reversed_transfer"` \| `"third_party_transfer"`)>?** Filter by type.
-   `status` **[Array][287]&lt;(`"queued"` \| `"pending"` \| `"settled"` \| `"failed"`)>?** Filter by status.
-   `search_description` **[string][251]?** Attempts to search for the provided string in the description field. '\*' can be used as a wildcard. Any record with a match will be returned.
-   `limit` **[number][286]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default = 100.
-   `offset` **[number][286]?** Index of the items to start retrieving from. Default = 0.
...
-   `uid` **[string][251]** A unique identifier generated by Rize
-   `settled_index` **[number][286]** A unique index that indicates the order in which Transaction Events were settled
-   `transaction_uid` **[string][251]** UID of the Transaction this line item belongs to
-   `phase` **[number][286]** Some Transfer types will trigger multiple transfers at the custodial level. Some of these custodial transfers must wait for all dependent custodial transfers to complete before initiating. Transaction Events with `phase` value 1 are recorded for the first set of custodial transfers that get initiated after the (Synthetic) Transfer starts. Custodial transfers in later phases cannot initiate before all events from previous phases are settled.
-   `source_custodial_account_uid` **[string][251]** Custodial Account from which the asset is pulled
-   `destination_custodial_account_uid` **[string][251]** Custodial Account where the asset lands
-   `custodial_line_item_uids` **[Array][287]&lt;[string][251]>** A list of UIDS referring to Custodial Line Items belonging to this event. There are always at least two line items if the status is `settled`.
-   `status` **[string][251]** 
-   `us_dollar_amount` **[string][251]** The amount will never be negative
...
-   `description` **[string][251]** 
-   `created_at` **[string][251]** The date and time when the event is first recognized by Rize. This may be when the Transfer is initiated if the event is associated with one.
-   `settled_at` **[string][251]** The date and time when the event is settled.
...
-   `source_custodial_account_uid` **[Array][287]&lt;[string][251]>?** Filter by source Custodial Account.
-   `destination_custodial_account_uid` **[Array][287]&lt;[string][251]>?** Filter by destination Custodial Account.
-   `custodial_account_uid` **[Array][287]&lt;[string][251]>?** Filter by Custodial Account, source or destination.
-   `type` **[Array][287]&lt;(`"odfi_ach_deposit"` \| `"odfi_ach_withdrawal"` \| `"rdfi_ach_deposit"` \| `"rdfi_ach_withdrawal"`)>?** Filter by type. Multiple values are allowed.
-   `transaction_uid` **[Array][287]&lt;[string][251]>?** Filter by Transaction. Multiple values are allowed
-   `limit` **[number][286]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default = 100.
-   `offset` **[number][286]?** Index of the items to start retrieving from. Default = 0.
...
-   `uid` **[string][251]** A unique identifier generated by Rize
-   `settled_index` **[number][286]** A unique index that indicates the order in which the Synthetic Line Items were settled
-   `transaction_uid` **[string][251]** UID of the Transaction this Synthetic Line Item belongs to
-   `synthetic_account_uid` **[string][251]** UID of the Synthetic Account this Synthetic Line Item is associated with
-   `status` **[string][251]** 
-   `us_dollar_amount` **[string][251]** The signed USD amount of this specific Synthetic Line Item
-   `running_us_dollar_balance` **[string][251]** The Synthetic Account balance after this Synthetic Line Item was settled
-   `description` **[string][251]** Human-readable description in context of Synthetic Accounts
-   `created_at` **[string][251]** The date and time when the Synthetic Line Item is first recognized by Rize. This may be when the Transfer is initiated if the Synthetic Line Item is associated with one.
-   `settled_at` **[string][251]** The date and time when the Synthetic Line Item is settled
...
-   `customer_uid` **[Array][287]&lt;[string][251]>?** Filter by Customer.
-   `pool_uid` **[Array][287]&lt;[string][251]>?** Filter by pool.
-   `synthetic_account_uid` **[Array][287]&lt;[string][251]>?** Filter by Synthetic Account.
-   `limit` **[number][286]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default = 100.
-   `offset` **[number][286]?** Index of the items to start retrieving from. Default = 0.
-   `transaction_uid` **[Array][287]&lt;[string][251]>?** Filter by Transaction.
-   `status` **[Array][287]&lt;(`"begun"` \| `"failed"` \| `"in_progress"` \| `"settled"`)>?** Filter by status.
...
-   `uid` **[string][251]** A unique identifier generated by Rize.
-   `settled_index` **[number][286]** A unique index that indicates the order in which the Custodial Line Items were settled.
-   `transaction_uid` **[string][251]** UID of the Transaction this Custodial Line Item belongs to.
-   `transaction_event_uid` **[string][251]** UID of the Transaction Event this Custodial Line Item belongs to.
-   `custodial_account_uid` **[string][251]** UID of the Custodial Account this Custodial Line Item is associated with.
-   `status` **[string][251]** 
-   `us_dollar_amount` **[string][251]** The signed USD amount of this specific Custodial Line Item
-   `running_us_dollar_balance` **([string][251] | null)?** US dollar balance of the Custodial Account as of the completion of this Custodial Line Item. This field may be empty unless the status is `settled` or `voided`.
-   `type` **[string][251]** Symbols and/or numbers that represent different types of Custodial Line Items.
-   `description` **[string][251]** Descriptions pulled from the custodians, such as through NACHA description or ISO-8583 data element 43.
-   `created_at` **[string][251]** The date and time when the Custodial Line Items is first recognized by Rize. This may be when the Transfer is initiated if the Custodial Line Item is associated with one.
-   `occurred_at` **[string][251]** This field may be empty if status is not settled or voided.
-   `settled_at` **[string][251]** The date and time when the Custodial Line Item is settled.
...
-   `customer_uid` **[Array][287]&lt;[string][251]>?** Filter by Customer.
-   `custodial_account_uid` **[Array][287]&lt;[string][251]>?** Filter by Custodial Account.
-   `status` **[Array][287]&lt;(`"settled"` \| `"voided"`)>?** Filter by status.
-   `us_dollar_amount_tax` **[number][286]?** Return any records having a us_dollar_amount at or below us_dollar_amount_max.
-   `us_dollar_amount_min` **[number][286]?** Return any records having a us_dollar_amount at or above us_dollar_amount_min.
-   `transaction_event_uid` **[Array][287]&lt;[string][251]>?** Filter by Transaction Event.
-   `transaction_uid` **[Array][287]&lt;[string][251]>?** Filter by Transaction.
-   `limit` **[number][286]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default = 100.
-   `offset` **[number][286]?** Index of the items to start retrieving from. Default = 0.
-   `sort` **(`"created_at_asc"` \| `"created_at_desc"` \| `"description_asc"` \| `"description_desc"` \| `"settled_index_asc"` \| `"settled_index_desc"` \| `"us_dollar_amount_asc"` \| `"us_dollar_amount_desc"`)?** 
...
-   `uid` **[string][251]** A unique identifier generated by Rize.
-   `external_uid` **[string][251]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `source_synthetic_account_uid` **[string][251]** Synthetic Account to pull asset from. Must be an active liability or external-type account. Cannot be equal to `destination_synthetic_account_uid`.
-   `destination_synthetic_account_uid` **[string][251]** Synthetic Account where the asset should land. Must be an active liability or external-type account. Cannot be equal to `source_synthetic_account_uid`.
-   `initiating_customer_uid` **[string][251]** 
-   `usd_transfer_amount` **[string][251]** The USD amount to transfer
...
-   `clientId` **[string][251]** Assign a client ID
-   `username` **[string][251]** Your Rize Message Queue username
-   `password` **[string][251]** Your Rize Message Queue password
-   `options`  

Returns **[Promise][252]&lt;[RizeMessageQueueClient][294]>** A promise that returns a RizeMessageQueueClient when resolved
...
-   `subscriptionName` **[string][251]** Assign a name for the subscription
-   `messageListener`  
...
-   `timeout` **[number][286]?** Specifies the number of milliseconds before the each request times out. (Default: 80000)
...
-   `programUid` **[string][251]** The Rize Program ID.
-   `hmac` **[string][251]** The HMAC that will be used to sign the JSON web signature in order to get access to the API.
-   `options` **[RizeOptions][295]?** Configuration options (optional, default `RizeOptions`)
...
Type: [ComplianceWorkflowService][296]
...
Type: [SyntheticAccountService][298]
...
Type: [CustodialAccountService][299]
...
[126]: #gettransactioneventlist

[127]: #parameters-39

[128]: #examples-38

[129]: #gettransactionevent

[130]: #parameters-40

[131]: #examples-39

[132]: #getsyntheticlineitemlist

[133]: #parameters-41

[134]: #examples-40

[135]: #getsyntheticlineitem

[136]: #parameters-42

[137]: #examples-41

[138]: #getcustodiallineitemlist

[139]: #parameters-43

[140]: #examples-42

[141]: #getcustodiallineitem
...
[160]: #complianceworkflowsummary

[161]: #properties-3

[162]: #complianceworkflowcustomer

[163]: #properties-4

[164]: #compliancedocument

[165]: #properties-5

[166]: #compliancedocumentacknowledgementrequest

[167]: #properties-6

[168]: #complianceworkflow
...
[172]: #custodialaccount

[173]: #properties-9

[174]: #custodialaccountlistquery
...
[184]: #debitcardlistquery

[185]: #properties-15

[186]: #debit-cardtypedefs

[187]: #document

[188]: #properties-16

[189]: #documentlistquery
...
[197]: #syntheticaccounttype

[198]: #properties-21

[199]: #syntheticaccounttypelistquery

[200]: #properties-22

[201]: #syntheticaccount

[202]: #properties-23

[203]: #syntheticaccountlistquery

[204]: #properties-24

[205]: #syntheticaccountcreaterequest
...
[209]: #transactionlistquery

[210]: #properties-27

[211]: #transactionevent

[212]: #properties-28

[213]: #transactioneventlistquery

[214]: #properties-29

[215]: #syntheticlineitem

[216]: #properties-30

[217]: #syntheticlineitemlistquery

[218]: #properties-31

[219]: #custodiallineitem

[220]: #properties-32

[221]: #custodiallineitemlistquery
...
[225]: #transferlistquery

[226]: #properties-35

[227]: #rizemessagequeue
...
[239]: #complianceworkflow-1

[240]: #customer-1

[241]: #syntheticaccount-1

[242]: #custodialaccount-1
...
[251]: https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/String

[252]: https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Promise

[253]: #complianceworkflow

[254]: #compliancedocumentacknowledgementrequest

[255]: #custodialaccount

[256]: #custodialaccountlistquery

[257]: #rizelist

[258]: #customerlistquery

[259]: #customer

[260]: #customerdetails

[261]: #debitcardlistquery

[262]: #debitcard

[263]: #address

[264]: #documentlistquery

[265]: #document

[266]: #httpresponse

[267]: #evaluationlistquery

[268]: #evaluation

[269]: #kycdocument

[270]: #syntheticaccountlistquery

[271]: #syntheticaccount

[272]: #syntheticaccountcreaterequest

[273]: #syntheticaccounttypelistquery

[274]: #syntheticaccounttype

[275]: #transactionlistquery

[276]: #transaction

[277]: #transactioneventlistquery

[278]: #transactionevent

[279]: #syntheticlineitemlistquery

[280]: #syntheticlineitem

[281]: #custodiallineitemlistquery

[282]: #custodiallineitem
...
[286]: https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Number

[287]: https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Array

[288]: #complianceworkflowsummary

[289]: #complianceworkflowcustomer

[290]: #compliancedocument

[291]: https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Boolean

[292]: #accounterror

[293]: https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Date

[294]: #rizemessagequeueclient

[295]: #rizeoptions

[296]: #complianceworkflowservice

[297]: #customerservice

[298]: #syntheticaccountservice

[299]: #custodialaccountservice

[300]: #transactionservice

[301]: #transferservice

[302]: #documentservice

[303]: #evaluationservice
