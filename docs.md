...
Returns **[Promise][222]&lt;[RizeList][227]&lt;[Evaluation][237]>>** A promise that returns an Evaluation List if resolved.
...
Returns **[Promise][222]&lt;[Evaluation][237]>** A promise that returns an Evaluation if resolved.
