...
-   [RizeList][78]
    -   [Properties][79]
-   [ComplianceWorkflowSummary][80]
    -   [Properties][81]
-   [ComplianceWorkflowCustomer][82]
    -   [Properties][83]
-   [ComplianceDocument][84]
    -   [Properties][85]
-   [ComplianceDocumentAcknowledgementRequest][86]
    -   [Properties][87]
...
-   [Customer][100]
    -   [Properties][101]
-   [CustomerListQuery][102]
    -   [Properties][103]
-   [SyntheticAccountType][104]
    -   [Properties][105]
-   [SyntheticAccountTypeListQuery][106]
    -   [Properties][107]
-   [SyntheticAccount][108]
    -   [Properties][109]
-   [SyntheticAccountListQuery][110]
    -   [Properties][111]
-   [SyntheticAccountCreateRequest][112]
    -   [Properties][113]
-   [Transaction][114]
    -   [Properties][115]
-   [TransactionListQuery][116]
    -   [Properties][117]
-   [SyntheticLineItem][118]
    -   [Properties][119]
-   [SyntheticLineItemListQuery][120]
    -   [Properties][121]
-   [Transfer][122]
    -   [Properties][123]
-   [TransferListQuery][124]
    -   [Properties][125]
-   [RizeOptions][126]
    -   [Properties][127]
-   [Rize][128]
    -   [Parameters][129]
    -   [complianceWorkflow][130]
    -   [customer][131]
    -   [syntheticAccount][132]
    -   [custodialAccount][133]
    -   [transaction][134]
    -   [transfer][135]
    -   [PACKAGE_VERSION][136]
...
-   `uid` **[string][137]** A unique identifier generated by Rize.
-   `external_uid` **[string][137]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `source_synthetic_account_uid` **[string][137]** Synthetic Account to pull asset from. Must be an active liability or external-type account. Cannot be equal to `destination_synthetic_account_uid`.
-   `destination_synthetic_account_uid` **[string][137]** Synthetic Account where the asset should land. Must be an active liability or external-type account. Cannot be equal to `source_synthetic_account_uid`.
-   `initiating_customer_uid` **[string][137]** 
-   `usd_transfer_amount` **[string][137]** The USD amount to transfer
...
-   `external_uid` **[string][137]?** A unique, immutable id provided Client.
-   `pool_uid` **[Array][158]&lt;[string][137]>?** Filter by pool. Multiple values are allowed.
-   `synthetic_account_uid` **[Array][158]&lt;[string][137]>?** Filter by Synthetic Account. Multiple values are allowed.
-   `limit` **[number][157]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default = 100.
-   `offset` **[number][157]?** Index of the items to start retrieving from. Default = 0.
...
[80]: #complianceworkflowsummary

[81]: #properties-1

[82]: #complianceworkflowcustomer

[83]: #properties-2

[84]: #compliancedocument

[85]: #properties-3

[86]: #compliancedocumentacknowledgementrequest

[87]: #properties-4

[88]: #complianceworkflow
...
[102]: #customerlistquery

[103]: #properties-12

[104]: #syntheticaccounttype

[105]: #properties-13

[106]: #syntheticaccounttypelistquery
...
[110]: #syntheticaccountlistquery

[111]: #properties-16

[112]: #syntheticaccountcreaterequest
...
[116]: #transactionlistquery

[117]: #properties-19

[118]: #syntheticlineitem

[119]: #properties-20

[120]: #syntheticlineitemlistquery
...
[130]: #complianceworkflow-1

[131]: #customer-1

[132]: #syntheticaccount-1

[133]: #custodialaccount-1
