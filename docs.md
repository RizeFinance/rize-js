...
-   `flags` **[object][249]** A mapping of categories to outcomes for those categories. Items are defined as: key - 
...
-   `pii_match` **[object][249]** A mapping of KYC categories to results returned from various services queried by our KYC partner.
