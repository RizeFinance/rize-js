...
-   [RizeList][73]
    -   [Properties][74]
-   [ComplianceWorkflowSummary][75]
    -   [Properties][76]
-   [ComplianceWorkflowCustomer][77]
    -   [Properties][78]
-   [ComplianceDocument][79]
    -   [Properties][80]
-   [ComplianceDocumentAcknowledgementRequest][81]
    -   [Properties][82]
-   [ComplianceWorkflow][83]
    -   [Properties][84]
-   [AccountError][85]
    -   [Properties][86]
-   [CustodialAccount][87]
    -   [Properties][88]
-   [CustodialAccountListQuery][89]
    -   [Properties][90]
-   [Address][91]
    -   [Properties][92]
-   [CustomerDetails][93]
...
-   [Customer][95]
    -   [Properties][96]
-   [CustomerListQuery][97]
    -   [Properties][98]
-   [SyntheticAccountType][99]
    -   [Properties][100]
-   [SyntheticAccountTypeListQuery][101]
    -   [Properties][102]
-   [SyntheticAccount][103]
    -   [Properties][104]
-   [SyntheticAccountListQuery][105]
    -   [Properties][106]
-   [SyntheticAccountCreateRequest][107]
    -   [Properties][108]
-   [Transaction][109]
    -   [Properties][110]
-   [TransactionListQuery][111]
    -   [Properties][112]
-   [SyntheticLineItem][113]
    -   [Properties][114]
-   [SyntheticLineItemListQuery][115]
    -   [Properties][116]
-   [RizeOptions][117]
    -   [Properties][118]
-   [Rize][119]
...
-   `customerExternalUid` **[string][127]** A Customer identifier supplied by the Partner, unique among the collection of all partner Customers.
-   `email` **[string][127]** Email address associated with the Customer.
...
Returns **[Promise][128]&lt;[ComplianceWorkflow][129]>** A promise that returns the new Compliance Workflow if resolved.
...
-   `customerExternalUid` **[string][127]** A Customer identifier supplied by the Partner, unique among the collection of all partner Customers.
-   `customerUid` **[string][127]** A UID referring to the Customer generated by Rize
-   `email` **[string][127]** Email address associated with the Customer.

Returns **[Promise][128]&lt;[ComplianceWorkflow][129]>** A promise that returns the new Compliance Workflow entity if resolved.
...
-   `customerUid` **[string][127]** A UID referring to the Customer
...
Returns **[Promise][128]&lt;[ComplianceWorkflow][129]>** A promise that returns the latest Compliance Workflow if resolved.
...
-   `complianceWorkflowUid` **[string][127]** A UID referring to the Compliance Workflow.
-   `customerUid` **[string][127]** A UID referring to the Customer.
-   `documents` **...[ComplianceDocumentAcknowledgementRequest][130]** 
...
Returns **[Promise][128]&lt;[ComplianceWorkflow][129]>** A promise that returns the updated Compliance Workflow if resolved.
...
-   `uid` **[string][127]** Rize-generated unique custodial account id
...
Returns **[Promise][128]&lt;[CustodialAccount][131]>** A promise that returns a Custodial Account if resolved.
...
-   `query` **[CustodialAccountListQuery][132]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][128]&lt;[RizeList][133]&lt;CustodialAccountList>>** A promise that returns a Custodial Account List if resolved.
...
-   `query` **[CustomerListQuery][134]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][128]&lt;[RizeList][133]&lt;[Customer][135]>>** A promise that returns a Customer List if resolved.
...
-   `uid` **[string][127]** Rize-generated unique customer id
...
Returns **[Promise][128]&lt;[Customer][135]>** A promise that returns a Customer if resolved.
...
-   `uid` **[string][127]** Rize-generated unique customer id
-   `email` **[string][127]** Email of the customer
-   `details` **[CustomerDetails][136]** An object containing the supplied identifying information for the Customer
...
Returns **[Promise][128]&lt;[Customer][135]>** A promise that returns the updated Customer if resolved.
...
Returns **[Promise][128]&lt;void>** A promise that returns void if resolved.
...
-   `uid` **[string][127]** Rize-generated unique customer id
-   `lockReason` **[string][127]** The reason that the Customer is being locked must be submitted with the request body.
...
Returns **[Promise][128]&lt;[Customer][135]>** A promise that returns the locked Customer if resolved.
...
-   `uid` **[string][127]** Rize-generated unique customer id
-   `unlockReason` **[string][127]** The reason that the Customer is being unlocked. (optional, default `null`)
...
Returns **[Promise][128]&lt;[Customer][135]>** A promise that returns the unlocked Customer if resolved.
...
-   `query` **[SyntheticAccountListQuery][137]**  (optional, default `{}`)
...
Returns **[Promise][128]&lt;[RizeList][133]&lt;[SyntheticAccount][138]>>** A promise that returns the Synthetic Account list if resolved.
...
-   `uid` **[string][127]** Rize-generated unique synthetic account id
...
Returns **[Promise][128]&lt;[SyntheticAccount][138]>** A promise that returns a SyntheticAccount if resolved.

### create

#### Parameters

-   `payload` **[SyntheticAccountCreateRequest][139]** is a JSON object needs to send as body parameters in order to create new synthetic accounts.
...
Returns **[Promise][128]&lt;[RizeList][133]&lt;[SyntheticAccount][138]>>** 
...
Returns **[Promise][128]&lt;[SyntheticAccount][138]>** A promise that returns a Synthetic Account if resolved.
...
-   `query` **[SyntheticAccountTypeListQuery][140]** An object containing key value paris for filtering the result. (optional, default `{}`)
...
Returns **[Promise][128]&lt;[RizeList][133]&lt;[SyntheticAccountType][141]>>** A promise that returns a Synthetic Account Type List if resolved.
...
-   `uid` **[string][127]** Rize-generated unique Synthetic Account Type id
...
Returns **[Promise][128]&lt;[SyntheticAccountType][141]>** A promise that returns a Synthetic Account Type if resolved.
...
-   `query` **[TransactionListQuery][142]?** An object containing key value pair for filtering the results list. (optional, default `{}`)

Returns **[Promise][128]&lt;[RizeList][133]&lt;[Transaction][143]>>** A promise that returns a Transaction List if resolved.
...
-   `uid` **[string][127]** Rize-generated unique transaction id
...
Returns **[Promise][128]&lt;[Transaction][143]>** A promise that returns a Transaction if resolved.
...
-   `query` **[SyntheticLineItemListQuery][144]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][128]&lt;[RizeList][133]&lt;[SyntheticLineItem][145]>>** A promise that returns a Synthetic Line Item List if resolved.
...
-   `begun_at` **[string][127]** The DateTime at which this Compliance Workflow was requested
...
-   `email` **[string][127]** 
-   `external_uid` **[string][127]** A Customer identifier supplied by the Client, unique among the collection of all Client Customers
-   `uid` **[string][127]** A UID referring to the Customer
...
-   `external_storage_name` **[string][127]** Amazon S3 key used to retrieve the contents of a Compliance Document
-   `compliance_document_url` **[string][127]** Amazon S3 URL used to retrieve the contents of a Compliance Document
-   `name` **[string][127]** 
...
-   `version` **[number][147]** 
-   `uid` **[string][127]** A UID referring to a Compliance Document; note that this UID will be different for each Customer
-   `accepted_at` **[string][127]** The DateTime at which this Compliance Document was acknowledged
...
-   `documentUid` **[string][127]** A UID referring to the Compliance Document being acknowledged.
-   `accept` **(`"yes"` \| `"no"`)** An indication of acceptance or rejection.
-   `userName` **[string][127]?** A label associated with the Customer (required for electronic signing).
-   `ipAddress` **[string][127]?** A numerical label assigned to each device connected to a computer network that uses the Internet Protocol for communication (required for electronic signing); in this case, the label associated with the computer used by the Customer.
...
-   `uid` **[string][127]** A unique identifier generated by Rize.
...
-   `error_code` **[string][127]** 
-   `error_name` **[string][127]** 
-   `error_description` **[string][127]** 
...
-   `uid` **[string][127]** A unique identifier generated by Rize
-   `external_uid` **[string][127]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `customer_uid` **[string][127]** A UID referring to the customer this Custodial Account belongs to
-   `pool_uid` **[Array][148]&lt;[string][127]>** A UID referring to the pool this Custodial Account belongs to
-   `program_service_offering_uid` **([string][127] | null)** A UID referring to the specific Program Service Offering for which this account was created. Nullable if asset.
...
-   `name` **([string][127] | null)** A friendly name used to identify the account at the Custodial Partner.
...
-   `net_usd_balance` **[string][127]** The current settled balance of this Custodial Account in US Dollars
-   `net_usd_pending_balance` **[string][127]** The sum of all pending transactions for this Custodial Account in US Dollars
-   `net_usd_available_balance` **[string][127]** The balance available to spend calculated as Normal balance less any withdrawals. Pending deposits are not included
-   `account_number` **([string][127] | null)** The ACH account number that can be used to make transfers into/out of this account. Nullable if asset.
-   `account_number_masked` **([string][127] | null)** Last 4 digits of the ACH account number. Nullable if asset.
-   `routing_number` **([string][127] | null)** The ABA routing number associated with the Custodial Partner. Nullable if asset.
...
-   `customer_uid` **[Array][148]&lt;[string][127]>?** Filter by Customer. Multiple values are allowed
-   `external_uid` **[string][127]?** A unique, immutable id provided Clien
-   `limit` **[string][127]?**  Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[string][127]?** Index of the items to start retrieving from. Default: 0
-   `liability` **[string][127]?** Filter by liability or asset
-   `type` **[Array][148]&lt;[string][127]>?** Filter by type. Multiple values are allowed.
...
-   `middle_name` **([string][127] | null)?** 
-   `last_name` **[string][127]** 
-   `suffix` **([string][127] | null)?** 
-   `phone` **[string][127]** 
-   `ssn` **[string][127]** 
-   `dob` **[string][127]** 
-   `address` **[Address][155]** 
...
-   `uid` **[string][127]** A unique identifier generated by Rize
-   `external_uid` **[string][127]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `program_uid` **[string][127]** A uid referring to the program this customer belongs to.
-   `pool_uids` **[Array][148]&lt;[string][127]>** A list of uids referring to Pools belonging to this Customer.
-   `email` **[string][127]** Email of the customer
...
-   `total_balance` **[string][127]** Total asset owned by the customer in US dollars.
-   `created_at` **[Date][154]** 
...
-   `lock_reason` **([string][127] | null)?** The lock reason provided by the Client, an admin User, or the system at the time the Customer was locked. This field will be null if and only if the locked_at is null.
-   `details` **[CustomerDetails][136]** An object containing the supplied identifying information for the Customer.
...
-   `first_name` **[string][127]?** Only return Customers with a first name matching exactly what is submitted
-   `last_name` **[string][127]?** Only return Customers with a last name matching exactly what is submitted
-   `email` **[string][127]?** Only return Customers with an email address matching exactly what is submitted
-   `locked` **[boolean][152]?** Only return locked Customers if true and only return unlocked Customers if false
-   `program_uid` **[string][127]?** Only return Customers belonging to the submitted Program.
-   `external_uid` **[string][127]?** A unique, immutable id provided by Client.
-   `pool_uid` **[Array][148]&lt;[string][127]>?** Filter by pool. Multiple values are allowed.
-   `limit` **[string][127]?**  Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[string][127]?** Index of the items to start retrieving from. Default: 0
...
-   `uid` **[string][127]** A unique identifier generated by Rize
-   `name` **[string][127]** A unique name to identify the resource
...
-   `description` **[string][127]** A description outlining the intended use and requirements for this program's instance of the synthetic_account_type
-   `program_uid` **[string][127]?** A uid referring to the Program this synthetic_account_type belongs to
...
-   `program_uid` **[string][127]?** Only list Synthetic Account Types that are available to be used by the given Program
...
-   `external_uid` **[string][127]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `name` **[string][127]** A unique name to identify the resource.
-   `pool_uid` **[string][127]** A UID referring to the pool this Synthetic Account belongs to.
-   `synthetic_account_type_uid` **[string][127]** A UID referring to the Synthetic Account Type this Synthetic Account should be created as.
...
-   `net_usd_balance` **[string][127]** The current settled balance of this account in US Dollars. This field will be null for synthetic_account_types in the external category.
-   `net_usd_pending_balance` **[string][127]** The sum of all pending transactions for this account in US Dollars. This field will be null for Synthetic Account Types in the external category.
-   `net_usd_available_balance` **[string][127]** The balance available to spend calculated as the settled balance less any pending withdrawals Pending deposits are not included. This field will be null for Synthetic Account Types in the external category.
...
-   `account_number` **([string][127] | null)** The ACH account number (if any) associated with this account. Some Synthetic Account Types require this field to be submitted along with the POST request. For example, any Synthetic Account Type from the `external` category will require an `account_number`. Submitting an `account_number` with a Synthetic Account Type that does not require one will result in the account number being ignored.
-   `account_number_last_four` **([string][127] | null)** Last 4 digits of the ACH account number.
-   `routing_number` **([string][127] | null)** The ABA routing number (if any) associated with this account. Some Synthetic Account Types require this field to be submitted along with the POST request. For example, any Synthetic Account Type from the `external` category will require a `routing_number`. Submitting a `routing_number` with a Synthetic Account Type that does not require one will result in the routing number being ignored.
-   `opened_at` **[string][127]** The DateTime at which this account was created
-   `closed_at` **([string][127] | null)** The DateTime at which this account was closed. This value will be present if the status is `archived` or `failed`.
-   `closed_to_synthetic_account_uid` **([string][127] | null)** A UID referring to the Synthetic Account where the funds in this account were transferred when closed. Any transactions issued against this account after it is closed will instead go to the `closed_to` account
...
-   `customer_uid` **[Array][148]&lt;[string][127]>?** Filter by Customer. Multiple string values are allowed.
-   `external_uid` **[string][127]?** A unique, immutable id provided Client
-   `pool_uid` **[Array][148]&lt;[string][127]>?** Filter by pool. Multiple string values are allowed.
-   `limit` **[number][147]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[number][147]?** Index of the items to start retrieving from. Default: 0
-   `synthetic_account_type_uid` **[string][127]?** Filter by Synthetic Account Type
...
-   `externalUid` **([string][127] | null)?** A unique identifier Client supplies
-   `name` **([string][127] | null)?** A unique name to identify the resource
-   `poolUid` **([string][127] | null)?** A UID referring to the pool this Synthetic Account belongs to
-   `syntheticAccountTypeUid` **([string][127] | null)?** A UID referring to the Synthetic Account Type this Synthetic Account should be created as
-   `accountNumber` **([string][127] | null)?** The ACH account number (if any) associated with this account. Some Synthetic Account Types require this field to be submitted along with the POST request. For example, any Synthetic Account Type from the `external` category will require an `account_number`. Submitting an `account_number` with a Synthetic Account Type that does not require one will result in the account number being ignored.
-   `routingNumber` **([string][127] | null)?** The ABA routing number (if any) associated with this account. Some Synthetic Account Types require this field to be submitted along with the POST request. For example, any Synthetic Account Type from the `external` category will require a `routing_number`. Submitting a `routing_number` with a Synthetic Account Type that does not require one will result in the routing number being ignored.
...
-   `source_synthetic_account_uid` **[string][127]** Synthetic Account from where the asset is pulled
-   `destination_synthetic_account_uid` **[string][127]** Synthetic Account where the asset is landed
-   `transaction_event_uids` **[Array][148]&lt;[string][127]>** A list of UIDS referring to Transaction Events belonging to this Transaction, if any. 
...
-   `custodial_account_uids` **[Array][148]&lt;[string][127]>** A list of UIDS referring to Custodial Accounts that are so far invovled in this Transaction. 
...
-   `us_dollar_amount` **[string][127]** The amount will never be negative
...
-   `created_at` **[string][127]** The date and time when the Transaction is first recognized by Rize. This may be when the Transfer is initiated if the Transaction is associated with one.
-   `settled_at` **[string][127]** The date and time when the Transaction is settled.
...
-   `customer_uid` **[Array][148]&lt;[string][127]>?** Filter by Customer.
-   `source_synthetic_account_uid` **[Array][148]&lt;[string][127]>?** Filter by source Synthetic Account.
-   `destination_synthetic_account_uid` **[Array][148]&lt;[string][127]>?** Filter by destination Synthetic Account.
-   `synthetic_account_uid` **[Array][148]&lt;[string][127]>?** Filter by Synthetic Account, source or destination.
...
-   `search_description` **[string][127]?** Attempts to search for the provided string in the description field. '\*' can be used as a wildcard. Any record with a match will be returned.
-   `limit` **[number][147]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default = 100.
-   `offset` **[number][147]?** Index of the items to start retrieving from. Default = 0.
...
-   `uid` **[string][127]** A unique identifier generated by Rize
-   `settled_index` **[number][147]** A unique index that indicates the order in which the Synthetic Line Items were settled
-   `transaction_uid` **[string][127]** UID of the Transaction this Synthetic Line Item belongs to
-   `synthetic_account_uid` **[string][127]** UID of the Synthetic Account this Synthetic Line Item is associated with
-   `status` **[string][127]** 
-   `us_dollar_amount` **[string][127]** The signed USD amount of this specific Synthetic Line Item
-   `running_us_dollar_balance` **[string][127]** The Synthetic Account balance after this Synthetic Line Item was settled
-   `description` **[string][127]** Human-readable description in context of Synthetic Accounts
-   `created_at` **[string][127]** The date and time when the Synthetic Line Item is first recognized by Rize. This may be when the Transfer is initiated if the Synthetic Line Item is associated with one.
-   `settled_at` **[string][127]** The date and time when the Synthetic Line Item is settled
...
-   `customer_uid` **[Array][148]&lt;[string][127]>?** Filter by Customer.
-   `pool_uid` **[Array][148]&lt;[string][127]>?** Filter by pool.
-   `synthetic_account_uid` **[Array][148]&lt;[string][127]>?** Filter by Synthetic Account.
-   `limit` **[number][147]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default = 100.
-   `offset` **[number][147]?** Index of the items to start retrieving from. Default = 0.
-   `transaction_uid` **[Array][148]&lt;[string][127]>?** Filter by Transaction.
-   `status` **[Array][148]&lt;(`"begun"` \| `"failed"` \| `"in_progress"` \| `"settled"`)>?** Filter by status.
...
-   `programUid` **[string][127]** The Rize Program ID.
-   `hmac` **[string][127]** The HMAC that will be used to sign the JSON web signature in order to get access to the API.
...
[75]: #complianceworkflowsummary

[76]: #properties-1

[77]: #complianceworkflowcustomer

[78]: #properties-2

[79]: #compliancedocument

[80]: #properties-3

[81]: #compliancedocumentacknowledgementrequest

[82]: #properties-4

[83]: #complianceworkflow
...
[97]: #customerlistquery

[98]: #properties-12

[99]: #syntheticaccounttype

[100]: #properties-13

[101]: #syntheticaccounttypelistquery

[102]: #properties-14

[103]: #syntheticaccount

[104]: #properties-15

[105]: #syntheticaccountlistquery

[106]: #properties-16

[107]: #syntheticaccountcreaterequest
...
[111]: #transactionlistquery

[112]: #properties-19

[113]: #syntheticlineitem

[114]: #properties-20

[115]: #syntheticlineitemlistquery
...
[121]: #complianceworkflow-1

[122]: #customer-1

[123]: #syntheticaccount-1

[124]: #custodialaccount-1
...
[129]: #complianceworkflow

[130]: #compliancedocumentacknowledgementrequest

[131]: #custodialaccount

[132]: #custodialaccountlistquery

[133]: #rizelist

[134]: #customerlistquery
...
[140]: #syntheticaccounttypelistquery

[141]: #syntheticaccounttype

[142]: #transactionlistquery

[143]: #transaction

[144]: #syntheticlineitemlistquery
