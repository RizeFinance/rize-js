...
-   [Address][101]
    -   [Properties][102]
-   [ComplianceWorkflowSummary][103]
    -   [Properties][104]
-   [ComplianceWorkflowCustomer][105]
    -   [Properties][106]
-   [ComplianceDocument][107]
    -   [Properties][108]
-   [ComplianceDocumentAcknowledgementRequest][109]
    -   [Properties][110]
-   [ComplianceWorkflow][111]
    -   [Properties][112]
-   [AccountError][113]
    -   [Properties][114]
-   [CustodialAccount][115]
    -   [Properties][116]
-   [CustodialAccountListQuery][117]
    -   [Properties][118]
-   [CustomerDetails][119]
    -   [Properties][120]
-   [Customer][121]
...
-   [DebitCard][125]
    -   [Properties][126]
-   [DebitCardListQuery][127]
    -   [Properties][128]
-   [debit-card.typedefs][129]
-   [SyntheticAccountType][130]
    -   [Properties][131]
-   [SyntheticAccountTypeListQuery][132]
    -   [Properties][133]
-   [SyntheticAccount][134]
    -   [Properties][135]
-   [SyntheticAccountListQuery][136]
    -   [Properties][137]
-   [SyntheticAccountCreateRequest][138]
    -   [Properties][139]
-   [Transaction][140]
    -   [Properties][141]
-   [TransactionListQuery][142]
    -   [Properties][143]
-   [SyntheticLineItem][144]
    -   [Properties][145]
-   [SyntheticLineItemListQuery][146]
    -   [Properties][147]
-   [CustodialLineItem][148]
    -   [Properties][149]
-   [CustodialLineItemListQuery][150]
    -   [Properties][151]
-   [RizeOptions][152]
    -   [Properties][153]
-   [Rize][154]
    -   [Parameters][155]
    -   [complianceWorkflow][156]
    -   [customer][157]
    -   [syntheticAccount][158]
    -   [custodialAccount][159]
    -   [transaction][160]
    -   [debitCard][161]
    -   [PACKAGE_VERSION][162]
...
-   `customerExternalUid` **[string][163]** A Customer identifier supplied by the Partner, unique among the collection of all partner Customers.
-   `email` **[string][163]** Email address associated with the Customer.
...
Returns **[Promise][164]&lt;[ComplianceWorkflow][165]>** A promise that returns the new Compliance Workflow if resolved.
...
-   `customerExternalUid` **[string][163]** A Customer identifier supplied by the Partner, unique among the collection of all partner Customers.
-   `customerUid` **[string][163]** A UID referring to the Customer generated by Rize
-   `email` **[string][163]** Email address associated with the Customer.

Returns **[Promise][164]&lt;[ComplianceWorkflow][165]>** A promise that returns the new Compliance Workflow entity if resolved.
...
-   `customerUid` **[string][163]** A UID referring to the Customer
...
Returns **[Promise][164]&lt;[ComplianceWorkflow][165]>** A promise that returns the latest Compliance Workflow if resolved.
...
-   `complianceWorkflowUid` **[string][163]** A UID referring to the Compliance Workflow.
-   `customerUid` **[string][163]** A UID referring to the Customer.
-   `documents` **...[ComplianceDocumentAcknowledgementRequest][166]** 
...
Returns **[Promise][164]&lt;[ComplianceWorkflow][165]>** A promise that returns the updated Compliance Workflow if resolved.
...
-   `uid` **[string][163]** Rize-generated unique custodial account id
...
Returns **[Promise][164]&lt;[CustodialAccount][167]>** A promise that returns a Custodial Account if resolved.
...
-   `query` **[CustodialAccountListQuery][168]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][164]&lt;[RizeList][169]&lt;CustodialAccountList>>** A promise that returns a Custodial Account List if resolved.
...
-   `query` **[CustomerListQuery][170]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][164]&lt;[RizeList][169]&lt;[Customer][171]>>** A promise that returns a Customer List if resolved.
...
-   `uid` **[string][163]** Rize-generated unique customer id
...
Returns **[Promise][164]&lt;[Customer][171]>** A promise that returns a Customer if resolved.
...
-   `uid` **[string][163]** Rize-generated unique customer id
-   `email` **[string][163]** Email of the customer
-   `details` **[CustomerDetails][172]** An object containing the supplied identifying information for the Customer
...
Returns **[Promise][164]&lt;[Customer][171]>** A promise that returns the updated Customer if resolved.
...
Returns **[Promise][164]&lt;void>** A promise that returns void if resolved.
...
-   `uid` **[string][163]** Rize-generated unique customer id
-   `lockReason` **[string][163]** The reason that the Customer is being locked must be submitted with the request body.
...
Returns **[Promise][164]&lt;[Customer][171]>** A promise that returns the locked Customer if resolved.
...
-   `uid` **[string][163]** Rize-generated unique customer id
-   `unlockReason` **[string][163]** The reason that the Customer is being unlocked. (optional, default `null`)
...
Returns **[Promise][164]&lt;[Customer][171]>** A promise that returns the unlocked Customer if resolved.
...
-   `query` **[DebitCardListQuery][173]?** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][164]&lt;[RizeList][169]&lt;[DebitCard][174]>>** A promise that returns a Debit Card List if resolved.
...
-   `uid` **[string][163]** Rize-generated unique debitCard id
...
Returns **[Promise][164]&lt;[DebitCard][174]>** A promise that returns a Debit Card if resolved.
...
-   `externalUid` **[string][163]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `customerUid` **[string][163]** A UID referring to the Customer who owns this Card
-   `poolUid` **[string][163]** A UID referring to the Pool to which this Card belongs
-   `shippingAddress` **([Address][175] | null)?** An optional field used to specify the shipping address for a physical Debit Card.Either the whole `address` must be nullable or all fields must be provided, with an except of `street2`, which is nullable.If no address is specified, the primary address associated with the customer will be used as a shipping address. (optional, default `null`)
...
-   `query` **[SyntheticAccountListQuery][176]**  (optional, default `{}`)
...
Returns **[Promise][164]&lt;[RizeList][169]&lt;[SyntheticAccount][177]>>** A promise that returns the Synthetic Account list if resolved.
...
-   `uid` **[string][163]** Rize-generated unique synthetic account id
...
Returns **[Promise][164]&lt;[SyntheticAccount][177]>** A promise that returns a SyntheticAccount if resolved.

### create

#### Parameters

-   `payload` **[SyntheticAccountCreateRequest][178]** is a JSON object needs to send as body parameters in order to create new synthetic accounts.
...
Returns **[Promise][164]&lt;[RizeList][169]&lt;[SyntheticAccount][177]>>** 
...
Returns **[Promise][164]&lt;[SyntheticAccount][177]>** A promise that returns a Synthetic Account if resolved.
...
-   `query` **[SyntheticAccountTypeListQuery][179]** An object containing key value paris for filtering the result. (optional, default `{}`)
...
Returns **[Promise][164]&lt;[RizeList][169]&lt;[SyntheticAccountType][180]>>** A promise that returns a Synthetic Account Type List if resolved.
...
-   `uid` **[string][163]** Rize-generated unique Synthetic Account Type id
...
Returns **[Promise][164]&lt;[SyntheticAccountType][180]>** A promise that returns a Synthetic Account Type if resolved.
...
-   `query` **[TransactionListQuery][181]?** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][164]&lt;[RizeList][169]&lt;[Transaction][182]>>** A promise that returns a Transaction List if resolved.
...
-   `uid` **[string][163]** Rize-generated unique transaction id
...
Returns **[Promise][164]&lt;[Transaction][182]>** A promise that returns a Transaction if resolved.
...
Returns **[Promise][164]&lt;[RizeList][169]&lt;TransactionEvent>>** A promise that returns a TransactionEvent List if resolved.
...
-   `uid` **[string][163]** Rize-generated unique transaction event id
...
Returns **[Promise][164]&lt;TransactionEvent>** A promise that returns a Transaction Event if resolved.
...
-   `query` **[SyntheticLineItemListQuery][183]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][164]&lt;[RizeList][169]&lt;[SyntheticLineItem][184]>>** A promise that returns a Synthetic Line Item List if resolved.
...
-   `uid` **[string][163]** Rize-generated unique Synthetic Line Item id
...
Returns **[Promise][164]&lt;[SyntheticLineItem][184]>** A promise that returns a Synthetic Line Item if resolved.

### getCustodialLineItemList

#### Parameters

-   `query` **[CustodialLineItemListQuery][185]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][164]&lt;[RizeList][169]&lt;[CustodialLineItem][186]>>** A promise that returns a Custodial Line Item List if resolved.
...
-   `uid` **[string][163]** Rize-generated unique Custodial Line Item id
...
Returns **[Promise][164]&lt;[CustodialLineItem][186]>** A promise that returns a Custodial Line Item if resolved.
...
-   `total_count` **[number][188]** Total count of items available to retrieve
-   `count` **[number][188]** Number of items retrieved
-   `limit` **[number][188]** Maximum number of items to retrieve
-   `offset` **[number][188]** Index of the first item to retrieve
-   `data` **[Array][189]&lt;T>** 
...
-   `street1` **[string][163]** 
-   `street2` **([string][163] | null)?** 
-   `city` **[string][163]** 
-   `state` **[string][163]** 
-   `postal_code` **[string][163]** 
...
-   `accepted_quantity` **[number][188]** 
-   `begun_at` **[string][163]** The DateTime at which this Compliance Workflow was requested
-   `completed_step` **[number][188]** 
-   `current_step` **[number][188]** 
...
-   `email` **[string][163]** 
-   `external_uid` **[string][163]** A Customer identifier supplied by the Client, unique among the collection of all Client Customers
-   `uid` **[string][163]** A UID referring to the Customer
...
-   `external_storage_name` **[string][163]** Amazon S3 key used to retrieve the contents of a Compliance Document
-   `compliance_document_url` **[string][163]** Amazon S3 URL used to retrieve the contents of a Compliance Document
-   `name` **[string][163]** 
-   `step` **[number][188]** Multiple Compliance Documents are grouped into a Step, and Compliance Documents are presented to a Customer, Step-by-Step
-   `version` **[number][188]** 
-   `uid` **[string][163]** A UID referring to a Compliance Document; note that this UID will be different for each Customer
-   `accepted_at` **[string][163]** The DateTime at which this Compliance Document was acknowledged
...
-   `documentUid` **[string][163]** A UID referring to the Compliance Document being acknowledged.
-   `accept` **(`"yes"` \| `"no"`)** An indication of acceptance or rejection.
-   `userName` **[string][163]?** A label associated with the Customer (required for electronic signing).
-   `ipAddress` **[string][163]?** A numerical label assigned to each device connected to a computer network that uses the Internet Protocol for communication (required for electronic signing); in this case, the label associated with the computer used by the Customer.
...
-   `uid` **[string][163]** A unique identifier generated by Rize.
-   `summary` **[ComplianceWorkflowSummary][190]** 
-   `customer` **[ComplianceWorkflowCustomer][191]** 
-   `accepted_documents` **[Array][189]&lt;[ComplianceDocument][192]>** 
-   `current_step_documents_pending` **[Array][189]&lt;Omit&lt;[ComplianceDocument][192], `"accepted_at"`>>** Compliance Documents that await acknowledgment in the current Step
-   `all_documents` **[Array][189]&lt;Omit&lt;[ComplianceDocument][192], (`"accepted_at"` \| `"uid"`)>>** The set of all Compliance Documents that would require acknowledgment
...
-   `error_code` **[string][163]** 
-   `error_name` **[string][163]** 
-   `error_description` **[string][163]** 
...
-   `uid` **[string][163]** A unique identifier generated by Rize
-   `external_uid` **[string][163]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `customer_uid` **[string][163]** A UID referring to the customer this Custodial Account belongs to
-   `pool_uid` **[Array][189]&lt;[string][163]>** A UID referring to the pool this Custodial Account belongs to
-   `program_service_offering_uid` **([string][163] | null)** A UID referring to the specific Program Service Offering for which this account was created. Nullable if asset.
...
-   `liability` **[boolean][193]** Liability or asset. Liability Custodial Accounts represent real accounts at Financial Institutions. Asset accounts are used for accounting purposes and may be generated by Rize during events such as new custodial account creations or new external account connections.
-   `name` **([string][163] | null)** A friendly name used to identify the account at the Custodial Partner.
-   `primary_account` **[boolean][193]** The date and time when the Customer was locked. This field will be null if and only if the lock_reason is null.
...
-   `account_errors` **[Array][189]&lt;[AccountError][194]>** A list of errors related to this account. These are passed through during interactions with the underlying Custodial Partner and can help with resolving customer issues. Only provided for accounts that are in an error or manual_review status.
-   `net_usd_balance` **[string][163]** The current settled balance of this Custodial Account in US Dollars
-   `net_usd_pending_balance` **[string][163]** The sum of all pending transactions for this Custodial Account in US Dollars
-   `net_usd_available_balance` **[string][163]** The balance available to spend calculated as Normal balance less any withdrawals. Pending deposits are not included
-   `account_number` **([string][163] | null)** The ACH account number that can be used to make transfers into/out of this account. Nullable if asset.
-   `account_number_masked` **([string][163] | null)** Last 4 digits of the ACH account number. Nullable if asset.
-   `routing_number` **([string][163] | null)** The ABA routing number associated with the Custodial Partner. Nullable if asset.
-   `opened_at` **[Date][195]** The DateTime at which this account was created
-   `closed_at` **[Date][195]** The DateTime at which this account was closed
...
-   `customer_uid` **[Array][189]&lt;[string][163]>?** Filter by Customer. Multiple values are allowed
-   `external_uid` **[string][163]?** A unique, immutable id provided Clien
-   `limit` **[string][163]?**  Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[string][163]?** Index of the items to start retrieving from. Default: 0
-   `liability` **[string][163]?** Filter by liability or asset
-   `type` **[Array][189]&lt;[string][163]>?** Filter by type. Multiple values are allowed.
...
-   `first_name` **[string][163]** 
-   `middle_name` **([string][163] | null)?** 
-   `last_name` **[string][163]** 
-   `suffix` **([string][163] | null)?** 
-   `phone` **[string][163]** 
-   `ssn` **[string][163]** 
-   `dob` **[string][163]** 
-   `address` **[Address][175]** 
...
-   `uid` **[string][163]** A unique identifier generated by Rize
-   `external_uid` **[string][163]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `program_uid` **[string][163]** A uid referring to the program this customer belongs to.
-   `pool_uids` **[Array][189]&lt;[string][163]>** A list of uids referring to Pools belonging to this Customer.
-   `email` **[string][163]** Email of the customer
...
-   `total_balance` **[string][163]** Total asset owned by the customer in US dollars.
-   `created_at` **[Date][195]** 
-   `locked_at` **([Date][195] | null)?** The date and time when the Customer was locked. This field will be null if and only if the lock_reason is null.
-   `lock_reason` **([string][163] | null)?** The lock reason provided by the Client, an admin User, or the system at the time the Customer was locked. This field will be null if and only if the locked_at is null.
-   `details` **[CustomerDetails][172]** An object containing the supplied identifying information for the Customer.
...
-   `include_initiated` **[boolean][193]?** By default, Customers in initiated status are not shown, even if the `status=initiated` parameter is provided. In order for Customers with status initiated to appear in search results, parameters must include `include_initiated=true`.
...
-   `first_name` **[string][163]?** Only return Customers with a first name matching exactly what is submitted
-   `last_name` **[string][163]?** Only return Customers with a last name matching exactly what is submitted
-   `email` **[string][163]?** Only return Customers with an email address matching exactly what is submitted
-   `locked` **[boolean][193]?** Only return locked Customers if true and only return unlocked Customers if false
-   `program_uid` **[string][163]?** Only return Customers belonging to the submitted Program.
-   `external_uid` **[string][163]?** A unique, immutable id provided by Client.
-   `pool_uid` **[Array][189]&lt;[string][163]>?** Filter by pool. Multiple values are allowed.
-   `limit` **[string][163]?**  Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[string][163]?** Index of the items to start retrieving from. Default: 0
...
-   `uid` **[string][163]** A unique identifier generated by Rize
-   `external_uid` **[string][163]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `customer_uid` **[string][163]** A UID referring to the Customer who owns this Card.
-   `pool_uid` **[string][163]** A UID referring to the Pool to which this Card belongs.
-   `synthetic_account_uid` **[string][163]** A UID referring to the specific Synthetic Account to which this Card belongs. Any debit or credit transactions from this Card will occur in this account.
-   `custodial_account_uid` **[string][163]** A UID referring to the specific Custodial Account to which this Card belongs. Any debit or credit transactions from this Card will occur in this account.
-   `card_last_four_digits` **([string][163] | null)?** Last 4 digits of the Debit Card number to aid in indentifying the Card. Null if the Card is not yet issued (i.e. status is `initiated`).
...
-   `ready_to_use` **[boolean][193]** If the Card can be used, this value will be `true`; `false` otherwise.
-   `lock_reason` **([string][163] | null)?** If the Card is in a locked state, this field will be populated describing why the Card was locked. Null if the Card is not locked.
-   `issued_on` **([string][163] | null)?** The date this Card was issued. It may be briefly null when a new Card is requested, but the issuance has not yet happened (i.e. status is `initiated`).
-   `locked_at` **([string][163] | null)?** The date and time at which this Card was locked. Null if the Card is not locked.
-   `closed_at` **([string][163] | null)?** The date and time at which this Card was closed. This field will be null unless the `status` is `closed`, `closed_by_administrator`, `lost`, or `stolen`.
-   `latest_shipping_address` **([Address][175] | null)?** An optional field used to specify the shipping address for a physical Debit Card.If no address was specified via `debitCard.create`, this field will be null. In case of reissuance, only the address from the latest shipment will be provided, if any.
...
-   `customer_uid` **[Array][189]&lt;[string][163]>?** Filter by Customer. Multiple values are allowed.
-   `external_uid` **[string][163]?** A unique, immutable id provided Client
-   `limit` **[string][163]?**  Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[string][163]?** Index of the items to start retrieving from. Default: 0
-   `pool_uid` **[Array][189]&lt;[string][163]>?** Filter by pool. Multiple values are allowed.
-   `locked` **[boolean][193]?** Only return locked Cards if `true` and only return unlocked Cards if `false`
...
-   `uid` **[string][163]** A unique identifier generated by Rize
-   `name` **[string][163]** A unique name to identify the resource
...
-   `description` **[string][163]** A description outlining the intended use and requirements for this program's instance of the synthetic_account_type
-   `program_uid` **[string][163]?** A uid referring to the Program this synthetic_account_type belongs to
...
-   `program_uid` **[string][163]?** Only list Synthetic Account Types that are available to be used by the given Program
-   `limit` **[number][188]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[number][188]?** Index of the items to start retrieving from. Default: 0
...
-   `external_uid` **[string][163]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `name` **[string][163]** A unique name to identify the resource.
-   `pool_uid` **[string][163]** A UID referring to the pool this Synthetic Account belongs to.
-   `synthetic_account_type_uid` **[string][163]** A UID referring to the Synthetic Account Type this Synthetic Account should be created as.
...
-   `liability` **[boolean][193]** Liability or asset. Any Synthetic Account created via POST /synthetic_accounts is a liability account, except for external accounts. Some asset Synthetic Accounts are automatically created by Rize during Customer onboarding for accounting purposes.
-   `net_usd_balance` **[string][163]** The current settled balance of this account in US Dollars. This field will be null for synthetic_account_types in the external category.
-   `net_usd_pending_balance` **[string][163]** The sum of all pending transactions for this account in US Dollars. This field will be null for Synthetic Account Types in the external category.
-   `net_usd_available_balance` **[string][163]** The balance available to spend calculated as the settled balance less any pending withdrawals Pending deposits are not included. This field will be null for Synthetic Account Types in the external category.
-   `master_account` **[boolean][193]** Used to identify the Master Synthetic Accounts that exist for every Program Customer. Master Synthetic Accounts are the default accounts where any unknown custodial transactions will settle and cannot be archived while a Program Customer is still active.
-   `account_number` **([string][163] | null)** The ACH account number (if any) associated with this account. Some Synthetic Account Types require this field to be submitted along with the POST request. For example, any Synthetic Account Type from the `external` category will require an `account_number`. Submitting an `account_number` with a Synthetic Account Type that does not require one will result in the account number being ignored.
-   `account_number_last_four` **([string][163] | null)** Last 4 digits of the ACH account number.
-   `routing_number` **([string][163] | null)** The ABA routing number (if any) associated with this account. Some Synthetic Account Types require this field to be submitted along with the POST request. For example, any Synthetic Account Type from the `external` category will require a `routing_number`. Submitting a `routing_number` with a Synthetic Account Type that does not require one will result in the routing number being ignored.
-   `opened_at` **[string][163]** The DateTime at which this account was created
-   `closed_at` **([string][163] | null)** The DateTime at which this account was closed. This value will be present if the status is `archived` or `failed`.
-   `closed_to_synthetic_account_uid` **([string][163] | null)** A UID referring to the Synthetic Account where the funds in this account were transferred when closed. Any transactions issued against this account after it is closed will instead go to the `closed_to` account
...
-   `customer_uid` **[Array][189]&lt;[string][163]>?** Filter by Customer. Multiple string values are allowed.
-   `external_uid` **[string][163]?** A unique, immutable id provided Client
-   `pool_uid` **[Array][189]&lt;[string][163]>?** Filter by pool. Multiple string values are allowed.
-   `limit` **[number][188]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[number][188]?** Index of the items to start retrieving from. Default: 0
-   `synthetic_account_type_uid` **[string][163]?** Filter by Synthetic Account Type
-   `synthetic_account_category` **(`"general"` \| `"external"` \| `"plaid_external"`)?** Filter by Synthetic Account Category
-   `liability` **[boolean][193]?** Filter by liability or asset
...
-   `externalUid` **([string][163] | null)?** A unique identifier Client supplies
-   `name` **([string][163] | null)?** A unique name to identify the resource
-   `poolUid` **([string][163] | null)?** A UID referring to the pool this Synthetic Account belongs to
-   `syntheticAccountTypeUid` **([string][163] | null)?** A UID referring to the Synthetic Account Type this Synthetic Account should be created as
-   `accountNumber` **([string][163] | null)?** The ACH account number (if any) associated with this account. Some Synthetic Account Types require this field to be submitted along with the POST request. For example, any Synthetic Account Type from the `external` category will require an `account_number`. Submitting an `account_number` with a Synthetic Account Type that does not require one will result in the account number being ignored.
-   `routingNumber` **([string][163] | null)?** The ABA routing number (if any) associated with this account. Some Synthetic Account Types require this field to be submitted along with the POST request. For example, any Synthetic Account Type from the `external` category will require a `routing_number`. Submitting a `routing_number` with a Synthetic Account Type that does not require one will result in the routing number being ignored.
...
-   `uid` **[string][163]** A unique identifier generated by Rize
-   `id` **[number][188]** A unique numeric identifier that indicates the order in which the Transactions were created
-   `settled_index` **([number][188] | null)?** A unique index that indicates the order in which the Transactions were settled. Null if status is `queued` or `pending`.
-   `transfer_uid` **([number][188] | null)?** The UID of the Transfer this Transaction is associated with, if any.
-   `source_synthetic_account_uid` **[string][163]** Synthetic Account from where the asset is pulled
-   `destination_synthetic_account_uid` **[string][163]** Synthetic Account where the asset is landed
-   `transaction_event_uids` **[Array][189]&lt;[string][163]>** A list of UIDS referring to Transaction Events belonging to this Transaction, if any. 
...
-   `custodial_account_uids` **[Array][189]&lt;[string][163]>** A list of UIDS referring to Custodial Accounts that are so far invovled in this Transaction. 
...
-   `us_dollar_amount` **[string][163]** The amount will never be negative
...
-   `description` **[string][163]** 
-   `created_at` **[string][163]** The date and time when the Transaction is first recognized by Rize. This may be when the Transfer is initiated if the Transaction is associated with one.
-   `settled_at` **[string][163]** The date and time when the Transaction is settled.
...
-   `customer_uid` **[Array][189]&lt;[string][163]>?** Filter by Customer.
-   `source_synthetic_account_uid` **[Array][189]&lt;[string][163]>?** Filter by source Synthetic Account.
-   `destination_synthetic_account_uid` **[Array][189]&lt;[string][163]>?** Filter by destination Synthetic Account.
-   `synthetic_account_uid` **[Array][189]&lt;[string][163]>?** Filter by Synthetic Account, source or destination.
-   `type` **[Array][189]&lt;(`"atm_withdrawal"` \| `"card_purchase"` \| `"card_refund"` \| `"dispute"` \| `"external_transfer"` \| `"fee"` \| `"internal_transfer"` \| `"other"` \| `"reversed_transfer"` \| `"third_party_transfer"`)>?** Filter by type.
-   `status` **[Array][189]&lt;(`"queued"` \| `"pending"` \| `"settled"` \| `"failed"`)>?** Filter by status.
-   `search_description` **[string][163]?** Attempts to search for the provided string in the description field. '\*' can be used as a wildcard. Any record with a match will be returned.
-   `limit` **[number][188]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default = 100.
-   `offset` **[number][188]?** Index of the items to start retrieving from. Default = 0.
...
-   `uid` **[string][163]** A unique identifier generated by Rize
-   `settled_index` **[number][188]** A unique index that indicates the order in which Transaction Events were settled
-   `transaction_uid` **[string][163]** UID of the Transaction this line item belongs to
-   `phase` **[number][188]** Some Transfer types will trigger multiple transfers at the custodial level. Some of these custodial transfers must wait for all dependent custodial transfers to complete before initiating. Transaction Events with `phase` value 1 are recorded for the first set of custodial transfers that get initiated after the (Synthetic) Transfer starts. Custodial transfers in later phases cannot initiate before all events from previous phases are settled.
-   `source_custodial_account_uid` **[string][163]** Custodial Account from which the asset is pulled
-   `destination_custodial_account_uid` **[string][163]** Custodial Account where the asset lands
-   `custodial_line_item_uids` **[Array][189]&lt;[string][163]>** A list of UIDS referring to Custodial Line Items belonging to this event. There are always at least two line items if the status is `settled`.
-   `status` **[string][163]** 
-   `us_dollar_amount` **[string][163]** The amount will never be negative
...
-   `description` **[string][163]** 
-   `created_at` **[string][163]** The date and time when the event is first recognized by Rize. This may be when the Transfer is initiated if the event is associated with one.
-   `settled_at` **[string][163]** The date and time when the event is settled.
    //\*\*
-   `source_custodial_account_uid` **[Array][189]&lt;[string][163]>?** Filter by source Custodial Account.
-   `destination_custodial_account_uid` **[Array][189]&lt;[string][163]>?** Filter by destination Custodial Account.
-   `custodial_account_uid` **[Array][189]&lt;[string][163]>?** Filter by Custodial Account, source or destination.
-   `type` **[Array][189]&lt;(`"odfi_ach_deposit"` \| `"odfi_ach_withdrawal"` \| `"rdfi_ach_deposit"` \| `"rdfi_ach_withdrawal"`)>?** Filter by type. Multiple values are allowed.
-   `transaction_uid` **[Array][189]&lt;[string][163]>?** Filter by Transaction. Multiple values are allowed
-   `limit` **[number][188]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default = 100.
-   `offset` **[number][188]?** Index of the items to start retrieving from. Default = 0.
...
-   `uid` **[string][163]** A unique identifier generated by Rize
-   `settled_index` **[number][188]** A unique index that indicates the order in which the Synthetic Line Items were settled
-   `transaction_uid` **[string][163]** UID of the Transaction this Synthetic Line Item belongs to
-   `synthetic_account_uid` **[string][163]** UID of the Synthetic Account this Synthetic Line Item is associated with
-   `status` **[string][163]** 
-   `us_dollar_amount` **[string][163]** The signed USD amount of this specific Synthetic Line Item
-   `running_us_dollar_balance` **[string][163]** The Synthetic Account balance after this Synthetic Line Item was settled
-   `description` **[string][163]** Human-readable description in context of Synthetic Accounts
-   `created_at` **[string][163]** The date and time when the Synthetic Line Item is first recognized by Rize. This may be when the Transfer is initiated if the Synthetic Line Item is associated with one.
-   `settled_at` **[string][163]** The date and time when the Synthetic Line Item is settled
...
-   `customer_uid` **[Array][189]&lt;[string][163]>?** Filter by Customer.
-   `pool_uid` **[Array][189]&lt;[string][163]>?** Filter by pool.
-   `synthetic_account_uid` **[Array][189]&lt;[string][163]>?** Filter by Synthetic Account.
-   `limit` **[number][188]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default = 100.
-   `offset` **[number][188]?** Index of the items to start retrieving from. Default = 0.
-   `transaction_uid` **[Array][189]&lt;[string][163]>?** Filter by Transaction.
-   `status` **[Array][189]&lt;(`"begun"` \| `"failed"` \| `"in_progress"` \| `"settled"`)>?** Filter by status.
...
-   `uid` **[string][163]** A unique identifier generated by Rize.
-   `settled_index` **[number][188]** A unique index that indicates the order in which the Custodial Line Items were settled.
-   `transaction_uid` **[string][163]** UID of the Transaction this Custodial Line Item belongs to.
-   `transaction_event_uid` **[string][163]** UID of the Transaction Event this Custodial Line Item belongs to.
-   `custodial_account_uid` **[string][163]** UID of the Custodial Account this Custodial Line Item is associated with.
-   `status` **[string][163]** 
-   `us_dollar_amount` **[string][163]** The signed USD amount of this specific Custodial Line Item
-   `running_us_dollar_balance` **([string][163] | null)?** US dollar balance of the Custodial Account as of the completion of this Custodial Line Item. This field may be empty unless the status is `settled` or `voided`.
-   `type` **[string][163]** Symbols and/or numbers that represent different types of Custodial Line Items.
-   `description` **[string][163]** Descriptions pulled from the custodians, such as through NACHA description or ISO-8583 data element 43.
-   `created_at` **[string][163]** The date and time when the Custodial Line Items is first recognized by Rize. This may be when the Transfer is initiated if the Custodial Line Item is associated with one.
-   `occurred_at` **[string][163]** This field may be empty if status is not settled or voided.
-   `settled_at` **[string][163]** The date and time when the Custodial Line Item is settled.
...
-   `customer_uid` **[Array][189]&lt;[string][163]>?** Filter by Customer.
-   `custodial_account_uid` **[Array][189]&lt;[string][163]>?** Filter by Custodial Account.
-   `status` **[Array][189]&lt;(`"settled"` \| `"voided"`)>?** Filter by status.
-   `us_dollar_amount_tax` **[number][188]?** Return any records having a us_dollar_amount at or below us_dollar_amount_max.
-   `us_dollar_amount_min` **[number][188]?** Return any records having a us_dollar_amount at or above us_dollar_amount_min.
-   `transaction_event_uid` **[Array][189]&lt;[string][163]>?** Filter by Transaction Event.
-   `transaction_uid` **[Array][189]&lt;[string][163]>?** Filter by Transaction.
-   `limit` **[number][188]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default = 100.
-   `offset` **[number][188]?** Index of the items to start retrieving from. Default = 0.
-   `sort` **(`"created_at_asc"` \| `"created_at_desc"` \| `"description_asc"` \| `"description_desc"` \| `"settled_index_asc"` \| `"settled_index_desc"` \| `"us_dollar_amount_asc"` \| `"us_dollar_amount_desc"`)?** 
...
-   `timeout` **[number][188]?** Specifies the number of milliseconds before the each request times out. (Default: 80000)
...
-   `programUid` **[string][163]** The Rize Program ID.
-   `hmac` **[string][163]** The HMAC that will be used to sign the JSON web signature in order to get access to the API.
-   `options` **[RizeOptions][196]?** Configuration options (optional, default `RizeOptions`)
...
Type: [ComplianceWorkflowService][197]
...
Type: [SyntheticAccountService][199]
...
Type: [CustodialAccountService][200]
...
[103]: #complianceworkflowsummary

[104]: #properties-2

[105]: #complianceworkflowcustomer
...
[115]: #custodialaccount

[116]: #properties-8

[117]: #custodialaccountlistquery
...
[127]: #debitcardlistquery

[128]: #properties-14

[129]: #debit-cardtypedefs

[130]: #syntheticaccounttype

[131]: #properties-15

[132]: #syntheticaccounttypelistquery

[133]: #properties-16

[134]: #syntheticaccount

[135]: #properties-17

[136]: #syntheticaccountlistquery

[137]: #properties-18

[138]: #syntheticaccountcreaterequest
...
[142]: #transactionlistquery

[143]: #properties-21

[144]: #syntheticlineitem

[145]: #properties-22

[146]: #syntheticlineitemlistquery

[147]: #properties-23

[148]: #custodiallineitem

[149]: #properties-24

[150]: #custodiallineitemlistquery
...
[156]: #complianceworkflow-1

[157]: #customer-1

[158]: #syntheticaccount-1

[159]: #custodialaccount-1
...
[164]: https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Promise

[165]: #complianceworkflow

[166]: #compliancedocumentacknowledgementrequest

[167]: #custodialaccount
...
[176]: #syntheticaccountlistquery

[177]: #syntheticaccount

[178]: #syntheticaccountcreaterequest
...
[183]: #syntheticlineitemlistquery

[184]: #syntheticlineitem

[185]: #custodiallineitemlistquery

[186]: #custodiallineitem
...
[191]: #complianceworkflowcustomer

[192]: #compliancedocument

[193]: https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Boolean

[194]: #accounterror

[195]: https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Date

[196]: #rizeoptions

[197]: #complianceworkflowservice

[198]: #customerservice

[199]: #syntheticaccountservice

[200]: #custodialaccountservice
