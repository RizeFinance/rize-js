...
-   [TransactionService][64]
    ...
    -   [getSyntheticLineItem][74]
        -   [Parameters][75]
        -   [Examples][76]
    -   [getCustodialLineItemList][77]
        -   [Parameters][78]
        -   [Examples][79]
    -   [getCustodialLineItem][80]
        -   [Parameters][81]
        -   [Examples][82]
-   [RizeList][83]
    -   [Properties][84]
...
-   [SyntheticLineItemListQuery][125]
    -   [Properties][126]
-   [CustodialLineItem][127]
    -   [Properties][128]
-   [CustodialLineItemListQuery][129]
    -   [Properties][130]
-   [RizeOptions][131]
    -   [Properties][132]
-   [Rize][133]
    -   [Parameters][134]
    -   [complianceWorkflow][135]
    -   [customer][136]
    -   [syntheticAccount][137]
...
-   `customerExternalUid` **[string][141]** A Customer identifier supplied by the Partner, unique among the collection of all partner Customers.
-   `email` **[string][141]** Email address associated with the Customer.
...
Returns **[Promise][142]&lt;[ComplianceWorkflow][143]>** A promise that returns the new Compliance Workflow if resolved.
...
-   `customerExternalUid` **[string][141]** A Customer identifier supplied by the Partner, unique among the collection of all partner Customers.
-   `customerUid` **[string][141]** A UID referring to the Customer generated by Rize
-   `email` **[string][141]** Email address associated with the Customer.

Returns **[Promise][142]&lt;[ComplianceWorkflow][143]>** A promise that returns the new Compliance Workflow entity if resolved.
...
-   `customerUid` **[string][141]** A UID referring to the Customer
...
Returns **[Promise][142]&lt;[ComplianceWorkflow][143]>** A promise that returns the latest Compliance Workflow if resolved.
...
-   `complianceWorkflowUid` **[string][141]** A UID referring to the Compliance Workflow.
-   `customerUid` **[string][141]** A UID referring to the Customer.
-   `documents` **...[ComplianceDocumentAcknowledgementRequest][144]** 
...
Returns **[Promise][142]&lt;[ComplianceWorkflow][143]>** A promise that returns the updated Compliance Workflow if resolved.
...
-   `uid` **[string][141]** Rize-generated unique custodial account id
...
Returns **[Promise][142]&lt;[CustodialAccount][145]>** A promise that returns a Custodial Account if resolved.
...
-   `query` **[CustodialAccountListQuery][146]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][142]&lt;[RizeList][147]&lt;CustodialAccountList>>** A promise that returns a Custodial Account List if resolved.
...
-   `query` **[CustomerListQuery][148]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][142]&lt;[RizeList][147]&lt;[Customer][149]>>** A promise that returns a Customer List if resolved.
...
-   `uid` **[string][141]** Rize-generated unique customer id
...
Returns **[Promise][142]&lt;[Customer][149]>** A promise that returns a Customer if resolved.
...
-   `uid` **[string][141]** Rize-generated unique customer id
-   `email` **[string][141]** Email of the customer
-   `details` **[CustomerDetails][150]** An object containing the supplied identifying information for the Customer
...
Returns **[Promise][142]&lt;[Customer][149]>** A promise that returns the updated Customer if resolved.
...
Returns **[Promise][142]&lt;void>** A promise that returns void if resolved.
...
-   `uid` **[string][141]** Rize-generated unique customer id
-   `lockReason` **[string][141]** The reason that the Customer is being locked must be submitted with the request body.
...
Returns **[Promise][142]&lt;[Customer][149]>** A promise that returns the locked Customer if resolved.
...
-   `uid` **[string][141]** Rize-generated unique customer id
-   `unlockReason` **[string][141]** The reason that the Customer is being unlocked. (optional, default `null`)
...
Returns **[Promise][142]&lt;[Customer][149]>** A promise that returns the unlocked Customer if resolved.
...
-   `query` **[SyntheticAccountListQuery][151]**  (optional, default `{}`)
...
Returns **[Promise][142]&lt;[RizeList][147]&lt;[SyntheticAccount][152]>>** A promise that returns the Synthetic Account list if resolved.
...
-   `uid` **[string][141]** Rize-generated unique synthetic account id
...
Returns **[Promise][142]&lt;[SyntheticAccount][152]>** A promise that returns a SyntheticAccount if resolved.

### create

#### Parameters

-   `payload` **[SyntheticAccountCreateRequest][153]** is a JSON object needs to send as body parameters in order to create new synthetic accounts.
...
Returns **[Promise][142]&lt;[RizeList][147]&lt;[SyntheticAccount][152]>>** 
...
Returns **[Promise][142]&lt;[SyntheticAccount][152]>** A promise that returns a Synthetic Account if resolved.
...
-   `query` **[SyntheticAccountTypeListQuery][154]** An object containing key value paris for filtering the result. (optional, default `{}`)
...
Returns **[Promise][142]&lt;[RizeList][147]&lt;[SyntheticAccountType][155]>>** A promise that returns a Synthetic Account Type List if resolved.
...
-   `uid` **[string][141]** Rize-generated unique Synthetic Account Type id
...
Returns **[Promise][142]&lt;[SyntheticAccountType][155]>** A promise that returns a Synthetic Account Type if resolved.
...
-   `query` **[TransactionListQuery][156]?** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][142]&lt;[RizeList][147]&lt;[Transaction][157]>>** A promise that returns a Transaction List if resolved.
...
-   `uid` **[string][141]** Rize-generated unique transaction id
...
Returns **[Promise][142]&lt;[Transaction][157]>** A promise that returns a Transaction if resolved.
...
-   `query` **[SyntheticLineItemListQuery][158]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][142]&lt;[RizeList][147]&lt;[SyntheticLineItem][159]>>** A promise that returns a Synthetic Line Item List if resolved.
...
-   `uid` **[string][141]** Rize-generated unique Synthetic Line Item id
...
Returns **[Promise][142]&lt;[SyntheticLineItem][159]>** A promise that returns a Synthetic Line Item if resolved.

### getCustodialLineItemList

#### Parameters

-   `query` **[CustodialLineItemListQuery][160]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][142]&lt;[RizeList][147]&lt;[CustodialLineItem][161]>>** A promise that returns a Custodial Line Item List if resolved.
...
-   `uid` **[string][141]** Rize-generated unique Custodial Line Item id
...
Returns **[Promise][142]&lt;[CustodialLineItem][161]>** A promise that returns a Custodial Line Item if resolved.
...
-   `total_count` **[number][163]** Total count of items available to retrieve
-   `count` **[number][163]** Number of items retrieved
-   `limit` **[number][163]** Maximum number of items to retrieve
-   `offset` **[number][163]** Index of the first item to retrieve
-   `data` **[Array][164]&lt;T>** 
...
-   `accepted_quantity` **[number][163]** 
-   `begun_at` **[string][141]** The DateTime at which this Compliance Workflow was requested
-   `completed_step` **[number][163]** 
-   `current_step` **[number][163]** 
...
-   `email` **[string][141]** 
-   `external_uid` **[string][141]** A Customer identifier supplied by the Client, unique among the collection of all Client Customers
-   `uid` **[string][141]** A UID referring to the Customer
...
-   `external_storage_name` **[string][141]** Amazon S3 key used to retrieve the contents of a Compliance Document
-   `compliance_document_url` **[string][141]** Amazon S3 URL used to retrieve the contents of a Compliance Document
-   `name` **[string][141]** 
-   `step` **[number][163]** Multiple Compliance Documents are grouped into a Step, and Compliance Documents are presented to a Customer, Step-by-Step
-   `version` **[number][163]** 
-   `uid` **[string][141]** A UID referring to a Compliance Document; note that this UID will be different for each Customer
-   `accepted_at` **[string][141]** The DateTime at which this Compliance Document was acknowledged
...
-   `documentUid` **[string][141]** A UID referring to the Compliance Document being acknowledged.
-   `accept` **(`"yes"` \| `"no"`)** An indication of acceptance or rejection.
-   `userName` **[string][141]?** A label associated with the Customer (required for electronic signing).
-   `ipAddress` **[string][141]?** A numerical label assigned to each device connected to a computer network that uses the Internet Protocol for communication (required for electronic signing); in this case, the label associated with the computer used by the Customer.
...
-   `uid` **[string][141]** A unique identifier generated by Rize.
-   `summary` **[ComplianceWorkflowSummary][165]** 
-   `customer` **[ComplianceWorkflowCustomer][166]** 
-   `accepted_documents` **[Array][164]&lt;[ComplianceDocument][167]>** 
-   `current_step_documents_pending` **[Array][164]&lt;Omit&lt;[ComplianceDocument][167], `"accepted_at"`>>** Compliance Documents that await acknowledgment in the current Step
-   `all_documents` **[Array][164]&lt;Omit&lt;[ComplianceDocument][167], (`"accepted_at"` \| `"uid"`)>>** The set of all Compliance Documents that would require acknowledgment
...
-   `error_code` **[string][141]** 
-   `error_name` **[string][141]** 
-   `error_description` **[string][141]** 
...
-   `uid` **[string][141]** A unique identifier generated by Rize
-   `external_uid` **[string][141]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `customer_uid` **[string][141]** A UID referring to the customer this Custodial Account belongs to
-   `pool_uid` **[Array][164]&lt;[string][141]>** A UID referring to the pool this Custodial Account belongs to
-   `program_service_offering_uid` **([string][141] | null)** A UID referring to the specific Program Service Offering for which this account was created. Nullable if asset.
...
-   `liability` **[boolean][168]** Liability or asset. Liability Custodial Accounts represent real accounts at Financial Institutions. Asset accounts are used for accounting purposes and may be generated by Rize during events such as new custodial account creations or new external account connections.
-   `name` **([string][141] | null)** A friendly name used to identify the account at the Custodial Partner.
-   `primary_account` **[boolean][168]** The date and time when the Customer was locked. This field will be null if and only if the lock_reason is null.
...
-   `account_errors` **[Array][164]&lt;[AccountError][169]>** A list of errors related to this account. These are passed through during interactions with the underlying Custodial Partner and can help with resolving customer issues. Only provided for accounts that are in an error or manual_review status.
-   `net_usd_balance` **[string][141]** The current settled balance of this Custodial Account in US Dollars
-   `net_usd_pending_balance` **[string][141]** The sum of all pending transactions for this Custodial Account in US Dollars
-   `net_usd_available_balance` **[string][141]** The balance available to spend calculated as Normal balance less any withdrawals. Pending deposits are not included
-   `account_number` **([string][141] | null)** The ACH account number that can be used to make transfers into/out of this account. Nullable if asset.
-   `account_number_masked` **([string][141] | null)** Last 4 digits of the ACH account number. Nullable if asset.
-   `routing_number` **([string][141] | null)** The ABA routing number associated with the Custodial Partner. Nullable if asset.
-   `opened_at` **[Date][170]** The DateTime at which this account was created
-   `closed_at` **[Date][170]** The DateTime at which this account was closed
...
-   `customer_uid` **[Array][164]&lt;[string][141]>?** Filter by Customer. Multiple values are allowed
-   `external_uid` **[string][141]?** A unique, immutable id provided Clien
-   `limit` **[string][141]?**  Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[string][141]?** Index of the items to start retrieving from. Default: 0
-   `liability` **[string][141]?** Filter by liability or asset
-   `type` **[Array][164]&lt;[string][141]>?** Filter by type. Multiple values are allowed.
...
-   `first_name` **[string][141]** 
-   `middle_name` **([string][141] | null)?** 
-   `last_name` **[string][141]** 
-   `suffix` **([string][141] | null)?** 
-   `phone` **[string][141]** 
-   `ssn` **[string][141]** 
-   `dob` **[string][141]** 
-   `address` **[Address][171]** 
...
-   `uid` **[string][141]** A unique identifier generated by Rize
-   `external_uid` **[string][141]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `program_uid` **[string][141]** A uid referring to the program this customer belongs to.
-   `pool_uids` **[Array][164]&lt;[string][141]>** A list of uids referring to Pools belonging to this Customer.
-   `email` **[string][141]** Email of the customer
...
-   `total_balance` **[string][141]** Total asset owned by the customer in US dollars.
-   `created_at` **[Date][170]** 
-   `locked_at` **([Date][170] | null)?** The date and time when the Customer was locked. This field will be null if and only if the lock_reason is null.
-   `lock_reason` **([string][141] | null)?** The lock reason provided by the Client, an admin User, or the system at the time the Customer was locked. This field will be null if and only if the locked_at is null.
-   `details` **[CustomerDetails][150]** An object containing the supplied identifying information for the Customer.
...
-   `include_initiated` **[boolean][168]?** By default, Customers in initiated status are not shown, even if the `status=initiated` parameter is provided. In order for Customers with status initiated to appear in search results, parameters must include `include_initiated=true`.
...
-   `first_name` **[string][141]?** Only return Customers with a first name matching exactly what is submitted
-   `last_name` **[string][141]?** Only return Customers with a last name matching exactly what is submitted
-   `email` **[string][141]?** Only return Customers with an email address matching exactly what is submitted
-   `locked` **[boolean][168]?** Only return locked Customers if true and only return unlocked Customers if false
-   `program_uid` **[string][141]?** Only return Customers belonging to the submitted Program.
-   `external_uid` **[string][141]?** A unique, immutable id provided by Client.
-   `pool_uid` **[Array][164]&lt;[string][141]>?** Filter by pool. Multiple values are allowed.
-   `limit` **[string][141]?**  Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[string][141]?** Index of the items to start retrieving from. Default: 0
...
-   `uid` **[string][141]** A unique identifier generated by Rize
-   `name` **[string][141]** A unique name to identify the resource
...
-   `description` **[string][141]** A description outlining the intended use and requirements for this program's instance of the synthetic_account_type
-   `program_uid` **[string][141]?** A uid referring to the Program this synthetic_account_type belongs to
...
-   `program_uid` **[string][141]?** Only list Synthetic Account Types that are available to be used by the given Program
-   `limit` **[number][163]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[number][163]?** Index of the items to start retrieving from. Default: 0
...
-   `external_uid` **[string][141]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `name` **[string][141]** A unique name to identify the resource.
-   `pool_uid` **[string][141]** A UID referring to the pool this Synthetic Account belongs to.
-   `synthetic_account_type_uid` **[string][141]** A UID referring to the Synthetic Account Type this Synthetic Account should be created as.
...
-   `liability` **[boolean][168]** Liability or asset. Any Synthetic Account created via POST /synthetic_accounts is a liability account, except for external accounts. Some asset Synthetic Accounts are automatically created by Rize during Customer onboarding for accounting purposes.
-   `net_usd_balance` **[string][141]** The current settled balance of this account in US Dollars. This field will be null for synthetic_account_types in the external category.
-   `net_usd_pending_balance` **[string][141]** The sum of all pending transactions for this account in US Dollars. This field will be null for Synthetic Account Types in the external category.
-   `net_usd_available_balance` **[string][141]** The balance available to spend calculated as the settled balance less any pending withdrawals Pending deposits are not included. This field will be null for Synthetic Account Types in the external category.
-   `master_account` **[boolean][168]** Used to identify the Master Synthetic Accounts that exist for every Program Customer. Master Synthetic Accounts are the default accounts where any unknown custodial transactions will settle and cannot be archived while a Program Customer is still active.
-   `account_number` **([string][141] | null)** The ACH account number (if any) associated with this account. Some Synthetic Account Types require this field to be submitted along with the POST request. For example, any Synthetic Account Type from the `external` category will require an `account_number`. Submitting an `account_number` with a Synthetic Account Type that does not require one will result in the account number being ignored.
-   `account_number_last_four` **([string][141] | null)** Last 4 digits of the ACH account number.
-   `routing_number` **([string][141] | null)** The ABA routing number (if any) associated with this account. Some Synthetic Account Types require this field to be submitted along with the POST request. For example, any Synthetic Account Type from the `external` category will require a `routing_number`. Submitting a `routing_number` with a Synthetic Account Type that does not require one will result in the routing number being ignored.
-   `opened_at` **[string][141]** The DateTime at which this account was created
-   `closed_at` **([string][141] | null)** The DateTime at which this account was closed. This value will be present if the status is `archived` or `failed`.
-   `closed_to_synthetic_account_uid` **([string][141] | null)** A UID referring to the Synthetic Account where the funds in this account were transferred when closed. Any transactions issued against this account after it is closed will instead go to the `closed_to` account
...
-   `customer_uid` **[Array][164]&lt;[string][141]>?** Filter by Customer. Multiple string values are allowed.
-   `external_uid` **[string][141]?** A unique, immutable id provided Client
-   `pool_uid` **[Array][164]&lt;[string][141]>?** Filter by pool. Multiple string values are allowed.
-   `limit` **[number][163]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[number][163]?** Index of the items to start retrieving from. Default: 0
-   `synthetic_account_type_uid` **[string][141]?** Filter by Synthetic Account Type
-   `synthetic_account_category` **(`"general"` \| `"external"` \| `"plaid_external"`)?** Filter by Synthetic Account Category
-   `liability` **[boolean][168]?** Filter by liability or asset
...
-   `externalUid` **([string][141] | null)?** A unique identifier Client supplies
-   `name` **([string][141] | null)?** A unique name to identify the resource
-   `poolUid` **([string][141] | null)?** A UID referring to the pool this Synthetic Account belongs to
-   `syntheticAccountTypeUid` **([string][141] | null)?** A UID referring to the Synthetic Account Type this Synthetic Account should be created as
-   `accountNumber` **([string][141] | null)?** The ACH account number (if any) associated with this account. Some Synthetic Account Types require this field to be submitted along with the POST request. For example, any Synthetic Account Type from the `external` category will require an `account_number`. Submitting an `account_number` with a Synthetic Account Type that does not require one will result in the account number being ignored.
-   `routingNumber` **([string][141] | null)?** The ABA routing number (if any) associated with this account. Some Synthetic Account Types require this field to be submitted along with the POST request. For example, any Synthetic Account Type from the `external` category will require a `routing_number`. Submitting a `routing_number` with a Synthetic Account Type that does not require one will result in the routing number being ignored.
...
-   `uid` **[string][141]** A unique identifier generated by Rize
-   `id` **[number][163]** A unique numeric identifier that indicates the order in which the Transactions were created
-   `settled_index` **([number][163] | null)?** A unique index that indicates the order in which the Transactions were settled. Null if status is `queued` or `pending`.
-   `transfer_uid` **([number][163] | null)?** The UID of the Transfer this Transaction is associated with, if any.
-   `source_synthetic_account_uid` **[string][141]** Synthetic Account from where the asset is pulled
-   `destination_synthetic_account_uid` **[string][141]** Synthetic Account where the asset is landed
-   `transaction_event_uids` **[Array][164]&lt;[string][141]>** A list of UIDS referring to Transaction Events belonging to this Transaction, if any. 
...
-   `custodial_account_uids` **[Array][164]&lt;[string][141]>** A list of UIDS referring to Custodial Accounts that are so far invovled in this Transaction. 
...
-   `us_dollar_amount` **[string][141]** The amount will never be negative
...
-   `description` **[string][141]** 
-   `created_at` **[string][141]** The date and time when the Transaction is first recognized by Rize. This may be when the Transfer is initiated if the Transaction is associated with one.
-   `settled_at` **[string][141]** The date and time when the Transaction is settled.
...
-   `customer_uid` **[Array][164]&lt;[string][141]>?** Filter by Customer.
-   `source_synthetic_account_uid` **[Array][164]&lt;[string][141]>?** Filter by source Synthetic Account.
-   `destination_synthetic_account_uid` **[Array][164]&lt;[string][141]>?** Filter by destination Synthetic Account.
-   `synthetic_account_uid` **[Array][164]&lt;[string][141]>?** Filter by Synthetic Account, source or destination.
-   `type` **[Array][164]&lt;(`"atm_withdrawal"` \| `"card_purchase"` \| `"card_refund"` \| `"dispute"` \| `"external_transfer"` \| `"fee"` \| `"internal_transfer"` \| `"other"` \| `"reversed_transfer"` \| `"third_party_transfer"`)>?** Filter by type.
-   `status` **[Array][164]&lt;(`"queued"` \| `"pending"` \| `"settled"` \| `"failed"`)>?** Filter by status.
-   `search_description` **[string][141]?** Attempts to search for the provided string in the description field. '\*' can be used as a wildcard. Any record with a match will be returned.
-   `limit` **[number][163]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default = 100.
-   `offset` **[number][163]?** Index of the items to start retrieving from. Default = 0.
...
-   `uid` **[string][141]** A unique identifier generated by Rize
-   `settled_index` **[number][163]** A unique index that indicates the order in which the Synthetic Line Items were settled
-   `transaction_uid` **[string][141]** UID of the Transaction this Synthetic Line Item belongs to
-   `synthetic_account_uid` **[string][141]** UID of the Synthetic Account this Synthetic Line Item is associated with
-   `status` **[string][141]** 
-   `us_dollar_amount` **[string][141]** The signed USD amount of this specific Synthetic Line Item
-   `running_us_dollar_balance` **[string][141]** The Synthetic Account balance after this Synthetic Line Item was settled
-   `description` **[string][141]** Human-readable description in context of Synthetic Accounts
-   `created_at` **[string][141]** The date and time when the Synthetic Line Item is first recognized by Rize. This may be when the Transfer is initiated if the Synthetic Line Item is associated with one.
-   `settled_at` **[string][141]** The date and time when the Synthetic Line Item is settled
...
-   `customer_uid` **[Array][164]&lt;[string][141]>?** Filter by Customer.
-   `pool_uid` **[Array][164]&lt;[string][141]>?** Filter by pool.
-   `synthetic_account_uid` **[Array][164]&lt;[string][141]>?** Filter by Synthetic Account.
-   `limit` **[number][163]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default = 100.
-   `offset` **[number][163]?** Index of the items to start retrieving from. Default = 0.
-   `transaction_uid` **[Array][164]&lt;[string][141]>?** Filter by Transaction.
-   `status` **[Array][164]&lt;(`"begun"` \| `"failed"` \| `"in_progress"` \| `"settled"`)>?** Filter by status.
...
-   `uid` **[string][141]** A unique identifier generated by Rize.
-   `settled_index` **[number][163]** A unique index that indicates the order in which the Custodial Line Items were settled.
-   `transaction_uid` **[string][141]** UID of the Transaction this Custodial Line Item belongs to.
-   `transaction_event_uid` **[string][141]** UID of the Transaction Event this Custodial Line Item belongs to.
-   `custodial_account_uid` **[string][141]** UID of the Custodial Account this Custodial Line Item is associated with.
-   `status` **[string][141]** 
-   `us_dollar_amount` **[string][141]** The signed USD amount of this specific Custodial Line Item
-   `running_us_dollar_balance` **([string][141] | null)?** US dollar balance of the Custodial Account as of the completion of this Custodial Line Item. This field may be empty unless the status is `settled` or `voided`.
-   `type` **[string][141]** Symbols and/or numbers that represent different types of Custodial Line Items.
-   `description` **[string][141]** Descriptions pulled from the custodians, such as through NACHA description or ISO-8583 data element 43.
-   `created_at` **[string][141]** The date and time when the Custodial Line Items is first recognized by Rize. This may be when the Transfer is initiated if the Custodial Line Item is associated with one.
-   `occurred_at` **[string][141]** This field may be empty if status is not settled or voided.
-   `settled_at` **[string][141]** The date and time when the Custodial Line Item is settled.
...
-   `customer_uid` **[Array][164]&lt;[string][141]>?** Filter by Customer.
-   `custodial_account_uid` **[Array][164]&lt;[string][141]>?** Filter by Custodial Account.
-   `status` **[Array][164]&lt;(`"settled"` \| `"voided"`)>?** Filter by status.
-   `us_dollar_amount_tax` **[number][163]?** Return any records having a us_dollar_amount at or below us_dollar_amount_max.
-   `us_dollar_amount_min` **[number][163]?** Return any records having a us_dollar_amount at or above us_dollar_amount_min.
-   `transaction_event_uid` **[Array][164]&lt;[string][141]>?** Filter by Transaction Event.
-   `transaction_uid` **[Array][164]&lt;[string][141]>?** Filter by Transaction.
-   `limit` **[number][163]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default = 100.
-   `offset` **[number][163]?** Index of the items to start retrieving from. Default = 0.
...
-   `timeout` **[number][163]?** Specifies the number of milliseconds before the each request times out. (Default: 80000)
...
-   `programUid` **[string][141]** The Rize Program ID.
-   `hmac` **[string][141]** The HMAC that will be used to sign the JSON web signature in order to get access to the API.
-   `options` **[RizeOptions][172]?** Configuration options (optional, default `RizeOptions`)
...
Type: [ComplianceWorkflowService][173]
...
Type: [SyntheticAccountService][175]
...
Type: [CustodialAccountService][176]
...
[77]: #getcustodiallineitemlist

[78]: #parameters-24

[79]: #examples-23

[80]: #getcustodiallineitem
...
[127]: #custodiallineitem

[128]: #properties-22

[129]: #custodiallineitemlistquery
...
[135]: #complianceworkflow-1

[136]: #customer-1

[137]: #syntheticaccount-1

[138]: #custodialaccount-1
...
[143]: #complianceworkflow

[144]: #compliancedocumentacknowledgementrequest
...
[148]: #customerlistquery

[149]: #customer

[150]: #customerdetails

[151]: #syntheticaccountlistquery

[152]: #syntheticaccount

[153]: #syntheticaccountcreaterequest

[154]: #syntheticaccounttypelistquery

[155]: #syntheticaccounttype

[156]: #transactionlistquery

[157]: #transaction

[158]: #syntheticlineitemlistquery

[159]: #syntheticlineitem
...
[165]: #complianceworkflowsummary

[166]: #complianceworkflowcustomer

[167]: #compliancedocument
...
[173]: #complianceworkflowservice

[174]: #customerservice

[175]: #syntheticaccountservice

[176]: #custodialaccountservice
