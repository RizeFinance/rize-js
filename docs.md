...
-   `created_at` **[Date][104]** 
-   `locked_at` **([Date][104] | null)?** The date and time when the Customer was locked. This field will be null if and only if the lock_reason is null.
...
-   `description` **[string][88]** 
-   `program_uid` **[string][88]?** 
