...
-   [RizeList][81]
    -   [Properties][82]
-   [ComplianceWorkflowSummary][83]
    -   [Properties][84]
-   [ComplianceWorkflowCustomer][85]
    -   [Properties][86]
-   [ComplianceDocument][87]
    -   [Properties][88]
-   [ComplianceDocumentAcknowledgementRequest][89]
    -   [Properties][90]
-   [ComplianceWorkflow][91]
    -   [Properties][92]
-   [AccountError][93]
    -   [Properties][94]
-   [CustodialAccount][95]
    -   [Properties][96]
-   [CustodialAccountListQuery][97]
    -   [Properties][98]
-   [Address][99]
    -   [Properties][100]
-   [CustomerDetails][101]
...
-   [Customer][103]
    -   [Properties][104]
-   [CustomerListQuery][105]
    -   [Properties][106]
-   [SyntheticAccountType][107]
    -   [Properties][108]
-   [SyntheticAccountTypeListQuery][109]
    -   [Properties][110]
-   [SyntheticAccount][111]
    -   [Properties][112]
-   [SyntheticAccountListQuery][113]
    -   [Properties][114]
-   [SyntheticAccountCreateRequest][115]
    -   [Properties][116]
-   [Transaction][117]
    -   [Properties][118]
-   [TransactionListQuery][119]
    -   [Properties][120]
-   [SyntheticLineItem][121]
    -   [Properties][122]
-   [SyntheticLineItemListQuery][123]
    -   [Properties][124]
-   [Transfer][125]
    -   [Properties][126]
-   [TransferListQuery][127]
    -   [Properties][128]
-   [RizeOptions][129]
    -   [Properties][130]
-   [Rize][131]
    -   [Parameters][132]
    -   [complianceWorkflow][133]
    -   [customer][134]
    -   [syntheticAccount][135]
    -   [custodialAccount][136]
    -   [transaction][137]
    -   [transfer][138]
    -   [PACKAGE_VERSION][139]
...
-   `customerExternalUid` **[string][140]** A Customer identifier supplied by the Partner, unique among the collection of all partner Customers.
-   `email` **[string][140]** Email address associated with the Customer.
...
Returns **[Promise][141]&lt;[ComplianceWorkflow][142]>** A promise that returns the new Compliance Workflow if resolved.
...
-   `customerExternalUid` **[string][140]** A Customer identifier supplied by the Partner, unique among the collection of all partner Customers.
-   `customerUid` **[string][140]** A UID referring to the Customer generated by Rize
-   `email` **[string][140]** Email address associated with the Customer.

Returns **[Promise][141]&lt;[ComplianceWorkflow][142]>** A promise that returns the new Compliance Workflow entity if resolved.
...
-   `customerUid` **[string][140]** A UID referring to the Customer
...
Returns **[Promise][141]&lt;[ComplianceWorkflow][142]>** A promise that returns the latest Compliance Workflow if resolved.
...
-   `complianceWorkflowUid` **[string][140]** A UID referring to the Compliance Workflow.
-   `customerUid` **[string][140]** A UID referring to the Customer.
-   `documents` **...[ComplianceDocumentAcknowledgementRequest][143]** 
...
Returns **[Promise][141]&lt;[ComplianceWorkflow][142]>** A promise that returns the updated Compliance Workflow if resolved.
...
-   `uid` **[string][140]** Rize-generated unique custodial account id
...
Returns **[Promise][141]&lt;[CustodialAccount][144]>** A promise that returns a Custodial Account if resolved.
...
-   `query` **[CustodialAccountListQuery][145]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][141]&lt;[RizeList][146]&lt;CustodialAccountList>>** A promise that returns a Custodial Account List if resolved.
...
-   `query` **[CustomerListQuery][147]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][141]&lt;[RizeList][146]&lt;[Customer][148]>>** A promise that returns a Customer List if resolved.
...
-   `uid` **[string][140]** Rize-generated unique customer id
...
Returns **[Promise][141]&lt;[Customer][148]>** A promise that returns a Customer if resolved.
...
-   `uid` **[string][140]** Rize-generated unique customer id
-   `email` **[string][140]** Email of the customer
-   `details` **[CustomerDetails][149]** An object containing the supplied identifying information for the Customer
...
Returns **[Promise][141]&lt;[Customer][148]>** A promise that returns the updated Customer if resolved.
...
Returns **[Promise][141]&lt;void>** A promise that returns void if resolved.
...
-   `uid` **[string][140]** Rize-generated unique customer id
-   `lockReason` **[string][140]** The reason that the Customer is being locked must be submitted with the request body.
...
Returns **[Promise][141]&lt;[Customer][148]>** A promise that returns the locked Customer if resolved.
...
-   `uid` **[string][140]** Rize-generated unique customer id
-   `unlockReason` **[string][140]** The reason that the Customer is being unlocked. (optional, default `null`)
...
Returns **[Promise][141]&lt;[Customer][148]>** A promise that returns the unlocked Customer if resolved.
...
-   `query` **[SyntheticAccountListQuery][150]**  (optional, default `{}`)
...
Returns **[Promise][141]&lt;[RizeList][146]&lt;[SyntheticAccount][151]>>** A promise that returns the Synthetic Account list if resolved.
...
-   `uid` **[string][140]** Rize-generated unique synthetic account id
...
Returns **[Promise][141]&lt;[SyntheticAccount][151]>** A promise that returns a SyntheticAccount if resolved.

### create

#### Parameters

-   `payload` **[SyntheticAccountCreateRequest][152]** is a JSON object needs to send as body parameters in order to create new synthetic accounts.
...
Returns **[Promise][141]&lt;[RizeList][146]&lt;[SyntheticAccount][151]>>** 
...
Returns **[Promise][141]&lt;[SyntheticAccount][151]>** A promise that returns a Synthetic Account if resolved.
...
-   `query` **[SyntheticAccountTypeListQuery][153]** An object containing key value paris for filtering the result. (optional, default `{}`)
...
Returns **[Promise][141]&lt;[RizeList][146]&lt;[SyntheticAccountType][154]>>** A promise that returns a Synthetic Account Type List if resolved.
...
-   `uid` **[string][140]** Rize-generated unique Synthetic Account Type id
...
Returns **[Promise][141]&lt;[SyntheticAccountType][154]>** A promise that returns a Synthetic Account Type if resolved.
...
-   `query` **[TransactionListQuery][155]?** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][141]&lt;[RizeList][146]&lt;[Transaction][156]>>** A promise that returns a Transaction List if resolved.
...
-   `uid` **[string][140]** Rize-generated unique transaction id
...
Returns **[Promise][141]&lt;[Transaction][156]>** A promise that returns a Transaction if resolved.
...
-   `query` **[SyntheticLineItemListQuery][157]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][141]&lt;[RizeList][146]&lt;[SyntheticLineItem][158]>>** A promise that returns a Synthetic Line Item List if resolved.
...
-   `uid` **[string][140]** Rize-generated unique Synthetic Line Item id
...
Returns **[Promise][141]&lt;[SyntheticLineItem][158]>** A promise that returns a Synthetic Line Item if resolved.
...
-   `query` **[TransferListQuery][159]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][141]&lt;[RizeList][146]&lt;[Transfer][160]>>** A promise that returns a Transfer List if resolved.
...
-   `total_count` **[number][162]** Total count of items available to retrieve
-   `count` **[number][162]** Number of items retrieved
-   `limit` **[number][162]** Maximum number of items to retrieve
-   `offset` **[number][162]** Index of the first item to retrieve
-   `data` **[Array][163]&lt;T>** 
...
-   `accepted_quantity` **[number][162]** 
-   `begun_at` **[string][140]** The DateTime at which this Compliance Workflow was requested
-   `completed_step` **[number][162]** 
-   `current_step` **[number][162]** 
...
-   `email` **[string][140]** 
-   `external_uid` **[string][140]** A Customer identifier supplied by the Client, unique among the collection of all Client Customers
-   `uid` **[string][140]** A UID referring to the Customer
...
-   `external_storage_name` **[string][140]** Amazon S3 key used to retrieve the contents of a Compliance Document
-   `compliance_document_url` **[string][140]** Amazon S3 URL used to retrieve the contents of a Compliance Document
-   `name` **[string][140]** 
-   `step` **[number][162]** Multiple Compliance Documents are grouped into a Step, and Compliance Documents are presented to a Customer, Step-by-Step
-   `version` **[number][162]** 
-   `uid` **[string][140]** A UID referring to a Compliance Document; note that this UID will be different for each Customer
-   `accepted_at` **[string][140]** The DateTime at which this Compliance Document was acknowledged
...
-   `documentUid` **[string][140]** A UID referring to the Compliance Document being acknowledged.
-   `accept` **(`"yes"` \| `"no"`)** An indication of acceptance or rejection.
-   `userName` **[string][140]?** A label associated with the Customer (required for electronic signing).
-   `ipAddress` **[string][140]?** A numerical label assigned to each device connected to a computer network that uses the Internet Protocol for communication (required for electronic signing); in this case, the label associated with the computer used by the Customer.
...
-   `uid` **[string][140]** A unique identifier generated by Rize.
-   `summary` **[ComplianceWorkflowSummary][164]** 
-   `customer` **[ComplianceWorkflowCustomer][165]** 
-   `accepted_documents` **[Array][163]&lt;[ComplianceDocument][166]>** 
-   `current_step_documents_pending` **[Array][163]&lt;Omit&lt;[ComplianceDocument][166], `"accepted_at"`>>** Compliance Documents that await acknowledgment in the current Step
-   `all_documents` **[Array][163]&lt;Omit&lt;[ComplianceDocument][166], (`"accepted_at"` \| `"uid"`)>>** The set of all Compliance Documents that would require acknowledgment
...
-   `error_code` **[string][140]** 
-   `error_name` **[string][140]** 
-   `error_description` **[string][140]** 
...
-   `uid` **[string][140]** A unique identifier generated by Rize
-   `external_uid` **[string][140]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `customer_uid` **[string][140]** A UID referring to the customer this Custodial Account belongs to
-   `pool_uid` **[Array][163]&lt;[string][140]>** A UID referring to the pool this Custodial Account belongs to
-   `program_service_offering_uid` **([string][140] | null)** A UID referring to the specific Program Service Offering for which this account was created. Nullable if asset.
...
-   `liability` **[boolean][167]** Liability or asset. Liability Custodial Accounts represent real accounts at Financial Institutions. Asset accounts are used for accounting purposes and may be generated by Rize during events such as new custodial account creations or new external account connections.
-   `name` **([string][140] | null)** A friendly name used to identify the account at the Custodial Partner.
-   `primary_account` **[boolean][167]** The date and time when the Customer was locked. This field will be null if and only if the lock_reason is null.
...
-   `account_errors` **[Array][163]&lt;[AccountError][168]>** A list of errors related to this account. These are passed through during interactions with the underlying Custodial Partner and can help with resolving customer issues. Only provided for accounts that are in an error or manual_review status.
-   `net_usd_balance` **[string][140]** The current settled balance of this Custodial Account in US Dollars
-   `net_usd_pending_balance` **[string][140]** The sum of all pending transactions for this Custodial Account in US Dollars
-   `net_usd_available_balance` **[string][140]** The balance available to spend calculated as Normal balance less any withdrawals. Pending deposits are not included
-   `account_number` **([string][140] | null)** The ACH account number that can be used to make transfers into/out of this account. Nullable if asset.
-   `account_number_masked` **([string][140] | null)** Last 4 digits of the ACH account number. Nullable if asset.
-   `routing_number` **([string][140] | null)** The ABA routing number associated with the Custodial Partner. Nullable if asset.
-   `opened_at` **[Date][169]** The DateTime at which this account was created
-   `closed_at` **[Date][169]** The DateTime at which this account was closed
...
-   `customer_uid` **[Array][163]&lt;[string][140]>?** Filter by Customer. Multiple values are allowed
-   `external_uid` **[string][140]?** A unique, immutable id provided Clien
-   `limit` **[string][140]?**  Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[string][140]?** Index of the items to start retrieving from. Default: 0
-   `liability` **[string][140]?** Filter by liability or asset
-   `type` **[Array][163]&lt;[string][140]>?** Filter by type. Multiple values are allowed.
...
-   `first_name` **[string][140]** 
-   `middle_name` **([string][140] | null)?** 
-   `last_name` **[string][140]** 
-   `suffix` **([string][140] | null)?** 
-   `phone` **[string][140]** 
-   `ssn` **[string][140]** 
-   `dob` **[string][140]** 
-   `address` **[Address][170]** 
...
-   `uid` **[string][140]** A unique identifier generated by Rize
-   `external_uid` **[string][140]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `program_uid` **[string][140]** A uid referring to the program this customer belongs to.
-   `pool_uids` **[Array][163]&lt;[string][140]>** A list of uids referring to Pools belonging to this Customer.
-   `email` **[string][140]** Email of the customer
...
-   `total_balance` **[string][140]** Total asset owned by the customer in US dollars.
-   `created_at` **[Date][169]** 
-   `locked_at` **([Date][169] | null)?** The date and time when the Customer was locked. This field will be null if and only if the lock_reason is null.
-   `lock_reason` **([string][140] | null)?** The lock reason provided by the Client, an admin User, or the system at the time the Customer was locked. This field will be null if and only if the locked_at is null.
-   `details` **[CustomerDetails][149]** An object containing the supplied identifying information for the Customer.
...
-   `include_initiated` **[boolean][167]?** By default, Customers in initiated status are not shown, even if the `status=initiated` parameter is provided. In order for Customers with status initiated to appear in search results, parameters must include `include_initiated=true`.
...
-   `first_name` **[string][140]?** Only return Customers with a first name matching exactly what is submitted
-   `last_name` **[string][140]?** Only return Customers with a last name matching exactly what is submitted
-   `email` **[string][140]?** Only return Customers with an email address matching exactly what is submitted
-   `locked` **[boolean][167]?** Only return locked Customers if true and only return unlocked Customers if false
-   `program_uid` **[string][140]?** Only return Customers belonging to the submitted Program.
-   `external_uid` **[string][140]?** A unique, immutable id provided by Client.
-   `pool_uid` **[Array][163]&lt;[string][140]>?** Filter by pool. Multiple values are allowed.
-   `limit` **[string][140]?**  Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[string][140]?** Index of the items to start retrieving from. Default: 0
...
-   `uid` **[string][140]** A unique identifier generated by Rize
-   `name` **[string][140]** A unique name to identify the resource
...
-   `description` **[string][140]** A description outlining the intended use and requirements for this program's instance of the synthetic_account_type
-   `program_uid` **[string][140]?** A uid referring to the Program this synthetic_account_type belongs to
...
-   `program_uid` **[string][140]?** Only list Synthetic Account Types that are available to be used by the given Program
-   `limit` **[number][162]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[number][162]?** Index of the items to start retrieving from. Default: 0
...
-   `external_uid` **[string][140]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `name` **[string][140]** A unique name to identify the resource.
-   `pool_uid` **[string][140]** A UID referring to the pool this Synthetic Account belongs to.
-   `synthetic_account_type_uid` **[string][140]** A UID referring to the Synthetic Account Type this Synthetic Account should be created as.
...
-   `liability` **[boolean][167]** Liability or asset. Any Synthetic Account created via POST /synthetic_accounts is a liability account, except for external accounts. Some asset Synthetic Accounts are automatically created by Rize during Customer onboarding for accounting purposes.
-   `net_usd_balance` **[string][140]** The current settled balance of this account in US Dollars. This field will be null for synthetic_account_types in the external category.
-   `net_usd_pending_balance` **[string][140]** The sum of all pending transactions for this account in US Dollars. This field will be null for Synthetic Account Types in the external category.
-   `net_usd_available_balance` **[string][140]** The balance available to spend calculated as the settled balance less any pending withdrawals Pending deposits are not included. This field will be null for Synthetic Account Types in the external category.
-   `master_account` **[boolean][167]** Used to identify the Master Synthetic Accounts that exist for every Program Customer. Master Synthetic Accounts are the default accounts where any unknown custodial transactions will settle and cannot be archived while a Program Customer is still active.
-   `account_number` **([string][140] | null)** The ACH account number (if any) associated with this account. Some Synthetic Account Types require this field to be submitted along with the POST request. For example, any Synthetic Account Type from the `external` category will require an `account_number`. Submitting an `account_number` with a Synthetic Account Type that does not require one will result in the account number being ignored.
-   `account_number_last_four` **([string][140] | null)** Last 4 digits of the ACH account number.
-   `routing_number` **([string][140] | null)** The ABA routing number (if any) associated with this account. Some Synthetic Account Types require this field to be submitted along with the POST request. For example, any Synthetic Account Type from the `external` category will require a `routing_number`. Submitting a `routing_number` with a Synthetic Account Type that does not require one will result in the routing number being ignored.
-   `opened_at` **[string][140]** The DateTime at which this account was created
-   `closed_at` **([string][140] | null)** The DateTime at which this account was closed. This value will be present if the status is `archived` or `failed`.
-   `closed_to_synthetic_account_uid` **([string][140] | null)** A UID referring to the Synthetic Account where the funds in this account were transferred when closed. Any transactions issued against this account after it is closed will instead go to the `closed_to` account
...
-   `customer_uid` **[Array][163]&lt;[string][140]>?** Filter by Customer. Multiple string values are allowed.
-   `external_uid` **[string][140]?** A unique, immutable id provided Client
-   `pool_uid` **[Array][163]&lt;[string][140]>?** Filter by pool. Multiple string values are allowed.
-   `limit` **[number][162]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[number][162]?** Index of the items to start retrieving from. Default: 0
-   `synthetic_account_type_uid` **[string][140]?** Filter by Synthetic Account Type
-   `synthetic_account_category` **(`"general"` \| `"external"` \| `"plaid_external"`)?** Filter by Synthetic Account Category
-   `liability` **[boolean][167]?** Filter by liability or asset
...
-   `externalUid` **([string][140] | null)?** A unique identifier Client supplies
-   `name` **([string][140] | null)?** A unique name to identify the resource
-   `poolUid` **([string][140] | null)?** A UID referring to the pool this Synthetic Account belongs to
-   `syntheticAccountTypeUid` **([string][140] | null)?** A UID referring to the Synthetic Account Type this Synthetic Account should be created as
-   `accountNumber` **([string][140] | null)?** The ACH account number (if any) associated with this account. Some Synthetic Account Types require this field to be submitted along with the POST request. For example, any Synthetic Account Type from the `external` category will require an `account_number`. Submitting an `account_number` with a Synthetic Account Type that does not require one will result in the account number being ignored.
-   `routingNumber` **([string][140] | null)?** The ABA routing number (if any) associated with this account. Some Synthetic Account Types require this field to be submitted along with the POST request. For example, any Synthetic Account Type from the `external` category will require a `routing_number`. Submitting a `routing_number` with a Synthetic Account Type that does not require one will result in the routing number being ignored.
...
-   `uid` **[string][140]** A unique identifier generated by Rize
-   `id` **[number][162]** A unique numeric identifier that indicates the order in which the Transactions were created
-   `settled_index` **([number][162] | null)?** A unique index that indicates the order in which the Transactions were settled. Null if status is `queued` or `pending`.
-   `transfer_uid` **([number][162] | null)?** The UID of the Transfer this Transaction is associated with, if any.
-   `source_synthetic_account_uid` **[string][140]** Synthetic Account from where the asset is pulled
-   `destination_synthetic_account_uid` **[string][140]** Synthetic Account where the asset is landed
-   `transaction_event_uids` **[Array][163]&lt;[string][140]>** A list of UIDS referring to Transaction Events belonging to this Transaction, if any. 
...
-   `custodial_account_uids` **[Array][163]&lt;[string][140]>** A list of UIDS referring to Custodial Accounts that are so far invovled in this Transaction. 
...
-   `us_dollar_amount` **[string][140]** The amount will never be negative
...
-   `created_at` **[string][140]** The date and time when the Transaction is first recognized by Rize. This may be when the Transfer is initiated if the Transaction is associated with one.
-   `settled_at` **[string][140]** The date and time when the Transaction is settled.
...
-   `customer_uid` **[Array][163]&lt;[string][140]>?** Filter by Customer.
-   `source_synthetic_account_uid` **[Array][163]&lt;[string][140]>?** Filter by source Synthetic Account.
-   `destination_synthetic_account_uid` **[Array][163]&lt;[string][140]>?** Filter by destination Synthetic Account.
-   `synthetic_account_uid` **[Array][163]&lt;[string][140]>?** Filter by Synthetic Account, source or destination.
-   `type` **[Array][163]&lt;(`"atm_withdrawal"` \| `"card_purchase"` \| `"card_refund"` \| `"dispute"` \| `"external_transfer"` \| `"fee"` \| `"internal_transfer"` \| `"other"` \| `"reversed_transfer"` \| `"third_party_transfer"`)>?** Filter by type.
-   `status` **[Array][163]&lt;(`"queued"` \| `"pending"` \| `"settled"` \| `"failed"`)>?** Filter by status.
-   `search_description` **[string][140]?** Attempts to search for the provided string in the description field. '\*' can be used as a wildcard. Any record with a match will be returned.
-   `limit` **[number][162]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default = 100.
-   `offset` **[number][162]?** Index of the items to start retrieving from. Default = 0.
...
-   `uid` **[string][140]** A unique identifier generated by Rize
-   `settled_index` **[number][162]** A unique index that indicates the order in which the Synthetic Line Items were settled
-   `transaction_uid` **[string][140]** UID of the Transaction this Synthetic Line Item belongs to
-   `synthetic_account_uid` **[string][140]** UID of the Synthetic Account this Synthetic Line Item is associated with
-   `status` **[string][140]** 
-   `us_dollar_amount` **[string][140]** The signed USD amount of this specific Synthetic Line Item
-   `running_us_dollar_balance` **[string][140]** The Synthetic Account balance after this Synthetic Line Item was settled
-   `description` **[string][140]** Human-readable description in context of Synthetic Accounts
-   `created_at` **[string][140]** The date and time when the Synthetic Line Item is first recognized by Rize. This may be when the Transfer is initiated if the Synthetic Line Item is associated with one.
-   `settled_at` **[string][140]** The date and time when the Synthetic Line Item is settled
...
-   `customer_uid` **[Array][163]&lt;[string][140]>?** Filter by Customer.
-   `pool_uid` **[Array][163]&lt;[string][140]>?** Filter by pool.
-   `synthetic_account_uid` **[Array][163]&lt;[string][140]>?** Filter by Synthetic Account.
-   `limit` **[number][162]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default = 100.
-   `offset` **[number][162]?** Index of the items to start retrieving from. Default = 0.
-   `transaction_uid` **[Array][163]&lt;[string][140]>?** Filter by Transaction.
-   `status` **[Array][163]&lt;(`"begun"` \| `"failed"` \| `"in_progress"` \| `"settled"`)>?** Filter by status.
...
-   `uid` **[string][140]** A unique identifier generated by Rize.
-   `external_uid` **[string][140]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `source_synthetic_account_uid` **[string][140]** Synthetic Account to pull asset from. Must be an active liability or external-type account. Cannot be equal to `destination_synthetic_account_uid`.
-   `destination_synthetic_account_uid` **[string][140]** Synthetic Account where the asset should land. Must be an active liability or external-type account. Cannot be equal to `source_synthetic_account_uid`.
-   `initiating_customer_uid` **[string][140]** 
-   `usd_transfer_amount` **[string][140]** The USD amount to transfer
...
-   `external_uid` **[string][140]?** A unique, immutable id provided Client.
-   `pool_uid` **[Array][163]&lt;[string][140]>?** Filter by pool. Multiple values are allowed.
-   `synthetic_account_uid` **[Array][163]&lt;[string][140]>?** Filter by Synthetic Account. Multiple values are allowed.
-   `limit` **[number][162]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default = 100.
-   `offset` **[number][162]?** Index of the items to start retrieving from. Default = 0.
...
-   `timeout` **[number][162]?** Specifies the number of milliseconds before the each request times out. (Default: 80000)
...
-   `programUid` **[string][140]** The Rize Program ID.
-   `hmac` **[string][140]** The HMAC that will be used to sign the JSON web signature in order to get access to the API.
-   `options` **[RizeOptions][171]?** Configuration options (optional, default `RizeOptions`)
...
Type: [ComplianceWorkflowService][172]
...
Type: [SyntheticAccountService][174]
...
Type: [CustodialAccountService][175]
...
[83]: #complianceworkflowsummary

[84]: #properties-1

[85]: #complianceworkflowcustomer

[86]: #properties-2

[87]: #compliancedocument

[88]: #properties-3

[89]: #compliancedocumentacknowledgementrequest

[90]: #properties-4

[91]: #complianceworkflow
...
[105]: #customerlistquery

[106]: #properties-12

[107]: #syntheticaccounttype

[108]: #properties-13

[109]: #syntheticaccounttypelistquery

[110]: #properties-14

[111]: #syntheticaccount

[112]: #properties-15

[113]: #syntheticaccountlistquery

[114]: #properties-16

[115]: #syntheticaccountcreaterequest
...
[119]: #transactionlistquery

[120]: #properties-19

[121]: #syntheticlineitem

[122]: #properties-20

[123]: #syntheticlineitemlistquery
...
[133]: #complianceworkflow-1

[134]: #customer-1

[135]: #syntheticaccount-1

[136]: #custodialaccount-1
...
[142]: #complianceworkflow

[143]: #compliancedocumentacknowledgementrequest

[144]: #custodialaccount

[145]: #custodialaccountlistquery

[146]: #rizelist

[147]: #customerlistquery

[148]: #customer

[149]: #customerdetails

[150]: #syntheticaccountlistquery

[151]: #syntheticaccount

[152]: #syntheticaccountcreaterequest
...
[157]: #syntheticlineitemlistquery

[158]: #syntheticlineitem

[159]: #transferlistquery
...
[164]: #complianceworkflowsummary

[165]: #complianceworkflowcustomer

[166]: #compliancedocument

[167]: https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Boolean

[168]: #accounterror

[169]: https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Date

[170]: #address

[171]: #rizeoptions

[172]: #complianceworkflowservice

[173]: #customerservice

[174]: #syntheticaccountservice

[175]: #custodialaccountservice

[176]: #transactionservice
