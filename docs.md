...
-   [TransactionService][116]
    ...
    -   [get][120]
        -   [Parameters][121]
        -   [Examples][122]
    -   [getTransactionEventList][123]
        -   [Parameters][124]
        -   [Examples][125]
    -   [getTransactionEvent][126]
        -   [Parameters][127]
        -   [Examples][128]
    -   [getSyntheticLineItemList][129]
        -   [Parameters][130]
        -   [Examples][131]
    -   [getSyntheticLineItem][132]
        -   [Parameters][133]
        -   [Examples][134]
    -   [getCustodialLineItemList][135]
        -   [Parameters][136]
        -   [Examples][137]
    -   [getCustodialLineItem][138]
        -   [Parameters][139]
        -   [Examples][140]
-   [TransferService][141]
    -   [getList][142]
...
-   [HTTPResponse][155]
    -   [Properties][156]
-   [ComplianceWorkflowSummary][157]
    -   [Properties][158]
-   [ComplianceWorkflowCustomer][159]
    -   [Properties][160]
-   [ComplianceDocument][161]
    -   [Properties][162]
-   [ComplianceDocumentAcknowledgementRequest][163]
    -   [Properties][164]
-   [ComplianceWorkflow][165]
    -   [Properties][166]
-   [AccountError][167]
    -   [Properties][168]
-   [CustodialAccount][169]
    -   [Properties][170]
-   [CustodialAccountListQuery][171]
    -   [Properties][172]
-   [CustomerDetails][173]
    -   [Properties][174]
-   [Customer][175]
    -   [Properties][176]
-   [CustomerListQuery][177]
    -   [Properties][178]
-   [DebitCard][179]
    -   [Properties][180]
-   [DebitCardListQuery][181]
    -   [Properties][182]
-   [debit-card.typedefs][183]
-   [Document][184]
    -   [Properties][185]
-   [DocumentListQuery][186]
    -   [Properties][187]
-   [Evaluation][188]
    -   [Properties][189]
-   [EvaluationListQuery][190]
    -   [Properties][191]
-   [KYCDocument][192]
    -   [Properties][193]
-   [SyntheticAccountType][194]
    -   [Properties][195]
-   [SyntheticAccountTypeListQuery][196]
    -   [Properties][197]
-   [SyntheticAccount][198]
    -   [Properties][199]
-   [SyntheticAccountListQuery][200]
    -   [Properties][201]
-   [SyntheticAccountCreateRequest][202]
    -   [Properties][203]
-   [Transaction][204]
    -   [Properties][205]
-   [TransactionListQuery][206]
    -   [Properties][207]
-   [SyntheticLineItem][208]
    -   [Properties][209]
-   [SyntheticLineItemListQuery][210]
    -   [Properties][211]
-   [CustodialLineItem][212]
    -   [Properties][213]
-   [CustodialLineItemListQuery][214]
    -   [Properties][215]
-   [Transfer][216]
    -   [Properties][217]
-   [TransferListQuery][218]
    -   [Properties][219]
-   [RizeOptions][220]
    -   [Properties][221]
-   [Rize][222]
    -   [Parameters][223]
    -   [complianceWorkflow][224]
    -   [customer][225]
    -   [syntheticAccount][226]
    -   [custodialAccount][227]
    -   [transaction][228]
    -   [transfer][229]
    -   [debitCard][230]
    -   [document][231]
...
-   `customerExternalUid` **[string][235]** A Customer identifier supplied by the Partner, unique among the collection of all partner Customers.
-   `email` **[string][235]** Email address associated with the Customer.
...
Returns **[Promise][236]&lt;[ComplianceWorkflow][237]>** A promise that returns the new Compliance Workflow if resolved.
...
-   `customerExternalUid` **[string][235]** A Customer identifier supplied by the Partner, unique among the collection of all partner Customers.
-   `customerUid` **[string][235]** A UID referring to the Customer generated by Rize
-   `email` **[string][235]** Email address associated with the Customer.

Returns **[Promise][236]&lt;[ComplianceWorkflow][237]>** A promise that returns the new Compliance Workflow entity if resolved.
...
-   `customerUid` **[string][235]** A UID referring to the Customer
...
Returns **[Promise][236]&lt;[ComplianceWorkflow][237]>** A promise that returns the latest Compliance Workflow if resolved.
...
-   `complianceWorkflowUid` **[string][235]** A UID referring to the Compliance Workflow.
-   `customerUid` **[string][235]** A UID referring to the Customer.
-   `documents` **...[ComplianceDocumentAcknowledgementRequest][238]** 
...
Returns **[Promise][236]&lt;[ComplianceWorkflow][237]>** A promise that returns the updated Compliance Workflow if resolved.
...
-   `uid` **[string][235]** Rize-generated unique custodial account id
...
Returns **[Promise][236]&lt;[CustodialAccount][239]>** A promise that returns a Custodial Account if resolved.
...
-   `query` **[CustodialAccountListQuery][240]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][236]&lt;[RizeList][241]&lt;CustodialAccountList>>** A promise that returns a Custodial Account List if resolved.
...
-   `query` **[CustomerListQuery][242]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][236]&lt;[RizeList][241]&lt;[Customer][243]>>** A promise that returns a Customer List if resolved.
...
-   `uid` **[string][235]** Rize-generated unique customer id
...
Returns **[Promise][236]&lt;[Customer][243]>** A promise that returns a Customer if resolved.
...
-   `uid` **[string][235]** Rize-generated unique customer id
-   `email` **[string][235]** Email of the customer
-   `details` **[CustomerDetails][244]** An object containing the supplied identifying information for the Customer
...
Returns **[Promise][236]&lt;[Customer][243]>** A promise that returns the updated Customer if resolved.
...
Returns **[Promise][236]&lt;void>** A promise that returns void if resolved.
...
-   `uid` **[string][235]** Rize-generated unique customer id
-   `lockReason` **[string][235]** The reason that the Customer is being locked must be submitted with the request body.
...
Returns **[Promise][236]&lt;[Customer][243]>** A promise that returns the locked Customer if resolved.
...
-   `uid` **[string][235]** Rize-generated unique customer id
-   `unlockReason` **[string][235]** The reason that the Customer is being unlocked. (optional, default `null`)
...
Returns **[Promise][236]&lt;[Customer][243]>** A promise that returns the unlocked Customer if resolved.
...
-   `query` **[DebitCardListQuery][245]?** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][236]&lt;[RizeList][241]&lt;[DebitCard][246]>>** A promise that returns a Debit Card List if resolved.
...
-   `uid` **[string][235]** Rize-generated unique debitCard id
...
Returns **[Promise][236]&lt;[DebitCard][246]>** A promise that returns a Debit Card if resolved.
...
-   `externalUid` **[string][235]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `customerUid` **[string][235]** A UID referring to the Customer who owns this Card
-   `poolUid` **[string][235]** A UID referring to the Pool to which this Card belongs
-   `shippingAddress` **([Address][247] | null)?** An optional field used to specify the shipping address for a physical Debit Card.Either the whole `address` must be nullable or all fields must be provided, with an except of `street2`, which is nullable.If no address is specified, the primary address associated with the customer will be used as a shipping address. (optional, default `null`)
...
-   `uid` **[string][235]** Rize-generated unique Debit Card id
-   `lockReason` **[string][235]** A lock reason is required to be submitted when locking a Debit Card
...
-   `query` **[DocumentListQuery][248]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][236]&lt;[RizeList][241]&lt;[Document][249]>>** A promise that returns a Document List if resolved.
...
-   `uid` **[string][235]** Rize-generated unique document id
...
Returns **[Promise][236]&lt;[Document][249]>** A promise that returns a downloaded Document if resolved.
...
Returns **[Promise][236]&lt;[Document][249]>** A promise that returns a Document if resolved.
...
-   `query` **[EvaluationListQuery][250]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][236]&lt;[RizeList][241]&lt;[Evaluation][251]>>** A promise that returns an Evaluation List if resolved.
...
-   `uid` **[string][235]** Rize-generated unique evaluation id
...
Returns **[Promise][236]&lt;[Evaluation][251]>** A promise that returns an Evaluation if resolved.
...
-   `evaluationUid` **[string][235]** An object containing key value pair for getting the results list.
...
Returns **[Promise][236]&lt;[RizeList][241]&lt;[KYCDocument][252]>>** A promise that returns a List of KYC Documents if resolved.
...
-   `evaluationUid` **[string][235]** A uid referring to the evaluation with which this document is associated
-   `filename` **[string][235]** The name of the file to be uploaded
-   `fileContent` **[string][235]** The contents of the file to be uploaded, base64-encoded.
-   `note` **[string][235]** A note describing this document
...
Returns **[Promise][236]&lt;[KYCDocument][252]>** A promise that returns a KYC Document if resolved.
...
-   `uid` **[string][235]** Rize-generated unique KYC Document id
...
Returns **[Promise][236]&lt;[KYCDocument][252]>** A promise that returns a KYC Document Metadata if resolved.
...
Returns **[Promise][236]&lt;[HTTPResponse][253]&lt;[string][235]>>** A promise that returns a binary KYC Document with headers if resolved.
...
Returns **[Promise][236]&lt;[string][235]>** A promise that returns a base64-encoded KYC Document string if resolved.
...
-   `query` **[SyntheticAccountListQuery][254]** An object containing key value paris for filtering the result. (optional, default `{}`)
...
Returns **[Promise][236]&lt;[RizeList][241]&lt;[SyntheticAccount][255]>>** A promise that returns the Synthetic Account list if resolved.
...
-   `uid` **[string][235]** Rize-generated unique synthetic account id
...
Returns **[Promise][236]&lt;[SyntheticAccount][255]>** A promise that returns a SyntheticAccount if resolved.

### create

#### Parameters

-   `payload` **[SyntheticAccountCreateRequest][256]** is a JSON object needs to send as body parameters in order to create new synthetic accounts.
...
Returns **[Promise][236]&lt;[RizeList][241]&lt;[SyntheticAccount][255]>>** 
...
Returns **[Promise][236]&lt;[SyntheticAccount][255]>** A promise that returns a Synthetic Account if resolved.
...
-   `query` **[SyntheticAccountTypeListQuery][257]** An object containing key value paris for filtering the result. (optional, default `{}`)
...
Returns **[Promise][236]&lt;[RizeList][241]&lt;[SyntheticAccountType][258]>>** A promise that returns a Synthetic Account Type List if resolved.
...
-   `uid` **[string][235]** Rize-generated unique Synthetic Account Type id
...
Returns **[Promise][236]&lt;[SyntheticAccountType][258]>** A promise that returns a Synthetic Account Type if resolved.
...
-   `query` **[TransactionListQuery][259]?** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][236]&lt;[RizeList][241]&lt;[Transaction][260]>>** A promise that returns a Transaction List if resolved.
...
-   `uid` **[string][235]** Rize-generated unique transaction id
...
Returns **[Promise][236]&lt;[Transaction][260]>** A promise that returns a Transaction if resolved.
...
Returns **[Promise][236]&lt;[RizeList][241]&lt;TransactionEvent>>** A promise that returns a TransactionEvent List if resolved.
...
-   `uid` **[string][235]** Rize-generated unique transaction event id
...
Returns **[Promise][236]&lt;TransactionEvent>** A promise that returns a Transaction Event if resolved.
...
-   `query` **[SyntheticLineItemListQuery][261]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][236]&lt;[RizeList][241]&lt;[SyntheticLineItem][262]>>** A promise that returns a Synthetic Line Item List if resolved.
...
-   `uid` **[string][235]** Rize-generated unique Synthetic Line Item id
...
Returns **[Promise][236]&lt;[SyntheticLineItem][262]>** A promise that returns a Synthetic Line Item if resolved.

### getCustodialLineItemList

#### Parameters

-   `query` **[CustodialLineItemListQuery][263]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][236]&lt;[RizeList][241]&lt;[CustodialLineItem][264]>>** A promise that returns a Custodial Line Item List if resolved.
...
-   `uid` **[string][235]** Rize-generated unique Custodial Line Item id
...
Returns **[Promise][236]&lt;[CustodialLineItem][264]>** A promise that returns a Custodial Line Item if resolved.
...
-   `query` **[TransferListQuery][265]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][236]&lt;[RizeList][241]&lt;[Transfer][266]>>** A promise that returns a Transfer List if resolved.
...
-   `uid` **[string][235]** Rize-generated unique Transfer id
...
Returns **[Promise][236]&lt;[Transfer][266]>** A promise that returns a Transfer if resolved.
...
-   `externalUid` **[string][235]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `sourceSyntheticAccountUid` **[string][235]** Synthetic Account to pull asset from. Must be an active liability or external-type account. Cannot be equal to `destination_synthetic_account_uid`.
-   `destinationSyntheticAccountUid` **[string][235]** Synthetic Account where the asset should land. Must be an active liability or external-type account. Cannot be equal to `source_synthetic_account_uid`.
-   `initiatingCustomerUid` **[string][235]** 
-   `usTransferAmount` **[string][235]** The USD amount to transfer.
...
-   `total_count` **[number][268]** Total count of items available to retrieve
-   `count` **[number][268]** Number of items retrieved
-   `limit` **[number][268]** Maximum number of items to retrieve
-   `offset` **[number][268]** Index of the first item to retrieve
-   `data` **[Array][269]&lt;T>** 
...
-   `street1` **[string][235]** 
-   `street2` **([string][235] | null)?** 
-   `city` **[string][235]** 
-   `state` **[string][235]** 
-   `postal_code` **[string][235]** 
...
-   `accepted_quantity` **[number][268]** 
-   `begun_at` **[string][235]** The DateTime at which this Compliance Workflow was requested
-   `completed_step` **[number][268]** 
-   `current_step` **[number][268]** 
...
-   `email` **[string][235]** 
-   `external_uid` **[string][235]** A Customer identifier supplied by the Client, unique among the collection of all Client Customers
-   `uid` **[string][235]** A UID referring to the Customer
...
-   `external_storage_name` **[string][235]** Amazon S3 key used to retrieve the contents of a Compliance Document
-   `compliance_document_url` **[string][235]** Amazon S3 URL used to retrieve the contents of a Compliance Document
-   `name` **[string][235]** 
-   `step` **[number][268]** Multiple Compliance Documents are grouped into a Step, and Compliance Documents are presented to a Customer, Step-by-Step
-   `version` **[number][268]** 
-   `uid` **[string][235]** A UID referring to a Compliance Document; note that this UID will be different for each Customer
-   `accepted_at` **[string][235]** The DateTime at which this Compliance Document was acknowledged
...
-   `documentUid` **[string][235]** A UID referring to the Compliance Document being acknowledged.
-   `accept` **(`"yes"` \| `"no"`)** An indication of acceptance or rejection.
-   `userName` **[string][235]?** A label associated with the Customer (required for electronic signing).
-   `ipAddress` **[string][235]?** A numerical label assigned to each device connected to a computer network that uses the Internet Protocol for communication (required for electronic signing); in this case, the label associated with the computer used by the Customer.
...
-   `uid` **[string][235]** A unique identifier generated by Rize.
-   `summary` **[ComplianceWorkflowSummary][270]** 
-   `customer` **[ComplianceWorkflowCustomer][271]** 
-   `accepted_documents` **[Array][269]&lt;[ComplianceDocument][272]>** 
-   `current_step_documents_pending` **[Array][269]&lt;Omit&lt;[ComplianceDocument][272], `"accepted_at"`>>** Compliance Documents that await acknowledgment in the current Step
-   `all_documents` **[Array][269]&lt;Omit&lt;[ComplianceDocument][272], (`"accepted_at"` \| `"uid"`)>>** The set of all Compliance Documents that would require acknowledgment
...
-   `error_code` **[string][235]** 
-   `error_name` **[string][235]** 
-   `error_description` **[string][235]** 
...
-   `uid` **[string][235]** A unique identifier generated by Rize
-   `external_uid` **[string][235]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `customer_uid` **[string][235]** A UID referring to the customer this Custodial Account belongs to
-   `pool_uid` **[Array][269]&lt;[string][235]>** A UID referring to the pool this Custodial Account belongs to
-   `program_service_offering_uid` **([string][235] | null)** A UID referring to the specific Program Service Offering for which this account was created. Nullable if asset.
...
-   `liability` **[boolean][273]** Liability or asset. Liability Custodial Accounts represent real accounts at Financial Institutions. Asset accounts are used for accounting purposes and may be generated by Rize during events such as new custodial account creations or new external account connections.
-   `name` **([string][235] | null)** A friendly name used to identify the account at the Custodial Partner.
-   `primary_account` **[boolean][273]** The date and time when the Customer was locked. This field will be null if and only if the lock_reason is null.
...
-   `account_errors` **[Array][269]&lt;[AccountError][274]>** A list of errors related to this account. These are passed through during interactions with the underlying Custodial Partner and can help with resolving customer issues. Only provided for accounts that are in an error or manual_review status.
-   `net_usd_balance` **[string][235]** The current settled balance of this Custodial Account in US Dollars
-   `net_usd_pending_balance` **[string][235]** The sum of all pending transactions for this Custodial Account in US Dollars
-   `net_usd_available_balance` **[string][235]** The balance available to spend calculated as Normal balance less any withdrawals. Pending deposits are not included
-   `account_number` **([string][235] | null)** The ACH account number that can be used to make transfers into/out of this account. Nullable if asset.
-   `account_number_masked` **([string][235] | null)** Last 4 digits of the ACH account number. Nullable if asset.
-   `routing_number` **([string][235] | null)** The ABA routing number associated with the Custodial Partner. Nullable if asset.
-   `opened_at` **[Date][275]** The DateTime at which this account was created
-   `closed_at` **[Date][275]** The DateTime at which this account was closed
...
-   `customer_uid` **[Array][269]&lt;[string][235]>?** Filter by Customer. Multiple values are allowed
-   `external_uid` **[string][235]?** A unique, immutable id provided Clien
-   `limit` **[string][235]?**  Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[string][235]?** Index of the items to start retrieving from. Default: 0
-   `liability` **[string][235]?** Filter by liability or asset
-   `type` **[Array][269]&lt;[string][235]>?** Filter by type. Multiple values are allowed.
...
-   `first_name` **[string][235]** 
-   `middle_name` **([string][235] | null)?** 
-   `last_name` **[string][235]** 
-   `suffix` **([string][235] | null)?** 
-   `phone` **[string][235]** 
-   `ssn` **[string][235]** 
-   `dob` **[string][235]** 
-   `address` **[Address][247]** 
...
-   `uid` **[string][235]** A unique identifier generated by Rize
-   `external_uid` **[string][235]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `program_uid` **[string][235]** A uid referring to the program this customer belongs to.
-   `pool_uids` **[Array][269]&lt;[string][235]>** A list of uids referring to Pools belonging to this Customer.
-   `email` **[string][235]** Email of the customer
...
-   `total_balance` **[string][235]** Total asset owned by the customer in US dollars.
-   `created_at` **[Date][275]** 
-   `locked_at` **([Date][275] | null)?** The date and time when the Customer was locked. This field will be null if and only if the lock_reason is null.
-   `lock_reason` **([string][235] | null)?** The lock reason provided by the Client, an admin User, or the system at the time the Customer was locked. This field will be null if and only if the locked_at is null.
-   `details` **[CustomerDetails][244]** An object containing the supplied identifying information for the Customer.
...
-   `include_initiated` **[boolean][273]?** By default, Customers in initiated status are not shown, even if the `status=initiated` parameter is provided. In order for Customers with status initiated to appear in search results, parameters must include `include_initiated=true`.
...
-   `first_name` **[string][235]?** Only return Customers with a first name matching exactly what is submitted
-   `last_name` **[string][235]?** Only return Customers with a last name matching exactly what is submitted
-   `email` **[string][235]?** Only return Customers with an email address matching exactly what is submitted
-   `locked` **[boolean][273]?** Only return locked Customers if true and only return unlocked Customers if false
-   `program_uid` **[string][235]?** Only return Customers belonging to the submitted Program.
-   `external_uid` **[string][235]?** A unique, immutable id provided by Client.
-   `pool_uid` **[Array][269]&lt;[string][235]>?** Filter by pool. Multiple values are allowed.
-   `limit` **[string][235]?**  Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[string][235]?** Index of the items to start retrieving from. Default: 0
...
-   `uid` **[string][235]** A unique identifier generated by Rize
-   `external_uid` **[string][235]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `customer_uid` **[string][235]** A UID referring to the Customer who owns this Card.
-   `pool_uid` **[string][235]** A UID referring to the Pool to which this Card belongs.
-   `synthetic_account_uid` **[string][235]** A UID referring to the specific Synthetic Account to which this Card belongs. Any debit or credit transactions from this Card will occur in this account.
-   `custodial_account_uid` **[string][235]** A UID referring to the specific Custodial Account to which this Card belongs. Any debit or credit transactions from this Card will occur in this account.
-   `card_last_four_digits` **([string][235] | null)?** Last 4 digits of the Debit Card number to aid in indentifying the Card. Null if the Card is not yet issued (i.e. status is `initiated`).
...
-   `ready_to_use` **[boolean][273]** If the Card can be used, this value will be `true`; `false` otherwise.
-   `lock_reason` **([string][235] | null)?** If the Card is in a locked state, this field will be populated describing why the Card was locked. Null if the Card is not locked.
-   `issued_on` **([string][235] | null)?** The date this Card was issued. It may be briefly null when a new Card is requested, but the issuance has not yet happened (i.e. status is `initiated`).
-   `locked_at` **([string][235] | null)?** The date and time at which this Card was locked. Null if the Card is not locked.
-   `closed_at` **([string][235] | null)?** The date and time at which this Card was closed. This field will be null unless the `status` is `closed`, `closed_by_administrator`, `lost`, or `stolen`.
-   `latest_shipping_address` **([Address][247] | null)?** An optional field used to specify the shipping address for a physical Debit Card.If no address was specified via `debitCard.create`, this field will be null. In case of reissuance, only the address from the latest shipment will be provided, if any.
...
-   `customer_uid` **[Array][269]&lt;[string][235]>?** Filter by Customer. Multiple values are allowed.
-   `external_uid` **[string][235]?** A unique, immutable id provided Client
-   `limit` **[string][235]?**  Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[string][235]?** Index of the items to start retrieving from. Default: 0
-   `pool_uid` **[Array][269]&lt;[string][235]>?** Filter by pool. Multiple values are allowed.
-   `locked` **[boolean][273]?** Only return locked Cards if `true` and only return unlocked Cards if `false`
...
-   `uid` **[string][235]** A unique identifier generated by Rize
-   `document_type` **[string][235]** The document type. Only monthly statements are currently available.
...
-   `period_started_at` **[string][235]** The date and time when the document period started at, inclusive
-   `period_ended_at` **[string][235]** The date and time when the document period ended at, exclusive
-   `created_at` **[string][235]** The date and time when the document became available
-   `customer_uids` **[Array][269]&lt;[string][235]>** A list of UIDs of Customers that are associated with the document.(not implemented) Note that once we allow joint pool and accounts, this list will be pessimistic; each
...
-   `custodial_account_uids` **[Array][269]&lt;[string][235]>** A list of UIDs of Custodial Accounts that are associated with the document.If `scope_type` is `custodial_account`, this list will contain only one UID. In fact, currently as implemented,
    this list should always have exactly one UID.
-   `synthetic_account_uids` **[Array][269]&lt;[string][235]>** A list of UIDs of Synthetic Accounts that are associated with the document.If `scope_type` is `synthetic_account`, this list will contain only one UID.
...
-   `month` **[number][268]?** Filter by month. This includes any document for which the period started in the specified month.
-   `year` **[number][268]?** Filter by year
-   `scope_type` **(`"customer"` \| `"synthetic_account"` \| `"custodial_account"`)?** (not implemented) Filter by scope type
-   `custodial_account_uid` **[string][235]?** Filter by Custodial Account
-   `customer_uid` **[Array][269]&lt;[string][235]>?** Filter by Customer. Multiple values are allowed.
-   `synthetic_account_uid` **[Array][269]&lt;[string][235]>?** Filter by Synthetic Account. Multiple values are allowed.
-   `limit` **[number][268]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default = 100.
-   `offset` **[number][268]?** Index of the items to start retrieving from. Default = 0.
...
-   `customer_uid` **[Array][269]&lt;[string][235]>?** Filter by Customer. Multiple values are allowed
-   `latest` **[boolean][273]?** Return only the latest evaluation
...
-   `filename` **[string][235]** The name of this file, exclusive of any extension.
-   `note` **[string][235]** A note describing the document.
-   `extension` **[string][235]** The filename extension.
-   `created_at` **[string][235]** 
...
-   `uid` **[string][235]** A unique identifier generated by Rize
-   `name` **[string][235]** A unique name to identify the resource
...
-   `description` **[string][235]** A description outlining the intended use and requirements for this program's instance of the synthetic_account_type
-   `program_uid` **[string][235]?** A uid referring to the Program this synthetic_account_type belongs to
...
-   `program_uid` **[string][235]?** Only list Synthetic Account Types that are available to be used by the given Program
-   `limit` **[number][268]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[number][268]?** Index of the items to start retrieving from. Default: 0
...
-   `external_uid` **[string][235]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `name` **[string][235]** A unique name to identify the resource.
-   `pool_uid` **[string][235]** A UID referring to the pool this Synthetic Account belongs to.
-   `synthetic_account_type_uid` **[string][235]** A UID referring to the Synthetic Account Type this Synthetic Account should be created as.
...
-   `liability` **[boolean][273]** Liability or asset. Any Synthetic Account created via POST /synthetic_accounts is a liability account, except for external accounts. Some asset Synthetic Accounts are automatically created by Rize during Customer onboarding for accounting purposes.
-   `net_usd_balance` **[string][235]** The current settled balance of this account in US Dollars. This field will be null for synthetic_account_types in the external category.
-   `net_usd_pending_balance` **[string][235]** The sum of all pending transactions for this account in US Dollars. This field will be null for Synthetic Account Types in the external category.
-   `net_usd_available_balance` **[string][235]** The balance available to spend calculated as the settled balance less any pending withdrawals Pending deposits are not included. This field will be null for Synthetic Account Types in the external category.
-   `master_account` **[boolean][273]** Used to identify the Master Synthetic Accounts that exist for every Program Customer. Master Synthetic Accounts are the default accounts where any unknown custodial transactions will settle and cannot be archived while a Program Customer is still active.
-   `account_number` **([string][235] | null)** The ACH account number (if any) associated with this account. Some Synthetic Account Types require this field to be submitted along with the POST request. For example, any Synthetic Account Type from the `external` category will require an `account_number`. Submitting an `account_number` with a Synthetic Account Type that does not require one will result in the account number being ignored.
-   `account_number_last_four` **([string][235] | null)** Last 4 digits of the ACH account number.
-   `routing_number` **([string][235] | null)** The ABA routing number (if any) associated with this account. Some Synthetic Account Types require this field to be submitted along with the POST request. For example, any Synthetic Account Type from the `external` category will require a `routing_number`. Submitting a `routing_number` with a Synthetic Account Type that does not require one will result in the routing number being ignored.
-   `opened_at` **[string][235]** The DateTime at which this account was created
-   `closed_at` **([string][235] | null)** The DateTime at which this account was closed. This value will be present if the status is `archived` or `failed`.
-   `closed_to_synthetic_account_uid` **([string][235] | null)** A UID referring to the Synthetic Account where the funds in this account were transferred when closed. Any transactions issued against this account after it is closed will instead go to the `closed_to` account
...
-   `customer_uid` **[Array][269]&lt;[string][235]>?** Filter by Customer. Multiple string values are allowed.
-   `external_uid` **[string][235]?** A unique, immutable id provided Client
-   `pool_uid` **[Array][269]&lt;[string][235]>?** Filter by pool. Multiple string values are allowed.
-   `limit` **[number][268]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[number][268]?** Index of the items to start retrieving from. Default: 0
-   `synthetic_account_type_uid` **[string][235]?** Filter by Synthetic Account Type
-   `synthetic_account_category` **(`"general"` \| `"external"` \| `"plaid_external"`)?** Filter by Synthetic Account Category
-   `liability` **[boolean][273]?** Filter by liability or asset
...
-   `externalUid` **([string][235] | null)?** A unique identifier Client supplies
-   `name` **([string][235] | null)?** A unique name to identify the resource
-   `poolUid` **([string][235] | null)?** A UID referring to the pool this Synthetic Account belongs to
-   `syntheticAccountTypeUid` **([string][235] | null)?** A UID referring to the Synthetic Account Type this Synthetic Account should be created as
-   `accountNumber` **([string][235] | null)?** The ACH account number (if any) associated with this account. Some Synthetic Account Types require this field to be submitted along with the POST request. For example, any Synthetic Account Type from the `external` category will require an `account_number`. Submitting an `account_number` with a Synthetic Account Type that does not require one will result in the account number being ignored.
-   `routingNumber` **([string][235] | null)?** The ABA routing number (if any) associated with this account. Some Synthetic Account Types require this field to be submitted along with the POST request. For example, any Synthetic Account Type from the `external` category will require a `routing_number`. Submitting a `routing_number` with a Synthetic Account Type that does not require one will result in the routing number being ignored.
...
-   `uid` **[string][235]** A unique identifier generated by Rize
-   `id` **[number][268]** A unique numeric identifier that indicates the order in which the Transactions were created
-   `settled_index` **([number][268] | null)?** A unique index that indicates the order in which the Transactions were settled. Null if status is `queued` or `pending`.
-   `transfer_uid` **([number][268] | null)?** The UID of the Transfer this Transaction is associated with, if any.
-   `source_synthetic_account_uid` **[string][235]** Synthetic Account from where the asset is pulled
-   `destination_synthetic_account_uid` **[string][235]** Synthetic Account where the asset is landed
-   `transaction_event_uids` **[Array][269]&lt;[string][235]>** A list of UIDS referring to Transaction Events belonging to this Transaction, if any. 
...
-   `custodial_account_uids` **[Array][269]&lt;[string][235]>** A list of UIDS referring to Custodial Accounts that are so far invovled in this Transaction. 
...
-   `us_dollar_amount` **[string][235]** The amount will never be negative
...
-   `description` **[string][235]** 
-   `created_at` **[string][235]** The date and time when the Transaction is first recognized by Rize. This may be when the Transfer is initiated if the Transaction is associated with one.
-   `settled_at` **[string][235]** The date and time when the Transaction is settled.
...
-   `customer_uid` **[Array][269]&lt;[string][235]>?** Filter by Customer.
-   `source_synthetic_account_uid` **[Array][269]&lt;[string][235]>?** Filter by source Synthetic Account.
-   `destination_synthetic_account_uid` **[Array][269]&lt;[string][235]>?** Filter by destination Synthetic Account.
-   `synthetic_account_uid` **[Array][269]&lt;[string][235]>?** Filter by Synthetic Account, source or destination.
-   `type` **[Array][269]&lt;(`"atm_withdrawal"` \| `"card_purchase"` \| `"card_refund"` \| `"dispute"` \| `"external_transfer"` \| `"fee"` \| `"internal_transfer"` \| `"other"` \| `"reversed_transfer"` \| `"third_party_transfer"`)>?** Filter by type.
-   `status` **[Array][269]&lt;(`"queued"` \| `"pending"` \| `"settled"` \| `"failed"`)>?** Filter by status.
-   `search_description` **[string][235]?** Attempts to search for the provided string in the description field. '\*' can be used as a wildcard. Any record with a match will be returned.
-   `limit` **[number][268]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default = 100.
-   `offset` **[number][268]?** Index of the items to start retrieving from. Default = 0.
...
-   `uid` **[string][235]** A unique identifier generated by Rize
-   `settled_index` **[number][268]** A unique index that indicates the order in which Transaction Events were settled
-   `transaction_uid` **[string][235]** UID of the Transaction this line item belongs to
-   `phase` **[number][268]** Some Transfer types will trigger multiple transfers at the custodial level. Some of these custodial transfers must wait for all dependent custodial transfers to complete before initiating. Transaction Events with `phase` value 1 are recorded for the first set of custodial transfers that get initiated after the (Synthetic) Transfer starts. Custodial transfers in later phases cannot initiate before all events from previous phases are settled.
-   `source_custodial_account_uid` **[string][235]** Custodial Account from which the asset is pulled
-   `destination_custodial_account_uid` **[string][235]** Custodial Account where the asset lands
-   `custodial_line_item_uids` **[Array][269]&lt;[string][235]>** A list of UIDS referring to Custodial Line Items belonging to this event. There are always at least two line items if the status is `settled`.
-   `status` **[string][235]** 
-   `us_dollar_amount` **[string][235]** The amount will never be negative
...
-   `description` **[string][235]** 
-   `created_at` **[string][235]** The date and time when the event is first recognized by Rize. This may be when the Transfer is initiated if the event is associated with one.
-   `settled_at` **[string][235]** The date and time when the event is settled.
    //\*\*
-   `source_custodial_account_uid` **[Array][269]&lt;[string][235]>?** Filter by source Custodial Account.
-   `destination_custodial_account_uid` **[Array][269]&lt;[string][235]>?** Filter by destination Custodial Account.
-   `custodial_account_uid` **[Array][269]&lt;[string][235]>?** Filter by Custodial Account, source or destination.
-   `type` **[Array][269]&lt;(`"odfi_ach_deposit"` \| `"odfi_ach_withdrawal"` \| `"rdfi_ach_deposit"` \| `"rdfi_ach_withdrawal"`)>?** Filter by type. Multiple values are allowed.
-   `transaction_uid` **[Array][269]&lt;[string][235]>?** Filter by Transaction. Multiple values are allowed
-   `limit` **[number][268]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default = 100.
-   `offset` **[number][268]?** Index of the items to start retrieving from. Default = 0.
...
-   `uid` **[string][235]** A unique identifier generated by Rize
-   `settled_index` **[number][268]** A unique index that indicates the order in which the Synthetic Line Items were settled
-   `transaction_uid` **[string][235]** UID of the Transaction this Synthetic Line Item belongs to
-   `synthetic_account_uid` **[string][235]** UID of the Synthetic Account this Synthetic Line Item is associated with
-   `status` **[string][235]** 
-   `us_dollar_amount` **[string][235]** The signed USD amount of this specific Synthetic Line Item
-   `running_us_dollar_balance` **[string][235]** The Synthetic Account balance after this Synthetic Line Item was settled
-   `description` **[string][235]** Human-readable description in context of Synthetic Accounts
-   `created_at` **[string][235]** The date and time when the Synthetic Line Item is first recognized by Rize. This may be when the Transfer is initiated if the Synthetic Line Item is associated with one.
-   `settled_at` **[string][235]** The date and time when the Synthetic Line Item is settled
...
-   `customer_uid` **[Array][269]&lt;[string][235]>?** Filter by Customer.
-   `pool_uid` **[Array][269]&lt;[string][235]>?** Filter by pool.
-   `synthetic_account_uid` **[Array][269]&lt;[string][235]>?** Filter by Synthetic Account.
-   `limit` **[number][268]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default = 100.
-   `offset` **[number][268]?** Index of the items to start retrieving from. Default = 0.
-   `transaction_uid` **[Array][269]&lt;[string][235]>?** Filter by Transaction.
-   `status` **[Array][269]&lt;(`"begun"` \| `"failed"` \| `"in_progress"` \| `"settled"`)>?** Filter by status.
...
-   `uid` **[string][235]** A unique identifier generated by Rize.
-   `settled_index` **[number][268]** A unique index that indicates the order in which the Custodial Line Items were settled.
-   `transaction_uid` **[string][235]** UID of the Transaction this Custodial Line Item belongs to.
-   `transaction_event_uid` **[string][235]** UID of the Transaction Event this Custodial Line Item belongs to.
-   `custodial_account_uid` **[string][235]** UID of the Custodial Account this Custodial Line Item is associated with.
-   `status` **[string][235]** 
-   `us_dollar_amount` **[string][235]** The signed USD amount of this specific Custodial Line Item
-   `running_us_dollar_balance` **([string][235] | null)?** US dollar balance of the Custodial Account as of the completion of this Custodial Line Item. This field may be empty unless the status is `settled` or `voided`.
-   `type` **[string][235]** Symbols and/or numbers that represent different types of Custodial Line Items.
-   `description` **[string][235]** Descriptions pulled from the custodians, such as through NACHA description or ISO-8583 data element 43.
-   `created_at` **[string][235]** The date and time when the Custodial Line Items is first recognized by Rize. This may be when the Transfer is initiated if the Custodial Line Item is associated with one.
-   `occurred_at` **[string][235]** This field may be empty if status is not settled or voided.
-   `settled_at` **[string][235]** The date and time when the Custodial Line Item is settled.
...
-   `customer_uid` **[Array][269]&lt;[string][235]>?** Filter by Customer.
-   `custodial_account_uid` **[Array][269]&lt;[string][235]>?** Filter by Custodial Account.
-   `status` **[Array][269]&lt;(`"settled"` \| `"voided"`)>?** Filter by status.
-   `us_dollar_amount_tax` **[number][268]?** Return any records having a us_dollar_amount at or below us_dollar_amount_max.
-   `us_dollar_amount_min` **[number][268]?** Return any records having a us_dollar_amount at or above us_dollar_amount_min.
-   `transaction_event_uid` **[Array][269]&lt;[string][235]>?** Filter by Transaction Event.
-   `transaction_uid` **[Array][269]&lt;[string][235]>?** Filter by Transaction.
-   `limit` **[number][268]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default = 100.
-   `offset` **[number][268]?** Index of the items to start retrieving from. Default = 0.
-   `sort` **(`"created_at_asc"` \| `"created_at_desc"` \| `"description_asc"` \| `"description_desc"` \| `"settled_index_asc"` \| `"settled_index_desc"` \| `"us_dollar_amount_asc"` \| `"us_dollar_amount_desc"`)?** 
...
-   `uid` **[string][235]** A unique identifier generated by Rize.
-   `external_uid` **[string][235]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `source_synthetic_account_uid` **[string][235]** Synthetic Account to pull asset from. Must be an active liability or external-type account. Cannot be equal to `destination_synthetic_account_uid`.
-   `destination_synthetic_account_uid` **[string][235]** Synthetic Account where the asset should land. Must be an active liability or external-type account. Cannot be equal to `source_synthetic_account_uid`.
-   `initiating_customer_uid` **[string][235]** 
-   `usd_transfer_amount` **[string][235]** The USD amount to transfer
...
-   `timeout` **[number][268]?** Specifies the number of milliseconds before the each request times out. (Default: 80000)
...
-   `programUid` **[string][235]** The Rize Program ID.
-   `hmac` **[string][235]** The HMAC that will be used to sign the JSON web signature in order to get access to the API.
-   `options` **[RizeOptions][276]?** Configuration options (optional, default `RizeOptions`)
...
Type: [ComplianceWorkflowService][277]
...
Type: [SyntheticAccountService][279]
...
Type: [CustodialAccountService][280]
...
[123]: #gettransactioneventlist

[124]: #parameters-38

[125]: #examples-37

[126]: #gettransactionevent

[127]: #parameters-39

[128]: #examples-38

[129]: #getsyntheticlineitemlist

[130]: #parameters-40

[131]: #examples-39

[132]: #getsyntheticlineitem

[133]: #parameters-41

[134]: #examples-40

[135]: #getcustodiallineitemlist

[136]: #parameters-42

[137]: #examples-41

[138]: #getcustodiallineitem
...
[159]: #complianceworkflowcustomer
...
[169]: #custodialaccount

[170]: #properties-9

[171]: #custodialaccountlistquery
...
[181]: #debitcardlistquery

[182]: #properties-15

[183]: #debit-cardtypedefs

[184]: #document

[185]: #properties-16

[186]: #documentlistquery
...
[194]: #syntheticaccounttype

[195]: #properties-21

[196]: #syntheticaccounttypelistquery

[197]: #properties-22

[198]: #syntheticaccount

[199]: #properties-23

[200]: #syntheticaccountlistquery

[201]: #properties-24

[202]: #syntheticaccountcreaterequest
...
[206]: #transactionlistquery

[207]: #properties-27

[208]: #syntheticlineitem

[209]: #properties-28

[210]: #syntheticlineitemlistquery
...
[214]: #custodiallineitemlistquery
...
[224]: #complianceworkflow-1

[225]: #customer-1

[226]: #syntheticaccount-1

[227]: #custodialaccount-1
...
[237]: #complianceworkflow

[238]: #compliancedocumentacknowledgementrequest

[239]: #custodialaccount

[240]: #custodialaccountlistquery

[241]: #rizelist

[242]: #customerlistquery
...
[248]: #documentlistquery

[249]: #document

[250]: #evaluationlistquery
...
[255]: #syntheticaccount

[256]: #syntheticaccountcreaterequest

[257]: #syntheticaccounttypelistquery

[258]: #syntheticaccounttype

[259]: #transactionlistquery

[260]: #transaction

[261]: #syntheticlineitemlistquery

[262]: #syntheticlineitem

[263]: #custodiallineitemlistquery
...
[270]: #complianceworkflowsummary

[271]: #complianceworkflowcustomer

[272]: #compliancedocument

[273]: https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Boolean

[274]: #accounterror

[275]: https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Date

[276]: #rizeoptions

[277]: #complianceworkflowservice

[278]: #customerservice

[279]: #syntheticaccountservice

[280]: #custodialaccountservice

[281]: #transactionservice

[282]: #transferservice

[283]: #documentservice

[284]: #evaluationservice
