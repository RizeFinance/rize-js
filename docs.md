...
-   [TransactionService][110]
    ...
    -   [get][114]
        -   [Parameters][115]
        -   [Examples][116]
    -   [getTransactionEventList][117]
        -   [Parameters][118]
        -   [Examples][119]
    -   [getTransactionEvent][120]
        -   [Parameters][121]
        -   [Examples][122]
    -   [getSyntheticLineItemList][123]
        -   [Parameters][124]
        -   [Examples][125]
    -   [getSyntheticLineItem][126]
        -   [Parameters][127]
        -   [Examples][128]
    -   [getCustodialLineItemList][129]
        -   [Parameters][130]
        -   [Examples][131]
    -   [getCustodialLineItem][132]
        -   [Parameters][133]
        -   [Examples][134]
-   [TransferService][135]
    -   [getList][136]
...
-   [HTTPResponse][151]
    -   [Properties][152]
-   [ComplianceWorkflowSummary][153]
    -   [Properties][154]
-   [ComplianceWorkflowCustomer][155]
    -   [Properties][156]
-   [ComplianceDocument][157]
    -   [Properties][158]
-   [ComplianceDocumentAcknowledgementRequest][159]
    -   [Properties][160]
-   [ComplianceWorkflow][161]
    -   [Properties][162]
-   [AccountError][163]
    -   [Properties][164]
-   [CustodialAccount][165]
    -   [Properties][166]
-   [CustodialAccountListQuery][167]
    -   [Properties][168]
-   [CustomerDetails][169]
    -   [Properties][170]
-   [Customer][171]
    -   [Properties][172]
-   [CustomerListQuery][173]
    -   [Properties][174]
-   [DebitCard][175]
    -   [Properties][176]
-   [DebitCardListQuery][177]
    -   [Properties][178]
-   [debit-card.typedefs][179]
-   [Document][180]
    -   [Properties][181]
-   [DocumentListQuery][182]
    -   [Properties][183]
-   [Evaluation][184]
    -   [Properties][185]
-   [EvaluationListQuery][186]
    -   [Properties][187]
-   [KYCDocument][188]
    -   [Properties][189]
-   [SyntheticAccountType][190]
    -   [Properties][191]
-   [SyntheticAccountTypeListQuery][192]
    -   [Properties][193]
-   [SyntheticAccount][194]
    -   [Properties][195]
-   [SyntheticAccountListQuery][196]
    -   [Properties][197]
-   [SyntheticAccountCreateRequest][198]
    -   [Properties][199]
-   [Transaction][200]
    -   [Properties][201]
-   [TransactionListQuery][202]
    -   [Properties][203]
-   [SyntheticLineItem][204]
    -   [Properties][205]
-   [SyntheticLineItemListQuery][206]
    -   [Properties][207]
-   [CustodialLineItem][208]
    -   [Properties][209]
-   [CustodialLineItemListQuery][210]
    -   [Properties][211]
-   [Transfer][212]
    -   [Properties][213]
-   [TransferListQuery][214]
    -   [Properties][215]
-   [RizeOptions][216]
    -   [Properties][217]
-   [Rize][218]
    -   [Parameters][219]
    -   [complianceWorkflow][220]
    -   [customer][221]
    -   [syntheticAccount][222]
    -   [custodialAccount][223]
    -   [transaction][224]
    -   [transfer][225]
    -   [debitCard][226]
    -   [document][227]
...
-   `customerExternalUid` **[string][231]** A Customer identifier supplied by the Partner, unique among the collection of all partner Customers.
-   `email` **[string][231]** Email address associated with the Customer.
...
Returns **[Promise][232]&lt;[ComplianceWorkflow][233]>** A promise that returns the new Compliance Workflow if resolved.
...
-   `customerExternalUid` **[string][231]** A Customer identifier supplied by the Partner, unique among the collection of all partner Customers.
-   `customerUid` **[string][231]** A UID referring to the Customer generated by Rize
-   `email` **[string][231]** Email address associated with the Customer.

Returns **[Promise][232]&lt;[ComplianceWorkflow][233]>** A promise that returns the new Compliance Workflow entity if resolved.
...
-   `customerUid` **[string][231]** A UID referring to the Customer
...
Returns **[Promise][232]&lt;[ComplianceWorkflow][233]>** A promise that returns the latest Compliance Workflow if resolved.
...
-   `complianceWorkflowUid` **[string][231]** A UID referring to the Compliance Workflow.
-   `customerUid` **[string][231]** A UID referring to the Customer.
-   `documents` **...[ComplianceDocumentAcknowledgementRequest][234]** 
...
Returns **[Promise][232]&lt;[ComplianceWorkflow][233]>** A promise that returns the updated Compliance Workflow if resolved.
...
-   `uid` **[string][231]** Rize-generated unique custodial account id
...
Returns **[Promise][232]&lt;[CustodialAccount][235]>** A promise that returns a Custodial Account if resolved.
...
-   `query` **[CustodialAccountListQuery][236]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][232]&lt;[RizeList][237]&lt;CustodialAccountList>>** A promise that returns a Custodial Account List if resolved.
...
-   `query` **[CustomerListQuery][238]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][232]&lt;[RizeList][237]&lt;[Customer][239]>>** A promise that returns a Customer List if resolved.
...
-   `uid` **[string][231]** Rize-generated unique customer id
...
Returns **[Promise][232]&lt;[Customer][239]>** A promise that returns a Customer if resolved.
...
-   `uid` **[string][231]** Rize-generated unique customer id
-   `email` **[string][231]** Email of the customer
-   `details` **[CustomerDetails][240]** An object containing the supplied identifying information for the Customer
...
Returns **[Promise][232]&lt;[Customer][239]>** A promise that returns the updated Customer if resolved.
...
Returns **[Promise][232]&lt;void>** A promise that returns void if resolved.
...
-   `uid` **[string][231]** Rize-generated unique customer id
-   `lockReason` **[string][231]** The reason that the Customer is being locked must be submitted with the request body.
...
Returns **[Promise][232]&lt;[Customer][239]>** A promise that returns the locked Customer if resolved.
...
-   `uid` **[string][231]** Rize-generated unique customer id
-   `unlockReason` **[string][231]** The reason that the Customer is being unlocked. (optional, default `null`)
...
Returns **[Promise][232]&lt;[Customer][239]>** A promise that returns the unlocked Customer if resolved.
...
-   `query` **[DebitCardListQuery][241]?** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][232]&lt;[RizeList][237]&lt;[DebitCard][242]>>** A promise that returns a Debit Card List if resolved.
...
-   `uid` **[string][231]** Rize-generated unique debitCard id
...
Returns **[Promise][232]&lt;[DebitCard][242]>** A promise that returns a Debit Card if resolved.
...
-   `externalUid` **[string][231]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `customerUid` **[string][231]** A UID referring to the Customer who owns this Card
-   `poolUid` **[string][231]** A UID referring to the Pool to which this Card belongs
-   `shippingAddress` **([Address][243] | null)?** An optional field used to specify the shipping address for a physical Debit Card.Either the whole `address` must be nullable or all fields must be provided, with an except of `street2`, which is nullable.If no address is specified, the primary address associated with the customer will be used as a shipping address. (optional, default `null`)
...
-   `uid` **[string][231]** Rize-generated unique Debit Card id
-   `lockReason` **[string][231]** A lock reason is required to be submitted when locking a Debit Card
...
-   `query` **[DocumentListQuery][244]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][232]&lt;[RizeList][237]&lt;[Document][245]>>** A promise that returns a Document List if resolved.
...
Returns **[Promise][232]&lt;[HTTPResponse][246]>** A promise that returns a downloaded Document if resolved.
...
Returns **[Promise][232]&lt;[string][231]>** A promise that returns a base64-encoded Document string if resolved.
...
Returns **[Promise][232]&lt;[Document][245]>** A promise that returns a Document if resolved.
...
-   `query` **[EvaluationListQuery][247]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][232]&lt;[RizeList][237]&lt;[Evaluation][248]>>** A promise that returns an Evaluation List if resolved.
...
-   `uid` **[string][231]** Rize-generated unique evaluation id
...
Returns **[Promise][232]&lt;[Evaluation][248]>** A promise that returns an Evaluation if resolved.
...
-   `evaluationUid` **[string][231]** An object containing key value pair for getting the results list.
...
Returns **[Promise][232]&lt;[RizeList][237]&lt;[KYCDocument][249]>>** A promise that returns a List of KYC Documents if resolved.
...
-   `uid` **[string][231]** Rize-generated unique KYC Document id
...
Returns **[Promise][232]&lt;[KYCDocument][249]>** A promise that returns a KYC Document Metadata if resolved.
...
-   `query` **[SyntheticAccountListQuery][250]** An object containing key value paris for filtering the result. (optional, default `{}`)
...
Returns **[Promise][232]&lt;[RizeList][237]&lt;[SyntheticAccount][251]>>** A promise that returns the Synthetic Account list if resolved.
...
-   `uid` **[string][231]** Rize-generated unique synthetic account id
...
Returns **[Promise][232]&lt;[SyntheticAccount][251]>** A promise that returns a SyntheticAccount if resolved.

### create

#### Parameters

-   `payload` **[SyntheticAccountCreateRequest][252]** is a JSON object needs to send as body parameters in order to create new synthetic accounts.
...
Returns **[Promise][232]&lt;[RizeList][237]&lt;[SyntheticAccount][251]>>** 
...
Returns **[Promise][232]&lt;[SyntheticAccount][251]>** A promise that returns a Synthetic Account if resolved.
...
-   `query` **[SyntheticAccountTypeListQuery][253]** An object containing key value paris for filtering the result. (optional, default `{}`)
...
Returns **[Promise][232]&lt;[RizeList][237]&lt;[SyntheticAccountType][254]>>** A promise that returns a Synthetic Account Type List if resolved.
...
-   `uid` **[string][231]** Rize-generated unique Synthetic Account Type id
...
Returns **[Promise][232]&lt;[SyntheticAccountType][254]>** A promise that returns a Synthetic Account Type if resolved.
...
-   `query` **[TransactionListQuery][255]?** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][232]&lt;[RizeList][237]&lt;[Transaction][256]>>** A promise that returns a Transaction List if resolved.
...
-   `uid` **[string][231]** Rize-generated unique transaction id
...
Returns **[Promise][232]&lt;[Transaction][256]>** A promise that returns a Transaction if resolved.
...
Returns **[Promise][232]&lt;[RizeList][237]&lt;TransactionEvent>>** A promise that returns a TransactionEvent List if resolved.
...
-   `uid` **[string][231]** Rize-generated unique transaction event id
...
Returns **[Promise][232]&lt;TransactionEvent>** A promise that returns a Transaction Event if resolved.
...
-   `query` **[SyntheticLineItemListQuery][257]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][232]&lt;[RizeList][237]&lt;[SyntheticLineItem][258]>>** A promise that returns a Synthetic Line Item List if resolved.
...
-   `uid` **[string][231]** Rize-generated unique Synthetic Line Item id
...
Returns **[Promise][232]&lt;[SyntheticLineItem][258]>** A promise that returns a Synthetic Line Item if resolved.

### getCustodialLineItemList

#### Parameters

-   `query` **[CustodialLineItemListQuery][259]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][232]&lt;[RizeList][237]&lt;[CustodialLineItem][260]>>** A promise that returns a Custodial Line Item List if resolved.
...
-   `uid` **[string][231]** Rize-generated unique Custodial Line Item id
...
Returns **[Promise][232]&lt;[CustodialLineItem][260]>** A promise that returns a Custodial Line Item if resolved.
...
-   `query` **[TransferListQuery][261]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][232]&lt;[RizeList][237]&lt;[Transfer][262]>>** A promise that returns a Transfer List if resolved.
...
-   `uid` **[string][231]** Rize-generated unique Transfer id
...
Returns **[Promise][232]&lt;[Transfer][262]>** A promise that returns a Transfer if resolved.
...
-   `externalUid` **[string][231]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `sourceSyntheticAccountUid` **[string][231]** Synthetic Account to pull asset from. Must be an active liability or external-type account. Cannot be equal to `destination_synthetic_account_uid`.
-   `destinationSyntheticAccountUid` **[string][231]** Synthetic Account where the asset should land. Must be an active liability or external-type account. Cannot be equal to `source_synthetic_account_uid`.
-   `initiatingCustomerUid` **[string][231]** 
-   `usTransferAmount` **[string][231]** The USD amount to transfer.
...
-   `total_count` **[number][264]** Total count of items available to retrieve
-   `count` **[number][264]** Number of items retrieved
-   `limit` **[number][264]** Maximum number of items to retrieve
-   `offset` **[number][264]** Index of the first item to retrieve
-   `data` **[Array][265]&lt;T>** 
...
-   `street1` **[string][231]** 
-   `street2` **([string][231] | null)?** 
-   `city` **[string][231]** 
-   `state` **[string][231]** 
-   `postal_code` **[string][231]** 
...
-   `data` **[string][231]** Object that contains more information about the response.
-   `headers` **[string][231]** Collection of response headers.
...
-   `accepted_quantity` **[number][264]** 
-   `begun_at` **[string][231]** The DateTime at which this Compliance Workflow was requested
-   `completed_step` **[number][264]** 
-   `current_step` **[number][264]** 
...
-   `email` **[string][231]** 
-   `external_uid` **[string][231]** A Customer identifier supplied by the Client, unique among the collection of all Client Customers
-   `uid` **[string][231]** A UID referring to the Customer
...
-   `external_storage_name` **[string][231]** Amazon S3 key used to retrieve the contents of a Compliance Document
-   `compliance_document_url` **[string][231]** Amazon S3 URL used to retrieve the contents of a Compliance Document
-   `name` **[string][231]** 
-   `step` **[number][264]** Multiple Compliance Documents are grouped into a Step, and Compliance Documents are presented to a Customer, Step-by-Step
-   `version` **[number][264]** 
-   `uid` **[string][231]** A UID referring to a Compliance Document; note that this UID will be different for each Customer
-   `accepted_at` **[string][231]** The DateTime at which this Compliance Document was acknowledged
...
-   `documentUid` **[string][231]** A UID referring to the Compliance Document being acknowledged.
-   `accept` **(`"yes"` \| `"no"`)** An indication of acceptance or rejection.
-   `userName` **[string][231]?** A label associated with the Customer (required for electronic signing).
-   `ipAddress` **[string][231]?** A numerical label assigned to each device connected to a computer network that uses the Internet Protocol for communication (required for electronic signing); in this case, the label associated with the computer used by the Customer.
...
-   `uid` **[string][231]** A unique identifier generated by Rize.
-   `summary` **[ComplianceWorkflowSummary][266]** 
-   `customer` **[ComplianceWorkflowCustomer][267]** 
-   `accepted_documents` **[Array][265]&lt;[ComplianceDocument][268]>** 
-   `current_step_documents_pending` **[Array][265]&lt;Omit&lt;[ComplianceDocument][268], `"accepted_at"`>>** Compliance Documents that await acknowledgment in the current Step
-   `all_documents` **[Array][265]&lt;Omit&lt;[ComplianceDocument][268], (`"accepted_at"` \| `"uid"`)>>** The set of all Compliance Documents that would require acknowledgment
...
-   `error_code` **[string][231]** 
-   `error_name` **[string][231]** 
-   `error_description` **[string][231]** 
...
-   `uid` **[string][231]** A unique identifier generated by Rize
-   `external_uid` **[string][231]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `customer_uid` **[string][231]** A UID referring to the customer this Custodial Account belongs to
-   `pool_uid` **[Array][265]&lt;[string][231]>** A UID referring to the pool this Custodial Account belongs to
-   `program_service_offering_uid` **([string][231] | null)** A UID referring to the specific Program Service Offering for which this account was created. Nullable if asset.
...
-   `liability` **[boolean][269]** Liability or asset. Liability Custodial Accounts represent real accounts at Financial Institutions. Asset accounts are used for accounting purposes and may be generated by Rize during events such as new custodial account creations or new external account connections.
-   `name` **([string][231] | null)** A friendly name used to identify the account at the Custodial Partner.
-   `primary_account` **[boolean][269]** The date and time when the Customer was locked. This field will be null if and only if the lock_reason is null.
...
-   `account_errors` **[Array][265]&lt;[AccountError][270]>** A list of errors related to this account. These are passed through during interactions with the underlying Custodial Partner and can help with resolving customer issues. Only provided for accounts that are in an error or manual_review status.
-   `net_usd_balance` **[string][231]** The current settled balance of this Custodial Account in US Dollars
-   `net_usd_pending_balance` **[string][231]** The sum of all pending transactions for this Custodial Account in US Dollars
-   `net_usd_available_balance` **[string][231]** The balance available to spend calculated as Normal balance less any withdrawals. Pending deposits are not included
-   `account_number` **([string][231] | null)** The ACH account number that can be used to make transfers into/out of this account. Nullable if asset.
-   `account_number_masked` **([string][231] | null)** Last 4 digits of the ACH account number. Nullable if asset.
-   `routing_number` **([string][231] | null)** The ABA routing number associated with the Custodial Partner. Nullable if asset.
-   `opened_at` **[Date][271]** The DateTime at which this account was created
-   `closed_at` **[Date][271]** The DateTime at which this account was closed
...
-   `customer_uid` **[Array][265]&lt;[string][231]>?** Filter by Customer. Multiple values are allowed
-   `external_uid` **[string][231]?** A unique, immutable id provided Clien
-   `limit` **[string][231]?**  Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[string][231]?** Index of the items to start retrieving from. Default: 0
-   `liability` **[string][231]?** Filter by liability or asset
-   `type` **[Array][265]&lt;[string][231]>?** Filter by type. Multiple values are allowed.
...
-   `first_name` **[string][231]** 
-   `middle_name` **([string][231] | null)?** 
-   `last_name` **[string][231]** 
-   `suffix` **([string][231] | null)?** 
-   `phone` **[string][231]** 
-   `ssn` **[string][231]** 
-   `dob` **[string][231]** 
-   `address` **[Address][243]** 
...
-   `uid` **[string][231]** A unique identifier generated by Rize
-   `external_uid` **[string][231]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `program_uid` **[string][231]** A uid referring to the program this customer belongs to.
-   `pool_uids` **[Array][265]&lt;[string][231]>** A list of uids referring to Pools belonging to this Customer.
-   `email` **[string][231]** Email of the customer
...
-   `total_balance` **[string][231]** Total asset owned by the customer in US dollars.
-   `created_at` **[Date][271]** 
-   `locked_at` **([Date][271] | null)?** The date and time when the Customer was locked. This field will be null if and only if the lock_reason is null.
-   `lock_reason` **([string][231] | null)?** The lock reason provided by the Client, an admin User, or the system at the time the Customer was locked. This field will be null if and only if the locked_at is null.
-   `details` **[CustomerDetails][240]** An object containing the supplied identifying information for the Customer.
...
-   `include_initiated` **[boolean][269]?** By default, Customers in initiated status are not shown, even if the `status=initiated` parameter is provided. In order for Customers with status initiated to appear in search results, parameters must include `include_initiated=true`.
...
-   `first_name` **[string][231]?** Only return Customers with a first name matching exactly what is submitted
-   `last_name` **[string][231]?** Only return Customers with a last name matching exactly what is submitted
-   `email` **[string][231]?** Only return Customers with an email address matching exactly what is submitted
-   `locked` **[boolean][269]?** Only return locked Customers if true and only return unlocked Customers if false
-   `program_uid` **[string][231]?** Only return Customers belonging to the submitted Program.
-   `external_uid` **[string][231]?** A unique, immutable id provided by Client.
-   `pool_uid` **[Array][265]&lt;[string][231]>?** Filter by pool. Multiple values are allowed.
-   `limit` **[string][231]?**  Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[string][231]?** Index of the items to start retrieving from. Default: 0
...
-   `uid` **[string][231]** A unique identifier generated by Rize
-   `external_uid` **[string][231]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `customer_uid` **[string][231]** A UID referring to the Customer who owns this Card.
-   `pool_uid` **[string][231]** A UID referring to the Pool to which this Card belongs.
-   `synthetic_account_uid` **[string][231]** A UID referring to the specific Synthetic Account to which this Card belongs. Any debit or credit transactions from this Card will occur in this account.
-   `custodial_account_uid` **[string][231]** A UID referring to the specific Custodial Account to which this Card belongs. Any debit or credit transactions from this Card will occur in this account.
-   `card_last_four_digits` **([string][231] | null)?** Last 4 digits of the Debit Card number to aid in indentifying the Card. Null if the Card is not yet issued (i.e. status is `initiated`).
...
-   `ready_to_use` **[boolean][269]** If the Card can be used, this value will be `true`; `false` otherwise.
-   `lock_reason` **([string][231] | null)?** If the Card is in a locked state, this field will be populated describing why the Card was locked. Null if the Card is not locked.
-   `issued_on` **([string][231] | null)?** The date this Card was issued. It may be briefly null when a new Card is requested, but the issuance has not yet happened (i.e. status is `initiated`).
-   `locked_at` **([string][231] | null)?** The date and time at which this Card was locked. Null if the Card is not locked.
-   `closed_at` **([string][231] | null)?** The date and time at which this Card was closed. This field will be null unless the `status` is `closed`, `closed_by_administrator`, `lost`, or `stolen`.
-   `latest_shipping_address` **([Address][243] | null)?** An optional field used to specify the shipping address for a physical Debit Card.If no address was specified via `debitCard.create`, this field will be null. In case of reissuance, only the address from the latest shipment will be provided, if any.
...
-   `customer_uid` **[Array][265]&lt;[string][231]>?** Filter by Customer. Multiple values are allowed.
-   `external_uid` **[string][231]?** A unique, immutable id provided Client
-   `limit` **[string][231]?**  Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[string][231]?** Index of the items to start retrieving from. Default: 0
-   `pool_uid` **[Array][265]&lt;[string][231]>?** Filter by pool. Multiple values are allowed.
-   `locked` **[boolean][269]?** Only return locked Cards if `true` and only return unlocked Cards if `false`
...
-   `uid` **[string][231]** A unique identifier generated by Rize
-   `document_type` **[string][231]** The document type. Only monthly statements are currently available.
...
-   `period_started_at` **[string][231]** The date and time when the document period started at, inclusive
-   `period_ended_at` **[string][231]** The date and time when the document period ended at, exclusive
-   `created_at` **[string][231]** The date and time when the document became available
-   `customer_uids` **[Array][265]&lt;[string][231]>** A list of UIDs of Customers that are associated with the document.(not implemented) Note that once we allow joint pool and accounts, this list will be pessimistic; each
...
-   `custodial_account_uids` **[Array][265]&lt;[string][231]>** A list of UIDs of Custodial Accounts that are associated with the document.If `scope_type` is `custodial_account`, this list will contain only one UID. In fact, currently as implemented,
    this list should always have exactly one UID.
-   `synthetic_account_uids` **[Array][265]&lt;[string][231]>** A list of UIDs of Synthetic Accounts that are associated with the document.If `scope_type` is `synthetic_account`, this list will contain only one UID.
...
-   `month` **[number][264]?** Filter by month. This includes any document for which the period started in the specified month.
-   `year` **[number][264]?** Filter by year
-   `scope_type` **(`"customer"` \| `"synthetic_account"` \| `"custodial_account"`)?** (not implemented) Filter by scope type
-   `custodial_account_uid` **[string][231]?** Filter by Custodial Account
-   `customer_uid` **[Array][265]&lt;[string][231]>?** Filter by Customer. Multiple values are allowed.
-   `synthetic_account_uid` **[Array][265]&lt;[string][231]>?** Filter by Synthetic Account. Multiple values are allowed.
-   `limit` **[number][264]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default = 100.
-   `offset` **[number][264]?** Index of the items to start retrieving from. Default = 0.
...
-   `customer_uid` **[Array][265]&lt;[string][231]>?** Filter by Customer. Multiple values are allowed
-   `latest` **[boolean][269]?** Return only the latest evaluation
...
-   `filename` **[string][231]** The name of this file, exclusive of any extension.
-   `note` **[string][231]** A note describing the document.
-   `extension` **[string][231]** The filename extension.
-   `created_at` **[string][231]** 
...
-   `uid` **[string][231]** A unique identifier generated by Rize
-   `name` **[string][231]** A unique name to identify the resource
...
-   `description` **[string][231]** A description outlining the intended use and requirements for this program's instance of the synthetic_account_type
-   `program_uid` **[string][231]?** A uid referring to the Program this synthetic_account_type belongs to
...
-   `program_uid` **[string][231]?** Only list Synthetic Account Types that are available to be used by the given Program
-   `limit` **[number][264]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[number][264]?** Index of the items to start retrieving from. Default: 0
...
-   `external_uid` **[string][231]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `name` **[string][231]** A unique name to identify the resource.
-   `pool_uid` **[string][231]** A UID referring to the pool this Synthetic Account belongs to.
-   `synthetic_account_type_uid` **[string][231]** A UID referring to the Synthetic Account Type this Synthetic Account should be created as.
...
-   `liability` **[boolean][269]** Liability or asset. Any Synthetic Account created via POST /synthetic_accounts is a liability account, except for external accounts. Some asset Synthetic Accounts are automatically created by Rize during Customer onboarding for accounting purposes.
-   `net_usd_balance` **[string][231]** The current settled balance of this account in US Dollars. This field will be null for synthetic_account_types in the external category.
-   `net_usd_pending_balance` **[string][231]** The sum of all pending transactions for this account in US Dollars. This field will be null for Synthetic Account Types in the external category.
-   `net_usd_available_balance` **[string][231]** The balance available to spend calculated as the settled balance less any pending withdrawals Pending deposits are not included. This field will be null for Synthetic Account Types in the external category.
-   `master_account` **[boolean][269]** Used to identify the Master Synthetic Accounts that exist for every Program Customer. Master Synthetic Accounts are the default accounts where any unknown custodial transactions will settle and cannot be archived while a Program Customer is still active.
-   `account_number` **([string][231] | null)** The ACH account number (if any) associated with this account. Some Synthetic Account Types require this field to be submitted along with the POST request. For example, any Synthetic Account Type from the `external` category will require an `account_number`. Submitting an `account_number` with a Synthetic Account Type that does not require one will result in the account number being ignored.
-   `account_number_last_four` **([string][231] | null)** Last 4 digits of the ACH account number.
-   `routing_number` **([string][231] | null)** The ABA routing number (if any) associated with this account. Some Synthetic Account Types require this field to be submitted along with the POST request. For example, any Synthetic Account Type from the `external` category will require a `routing_number`. Submitting a `routing_number` with a Synthetic Account Type that does not require one will result in the routing number being ignored.
-   `opened_at` **[string][231]** The DateTime at which this account was created
-   `closed_at` **([string][231] | null)** The DateTime at which this account was closed. This value will be present if the status is `archived` or `failed`.
-   `closed_to_synthetic_account_uid` **([string][231] | null)** A UID referring to the Synthetic Account where the funds in this account were transferred when closed. Any transactions issued against this account after it is closed will instead go to the `closed_to` account
...
-   `customer_uid` **[Array][265]&lt;[string][231]>?** Filter by Customer. Multiple string values are allowed.
-   `external_uid` **[string][231]?** A unique, immutable id provided Client
-   `pool_uid` **[Array][265]&lt;[string][231]>?** Filter by pool. Multiple string values are allowed.
-   `limit` **[number][264]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[number][264]?** Index of the items to start retrieving from. Default: 0
-   `synthetic_account_type_uid` **[string][231]?** Filter by Synthetic Account Type
-   `synthetic_account_category` **(`"general"` \| `"external"` \| `"plaid_external"`)?** Filter by Synthetic Account Category
-   `liability` **[boolean][269]?** Filter by liability or asset
...
-   `externalUid` **([string][231] | null)?** A unique identifier Client supplies
-   `name` **([string][231] | null)?** A unique name to identify the resource
-   `poolUid` **([string][231] | null)?** A UID referring to the pool this Synthetic Account belongs to
-   `syntheticAccountTypeUid` **([string][231] | null)?** A UID referring to the Synthetic Account Type this Synthetic Account should be created as
-   `accountNumber` **([string][231] | null)?** The ACH account number (if any) associated with this account. Some Synthetic Account Types require this field to be submitted along with the POST request. For example, any Synthetic Account Type from the `external` category will require an `account_number`. Submitting an `account_number` with a Synthetic Account Type that does not require one will result in the account number being ignored.
-   `routingNumber` **([string][231] | null)?** The ABA routing number (if any) associated with this account. Some Synthetic Account Types require this field to be submitted along with the POST request. For example, any Synthetic Account Type from the `external` category will require a `routing_number`. Submitting a `routing_number` with a Synthetic Account Type that does not require one will result in the routing number being ignored.
...
-   `uid` **[string][231]** A unique identifier generated by Rize
-   `id` **[number][264]** A unique numeric identifier that indicates the order in which the Transactions were created
-   `settled_index` **([number][264] | null)?** A unique index that indicates the order in which the Transactions were settled. Null if status is `queued` or `pending`.
-   `transfer_uid` **([number][264] | null)?** The UID of the Transfer this Transaction is associated with, if any.
-   `source_synthetic_account_uid` **[string][231]** Synthetic Account from where the asset is pulled
-   `destination_synthetic_account_uid` **[string][231]** Synthetic Account where the asset is landed
-   `transaction_event_uids` **[Array][265]&lt;[string][231]>** A list of UIDS referring to Transaction Events belonging to this Transaction, if any. 
...
-   `custodial_account_uids` **[Array][265]&lt;[string][231]>** A list of UIDS referring to Custodial Accounts that are so far invovled in this Transaction. 
...
-   `us_dollar_amount` **[string][231]** The amount will never be negative
...
-   `description` **[string][231]** 
-   `created_at` **[string][231]** The date and time when the Transaction is first recognized by Rize. This may be when the Transfer is initiated if the Transaction is associated with one.
-   `settled_at` **[string][231]** The date and time when the Transaction is settled.
...
-   `customer_uid` **[Array][265]&lt;[string][231]>?** Filter by Customer.
-   `source_synthetic_account_uid` **[Array][265]&lt;[string][231]>?** Filter by source Synthetic Account.
-   `destination_synthetic_account_uid` **[Array][265]&lt;[string][231]>?** Filter by destination Synthetic Account.
-   `synthetic_account_uid` **[Array][265]&lt;[string][231]>?** Filter by Synthetic Account, source or destination.
-   `type` **[Array][265]&lt;(`"atm_withdrawal"` \| `"card_purchase"` \| `"card_refund"` \| `"dispute"` \| `"external_transfer"` \| `"fee"` \| `"internal_transfer"` \| `"other"` \| `"reversed_transfer"` \| `"third_party_transfer"`)>?** Filter by type.
-   `status` **[Array][265]&lt;(`"queued"` \| `"pending"` \| `"settled"` \| `"failed"`)>?** Filter by status.
-   `search_description` **[string][231]?** Attempts to search for the provided string in the description field. '\*' can be used as a wildcard. Any record with a match will be returned.
-   `limit` **[number][264]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default = 100.
-   `offset` **[number][264]?** Index of the items to start retrieving from. Default = 0.
...
-   `uid` **[string][231]** A unique identifier generated by Rize
-   `settled_index` **[number][264]** A unique index that indicates the order in which Transaction Events were settled
-   `transaction_uid` **[string][231]** UID of the Transaction this line item belongs to
-   `phase` **[number][264]** Some Transfer types will trigger multiple transfers at the custodial level. Some of these custodial transfers must wait for all dependent custodial transfers to complete before initiating. Transaction Events with `phase` value 1 are recorded for the first set of custodial transfers that get initiated after the (Synthetic) Transfer starts. Custodial transfers in later phases cannot initiate before all events from previous phases are settled.
-   `source_custodial_account_uid` **[string][231]** Custodial Account from which the asset is pulled
-   `destination_custodial_account_uid` **[string][231]** Custodial Account where the asset lands
-   `custodial_line_item_uids` **[Array][265]&lt;[string][231]>** A list of UIDS referring to Custodial Line Items belonging to this event. There are always at least two line items if the status is `settled`.
-   `status` **[string][231]** 
-   `us_dollar_amount` **[string][231]** The amount will never be negative
...
-   `description` **[string][231]** 
-   `created_at` **[string][231]** The date and time when the event is first recognized by Rize. This may be when the Transfer is initiated if the event is associated with one.
-   `settled_at` **[string][231]** The date and time when the event is settled.
    //\*\*
-   `source_custodial_account_uid` **[Array][265]&lt;[string][231]>?** Filter by source Custodial Account.
-   `destination_custodial_account_uid` **[Array][265]&lt;[string][231]>?** Filter by destination Custodial Account.
-   `custodial_account_uid` **[Array][265]&lt;[string][231]>?** Filter by Custodial Account, source or destination.
-   `type` **[Array][265]&lt;(`"odfi_ach_deposit"` \| `"odfi_ach_withdrawal"` \| `"rdfi_ach_deposit"` \| `"rdfi_ach_withdrawal"`)>?** Filter by type. Multiple values are allowed.
-   `transaction_uid` **[Array][265]&lt;[string][231]>?** Filter by Transaction. Multiple values are allowed
-   `limit` **[number][264]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default = 100.
-   `offset` **[number][264]?** Index of the items to start retrieving from. Default = 0.
...
-   `uid` **[string][231]** A unique identifier generated by Rize
-   `settled_index` **[number][264]** A unique index that indicates the order in which the Synthetic Line Items were settled
-   `transaction_uid` **[string][231]** UID of the Transaction this Synthetic Line Item belongs to
-   `synthetic_account_uid` **[string][231]** UID of the Synthetic Account this Synthetic Line Item is associated with
-   `status` **[string][231]** 
-   `us_dollar_amount` **[string][231]** The signed USD amount of this specific Synthetic Line Item
-   `running_us_dollar_balance` **[string][231]** The Synthetic Account balance after this Synthetic Line Item was settled
-   `description` **[string][231]** Human-readable description in context of Synthetic Accounts
-   `created_at` **[string][231]** The date and time when the Synthetic Line Item is first recognized by Rize. This may be when the Transfer is initiated if the Synthetic Line Item is associated with one.
-   `settled_at` **[string][231]** The date and time when the Synthetic Line Item is settled
...
-   `customer_uid` **[Array][265]&lt;[string][231]>?** Filter by Customer.
-   `pool_uid` **[Array][265]&lt;[string][231]>?** Filter by pool.
-   `synthetic_account_uid` **[Array][265]&lt;[string][231]>?** Filter by Synthetic Account.
-   `limit` **[number][264]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default = 100.
-   `offset` **[number][264]?** Index of the items to start retrieving from. Default = 0.
-   `transaction_uid` **[Array][265]&lt;[string][231]>?** Filter by Transaction.
-   `status` **[Array][265]&lt;(`"begun"` \| `"failed"` \| `"in_progress"` \| `"settled"`)>?** Filter by status.
...
-   `uid` **[string][231]** A unique identifier generated by Rize.
-   `settled_index` **[number][264]** A unique index that indicates the order in which the Custodial Line Items were settled.
-   `transaction_uid` **[string][231]** UID of the Transaction this Custodial Line Item belongs to.
-   `transaction_event_uid` **[string][231]** UID of the Transaction Event this Custodial Line Item belongs to.
-   `custodial_account_uid` **[string][231]** UID of the Custodial Account this Custodial Line Item is associated with.
-   `status` **[string][231]** 
-   `us_dollar_amount` **[string][231]** The signed USD amount of this specific Custodial Line Item
-   `running_us_dollar_balance` **([string][231] | null)?** US dollar balance of the Custodial Account as of the completion of this Custodial Line Item. This field may be empty unless the status is `settled` or `voided`.
-   `type` **[string][231]** Symbols and/or numbers that represent different types of Custodial Line Items.
-   `description` **[string][231]** Descriptions pulled from the custodians, such as through NACHA description or ISO-8583 data element 43.
-   `created_at` **[string][231]** The date and time when the Custodial Line Items is first recognized by Rize. This may be when the Transfer is initiated if the Custodial Line Item is associated with one.
-   `occurred_at` **[string][231]** This field may be empty if status is not settled or voided.
-   `settled_at` **[string][231]** The date and time when the Custodial Line Item is settled.
...
-   `customer_uid` **[Array][265]&lt;[string][231]>?** Filter by Customer.
-   `custodial_account_uid` **[Array][265]&lt;[string][231]>?** Filter by Custodial Account.
-   `status` **[Array][265]&lt;(`"settled"` \| `"voided"`)>?** Filter by status.
-   `us_dollar_amount_tax` **[number][264]?** Return any records having a us_dollar_amount at or below us_dollar_amount_max.
-   `us_dollar_amount_min` **[number][264]?** Return any records having a us_dollar_amount at or above us_dollar_amount_min.
-   `transaction_event_uid` **[Array][265]&lt;[string][231]>?** Filter by Transaction Event.
-   `transaction_uid` **[Array][265]&lt;[string][231]>?** Filter by Transaction.
-   `limit` **[number][264]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default = 100.
-   `offset` **[number][264]?** Index of the items to start retrieving from. Default = 0.
-   `sort` **(`"created_at_asc"` \| `"created_at_desc"` \| `"description_asc"` \| `"description_desc"` \| `"settled_index_asc"` \| `"settled_index_desc"` \| `"us_dollar_amount_asc"` \| `"us_dollar_amount_desc"`)?** 
...
-   `uid` **[string][231]** A unique identifier generated by Rize.
-   `external_uid` **[string][231]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `source_synthetic_account_uid` **[string][231]** Synthetic Account to pull asset from. Must be an active liability or external-type account. Cannot be equal to `destination_synthetic_account_uid`.
-   `destination_synthetic_account_uid` **[string][231]** Synthetic Account where the asset should land. Must be an active liability or external-type account. Cannot be equal to `source_synthetic_account_uid`.
-   `initiating_customer_uid` **[string][231]** 
-   `usd_transfer_amount` **[string][231]** The USD amount to transfer
...
-   `timeout` **[number][264]?** Specifies the number of milliseconds before the each request times out. (Default: 80000)
...
-   `programUid` **[string][231]** The Rize Program ID.
-   `hmac` **[string][231]** The HMAC that will be used to sign the JSON web signature in order to get access to the API.
-   `options` **[RizeOptions][272]?** Configuration options (optional, default `RizeOptions`)
...
Type: [ComplianceWorkflowService][273]
...
Type: [SyntheticAccountService][275]
...
Type: [CustodialAccountService][276]
...
[117]: #gettransactioneventlist

[118]: #parameters-36

[119]: #examples-35

[120]: #gettransactionevent

[121]: #parameters-37

[122]: #examples-36

[123]: #getsyntheticlineitemlist

[124]: #parameters-38

[125]: #examples-37

[126]: #getsyntheticlineitem

[127]: #parameters-39

[128]: #examples-38

[129]: #getcustodiallineitemlist

[130]: #parameters-40

[131]: #examples-39

[132]: #getcustodiallineitem
...
[153]: #complianceworkflowsummary

[154]: #properties-4

[155]: #complianceworkflowcustomer

[156]: #properties-5

[157]: #compliancedocument

[158]: #properties-6

[159]: #compliancedocumentacknowledgementrequest

[160]: #properties-7

[161]: #complianceworkflow
...
[177]: #debitcardlistquery

[178]: #properties-16

[179]: #debit-cardtypedefs

[180]: #document

[181]: #properties-17

[182]: #documentlistquery
...
[190]: #syntheticaccounttype

[191]: #properties-22

[192]: #syntheticaccounttypelistquery

[193]: #properties-23

[194]: #syntheticaccount

[195]: #properties-24

[196]: #syntheticaccountlistquery

[197]: #properties-25

[198]: #syntheticaccountcreaterequest
...
[202]: #transactionlistquery

[203]: #properties-28

[204]: #syntheticlineitem

[205]: #properties-29

[206]: #syntheticlineitemlistquery

[207]: #properties-30

[208]: #custodiallineitem

[209]: #properties-31

[210]: #custodiallineitemlistquery
...
[220]: #complianceworkflow-1

[221]: #customer-1

[222]: #syntheticaccount-1

[223]: #custodialaccount-1
...
[233]: #complianceworkflow

[234]: #compliancedocumentacknowledgementrequest

[235]: #custodialaccount

[236]: #custodialaccountlistquery

[237]: #rizelist

[238]: #customerlistquery

[239]: #customer

[240]: #customerdetails

[241]: #debitcardlistquery

[242]: #debitcard

[243]: #address

[244]: #documentlistquery

[245]: #document

[246]: #httpresponse

[247]: #evaluationlistquery

[248]: #evaluation

[249]: #kycdocument

[250]: #syntheticaccountlistquery

[251]: #syntheticaccount

[252]: #syntheticaccountcreaterequest

[253]: #syntheticaccounttypelistquery

[254]: #syntheticaccounttype

[255]: #transactionlistquery
...
[259]: #custodiallineitemlistquery

[260]: #custodiallineitem

[261]: #transferlistquery

[262]: #transfer

[263]: https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Object
...
[266]: #complianceworkflowsummary

[267]: #complianceworkflowcustomer

[268]: #compliancedocument

[269]: https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Boolean

[270]: #accounterror

[271]: https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Date

[272]: #rizeoptions

[273]: #complianceworkflowservice

[274]: #customerservice

[275]: #syntheticaccountservice

[276]: #custodialaccountservice

[277]: #transactionservice

[278]: #transferservice

[279]: #documentservice

[280]: #evaluationservice
