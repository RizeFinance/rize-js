...
-   [TransactionService][109]
    ...
    -   [get][113]
        -   [Parameters][114]
        -   [Examples][115]
    -   [getTransactionEventList][116]
        -   [Parameters][117]
        -   [Examples][118]
    -   [getTransactionEvent][119]
        -   [Parameters][120]
        -   [Examples][121]
    -   [getSyntheticLineItemList][122]
        -   [Parameters][123]
        -   [Examples][124]
    -   [getSyntheticLineItem][125]
        -   [Parameters][126]
        -   [Examples][127]
    -   [getCustodialLineItemList][128]
        -   [Parameters][129]
        -   [Examples][130]
    -   [getCustodialLineItem][131]
        -   [Parameters][132]
        -   [Examples][133]
-   [TransferService][134]
    -   [getList][135]
...
-   [HTTPResponse][148]
    -   [Properties][149]
-   [ComplianceWorkflowSummary][150]
    -   [Properties][151]
-   [ComplianceWorkflowCustomer][152]
    -   [Properties][153]
-   [ComplianceDocument][154]
    -   [Properties][155]
-   [ComplianceDocumentAcknowledgementRequest][156]
    -   [Properties][157]
-   [ComplianceWorkflow][158]
    -   [Properties][159]
-   [AccountError][160]
    -   [Properties][161]
-   [CustodialAccount][162]
    -   [Properties][163]
-   [CustodialAccountListQuery][164]
    -   [Properties][165]
-   [CustomerDetails][166]
    -   [Properties][167]
-   [Customer][168]
    -   [Properties][169]
-   [CustomerListQuery][170]
    -   [Properties][171]
-   [DebitCard][172]
    -   [Properties][173]
-   [DebitCardListQuery][174]
    -   [Properties][175]
-   [debit-card.typedefs][176]
-   [Document][177]
    -   [Properties][178]
-   [DocumentListQuery][179]
    -   [Properties][180]
-   [KYCDocument][181]
    -   [Properties][182]
-   [SyntheticAccountType][183]
    -   [Properties][184]
-   [SyntheticAccountTypeListQuery][185]
    -   [Properties][186]
-   [SyntheticAccount][187]
    -   [Properties][188]
-   [SyntheticAccountListQuery][189]
    -   [Properties][190]
-   [SyntheticAccountCreateRequest][191]
    -   [Properties][192]
-   [Transaction][193]
    -   [Properties][194]
-   [TransactionListQuery][195]
    -   [Properties][196]
-   [SyntheticLineItem][197]
    -   [Properties][198]
-   [SyntheticLineItemListQuery][199]
    -   [Properties][200]
-   [CustodialLineItem][201]
    -   [Properties][202]
-   [CustodialLineItemListQuery][203]
    -   [Properties][204]
-   [Transfer][205]
    -   [Properties][206]
-   [TransferListQuery][207]
    -   [Properties][208]
-   [RizeOptions][209]
    -   [Properties][210]
-   [Rize][211]
    -   [Parameters][212]
    -   [complianceWorkflow][213]
    -   [customer][214]
    -   [syntheticAccount][215]
    -   [custodialAccount][216]
    -   [transaction][217]
    -   [transfer][218]
    -   [debitCard][219]
    -   [document][220]
...
-   `customerExternalUid` **[string][223]** A Customer identifier supplied by the Partner, unique among the collection of all partner Customers.
-   `email` **[string][223]** Email address associated with the Customer.
...
Returns **[Promise][224]&lt;[ComplianceWorkflow][225]>** A promise that returns the new Compliance Workflow if resolved.
...
-   `customerExternalUid` **[string][223]** A Customer identifier supplied by the Partner, unique among the collection of all partner Customers.
-   `customerUid` **[string][223]** A UID referring to the Customer generated by Rize
-   `email` **[string][223]** Email address associated with the Customer.

Returns **[Promise][224]&lt;[ComplianceWorkflow][225]>** A promise that returns the new Compliance Workflow entity if resolved.
...
-   `customerUid` **[string][223]** A UID referring to the Customer
...
Returns **[Promise][224]&lt;[ComplianceWorkflow][225]>** A promise that returns the latest Compliance Workflow if resolved.
...
-   `complianceWorkflowUid` **[string][223]** A UID referring to the Compliance Workflow.
-   `customerUid` **[string][223]** A UID referring to the Customer.
-   `documents` **...[ComplianceDocumentAcknowledgementRequest][226]** 
...
Returns **[Promise][224]&lt;[ComplianceWorkflow][225]>** A promise that returns the updated Compliance Workflow if resolved.
...
-   `uid` **[string][223]** Rize-generated unique custodial account id
...
Returns **[Promise][224]&lt;[CustodialAccount][227]>** A promise that returns a Custodial Account if resolved.
...
-   `query` **[CustodialAccountListQuery][228]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][224]&lt;[RizeList][229]&lt;CustodialAccountList>>** A promise that returns a Custodial Account List if resolved.
...
-   `query` **[CustomerListQuery][230]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][224]&lt;[RizeList][229]&lt;[Customer][231]>>** A promise that returns a Customer List if resolved.
...
-   `uid` **[string][223]** Rize-generated unique customer id
...
Returns **[Promise][224]&lt;[Customer][231]>** A promise that returns a Customer if resolved.
...
-   `uid` **[string][223]** Rize-generated unique customer id
-   `email` **[string][223]** Email of the customer
-   `details` **[CustomerDetails][232]** An object containing the supplied identifying information for the Customer
...
Returns **[Promise][224]&lt;[Customer][231]>** A promise that returns the updated Customer if resolved.
...
Returns **[Promise][224]&lt;void>** A promise that returns void if resolved.
...
-   `uid` **[string][223]** Rize-generated unique customer id
-   `lockReason` **[string][223]** The reason that the Customer is being locked must be submitted with the request body.
...
Returns **[Promise][224]&lt;[Customer][231]>** A promise that returns the locked Customer if resolved.
...
-   `uid` **[string][223]** Rize-generated unique customer id
-   `unlockReason` **[string][223]** The reason that the Customer is being unlocked. (optional, default `null`)
...
Returns **[Promise][224]&lt;[Customer][231]>** A promise that returns the unlocked Customer if resolved.
...
-   `query` **[DebitCardListQuery][233]?** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][224]&lt;[RizeList][229]&lt;[DebitCard][234]>>** A promise that returns a Debit Card List if resolved.
...
-   `uid` **[string][223]** Rize-generated unique debitCard id
...
Returns **[Promise][224]&lt;[DebitCard][234]>** A promise that returns a Debit Card if resolved.
...
-   `externalUid` **[string][223]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `customerUid` **[string][223]** A UID referring to the Customer who owns this Card
-   `poolUid` **[string][223]** A UID referring to the Pool to which this Card belongs
...
-   `uid` **[string][223]** Rize-generated unique Debit Card id
-   `lockReason` **[string][223]** A lock reason is required to be submitted when locking a Debit Card
...
-   `query` **[DocumentListQuery][236]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][224]&lt;[RizeList][229]&lt;[Document][237]>>** A promise that returns a Document List if resolved.
...
-   `uid` **[string][223]** Rize-generated unique document id
...
Returns **[Promise][224]&lt;[Document][237]>** A promise that returns a downloaded Document if resolved.
...
Returns **[Promise][224]&lt;[Document][237]>** A promise that returns a Document if resolved.
...
-   `evaluationUid` **[string][223]** An object containing key value pair for getting the results list.
...
Returns **[Promise][224]&lt;[RizeList][229]&lt;[KYCDocument][238]>>** A promise that returns a List of KYC Documents if resolved.
...
-   `evaluationUid` **[string][223]** A uid referring to the evaluation with which this document is associated
-   `filename` **[string][223]** The name of the file to be uploaded
-   `fileContent` **[string][223]** The contents of the file to be uploaded, base64-encoded.
-   `note` **[string][223]** A note describing this document
...
Returns **[Promise][224]&lt;[KYCDocument][238]>** A promise that returns a KYC Document if resolved.
...
-   `uid` **[string][223]** Rize-generated unique KYC Document id
...
Returns **[Promise][224]&lt;[KYCDocument][238]>** A promise that returns a KYC Document Metadata if resolved.
...
Returns **[Promise][224]&lt;[HTTPResponse][239]>** A promise that returns a base64-encoded KYC Document string if resolved.
...
Returns **[Promise][224]&lt;[string][223]>** A promise that returns a base64-encoded KYC Document string if resolved.
...
-   `query` **[SyntheticAccountListQuery][240]** An object containing key value paris for filtering the result. (optional, default `{}`)
...
Returns **[Promise][224]&lt;[RizeList][229]&lt;[SyntheticAccount][241]>>** A promise that returns the Synthetic Account list if resolved.
...
-   `uid` **[string][223]** Rize-generated unique synthetic account id
...
Returns **[Promise][224]&lt;[SyntheticAccount][241]>** A promise that returns a SyntheticAccount if resolved.

### create

#### Parameters

-   `payload` **[SyntheticAccountCreateRequest][242]** is a JSON object needs to send as body parameters in order to create new synthetic accounts.
...
Returns **[Promise][224]&lt;[RizeList][229]&lt;[SyntheticAccount][241]>>** 
...
Returns **[Promise][224]&lt;[SyntheticAccount][241]>** A promise that returns a Synthetic Account if resolved.
...
-   `query` **[SyntheticAccountTypeListQuery][243]** An object containing key value paris for filtering the result. (optional, default `{}`)
...
Returns **[Promise][224]&lt;[RizeList][229]&lt;[SyntheticAccountType][244]>>** A promise that returns a Synthetic Account Type List if resolved.
...
-   `uid` **[string][223]** Rize-generated unique Synthetic Account Type id
...
Returns **[Promise][224]&lt;[SyntheticAccountType][244]>** A promise that returns a Synthetic Account Type if resolved.
...
-   `query` **[TransactionListQuery][245]?** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][224]&lt;[RizeList][229]&lt;[Transaction][246]>>** A promise that returns a Transaction List if resolved.
...
-   `uid` **[string][223]** Rize-generated unique transaction id
...
Returns **[Promise][224]&lt;[Transaction][246]>** A promise that returns a Transaction if resolved.
...
Returns **[Promise][224]&lt;[RizeList][229]&lt;TransactionEvent>>** A promise that returns a TransactionEvent List if resolved.
...
-   `uid` **[string][223]** Rize-generated unique transaction event id
...
Returns **[Promise][224]&lt;TransactionEvent>** A promise that returns a Transaction Event if resolved.
...
-   `query` **[SyntheticLineItemListQuery][247]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][224]&lt;[RizeList][229]&lt;[SyntheticLineItem][248]>>** A promise that returns a Synthetic Line Item List if resolved.
...
-   `uid` **[string][223]** Rize-generated unique Synthetic Line Item id
...
Returns **[Promise][224]&lt;[SyntheticLineItem][248]>** A promise that returns a Synthetic Line Item if resolved.

### getCustodialLineItemList

#### Parameters

-   `query` **[CustodialLineItemListQuery][249]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][224]&lt;[RizeList][229]&lt;[CustodialLineItem][250]>>** A promise that returns a Custodial Line Item List if resolved.
...
-   `uid` **[string][223]** Rize-generated unique Custodial Line Item id
...
Returns **[Promise][224]&lt;[CustodialLineItem][250]>** A promise that returns a Custodial Line Item if resolved.
...
-   `query` **[TransferListQuery][251]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][224]&lt;[RizeList][229]&lt;[Transfer][252]>>** A promise that returns a Transfer List if resolved.
...
-   `uid` **[string][223]** Rize-generated unique Transfer id
...
Returns **[Promise][224]&lt;[Transfer][252]>** A promise that returns a Transfer if resolved.
...
-   `externalUid` **[string][223]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `sourceSyntheticAccountUid` **[string][223]** Synthetic Account to pull asset from. Must be an active liability or external-type account. Cannot be equal to `destination_synthetic_account_uid`.
-   `destinationSyntheticAccountUid` **[string][223]** Synthetic Account where the asset should land. Must be an active liability or external-type account. Cannot be equal to `source_synthetic_account_uid`.
-   `initiatingCustomerUid` **[string][223]** 
-   `usTransferAmount` **[string][223]** The USD amount to transfer.
...
-   `total_count` **[number][254]** Total count of items available to retrieve
-   `count` **[number][254]** Number of items retrieved
-   `limit` **[number][254]** Maximum number of items to retrieve
-   `offset` **[number][254]** Index of the first item to retrieve
-   `data` **[Array][255]&lt;T>** 
...
-   `street1` **[string][223]** 
-   `street2` **([string][223] | null)?** 
-   `city` **[string][223]** 
-   `state` **[string][223]** 
-   `postal_code` **[string][223]** 
...
-   `accepted_quantity` **[number][254]** 
-   `begun_at` **[string][223]** The DateTime at which this Compliance Workflow was requested
-   `completed_step` **[number][254]** 
-   `current_step` **[number][254]** 
...
-   `email` **[string][223]** 
-   `external_uid` **[string][223]** A Customer identifier supplied by the Client, unique among the collection of all Client Customers
-   `uid` **[string][223]** A UID referring to the Customer
...
-   `external_storage_name` **[string][223]** Amazon S3 key used to retrieve the contents of a Compliance Document
-   `compliance_document_url` **[string][223]** Amazon S3 URL used to retrieve the contents of a Compliance Document
-   `name` **[string][223]** 
-   `step` **[number][254]** Multiple Compliance Documents are grouped into a Step, and Compliance Documents are presented to a Customer, Step-by-Step
-   `version` **[number][254]** 
-   `uid` **[string][223]** A UID referring to a Compliance Document; note that this UID will be different for each Customer
-   `accepted_at` **[string][223]** The DateTime at which this Compliance Document was acknowledged
...
-   `documentUid` **[string][223]** A UID referring to the Compliance Document being acknowledged.
-   `accept` **(`"yes"` \| `"no"`)** An indication of acceptance or rejection.
-   `userName` **[string][223]?** A label associated with the Customer (required for electronic signing).
-   `ipAddress` **[string][223]?** A numerical label assigned to each device connected to a computer network that uses the Internet Protocol for communication (required for electronic signing); in this case, the label associated with the computer used by the Customer.
...
-   `uid` **[string][223]** A unique identifier generated by Rize.
-   `summary` **[ComplianceWorkflowSummary][256]** 
-   `customer` **[ComplianceWorkflowCustomer][257]** 
-   `accepted_documents` **[Array][255]&lt;[ComplianceDocument][258]>** 
-   `current_step_documents_pending` **[Array][255]&lt;Omit&lt;[ComplianceDocument][258], `"accepted_at"`>>** Compliance Documents that await acknowledgment in the current Step
-   `all_documents` **[Array][255]&lt;Omit&lt;[ComplianceDocument][258], (`"accepted_at"` \| `"uid"`)>>** The set of all Compliance Documents that would require acknowledgment
...
-   `error_code` **[string][223]** 
-   `error_name` **[string][223]** 
-   `error_description` **[string][223]** 
...
-   `uid` **[string][223]** A unique identifier generated by Rize
-   `external_uid` **[string][223]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `customer_uid` **[string][223]** A UID referring to the customer this Custodial Account belongs to
-   `pool_uid` **[Array][255]&lt;[string][223]>** A UID referring to the pool this Custodial Account belongs to
-   `program_service_offering_uid` **([string][223] | null)** A UID referring to the specific Program Service Offering for which this account was created. Nullable if asset.
...
-   `liability` **[boolean][259]** Liability or asset. Liability Custodial Accounts represent real accounts at Financial Institutions. Asset accounts are used for accounting purposes and may be generated by Rize during events such as new custodial account creations or new external account connections.
-   `name` **([string][223] | null)** A friendly name used to identify the account at the Custodial Partner.
-   `primary_account` **[boolean][259]** The date and time when the Customer was locked. This field will be null if and only if the lock_reason is null.
...
-   `account_errors` **[Array][255]&lt;[AccountError][260]>** A list of errors related to this account. These are passed through during interactions with the underlying Custodial Partner and can help with resolving customer issues. Only provided for accounts that are in an error or manual_review status.
-   `net_usd_balance` **[string][223]** The current settled balance of this Custodial Account in US Dollars
-   `net_usd_pending_balance` **[string][223]** The sum of all pending transactions for this Custodial Account in US Dollars
-   `net_usd_available_balance` **[string][223]** The balance available to spend calculated as Normal balance less any withdrawals. Pending deposits are not included
-   `account_number` **([string][223] | null)** The ACH account number that can be used to make transfers into/out of this account. Nullable if asset.
-   `account_number_masked` **([string][223] | null)** Last 4 digits of the ACH account number. Nullable if asset.
-   `routing_number` **([string][223] | null)** The ABA routing number associated with the Custodial Partner. Nullable if asset.
-   `opened_at` **[Date][261]** The DateTime at which this account was created
-   `closed_at` **[Date][261]** The DateTime at which this account was closed
...
-   `customer_uid` **[Array][255]&lt;[string][223]>?** Filter by Customer. Multiple values are allowed
-   `external_uid` **[string][223]?** A unique, immutable id provided Clien
-   `limit` **[string][223]?**  Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[string][223]?** Index of the items to start retrieving from. Default: 0
-   `liability` **[string][223]?** Filter by liability or asset
-   `type` **[Array][255]&lt;[string][223]>?** Filter by type. Multiple values are allowed.
...
-   `first_name` **[string][223]** 
-   `middle_name` **([string][223] | null)?** 
-   `last_name` **[string][223]** 
-   `suffix` **([string][223] | null)?** 
-   `phone` **[string][223]** 
-   `ssn` **[string][223]** 
-   `dob` **[string][223]** 
-   `address` **[Address][235]** 
...
-   `uid` **[string][223]** A unique identifier generated by Rize
-   `external_uid` **[string][223]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `program_uid` **[string][223]** A uid referring to the program this customer belongs to.
-   `pool_uids` **[Array][255]&lt;[string][223]>** A list of uids referring to Pools belonging to this Customer.
-   `email` **[string][223]** Email of the customer
...
-   `total_balance` **[string][223]** Total asset owned by the customer in US dollars.
-   `created_at` **[Date][261]** 
-   `locked_at` **([Date][261] | null)?** The date and time when the Customer was locked. This field will be null if and only if the lock_reason is null.
-   `lock_reason` **([string][223] | null)?** The lock reason provided by the Client, an admin User, or the system at the time the Customer was locked. This field will be null if and only if the locked_at is null.
-   `details` **[CustomerDetails][232]** An object containing the supplied identifying information for the Customer.
...
-   `include_initiated` **[boolean][259]?** By default, Customers in initiated status are not shown, even if the `status=initiated` parameter is provided. In order for Customers with status initiated to appear in search results, parameters must include `include_initiated=true`.
...
-   `first_name` **[string][223]?** Only return Customers with a first name matching exactly what is submitted
-   `last_name` **[string][223]?** Only return Customers with a last name matching exactly what is submitted
-   `email` **[string][223]?** Only return Customers with an email address matching exactly what is submitted
-   `locked` **[boolean][259]?** Only return locked Customers if true and only return unlocked Customers if false
-   `program_uid` **[string][223]?** Only return Customers belonging to the submitted Program.
-   `external_uid` **[string][223]?** A unique, immutable id provided by Client.
-   `pool_uid` **[Array][255]&lt;[string][223]>?** Filter by pool. Multiple values are allowed.
-   `limit` **[string][223]?**  Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[string][223]?** Index of the items to start retrieving from. Default: 0
...
-   `uid` **[string][223]** A unique identifier generated by Rize
-   `external_uid` **[string][223]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `customer_uid` **[string][223]** A UID referring to the Customer who owns this Card.
-   `pool_uid` **[string][223]** A UID referring to the Pool to which this Card belongs.
-   `synthetic_account_uid` **[string][223]** A UID referring to the specific Synthetic Account to which this Card belongs. Any debit or credit transactions from this Card will occur in this account.
-   `custodial_account_uid` **[string][223]** A UID referring to the specific Custodial Account to which this Card belongs. Any debit or credit transactions from this Card will occur in this account.
-   `card_last_four_digits` **([string][223] | null)?** Last 4 digits of the Debit Card number to aid in indentifying the Card. Null if the Card is not yet issued (i.e. status is `initiated`).
...
-   `ready_to_use` **[boolean][259]** If the Card can be used, this value will be `true`; `false` otherwise.
-   `lock_reason` **([string][223] | null)?** If the Card is in a locked state, this field will be populated describing why the Card was locked. Null if the Card is not locked.
-   `issued_on` **([string][223] | null)?** The date this Card was issued. It may be briefly null when a new Card is requested, but the issuance has not yet happened (i.e. status is `initiated`).
-   `locked_at` **([string][223] | null)?** The date and time at which this Card was locked. Null if the Card is not locked.
-   `closed_at` **([string][223] | null)?** The date and time at which this Card was closed. This field will be null unless the `status` is `closed`, `closed_by_administrator`, `lost`, or `stolen`.
...
-   `customer_uid` **[Array][255]&lt;[string][223]>?** Filter by Customer. Multiple values are allowed.
-   `external_uid` **[string][223]?** A unique, immutable id provided Client
-   `limit` **[string][223]?**  Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[string][223]?** Index of the items to start retrieving from. Default: 0
-   `pool_uid` **[Array][255]&lt;[string][223]>?** Filter by pool. Multiple values are allowed.
-   `locked` **[boolean][259]?** Only return locked Cards if `true` and only return unlocked Cards if `false`
...
-   `uid` **[string][223]** A unique identifier generated by Rize
-   `document_type` **[string][223]** The document type. Only monthly statements are currently available.
...
-   `period_started_at` **[string][223]** The date and time when the document period started at, inclusive
-   `period_ended_at` **[string][223]** The date and time when the document period ended at, exclusive
-   `created_at` **[string][223]** The date and time when the document became available
-   `customer_uids` **[Array][255]&lt;[string][223]>** A list of UIDs of Customers that are associated with the document.(not implemented) Note that once we allow joint pool and accounts, this list will be pessimistic; each
...
-   `custodial_account_uids` **[Array][255]&lt;[string][223]>** A list of UIDs of Custodial Accounts that are associated with the document.If `scope_type` is `custodial_account`, this list will contain only one UID. In fact, currently as implemented,
    this list should always have exactly one UID.
-   `synthetic_account_uids` **[Array][255]&lt;[string][223]>** A list of UIDs of Synthetic Accounts that are associated with the document.If `scope_type` is `synthetic_account`, this list will contain only one UID.
...
-   `month` **[number][254]?** Filter by month. This includes any document for which the period started in the specified month.
-   `year` **[number][254]?** Filter by year
-   `scope_type` **(`"customer"` \| `"synthetic_account"` \| `"custodial_account"`)?** (not implemented) Filter by scope type
-   `custodial_account_uid` **[string][223]?** Filter by Custodial Account
-   `customer_uid` **[Array][255]&lt;[string][223]>?** Filter by Customer. Multiple values are allowed.
-   `synthetic_account_uid` **[Array][255]&lt;[string][223]>?** Filter by Synthetic Account. Multiple values are allowed.
-   `limit` **[number][254]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default = 100.
-   `offset` **[number][254]?** Index of the items to start retrieving from. Default = 0.
...
-   `filename` **[string][223]** The name of this file, exclusive of any extension.
-   `note` **[string][223]** A note describing the document.
-   `extension` **[string][223]** The filename extension.
-   `created_at` **[string][223]** 
...
-   `uid` **[string][223]** A unique identifier generated by Rize
-   `name` **[string][223]** A unique name to identify the resource
...
-   `description` **[string][223]** A description outlining the intended use and requirements for this program's instance of the synthetic_account_type
-   `program_uid` **[string][223]?** A uid referring to the Program this synthetic_account_type belongs to
...
-   `program_uid` **[string][223]?** Only list Synthetic Account Types that are available to be used by the given Program
-   `limit` **[number][254]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[number][254]?** Index of the items to start retrieving from. Default: 0
...
-   `external_uid` **[string][223]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `name` **[string][223]** A unique name to identify the resource.
-   `pool_uid` **[string][223]** A UID referring to the pool this Synthetic Account belongs to.
-   `synthetic_account_type_uid` **[string][223]** A UID referring to the Synthetic Account Type this Synthetic Account should be created as.
...
-   `liability` **[boolean][259]** Liability or asset. Any Synthetic Account created via POST /synthetic_accounts is a liability account, except for external accounts. Some asset Synthetic Accounts are automatically created by Rize during Customer onboarding for accounting purposes.
-   `net_usd_balance` **[string][223]** The current settled balance of this account in US Dollars. This field will be null for synthetic_account_types in the external category.
-   `net_usd_pending_balance` **[string][223]** The sum of all pending transactions for this account in US Dollars. This field will be null for Synthetic Account Types in the external category.
-   `net_usd_available_balance` **[string][223]** The balance available to spend calculated as the settled balance less any pending withdrawals Pending deposits are not included. This field will be null for Synthetic Account Types in the external category.
-   `master_account` **[boolean][259]** Used to identify the Master Synthetic Accounts that exist for every Program Customer. Master Synthetic Accounts are the default accounts where any unknown custodial transactions will settle and cannot be archived while a Program Customer is still active.
-   `account_number` **([string][223] | null)** The ACH account number (if any) associated with this account. Some Synthetic Account Types require this field to be submitted along with the POST request. For example, any Synthetic Account Type from the `external` category will require an `account_number`. Submitting an `account_number` with a Synthetic Account Type that does not require one will result in the account number being ignored.
-   `account_number_last_four` **([string][223] | null)** Last 4 digits of the ACH account number.
-   `routing_number` **([string][223] | null)** The ABA routing number (if any) associated with this account. Some Synthetic Account Types require this field to be submitted along with the POST request. For example, any Synthetic Account Type from the `external` category will require a `routing_number`. Submitting a `routing_number` with a Synthetic Account Type that does not require one will result in the routing number being ignored.
-   `opened_at` **[string][223]** The DateTime at which this account was created
-   `closed_at` **([string][223] | null)** The DateTime at which this account was closed. This value will be present if the status is `archived` or `failed`.
-   `closed_to_synthetic_account_uid` **([string][223] | null)** A UID referring to the Synthetic Account where the funds in this account were transferred when closed. Any transactions issued against this account after it is closed will instead go to the `closed_to` account
...
-   `customer_uid` **[Array][255]&lt;[string][223]>?** Filter by Customer. Multiple string values are allowed.
-   `external_uid` **[string][223]?** A unique, immutable id provided Client
-   `pool_uid` **[Array][255]&lt;[string][223]>?** Filter by pool. Multiple string values are allowed.
-   `limit` **[number][254]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[number][254]?** Index of the items to start retrieving from. Default: 0
-   `synthetic_account_type_uid` **[string][223]?** Filter by Synthetic Account Type
-   `synthetic_account_category` **(`"general"` \| `"external"` \| `"plaid_external"`)?** Filter by Synthetic Account Category
-   `liability` **[boolean][259]?** Filter by liability or asset
...
-   `externalUid` **([string][223] | null)?** A unique identifier Client supplies
-   `name` **([string][223] | null)?** A unique name to identify the resource
-   `poolUid` **([string][223] | null)?** A UID referring to the pool this Synthetic Account belongs to
-   `syntheticAccountTypeUid` **([string][223] | null)?** A UID referring to the Synthetic Account Type this Synthetic Account should be created as
-   `accountNumber` **([string][223] | null)?** The ACH account number (if any) associated with this account. Some Synthetic Account Types require this field to be submitted along with the POST request. For example, any Synthetic Account Type from the `external` category will require an `account_number`. Submitting an `account_number` with a Synthetic Account Type that does not require one will result in the account number being ignored.
-   `routingNumber` **([string][223] | null)?** The ABA routing number (if any) associated with this account. Some Synthetic Account Types require this field to be submitted along with the POST request. For example, any Synthetic Account Type from the `external` category will require a `routing_number`. Submitting a `routing_number` with a Synthetic Account Type that does not require one will result in the routing number being ignored.
...
-   `uid` **[string][223]** A unique identifier generated by Rize
-   `id` **[number][254]** A unique numeric identifier that indicates the order in which the Transactions were created
-   `settled_index` **([number][254] | null)?** A unique index that indicates the order in which the Transactions were settled. Null if status is `queued` or `pending`.
-   `transfer_uid` **([number][254] | null)?** The UID of the Transfer this Transaction is associated with, if any.
-   `source_synthetic_account_uid` **[string][223]** Synthetic Account from where the asset is pulled
-   `destination_synthetic_account_uid` **[string][223]** Synthetic Account where the asset is landed
-   `transaction_event_uids` **[Array][255]&lt;[string][223]>** A list of UIDS referring to Transaction Events belonging to this Transaction, if any. 
...
-   `custodial_account_uids` **[Array][255]&lt;[string][223]>** A list of UIDS referring to Custodial Accounts that are so far invovled in this Transaction. 
...
-   `us_dollar_amount` **[string][223]** The amount will never be negative
...
-   `description` **[string][223]** 
-   `created_at` **[string][223]** The date and time when the Transaction is first recognized by Rize. This may be when the Transfer is initiated if the Transaction is associated with one.
-   `settled_at` **[string][223]** The date and time when the Transaction is settled.
...
-   `customer_uid` **[Array][255]&lt;[string][223]>?** Filter by Customer.
-   `source_synthetic_account_uid` **[Array][255]&lt;[string][223]>?** Filter by source Synthetic Account.
-   `destination_synthetic_account_uid` **[Array][255]&lt;[string][223]>?** Filter by destination Synthetic Account.
-   `synthetic_account_uid` **[Array][255]&lt;[string][223]>?** Filter by Synthetic Account, source or destination.
-   `type` **[Array][255]&lt;(`"atm_withdrawal"` \| `"card_purchase"` \| `"card_refund"` \| `"dispute"` \| `"external_transfer"` \| `"fee"` \| `"internal_transfer"` \| `"other"` \| `"reversed_transfer"` \| `"third_party_transfer"`)>?** Filter by type.
-   `status` **[Array][255]&lt;(`"queued"` \| `"pending"` \| `"settled"` \| `"failed"`)>?** Filter by status.
-   `search_description` **[string][223]?** Attempts to search for the provided string in the description field. '\*' can be used as a wildcard. Any record with a match will be returned.
-   `limit` **[number][254]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default = 100.
-   `offset` **[number][254]?** Index of the items to start retrieving from. Default = 0.
...
-   `uid` **[string][223]** A unique identifier generated by Rize
-   `settled_index` **[number][254]** A unique index that indicates the order in which Transaction Events were settled
-   `transaction_uid` **[string][223]** UID of the Transaction this line item belongs to
-   `phase` **[number][254]** Some Transfer types will trigger multiple transfers at the custodial level. Some of these custodial transfers must wait for all dependent custodial transfers to complete before initiating. Transaction Events with `phase` value 1 are recorded for the first set of custodial transfers that get initiated after the (Synthetic) Transfer starts. Custodial transfers in later phases cannot initiate before all events from previous phases are settled.
-   `source_custodial_account_uid` **[string][223]** Custodial Account from which the asset is pulled
-   `destination_custodial_account_uid` **[string][223]** Custodial Account where the asset lands
-   `custodial_line_item_uids` **[Array][255]&lt;[string][223]>** A list of UIDS referring to Custodial Line Items belonging to this event. There are always at least two line items if the status is `settled`.
-   `status` **[string][223]** 
-   `us_dollar_amount` **[string][223]** The amount will never be negative
...
-   `description` **[string][223]** 
-   `created_at` **[string][223]** The date and time when the event is first recognized by Rize. This may be when the Transfer is initiated if the event is associated with one.
-   `settled_at` **[string][223]** The date and time when the event is settled.
    //\*\*
-   `source_custodial_account_uid` **[Array][255]&lt;[string][223]>?** Filter by source Custodial Account.
-   `destination_custodial_account_uid` **[Array][255]&lt;[string][223]>?** Filter by destination Custodial Account.
-   `custodial_account_uid` **[Array][255]&lt;[string][223]>?** Filter by Custodial Account, source or destination.
-   `type` **[Array][255]&lt;(`"odfi_ach_deposit"` \| `"odfi_ach_withdrawal"` \| `"rdfi_ach_deposit"` \| `"rdfi_ach_withdrawal"`)>?** Filter by type. Multiple values are allowed.
-   `transaction_uid` **[Array][255]&lt;[string][223]>?** Filter by Transaction. Multiple values are allowed
-   `limit` **[number][254]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default = 100.
-   `offset` **[number][254]?** Index of the items to start retrieving from. Default = 0.
...
-   `uid` **[string][223]** A unique identifier generated by Rize
-   `settled_index` **[number][254]** A unique index that indicates the order in which the Synthetic Line Items were settled
-   `transaction_uid` **[string][223]** UID of the Transaction this Synthetic Line Item belongs to
-   `synthetic_account_uid` **[string][223]** UID of the Synthetic Account this Synthetic Line Item is associated with
-   `status` **[string][223]** 
-   `us_dollar_amount` **[string][223]** The signed USD amount of this specific Synthetic Line Item
-   `running_us_dollar_balance` **[string][223]** The Synthetic Account balance after this Synthetic Line Item was settled
-   `description` **[string][223]** Human-readable description in context of Synthetic Accounts
-   `created_at` **[string][223]** The date and time when the Synthetic Line Item is first recognized by Rize. This may be when the Transfer is initiated if the Synthetic Line Item is associated with one.
-   `settled_at` **[string][223]** The date and time when the Synthetic Line Item is settled
...
-   `customer_uid` **[Array][255]&lt;[string][223]>?** Filter by Customer.
-   `pool_uid` **[Array][255]&lt;[string][223]>?** Filter by pool.
-   `synthetic_account_uid` **[Array][255]&lt;[string][223]>?** Filter by Synthetic Account.
-   `limit` **[number][254]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default = 100.
-   `offset` **[number][254]?** Index of the items to start retrieving from. Default = 0.
-   `transaction_uid` **[Array][255]&lt;[string][223]>?** Filter by Transaction.
-   `status` **[Array][255]&lt;(`"begun"` \| `"failed"` \| `"in_progress"` \| `"settled"`)>?** Filter by status.
...
-   `uid` **[string][223]** A unique identifier generated by Rize.
-   `settled_index` **[number][254]** A unique index that indicates the order in which the Custodial Line Items were settled.
-   `transaction_uid` **[string][223]** UID of the Transaction this Custodial Line Item belongs to.
-   `transaction_event_uid` **[string][223]** UID of the Transaction Event this Custodial Line Item belongs to.
-   `custodial_account_uid` **[string][223]** UID of the Custodial Account this Custodial Line Item is associated with.
-   `status` **[string][223]** 
-   `us_dollar_amount` **[string][223]** The signed USD amount of this specific Custodial Line Item
-   `running_us_dollar_balance` **([string][223] | null)?** US dollar balance of the Custodial Account as of the completion of this Custodial Line Item. This field may be empty unless the status is `settled` or `voided`.
-   `type` **[string][223]** Symbols and/or numbers that represent different types of Custodial Line Items.
-   `description` **[string][223]** Descriptions pulled from the custodians, such as through NACHA description or ISO-8583 data element 43.
-   `created_at` **[string][223]** The date and time when the Custodial Line Items is first recognized by Rize. This may be when the Transfer is initiated if the Custodial Line Item is associated with one.
-   `occurred_at` **[string][223]** This field may be empty if status is not settled or voided.
-   `settled_at` **[string][223]** The date and time when the Custodial Line Item is settled.
...
-   `customer_uid` **[Array][255]&lt;[string][223]>?** Filter by Customer.
-   `custodial_account_uid` **[Array][255]&lt;[string][223]>?** Filter by Custodial Account.
-   `status` **[Array][255]&lt;(`"settled"` \| `"voided"`)>?** Filter by status.
-   `us_dollar_amount_tax` **[number][254]?** Return any records having a us_dollar_amount at or below us_dollar_amount_max.
-   `us_dollar_amount_min` **[number][254]?** Return any records having a us_dollar_amount at or above us_dollar_amount_min.
-   `transaction_event_uid` **[Array][255]&lt;[string][223]>?** Filter by Transaction Event.
-   `transaction_uid` **[Array][255]&lt;[string][223]>?** Filter by Transaction.
-   `limit` **[number][254]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default = 100.
-   `offset` **[number][254]?** Index of the items to start retrieving from. Default = 0.
-   `sort` **(`"created_at_asc"` \| `"created_at_desc"` \| `"description_asc"` \| `"description_desc"` \| `"settled_index_asc"` \| `"settled_index_desc"` \| `"us_dollar_amount_asc"` \| `"us_dollar_amount_desc"`)?** 
...
-   `uid` **[string][223]** A unique identifier generated by Rize.
-   `external_uid` **[string][223]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `source_synthetic_account_uid` **[string][223]** Synthetic Account to pull asset from. Must be an active liability or external-type account. Cannot be equal to `destination_synthetic_account_uid`.
-   `destination_synthetic_account_uid` **[string][223]** Synthetic Account where the asset should land. Must be an active liability or external-type account. Cannot be equal to `source_synthetic_account_uid`.
-   `initiating_customer_uid` **[string][223]** 
-   `usd_transfer_amount` **[string][223]** The USD amount to transfer
...
-   `timeout` **[number][254]?** Specifies the number of milliseconds before the each request times out. (Default: 80000)
...
-   `programUid` **[string][223]** The Rize Program ID.
-   `hmac` **[string][223]** The HMAC that will be used to sign the JSON web signature in order to get access to the API.
-   `options` **[RizeOptions][262]?** Configuration options (optional, default `RizeOptions`)
...
Type: [ComplianceWorkflowService][263]
...
Type: [SyntheticAccountService][265]
...
Type: [CustodialAccountService][266]
...
[116]: #gettransactioneventlist

[117]: #parameters-36

[118]: #examples-35

[119]: #gettransactionevent

[120]: #parameters-37

[121]: #examples-36

[122]: #getsyntheticlineitemlist

[123]: #parameters-38

[124]: #examples-37

[125]: #getsyntheticlineitem

[126]: #parameters-39

[127]: #examples-38

[128]: #getcustodiallineitemlist

[129]: #parameters-40

[130]: #examples-39

[131]: #getcustodiallineitem
...
[150]: #complianceworkflowsummary

[151]: #properties-3

[152]: #complianceworkflowcustomer

[153]: #properties-4

[154]: #compliancedocument

[155]: #properties-5

[156]: #compliancedocumentacknowledgementrequest

[157]: #properties-6

[158]: #complianceworkflow
...
[162]: #custodialaccount

[163]: #properties-9

[164]: #custodialaccountlistquery
...
[174]: #debitcardlistquery

[175]: #properties-15

[176]: #debit-cardtypedefs

[177]: #document

[178]: #properties-16

[179]: #documentlistquery
...
[183]: #syntheticaccounttype

[184]: #properties-19

[185]: #syntheticaccounttypelistquery

[186]: #properties-20

[187]: #syntheticaccount

[188]: #properties-21

[189]: #syntheticaccountlistquery

[190]: #properties-22

[191]: #syntheticaccountcreaterequest
...
[195]: #transactionlistquery

[196]: #properties-25

[197]: #syntheticlineitem

[198]: #properties-26

[199]: #syntheticlineitemlistquery

[200]: #properties-27

[201]: #custodiallineitem
...
[213]: #complianceworkflow-1

[214]: #customer-1

[215]: #syntheticaccount-1

[216]: #custodialaccount-1
...
[225]: #complianceworkflow

[226]: #compliancedocumentacknowledgementrequest

[227]: #custodialaccount

[228]: #custodialaccountlistquery

[229]: #rizelist

[230]: #customerlistquery

[231]: #customer

[232]: #customerdetails

[233]: #debitcardlistquery

[234]: #debitcard

[235]: #address

[236]: #documentlistquery
...
[240]: #syntheticaccountlistquery

[241]: #syntheticaccount

[242]: #syntheticaccountcreaterequest

[243]: #syntheticaccounttypelistquery

[244]: #syntheticaccounttype

[245]: #transactionlistquery

[246]: #transaction

[247]: #syntheticlineitemlistquery

[248]: #syntheticlineitem

[249]: #custodiallineitemlistquery

[250]: #custodiallineitem

[251]: #transferlistquery
...
[255]: https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Array

[256]: #complianceworkflowsummary

[257]: #complianceworkflowcustomer

[258]: #compliancedocument

[259]: https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Boolean

[260]: #accounterror

[261]: https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Date

[262]: #rizeoptions

[263]: #complianceworkflowservice

[264]: #customerservice

[265]: #syntheticaccountservice

[266]: #custodialaccountservice

[267]: #transactionservice
