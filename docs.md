...
-   `query` **[TransferListQuery][168]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][150]&lt;[RizeList][155]&lt;[Transfer][169]>>** A promise that returns a Transfer List if resolved.
...
-   `uid` **[string][149]** Rize-generated unique Transfer id
...
Returns **[Promise][150]&lt;[Transfer][169]>** A promise that returns a Transfer if resolved.
...
-   `uid` **[string][149]** A unique identifier generated by Rize.
-   `external_uid` **[string][149]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `source_synthetic_account_uid` **[string][149]** Synthetic Account to pull asset from. Must be an active liability or external-type account. Cannot be equal to `destination_synthetic_account_uid`.
-   `destination_synthetic_account_uid` **[string][149]** Synthetic Account where the asset should land. Must be an active liability or external-type account. Cannot be equal to `source_synthetic_account_uid`.
-   `initiating_customer_uid` **[string][149]** 
-   `usd_transfer_amount` **[string][149]** The USD amount to transfer
...
-   `external_uid` **[string][149]?** A unique, immutable id provided Client.
-   `pool_uid` **[Array][172]&lt;[string][149]>?** Filter by pool. Multiple values are allowed.
-   `synthetic_account_uid` **[Array][172]&lt;[string][149]>?** Filter by Synthetic Account. Multiple values are allowed.
-   `limit` **[number][171]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default = 100.
-   `offset` **[number][171]?** Index of the items to start retrieving from. Default = 0.
