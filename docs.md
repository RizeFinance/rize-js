...
-   [SyntheticAccountTypeListQuery][80]
    -   [Properties][81]
-   [SyntheticAccountCreateOptions][82]
    -   [Properties][83]
-   [RizeOptions][84]
    -   [Properties][85]
-   [Rize][86]
...
-   `query` **[SyntheticAccountListQuery][101]**  (optional, default `{}`)
...
Returns **[Promise][93]&lt;[RizeList][97]&lt;[SyntheticAccount][102]>>** A promise that returns the unlocked Customer if resolved.
...
Returns **[Promise][93]&lt;[RizeList][97]&lt;[SyntheticAccountType][103]>>** A promise that returns a Synthetic Account Type List if resolved.
...
Returns **[Promise][93]&lt;[SyntheticAccountType][103]>** A promise that returns a Synthetic Account Type if resolved.
...
-   `total_count` **[number][105]** Total count of items available to retrieve
-   `count` **[number][105]** Number of items retrieved
-   `limit` **[number][105]** Maximum number of items to retrieve
...
-   `summary` **[ComplianceWorkflowSummary][107]** 
-   `customer` **[ComplianceWorkflowCustomer][108]** 
...
-   `pool_uids` **[Array][106]&lt;[string][92]>** A list of uids referring to Pools belonging to this Customer.
-   `email` **[string][92]** Email of the customer
...
-   `customer_uid` **[Array][106]&lt;[string][92]>?** Filter by Customer. Multiple string values are allowed.
-   `external_uid` **[string][92]?** A unique, immutable id provided Client
-   `pool_uid` **[Array][106]&lt;[string][92]>?** Filter by pool. Multiple string values are allowed.
...
-   `timeout` **[number][105]?** Specifies the number of milliseconds before the each request times out. (Default: 80000)
...
-   `options` **[RizeOptions][113]?** Configuration options (optional, default `RizeOptions`)
...
Type: [ComplianceWorkflowService][114]
...
[82]: #syntheticaccountcreateoptions
...
[101]: #syntheticaccountlistquery

[102]: #syntheticaccount
...
[108]: #complianceworkflowcustomer
