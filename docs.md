...
-   [RizeList][80]
    -   [Properties][81]
-   [ComplianceWorkflowSummary][82]
    -   [Properties][83]
-   [ComplianceWorkflowCustomer][84]
    -   [Properties][85]
-   [ComplianceDocument][86]
    -   [Properties][87]
-   [ComplianceDocumentAcknowledgementRequest][88]
    -   [Properties][89]
-   [ComplianceWorkflow][90]
    -   [Properties][91]
-   [AccountError][92]
    -   [Properties][93]
-   [CustodialAccount][94]
    -   [Properties][95]
-   [CustodialAccountListQuery][96]
    -   [Properties][97]
-   [Address][98]
    -   [Properties][99]
-   [CustomerDetails][100]
...
-   [Customer][102]
    -   [Properties][103]
-   [CustomerListQuery][104]
    -   [Properties][105]
-   [SyntheticAccountType][106]
    -   [Properties][107]
-   [SyntheticAccountTypeListQuery][108]
    -   [Properties][109]
-   [SyntheticAccount][110]
    -   [Properties][111]
-   [SyntheticAccountListQuery][112]
    -   [Properties][113]
-   [SyntheticAccountCreateRequest][114]
    -   [Properties][115]
-   [Transaction][116]
    -   [Properties][117]
-   [TransactionListQuery][118]
    -   [Properties][119]
-   [SyntheticLineItem][120]
    -   [Properties][121]
-   [SyntheticLineItemListQuery][122]
    -   [Properties][123]
-   [CustodialLineItem][124]
    -   [Properties][125]
-   [CustodialLineItemListQuery][126]
    -   [Properties][127]
-   [RizeOptions][128]
    -   [Properties][129]
-   [Rize][130]
    -   [Parameters][131]
    -   [complianceWorkflow][132]
    -   [customer][133]
...
-   `customerExternalUid` **[string][138]** A Customer identifier supplied by the Partner, unique among the collection of all partner Customers.
-   `email` **[string][138]** Email address associated with the Customer.
...
Returns **[Promise][139]&lt;[ComplianceWorkflow][140]>** A promise that returns the new Compliance Workflow if resolved.
...
-   `customerExternalUid` **[string][138]** A Customer identifier supplied by the Partner, unique among the collection of all partner Customers.
-   `customerUid` **[string][138]** A UID referring to the Customer generated by Rize
-   `email` **[string][138]** Email address associated with the Customer.

Returns **[Promise][139]&lt;[ComplianceWorkflow][140]>** A promise that returns the new Compliance Workflow entity if resolved.
...
-   `customerUid` **[string][138]** A UID referring to the Customer
...
Returns **[Promise][139]&lt;[ComplianceWorkflow][140]>** A promise that returns the latest Compliance Workflow if resolved.
...
-   `complianceWorkflowUid` **[string][138]** A UID referring to the Compliance Workflow.
-   `customerUid` **[string][138]** A UID referring to the Customer.
-   `documents` **...[ComplianceDocumentAcknowledgementRequest][141]** 
...
Returns **[Promise][139]&lt;[ComplianceWorkflow][140]>** A promise that returns the updated Compliance Workflow if resolved.
...
-   `uid` **[string][138]** Rize-generated unique custodial account id
...
Returns **[Promise][139]&lt;[CustodialAccount][142]>** A promise that returns a Custodial Account if resolved.
...
-   `query` **[CustodialAccountListQuery][143]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][139]&lt;[RizeList][144]&lt;CustodialAccountList>>** A promise that returns a Custodial Account List if resolved.
...
-   `query` **[CustomerListQuery][145]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][139]&lt;[RizeList][144]&lt;[Customer][146]>>** A promise that returns a Customer List if resolved.
...
-   `uid` **[string][138]** Rize-generated unique customer id
...
Returns **[Promise][139]&lt;[Customer][146]>** A promise that returns a Customer if resolved.
...
-   `uid` **[string][138]** Rize-generated unique customer id
-   `email` **[string][138]** Email of the customer
-   `details` **[CustomerDetails][147]** An object containing the supplied identifying information for the Customer
...
Returns **[Promise][139]&lt;[Customer][146]>** A promise that returns the updated Customer if resolved.
...
Returns **[Promise][139]&lt;void>** A promise that returns void if resolved.
...
-   `uid` **[string][138]** Rize-generated unique customer id
-   `lockReason` **[string][138]** The reason that the Customer is being locked must be submitted with the request body.
...
Returns **[Promise][139]&lt;[Customer][146]>** A promise that returns the locked Customer if resolved.
...
-   `uid` **[string][138]** Rize-generated unique customer id
-   `unlockReason` **[string][138]** The reason that the Customer is being unlocked. (optional, default `null`)
...
Returns **[Promise][139]&lt;[Customer][146]>** A promise that returns the unlocked Customer if resolved.
...
-   `query` **[SyntheticAccountListQuery][148]**  (optional, default `{}`)
...
Returns **[Promise][139]&lt;[RizeList][144]&lt;[SyntheticAccount][149]>>** A promise that returns the Synthetic Account list if resolved.
...
-   `uid` **[string][138]** Rize-generated unique synthetic account id
...
Returns **[Promise][139]&lt;[SyntheticAccount][149]>** A promise that returns a SyntheticAccount if resolved.

### create

#### Parameters

-   `payload` **[SyntheticAccountCreateRequest][150]** is a JSON object needs to send as body parameters in order to create new synthetic accounts.
...
Returns **[Promise][139]&lt;[RizeList][144]&lt;[SyntheticAccount][149]>>** 
...
Returns **[Promise][139]&lt;[SyntheticAccount][149]>** A promise that returns a Synthetic Account if resolved.
...
-   `query` **[SyntheticAccountTypeListQuery][151]** An object containing key value paris for filtering the result. (optional, default `{}`)
...
Returns **[Promise][139]&lt;[RizeList][144]&lt;[SyntheticAccountType][152]>>** A promise that returns a Synthetic Account Type List if resolved.
...
-   `uid` **[string][138]** Rize-generated unique Synthetic Account Type id
...
Returns **[Promise][139]&lt;[SyntheticAccountType][152]>** A promise that returns a Synthetic Account Type if resolved.
...
-   `query` **[TransactionListQuery][153]?** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][139]&lt;[RizeList][144]&lt;[Transaction][154]>>** A promise that returns a Transaction List if resolved.
...
-   `uid` **[string][138]** Rize-generated unique transaction id
...
Returns **[Promise][139]&lt;[Transaction][154]>** A promise that returns a Transaction if resolved.
...
-   `query` **[SyntheticLineItemListQuery][155]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][139]&lt;[RizeList][144]&lt;[SyntheticLineItem][156]>>** A promise that returns a Synthetic Line Item List if resolved.
...
-   `uid` **[string][138]** Rize-generated unique Synthetic Line Item id
...
Returns **[Promise][139]&lt;[SyntheticLineItem][156]>** A promise that returns a Synthetic Line Item if resolved.

### getCustodialLineItemList

#### Parameters

-   `query` **[CustodialLineItemListQuery][157]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][139]&lt;[RizeList][144]&lt;[CustodialLineItem][158]>>** A promise that returns a Custodial Line Item List if resolved.
...
-   `total_count` **[number][160]** Total count of items available to retrieve
-   `count` **[number][160]** Number of items retrieved
-   `limit` **[number][160]** Maximum number of items to retrieve
-   `offset` **[number][160]** Index of the first item to retrieve
-   `data` **[Array][161]&lt;T>** 
...
-   `accepted_quantity` **[number][160]** 
-   `begun_at` **[string][138]** The DateTime at which this Compliance Workflow was requested
-   `completed_step` **[number][160]** 
-   `current_step` **[number][160]** 
...
-   `email` **[string][138]** 
-   `external_uid` **[string][138]** A Customer identifier supplied by the Client, unique among the collection of all Client Customers
-   `uid` **[string][138]** A UID referring to the Customer
...
-   `external_storage_name` **[string][138]** Amazon S3 key used to retrieve the contents of a Compliance Document
-   `compliance_document_url` **[string][138]** Amazon S3 URL used to retrieve the contents of a Compliance Document
-   `name` **[string][138]** 
-   `step` **[number][160]** Multiple Compliance Documents are grouped into a Step, and Compliance Documents are presented to a Customer, Step-by-Step
-   `version` **[number][160]** 
-   `uid` **[string][138]** A UID referring to a Compliance Document; note that this UID will be different for each Customer
-   `accepted_at` **[string][138]** The DateTime at which this Compliance Document was acknowledged
...
-   `documentUid` **[string][138]** A UID referring to the Compliance Document being acknowledged.
-   `accept` **(`"yes"` \| `"no"`)** An indication of acceptance or rejection.
-   `userName` **[string][138]?** A label associated with the Customer (required for electronic signing).
-   `ipAddress` **[string][138]?** A numerical label assigned to each device connected to a computer network that uses the Internet Protocol for communication (required for electronic signing); in this case, the label associated with the computer used by the Customer.
...
-   `uid` **[string][138]** A unique identifier generated by Rize.
-   `summary` **[ComplianceWorkflowSummary][162]** 
-   `customer` **[ComplianceWorkflowCustomer][163]** 
-   `accepted_documents` **[Array][161]&lt;[ComplianceDocument][164]>** 
-   `current_step_documents_pending` **[Array][161]&lt;Omit&lt;[ComplianceDocument][164], `"accepted_at"`>>** Compliance Documents that await acknowledgment in the current Step
-   `all_documents` **[Array][161]&lt;Omit&lt;[ComplianceDocument][164], (`"accepted_at"` \| `"uid"`)>>** The set of all Compliance Documents that would require acknowledgment
...
-   `error_code` **[string][138]** 
-   `error_name` **[string][138]** 
-   `error_description` **[string][138]** 
...
-   `uid` **[string][138]** A unique identifier generated by Rize
-   `external_uid` **[string][138]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `customer_uid` **[string][138]** A UID referring to the customer this Custodial Account belongs to
-   `pool_uid` **[Array][161]&lt;[string][138]>** A UID referring to the pool this Custodial Account belongs to
-   `program_service_offering_uid` **([string][138] | null)** A UID referring to the specific Program Service Offering for which this account was created. Nullable if asset.
...
-   `liability` **[boolean][165]** Liability or asset. Liability Custodial Accounts represent real accounts at Financial Institutions. Asset accounts are used for accounting purposes and may be generated by Rize during events such as new custodial account creations or new external account connections.
-   `name` **([string][138] | null)** A friendly name used to identify the account at the Custodial Partner.
-   `primary_account` **[boolean][165]** The date and time when the Customer was locked. This field will be null if and only if the lock_reason is null.
...
-   `account_errors` **[Array][161]&lt;[AccountError][166]>** A list of errors related to this account. These are passed through during interactions with the underlying Custodial Partner and can help with resolving customer issues. Only provided for accounts that are in an error or manual_review status.
-   `net_usd_balance` **[string][138]** The current settled balance of this Custodial Account in US Dollars
-   `net_usd_pending_balance` **[string][138]** The sum of all pending transactions for this Custodial Account in US Dollars
-   `net_usd_available_balance` **[string][138]** The balance available to spend calculated as Normal balance less any withdrawals. Pending deposits are not included
-   `account_number` **([string][138] | null)** The ACH account number that can be used to make transfers into/out of this account. Nullable if asset.
-   `account_number_masked` **([string][138] | null)** Last 4 digits of the ACH account number. Nullable if asset.
-   `routing_number` **([string][138] | null)** The ABA routing number associated with the Custodial Partner. Nullable if asset.
-   `opened_at` **[Date][167]** The DateTime at which this account was created
-   `closed_at` **[Date][167]** The DateTime at which this account was closed
...
-   `customer_uid` **[Array][161]&lt;[string][138]>?** Filter by Customer. Multiple values are allowed
-   `external_uid` **[string][138]?** A unique, immutable id provided Clien
-   `limit` **[string][138]?**  Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[string][138]?** Index of the items to start retrieving from. Default: 0
-   `liability` **[string][138]?** Filter by liability or asset
-   `type` **[Array][161]&lt;[string][138]>?** Filter by type. Multiple values are allowed.
...
-   `first_name` **[string][138]** 
-   `middle_name` **([string][138] | null)?** 
-   `last_name` **[string][138]** 
-   `suffix` **([string][138] | null)?** 
-   `phone` **[string][138]** 
-   `ssn` **[string][138]** 
-   `dob` **[string][138]** 
-   `address` **[Address][168]** 
...
-   `uid` **[string][138]** A unique identifier generated by Rize
-   `external_uid` **[string][138]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `program_uid` **[string][138]** A uid referring to the program this customer belongs to.
-   `pool_uids` **[Array][161]&lt;[string][138]>** A list of uids referring to Pools belonging to this Customer.
-   `email` **[string][138]** Email of the customer
...
-   `total_balance` **[string][138]** Total asset owned by the customer in US dollars.
-   `created_at` **[Date][167]** 
-   `locked_at` **([Date][167] | null)?** The date and time when the Customer was locked. This field will be null if and only if the lock_reason is null.
-   `lock_reason` **([string][138] | null)?** The lock reason provided by the Client, an admin User, or the system at the time the Customer was locked. This field will be null if and only if the locked_at is null.
-   `details` **[CustomerDetails][147]** An object containing the supplied identifying information for the Customer.
...
-   `include_initiated` **[boolean][165]?** By default, Customers in initiated status are not shown, even if the `status=initiated` parameter is provided. In order for Customers with status initiated to appear in search results, parameters must include `include_initiated=true`.
...
-   `first_name` **[string][138]?** Only return Customers with a first name matching exactly what is submitted
-   `last_name` **[string][138]?** Only return Customers with a last name matching exactly what is submitted
-   `email` **[string][138]?** Only return Customers with an email address matching exactly what is submitted
-   `locked` **[boolean][165]?** Only return locked Customers if true and only return unlocked Customers if false
-   `program_uid` **[string][138]?** Only return Customers belonging to the submitted Program.
-   `external_uid` **[string][138]?** A unique, immutable id provided by Client.
-   `pool_uid` **[Array][161]&lt;[string][138]>?** Filter by pool. Multiple values are allowed.
-   `limit` **[string][138]?**  Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[string][138]?** Index of the items to start retrieving from. Default: 0
...
-   `uid` **[string][138]** A unique identifier generated by Rize
-   `name` **[string][138]** A unique name to identify the resource
...
-   `description` **[string][138]** A description outlining the intended use and requirements for this program's instance of the synthetic_account_type
-   `program_uid` **[string][138]?** A uid referring to the Program this synthetic_account_type belongs to
...
-   `program_uid` **[string][138]?** Only list Synthetic Account Types that are available to be used by the given Program
-   `limit` **[number][160]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[number][160]?** Index of the items to start retrieving from. Default: 0
...
-   `external_uid` **[string][138]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `name` **[string][138]** A unique name to identify the resource.
-   `pool_uid` **[string][138]** A UID referring to the pool this Synthetic Account belongs to.
-   `synthetic_account_type_uid` **[string][138]** A UID referring to the Synthetic Account Type this Synthetic Account should be created as.
...
-   `liability` **[boolean][165]** Liability or asset. Any Synthetic Account created via POST /synthetic_accounts is a liability account, except for external accounts. Some asset Synthetic Accounts are automatically created by Rize during Customer onboarding for accounting purposes.
-   `net_usd_balance` **[string][138]** The current settled balance of this account in US Dollars. This field will be null for synthetic_account_types in the external category.
-   `net_usd_pending_balance` **[string][138]** The sum of all pending transactions for this account in US Dollars. This field will be null for Synthetic Account Types in the external category.
-   `net_usd_available_balance` **[string][138]** The balance available to spend calculated as the settled balance less any pending withdrawals Pending deposits are not included. This field will be null for Synthetic Account Types in the external category.
-   `master_account` **[boolean][165]** Used to identify the Master Synthetic Accounts that exist for every Program Customer. Master Synthetic Accounts are the default accounts where any unknown custodial transactions will settle and cannot be archived while a Program Customer is still active.
-   `account_number` **([string][138] | null)** The ACH account number (if any) associated with this account. Some Synthetic Account Types require this field to be submitted along with the POST request. For example, any Synthetic Account Type from the `external` category will require an `account_number`. Submitting an `account_number` with a Synthetic Account Type that does not require one will result in the account number being ignored.
-   `account_number_last_four` **([string][138] | null)** Last 4 digits of the ACH account number.
-   `routing_number` **([string][138] | null)** The ABA routing number (if any) associated with this account. Some Synthetic Account Types require this field to be submitted along with the POST request. For example, any Synthetic Account Type from the `external` category will require a `routing_number`. Submitting a `routing_number` with a Synthetic Account Type that does not require one will result in the routing number being ignored.
-   `opened_at` **[string][138]** The DateTime at which this account was created
-   `closed_at` **([string][138] | null)** The DateTime at which this account was closed. This value will be present if the status is `archived` or `failed`.
-   `closed_to_synthetic_account_uid` **([string][138] | null)** A UID referring to the Synthetic Account where the funds in this account were transferred when closed. Any transactions issued against this account after it is closed will instead go to the `closed_to` account
...
-   `customer_uid` **[Array][161]&lt;[string][138]>?** Filter by Customer. Multiple string values are allowed.
-   `external_uid` **[string][138]?** A unique, immutable id provided Client
-   `pool_uid` **[Array][161]&lt;[string][138]>?** Filter by pool. Multiple string values are allowed.
-   `limit` **[number][160]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[number][160]?** Index of the items to start retrieving from. Default: 0
-   `synthetic_account_type_uid` **[string][138]?** Filter by Synthetic Account Type
-   `synthetic_account_category` **(`"general"` \| `"external"` \| `"plaid_external"`)?** Filter by Synthetic Account Category
-   `liability` **[boolean][165]?** Filter by liability or asset
...
-   `externalUid` **([string][138] | null)?** A unique identifier Client supplies
-   `name` **([string][138] | null)?** A unique name to identify the resource
-   `poolUid` **([string][138] | null)?** A UID referring to the pool this Synthetic Account belongs to
-   `syntheticAccountTypeUid` **([string][138] | null)?** A UID referring to the Synthetic Account Type this Synthetic Account should be created as
-   `accountNumber` **([string][138] | null)?** The ACH account number (if any) associated with this account. Some Synthetic Account Types require this field to be submitted along with the POST request. For example, any Synthetic Account Type from the `external` category will require an `account_number`. Submitting an `account_number` with a Synthetic Account Type that does not require one will result in the account number being ignored.
-   `routingNumber` **([string][138] | null)?** The ABA routing number (if any) associated with this account. Some Synthetic Account Types require this field to be submitted along with the POST request. For example, any Synthetic Account Type from the `external` category will require a `routing_number`. Submitting a `routing_number` with a Synthetic Account Type that does not require one will result in the routing number being ignored.
...
-   `uid` **[string][138]** A unique identifier generated by Rize
-   `id` **[number][160]** A unique numeric identifier that indicates the order in which the Transactions were created
-   `settled_index` **([number][160] | null)?** A unique index that indicates the order in which the Transactions were settled. Null if status is `queued` or `pending`.
-   `transfer_uid` **([number][160] | null)?** The UID of the Transfer this Transaction is associated with, if any.
-   `source_synthetic_account_uid` **[string][138]** Synthetic Account from where the asset is pulled
-   `destination_synthetic_account_uid` **[string][138]** Synthetic Account where the asset is landed
-   `transaction_event_uids` **[Array][161]&lt;[string][138]>** A list of UIDS referring to Transaction Events belonging to this Transaction, if any. 
...
-   `custodial_account_uids` **[Array][161]&lt;[string][138]>** A list of UIDS referring to Custodial Accounts that are so far invovled in this Transaction. 
...
-   `us_dollar_amount` **[string][138]** The amount will never be negative
...
-   `created_at` **[string][138]** The date and time when the Transaction is first recognized by Rize. This may be when the Transfer is initiated if the Transaction is associated with one.
-   `settled_at` **[string][138]** The date and time when the Transaction is settled.
...
-   `customer_uid` **[Array][161]&lt;[string][138]>?** Filter by Customer.
-   `source_synthetic_account_uid` **[Array][161]&lt;[string][138]>?** Filter by source Synthetic Account.
-   `destination_synthetic_account_uid` **[Array][161]&lt;[string][138]>?** Filter by destination Synthetic Account.
-   `synthetic_account_uid` **[Array][161]&lt;[string][138]>?** Filter by Synthetic Account, source or destination.
-   `type` **[Array][161]&lt;(`"atm_withdrawal"` \| `"card_purchase"` \| `"card_refund"` \| `"dispute"` \| `"external_transfer"` \| `"fee"` \| `"internal_transfer"` \| `"other"` \| `"reversed_transfer"` \| `"third_party_transfer"`)>?** Filter by type.
-   `status` **[Array][161]&lt;(`"queued"` \| `"pending"` \| `"settled"` \| `"failed"`)>?** Filter by status.
-   `search_description` **[string][138]?** Attempts to search for the provided string in the description field. '\*' can be used as a wildcard. Any record with a match will be returned.
-   `limit` **[number][160]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default = 100.
-   `offset` **[number][160]?** Index of the items to start retrieving from. Default = 0.
...
-   `uid` **[string][138]** A unique identifier generated by Rize
-   `settled_index` **[number][160]** A unique index that indicates the order in which the Synthetic Line Items were settled
-   `transaction_uid` **[string][138]** UID of the Transaction this Synthetic Line Item belongs to
-   `synthetic_account_uid` **[string][138]** UID of the Synthetic Account this Synthetic Line Item is associated with
-   `status` **[string][138]** 
-   `us_dollar_amount` **[string][138]** The signed USD amount of this specific Synthetic Line Item
-   `running_us_dollar_balance` **[string][138]** The Synthetic Account balance after this Synthetic Line Item was settled
-   `description` **[string][138]** Human-readable description in context of Synthetic Accounts
-   `created_at` **[string][138]** The date and time when the Synthetic Line Item is first recognized by Rize. This may be when the Transfer is initiated if the Synthetic Line Item is associated with one.
-   `settled_at` **[string][138]** The date and time when the Synthetic Line Item is settled
...
-   `customer_uid` **[Array][161]&lt;[string][138]>?** Filter by Customer.
-   `pool_uid` **[Array][161]&lt;[string][138]>?** Filter by pool.
-   `synthetic_account_uid` **[Array][161]&lt;[string][138]>?** Filter by Synthetic Account.
-   `limit` **[number][160]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default = 100.
-   `offset` **[number][160]?** Index of the items to start retrieving from. Default = 0.
-   `transaction_uid` **[Array][161]&lt;[string][138]>?** Filter by Transaction.
-   `status` **[Array][161]&lt;(`"begun"` \| `"failed"` \| `"in_progress"` \| `"settled"`)>?** Filter by status.
...
-   `uid` **[string][138]** A unique identifier generated by Rize.
-   `settled_index` **[number][160]** A unique index that indicates the order in which the Custodial Line Items were settled.
-   `transaction_uid` **[string][138]** UID of the Transaction this Custodial Line Item belongs to.
-   `transaction_event_uid` **[string][138]** UID of the Transaction Event this Custodial Line Item belongs to.
-   `custodial_account_uid` **[string][138]** UID of the Custodial Account this Custodial Line Item is associated with.
-   `status` **[string][138]** 
-   `us_dollar_amount` **[string][138]** The signed USD amount of this specific Custodial Line Item
-   `running_us_dollar_balance` **([string][138] | null)?** US dollar balance of the Custodial Account as of the completion of this Custodial Line Item. This field may be empty unless the status is `settled` or `voided`.
-   `type` **[string][138]** Symbols and/or numbers that represent different types of Custodial Line Items.
-   `description` **[string][138]** Descriptions pulled from the custodians, such as through NACHA description or ISO-8583 data element 43.
-   `created_at` **[string][138]** The date and time when the Custodial Line Items is first recognized by Rize. This may be when the Transfer is initiated if the Custodial Line Item is associated with one.
-   `occurred_at` **[string][138]** This field may be empty if status is not settled or voided.
-   `settled_at` **[string][138]** The date and time when the Custodial Line Item is settled.
...
-   `customer_uid` **[Array][161]&lt;[string][138]>?** Filter by Customer.
-   `custodial_account_uid` **[Array][161]&lt;[string][138]>?** Filter by Custodial Account.
-   `status` **[Array][161]&lt;(`"settled"` \| `"voided"`)>?** Filter by status.
-   `us_dollar_amount_tax` **[number][160]?** Return any records having a us_dollar_amount at or below us_dollar_amount_max.
-   `us_dollar_amount_min` **[number][160]?** Return any records having a us_dollar_amount at or above us_dollar_amount_min.
-   `transaction_event_uid` **[Array][161]&lt;[string][138]>?** Filter by Transaction Event.
-   `transaction_uid` **[Array][161]&lt;[string][138]>?** Filter by Transaction.
-   `limit` **[number][160]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default = 100.
-   `offset` **[number][160]?** Index of the items to start retrieving from. Default = 0.
...
-   `timeout` **[number][160]?** Specifies the number of milliseconds before the each request times out. (Default: 80000)
...
-   `programUid` **[string][138]** The Rize Program ID.
-   `hmac` **[string][138]** The HMAC that will be used to sign the JSON web signature in order to get access to the API.
-   `options` **[RizeOptions][169]?** Configuration options (optional, default `RizeOptions`)
...
Type: [ComplianceWorkflowService][170]
...
Type: [SyntheticAccountService][172]
...
Type: [CustodialAccountService][173]
...
[82]: #complianceworkflowsummary

[83]: #properties-1

[84]: #complianceworkflowcustomer

[85]: #properties-2

[86]: #compliancedocument

[87]: #properties-3

[88]: #compliancedocumentacknowledgementrequest
...
[104]: #customerlistquery

[105]: #properties-12

[106]: #syntheticaccounttype

[107]: #properties-13

[108]: #syntheticaccounttypelistquery

[109]: #properties-14

[110]: #syntheticaccount

[111]: #properties-15

[112]: #syntheticaccountlistquery

[113]: #properties-16

[114]: #syntheticaccountcreaterequest
...
[118]: #transactionlistquery

[119]: #properties-19

[120]: #syntheticlineitem

[121]: #properties-20

[122]: #syntheticlineitemlistquery

[123]: #properties-21

[124]: #custodiallineitem

[125]: #properties-22

[126]: #custodiallineitemlistquery
...
[132]: #complianceworkflow-1

[133]: #customer-1

[134]: #syntheticaccount-1

[135]: #custodialaccount-1
...
[141]: #compliancedocumentacknowledgementrequest
...
[145]: #customerlistquery

[146]: #customer

[147]: #customerdetails

[148]: #syntheticaccountlistquery

[149]: #syntheticaccount

[150]: #syntheticaccountcreaterequest

[151]: #syntheticaccounttypelistquery

[152]: #syntheticaccounttype

[153]: #transactionlistquery

[154]: #transaction

[155]: #syntheticlineitemlistquery

[156]: #syntheticlineitem
...
[162]: #complianceworkflowsummary

[163]: #complianceworkflowcustomer
...
[170]: #complianceworkflowservice

[171]: #customerservice

[172]: #syntheticaccountservice

[173]: #custodialaccountservice
