...
-   [TransactionService][64]
    -   [getList][65]
        -   [Parameters][66]
    -   [getTransactionEventList][67]
        -   [Parameters][68]
        -   [Examples][69]
    -   [get][70]
        -   [Parameters][71]
        -   [Examples][72]
    -   [getTransactionEvent][73]
        -   [Parameters][74]
        -   [Examples][75]
-   [RizeList][76]
    -   [Properties][77]
-   [ComplianceWorkflowSummary][78]
    -   [Properties][79]
-   [ComplianceWorkflowCustomer][80]
    -   [Properties][81]
-   [ComplianceDocument][82]
    -   [Properties][83]
-   [ComplianceDocumentAcknowledgementRequest][84]
    -   [Properties][85]
...
-   [Customer][98]
    -   [Properties][99]
-   [CustomerListQuery][100]
    -   [Properties][101]
-   [SyntheticAccountType][102]
    -   [Properties][103]
-   [SyntheticAccountTypeListQuery][104]
    -   [Properties][105]
-   [SyntheticAccount][106]
    -   [Properties][107]
-   [SyntheticAccountListQuery][108]
    -   [Properties][109]
-   [SyntheticAccountCreateRequest][110]
    -   [Properties][111]
-   [Transaction][112]
    -   [Properties][113]
-   [TransactionListQuery][114]
    -   [Properties][115]
-   [TransactionEventListQuery][116]
    -   [Properties][117]
-   [RizeOptions][118]
    -   [Properties][119]
-   [Rize][120]
    -   [Parameters][121]
    -   [complianceWorkflow][122]
    -   [customer][123]
...
-   `customerExternalUid` **[string][128]** A Customer identifier supplied by the Partner, unique among the collection of all partner Customers.
-   `email` **[string][128]** Email address associated with the Customer.
...
Returns **[Promise][129]&lt;[ComplianceWorkflow][130]>** A promise that returns the new Compliance Workflow if resolved.
...
-   `customerExternalUid` **[string][128]** A Customer identifier supplied by the Partner, unique among the collection of all partner Customers.
-   `customerUid` **[string][128]** A UID referring to the Customer generated by Rize
-   `email` **[string][128]** Email address associated with the Customer.

Returns **[Promise][129]&lt;[ComplianceWorkflow][130]>** A promise that returns the new Compliance Workflow entity if resolved.
...
-   `customerUid` **[string][128]** A UID referring to the Customer
...
Returns **[Promise][129]&lt;[ComplianceWorkflow][130]>** A promise that returns the latest Compliance Workflow if resolved.
...
-   `complianceWorkflowUid` **[string][128]** A UID referring to the Compliance Workflow.
-   `customerUid` **[string][128]** A UID referring to the Customer.
-   `documents` **...[ComplianceDocumentAcknowledgementRequest][131]** 
...
Returns **[Promise][129]&lt;[ComplianceWorkflow][130]>** A promise that returns the updated Compliance Workflow if resolved.
...
-   `uid` **[string][128]** Rize-generated unique custodial account id
...
Returns **[Promise][129]&lt;[CustodialAccount][132]>** A promise that returns a Custodial Account if resolved.
...
-   `query` **[CustodialAccountListQuery][133]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][129]&lt;[RizeList][134]&lt;CustodialAccountList>>** A promise that returns a Custodial Account List if resolved.
...
-   `query` **[CustomerListQuery][135]** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][129]&lt;[RizeList][134]&lt;[Customer][136]>>** A promise that returns a Customer List if resolved.
...
-   `uid` **[string][128]** Rize-generated unique customer id
...
Returns **[Promise][129]&lt;[Customer][136]>** A promise that returns a Customer if resolved.
...
-   `uid` **[string][128]** Rize-generated unique customer id
-   `email` **[string][128]** Email of the customer
-   `details` **[CustomerDetails][137]** An object containing the supplied identifying information for the Customer
...
Returns **[Promise][129]&lt;[Customer][136]>** A promise that returns the updated Customer if resolved.
...
Returns **[Promise][129]&lt;void>** A promise that returns void if resolved.
...
-   `uid` **[string][128]** Rize-generated unique customer id
-   `lockReason` **[string][128]** The reason that the Customer is being locked must be submitted with the request body.
...
Returns **[Promise][129]&lt;[Customer][136]>** A promise that returns the locked Customer if resolved.
...
-   `uid` **[string][128]** Rize-generated unique customer id
-   `unlockReason` **[string][128]** The reason that the Customer is being unlocked. (optional, default `null`)
...
Returns **[Promise][129]&lt;[Customer][136]>** A promise that returns the unlocked Customer if resolved.
...
-   `query` **[SyntheticAccountListQuery][138]**  (optional, default `{}`)
...
Returns **[Promise][129]&lt;[RizeList][134]&lt;[SyntheticAccount][139]>>** A promise that returns the Synthetic Account list if resolved.
...
-   `uid` **[string][128]** Rize-generated unique synthetic account id
...
Returns **[Promise][129]&lt;[SyntheticAccount][139]>** A promise that returns a SyntheticAccount if resolved.

### create

#### Parameters

-   `payload` **[SyntheticAccountCreateRequest][140]** is a JSON object needs to send as body parameters in order to create new synthetic accounts.
...
Returns **[Promise][129]&lt;[RizeList][134]&lt;[SyntheticAccount][139]>>** 
...
Returns **[Promise][129]&lt;[SyntheticAccount][139]>** A promise that returns a Synthetic Account if resolved.
...
-   `query` **[SyntheticAccountTypeListQuery][141]** An object containing key value paris for filtering the result. (optional, default `{}`)
...
Returns **[Promise][129]&lt;[RizeList][134]&lt;[SyntheticAccountType][142]>>** A promise that returns a Synthetic Account Type List if resolved.
...
-   `uid` **[string][128]** Rize-generated unique Synthetic Account Type id
...
Returns **[Promise][129]&lt;[SyntheticAccountType][142]>** A promise that returns a Synthetic Account Type if resolved.
...
-   `query` **[TransactionListQuery][143]?** An object containing key value pair for filtering the results list. (optional, default `{}`)

Returns **[Promise][129]&lt;[RizeList][134]&lt;[Transaction][144]>>** A promise that returns a Transaction List if resolved.
...
-   `query` **[TransactionEventListQuery][145]?** An object containing key value pair for filtering the results list. (optional, default `{}`)
...
Returns **[Promise][129]&lt;[RizeList][134]&lt;TransactionEvent>>** A promise that returns a TransactionEvent List if resolved.
...
-   `uid` **[string][128]** Rize-generated unique transaction id
...
Returns **[Promise][129]&lt;[Transaction][144]>** A promise that returns a Transaction if resolved.
...
Returns **[Promise][129]&lt;TransactionEvent>** A promise that returns a Transaction Event if resolved.
...
-   `total_count` **[number][147]** Total count of items available to retrieve
-   `count` **[number][147]** Number of items retrieved
-   `limit` **[number][147]** Maximum number of items to retrieve
-   `offset` **[number][147]** Index of the first item to retrieve
-   `data` **[Array][148]&lt;T>** 
...
-   `accepted_quantity` **[number][147]** 
-   `begun_at` **[string][128]** The DateTime at which this Compliance Workflow was requested
-   `completed_step` **[number][147]** 
-   `current_step` **[number][147]** 
...
-   `email` **[string][128]** 
-   `external_uid` **[string][128]** A Customer identifier supplied by the Client, unique among the collection of all Client Customers
-   `uid` **[string][128]** A UID referring to the Customer
...
-   `external_storage_name` **[string][128]** Amazon S3 key used to retrieve the contents of a Compliance Document
-   `compliance_document_url` **[string][128]** Amazon S3 URL used to retrieve the contents of a Compliance Document
-   `name` **[string][128]** 
-   `step` **[number][147]** Multiple Compliance Documents are grouped into a Step, and Compliance Documents are presented to a Customer, Step-by-Step
-   `version` **[number][147]** 
-   `uid` **[string][128]** A UID referring to a Compliance Document; note that this UID will be different for each Customer
-   `accepted_at` **[string][128]** The DateTime at which this Compliance Document was acknowledged
...
-   `documentUid` **[string][128]** A UID referring to the Compliance Document being acknowledged.
-   `accept` **(`"yes"` \| `"no"`)** An indication of acceptance or rejection.
-   `userName` **[string][128]?** A label associated with the Customer (required for electronic signing).
-   `ipAddress` **[string][128]?** A numerical label assigned to each device connected to a computer network that uses the Internet Protocol for communication (required for electronic signing); in this case, the label associated with the computer used by the Customer.
...
-   `uid` **[string][128]** A unique identifier generated by Rize.
-   `summary` **[ComplianceWorkflowSummary][149]** 
-   `customer` **[ComplianceWorkflowCustomer][150]** 
-   `accepted_documents` **[Array][148]&lt;[ComplianceDocument][151]>** 
-   `current_step_documents_pending` **[Array][148]&lt;Omit&lt;[ComplianceDocument][151], `"accepted_at"`>>** Compliance Documents that await acknowledgment in the current Step
-   `all_documents` **[Array][148]&lt;Omit&lt;[ComplianceDocument][151], (`"accepted_at"` \| `"uid"`)>>** The set of all Compliance Documents that would require acknowledgment
...
-   `error_name` **[string][128]** 
-   `error_description` **[string][128]** 
...
-   `uid` **[string][128]** A unique identifier generated by Rize
-   `external_uid` **[string][128]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `customer_uid` **[string][128]** A UID referring to the customer this Custodial Account belongs to
-   `pool_uid` **[Array][148]&lt;[string][128]>** A UID referring to the pool this Custodial Account belongs to
-   `program_service_offering_uid` **([string][128] | null)** A UID referring to the specific Program Service Offering for which this account was created. Nullable if asset.
...
-   `liability` **[boolean][152]** Liability or asset. Liability Custodial Accounts represent real accounts at Financial Institutions. Asset accounts are used for accounting purposes and may be generated by Rize during events such as new custodial account creations or new external account connections.
-   `name` **([string][128] | null)** A friendly name used to identify the account at the Custodial Partner.
-   `primary_account` **[boolean][152]** The date and time when the Customer was locked. This field will be null if and only if the lock_reason is null.
...
-   `account_errors` **[Array][148]&lt;[AccountError][153]>** A list of errors related to this account. These are passed through during interactions with the underlying Custodial Partner and can help with resolving customer issues. Only provided for accounts that are in an error or manual_review status.
-   `net_usd_balance` **[string][128]** The current settled balance of this Custodial Account in US Dollars
-   `net_usd_pending_balance` **[string][128]** The sum of all pending transactions for this Custodial Account in US Dollars
-   `net_usd_available_balance` **[string][128]** The balance available to spend calculated as Normal balance less any withdrawals. Pending deposits are not included
-   `account_number` **([string][128] | null)** The ACH account number that can be used to make transfers into/out of this account. Nullable if asset.
-   `account_number_masked` **([string][128] | null)** Last 4 digits of the ACH account number. Nullable if asset.
-   `routing_number` **([string][128] | null)** The ABA routing number associated with the Custodial Partner. Nullable if asset.
-   `opened_at` **[Date][154]** The DateTime at which this account was created
-   `closed_at` **[Date][154]** The DateTime at which this account was closed
...
-   `customer_uid` **[Array][148]&lt;[string][128]>?** Filter by Customer. Multiple values are allowed
-   `external_uid` **[string][128]?** A unique, immutable id provided Clien
-   `limit` **[string][128]?**  Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[string][128]?** Index of the items to start retrieving from. Default: 0
-   `liability` **[string][128]?** Filter by liability or asset
-   `type` **[Array][148]&lt;[string][128]>?** Filter by type. Multiple values are allowed.
...
-   `middle_name` **([string][128] | null)?** 
-   `last_name` **[string][128]** 
-   `suffix` **([string][128] | null)?** 
-   `phone` **[string][128]** 
-   `ssn` **[string][128]** 
-   `dob` **[string][128]** 
-   `address` **[Address][155]** 
...
-   `uid` **[string][128]** A unique identifier generated by Rize
-   `external_uid` **[string][128]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `program_uid` **[string][128]** A uid referring to the program this customer belongs to.
-   `pool_uids` **[Array][148]&lt;[string][128]>** A list of uids referring to Pools belonging to this Customer.
-   `email` **[string][128]** Email of the customer
...
-   `total_balance` **[string][128]** Total asset owned by the customer in US dollars.
-   `created_at` **[Date][154]** 
-   `locked_at` **([Date][154] | null)?** The date and time when the Customer was locked. This field will be null if and only if the lock_reason is null.
-   `lock_reason` **([string][128] | null)?** The lock reason provided by the Client, an admin User, or the system at the time the Customer was locked. This field will be null if and only if the locked_at is null.
-   `details` **[CustomerDetails][137]** An object containing the supplied identifying information for the Customer.
...
-   `include_initiated` **[boolean][152]?** By default, Customers in initiated status are not shown, even if the `status=initiated` parameter is provided. In order for Customers with status initiated to appear in search results, parameters must include `include_initiated=true`.
...
-   `first_name` **[string][128]?** Only return Customers with a first name matching exactly what is submitted
-   `last_name` **[string][128]?** Only return Customers with a last name matching exactly what is submitted
-   `email` **[string][128]?** Only return Customers with an email address matching exactly what is submitted
-   `locked` **[boolean][152]?** Only return locked Customers if true and only return unlocked Customers if false
-   `program_uid` **[string][128]?** Only return Customers belonging to the submitted Program.
-   `external_uid` **[string][128]?** A unique, immutable id provided by Client.
-   `pool_uid` **[Array][148]&lt;[string][128]>?** Filter by pool. Multiple values are allowed.
-   `limit` **[string][128]?**  Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[string][128]?** Index of the items to start retrieving from. Default: 0
...
-   `uid` **[string][128]** A unique identifier generated by Rize
-   `name` **[string][128]** A unique name to identify the resource
...
-   `description` **[string][128]** A description outlining the intended use and requirements for this program's instance of the synthetic_account_type
-   `program_uid` **[string][128]?** A uid referring to the Program this synthetic_account_type belongs to
...
-   `program_uid` **[string][128]?** Only list Synthetic Account Types that are available to be used by the given Program
-   `limit` **[number][147]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[number][147]?** Index of the items to start retrieving from. Default: 0
...
-   `external_uid` **[string][128]** A unique identifier Client supplies. It should be given when creating a new resource and must be unique within the resource type. If the same value is given, no new resource will be created.
-   `name` **[string][128]** A unique name to identify the resource.
-   `pool_uid` **[string][128]** A UID referring to the pool this Synthetic Account belongs to.
-   `synthetic_account_type_uid` **[string][128]** A UID referring to the Synthetic Account Type this Synthetic Account should be created as.
...
-   `liability` **[boolean][152]** Liability or asset. Any Synthetic Account created via POST /synthetic_accounts is a liability account, except for external accounts. Some asset Synthetic Accounts are automatically created by Rize during Customer onboarding for accounting purposes.
-   `net_usd_balance` **[string][128]** The current settled balance of this account in US Dollars. This field will be null for synthetic_account_types in the external category.
-   `net_usd_pending_balance` **[string][128]** The sum of all pending transactions for this account in US Dollars. This field will be null for Synthetic Account Types in the external category.
-   `net_usd_available_balance` **[string][128]** The balance available to spend calculated as the settled balance less any pending withdrawals Pending deposits are not included. This field will be null for Synthetic Account Types in the external category.
-   `master_account` **[boolean][152]** Used to identify the Master Synthetic Accounts that exist for every Program Customer. Master Synthetic Accounts are the default accounts where any unknown custodial transactions will settle and cannot be archived while a Program Customer is still active.
-   `account_number` **([string][128] | null)** The ACH account number (if any) associated with this account. Some Synthetic Account Types require this field to be submitted along with the POST request. For example, any Synthetic Account Type from the `external` category will require an `account_number`. Submitting an `account_number` with a Synthetic Account Type that does not require one will result in the account number being ignored.
-   `account_number_last_four` **([string][128] | null)** Last 4 digits of the ACH account number.
-   `routing_number` **([string][128] | null)** The ABA routing number (if any) associated with this account. Some Synthetic Account Types require this field to be submitted along with the POST request. For example, any Synthetic Account Type from the `external` category will require a `routing_number`. Submitting a `routing_number` with a Synthetic Account Type that does not require one will result in the routing number being ignored.
-   `opened_at` **[string][128]** The DateTime at which this account was created
-   `closed_at` **([string][128] | null)** The DateTime at which this account was closed. This value will be present if the status is `archived` or `failed`.
-   `closed_to_synthetic_account_uid` **([string][128] | null)** A UID referring to the Synthetic Account where the funds in this account were transferred when closed. Any transactions issued against this account after it is closed will instead go to the `closed_to` account
...
-   `customer_uid` **[Array][148]&lt;[string][128]>?** Filter by Customer. Multiple string values are allowed.
-   `external_uid` **[string][128]?** A unique, immutable id provided Client
-   `pool_uid` **[Array][148]&lt;[string][128]>?** Filter by pool. Multiple string values are allowed.
-   `limit` **[number][147]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default: 100
-   `offset` **[number][147]?** Index of the items to start retrieving from. Default: 0
-   `synthetic_account_type_uid` **[string][128]?** Filter by Synthetic Account Type
-   `synthetic_account_category` **(`"general"` \| `"external"` \| `"plaid_external"`)?** Filter by Synthetic Account Category
-   `liability` **[boolean][152]?** Filter by liability or asset
...
-   `externalUid` **([string][128] | null)?** A unique identifier Client supplies
-   `name` **([string][128] | null)?** A unique name to identify the resource
-   `poolUid` **([string][128] | null)?** A UID referring to the pool this Synthetic Account belongs to
-   `syntheticAccountTypeUid` **([string][128] | null)?** A UID referring to the Synthetic Account Type this Synthetic Account should be created as
-   `accountNumber` **([string][128] | null)?** The ACH account number (if any) associated with this account. Some Synthetic Account Types require this field to be submitted along with the POST request. For example, any Synthetic Account Type from the `external` category will require an `account_number`. Submitting an `account_number` with a Synthetic Account Type that does not require one will result in the account number being ignored.
-   `routingNumber` **([string][128] | null)?** The ABA routing number (if any) associated with this account. Some Synthetic Account Types require this field to be submitted along with the POST request. For example, any Synthetic Account Type from the `external` category will require a `routing_number`. Submitting a `routing_number` with a Synthetic Account Type that does not require one will result in the routing number being ignored.
...
-   `uid` **[string][128]** A unique identifier generated by Rize
-   `id` **[number][147]** A unique numeric identifier that indicates the order in which the Transactions were created
-   `settled_index` **([number][147] | null)?** A unique index that indicates the order in which the Transactions were settled. Null if status is `queued` or `pending`.
-   `transfer_uid` **([number][147] | null)?** The UID of the Transfer this Transaction is associated with, if any.
-   `source_synthetic_account_uid` **[string][128]** Synthetic Account from where the asset is pulled
-   `destination_synthetic_account_uid` **[string][128]** Synthetic Account where the asset is landed
-   `transaction_event_uids` **[Array][148]&lt;[string][128]>** A list of UIDS referring to Transaction Events belonging to this Transaction, if any. 
...
-   `custodial_account_uids` **[Array][148]&lt;[string][128]>** A list of UIDS referring to Custodial Accounts that are so far invovled in this Transaction. 
...
-   `us_dollar_amount` **[string][128]** The amount will never be negative
...
-   `created_at` **[string][128]** The date and time when the Transaction is first recognized by Rize. This may be when the Transfer is initiated if the Transaction is associated with one.
-   `settled_at` **[string][128]** The date and time when the Transaction is settled.
...
-   `customer_uid` **[Array][148]&lt;[string][128]>?** Filter by Customer.
-   `source_synthetic_account_uid` **[Array][148]&lt;[string][128]>?** Filter by source Synthetic Account.
-   `destination_synthetic_account_uid` **[Array][148]&lt;[string][128]>?** Filter by destination Synthetic Account.
-   `synthetic_account_uid` **[Array][148]&lt;[string][128]>?** Filter by Synthetic Account, source or destination.
-   `type` **[Array][148]&lt;(`"atm_withdrawal"` \| `"card_purchase"` \| `"card_refund"` \| `"dispute"` \| `"external_transfer"` \| `"fee"` \| `"internal_transfer"` \| `"other"` \| `"reversed_transfer"` \| `"third_party_transfer"`)>?** Filter by type.
-   `status` **[Array][148]&lt;(`"queued"` \| `"pending"` \| `"settled"` \| `"failed"`)>?** Filter by status.
-   `search_description` **[string][128]?** Attempts to search for the provided string in the description field. '\*' can be used as a wildcard. Any record with a match will be returned.
-   `limit` **[number][147]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default = 100.
-   `offset` **[number][147]?** Index of the items to start retrieving from. Default = 0.
...
-   `uid` **[string][128]** A unique identifier generated by Rize
-   `settled_index` **[number][147]** A unique index that indicates the order in which Transaction Events were settled
-   `transaction_uid` **[string][128]** UID of the Transaction this line item belongs to
...
-   `source_custodial_account_uid` **[string][128]** Custodial Account from which the asset is pulled
-   `destination_custodial_account_uid` **[string][128]** Custodial Account where the asset lands
-   `custodial_line_item_uids` **[Array][148]&lt;[string][128]>** A list of UIDS referring to Custodial Line Items belonging to this event. There are always at least two line items if the status is settled.
-   `status` **[string][128]** Other statuses such as pending will be available later
-   `us_dollar_amount` **[string][128]** The amount will never be negative
...
-   `description` **[string][128]** 
-   `created_at` **[string][128]** The date and time when the event is first recognized by Rize. This may be when the Transfer is initiated if the event is associated with one.
-   `settled_at` **[string][128]** The date and time when the event is settled.
    //\*\*
-   `source_custodial_account_uid` **[Array][148]&lt;[string][128]>?** Filter by source Custodial Account.
-   `destination_custodial_account_uid` **[Array][148]&lt;[string][128]>?** Filter by destination Custodial Account.
-   `custodial_account_uid` **[Array][148]&lt;[string][128]>?** Filter by Custodial Account, source or destination.
-   `type` **[Array][148]&lt;(`"odfi_ach_deposit"` \| `"odfi_ach_withdrawal"` \| `"rdfi_ach_deposit"` \| `"rdfi_ach_withdrawal"`)>?** Filter by type. Multiple values are allowed.
-   `transaction_uid` **[string][128]?** Filter by Transaction. Multiple values are allowed
-   `limit` **[number][147]?** Maximum number of items to retrieve. This filter is automatically applied with the default value if not given. Default = 100.
-   `offset` **[number][147]?** Index of the items to start retrieving from. Default = 0.
...
-   `timeout` **[number][147]?** Specifies the number of milliseconds before the each request times out. (Default: 80000)
...
-   `programUid` **[string][128]** The Rize Program ID.
-   `hmac` **[string][128]** The HMAC that will be used to sign the JSON web signature in order to get access to the API.
-   `options` **[RizeOptions][156]?** Configuration options (optional, default `RizeOptions`)
...
Type: [ComplianceWorkflowService][157]
...
Type: [SyntheticAccountService][159]
...
Type: [CustodialAccountService][160]
...
[78]: #complianceworkflowsummary

[79]: #properties-1

[80]: #complianceworkflowcustomer

[81]: #properties-2

[82]: #compliancedocument

[83]: #properties-3

[84]: #compliancedocumentacknowledgementrequest

[85]: #properties-4

[86]: #complianceworkflow
...
[104]: #syntheticaccounttypelistquery

[105]: #properties-14

[106]: #syntheticaccount

[107]: #properties-15

[108]: #syntheticaccountlistquery

[109]: #properties-16

[110]: #syntheticaccountcreaterequest
...
[114]: #transactionlistquery

[115]: #properties-19

[116]: #transactioneventlistquery
...
[122]: #complianceworkflow-1

[123]: #customer-1

[124]: #syntheticaccount-1

[125]: #custodialaccount-1
...
[130]: #complianceworkflow

[131]: #compliancedocumentacknowledgementrequest

[132]: #custodialaccount

[133]: #custodialaccountlistquery

[134]: #rizelist

[135]: #customerlistquery

[136]: #customer

[137]: #customerdetails

[138]: #syntheticaccountlistquery

[139]: #syntheticaccount

[140]: #syntheticaccountcreaterequest

[141]: #syntheticaccounttypelistquery

[142]: #syntheticaccounttype

[143]: #transactionlistquery

[144]: #transaction

[145]: #transactioneventlistquery
...
[150]: #complianceworkflowcustomer

[151]: #compliancedocument

[152]: https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Boolean

[153]: #accounterror

[154]: https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Date

[155]: #address

[156]: #rizeoptions

[157]: #complianceworkflowservice

[158]: #customerservice

[159]: #syntheticaccountservice

[160]: #custodialaccountservice
